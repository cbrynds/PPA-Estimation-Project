...
--  approx. output signal timings: R: (c0, 1.574875ns)Sticky: (c1, 0.379250ns)
...
signal stk0 :  std_logic;
   -- timing of stk0: (c1, 0.164250ns)
signal level0 :  std_logic_vector(12 downto 0);
   -- timing of level0: (c0, 1.574875ns)
signal stk :  std_logic;
   -- timing of stk: (c1, 0.379250ns)
begin
   process(clk)
      begin
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.713000ns)Y: (c0, 1.789875ns)Cin: (c1, 0.594250ns)
--  approx. output signal timings: R: (c1, 1.092250ns)
...
--  approx. input signal timings: X: (c1, 1.092250ns)
--  approx. output signal timings: Count: (c2, 0.756625ns)R: (c2, 0.971625ns)
...
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c1, 1.092250ns)
signal count3, count3_d1 :  std_logic;
   -- timing of count3: (c1, 1.311000ns)
signal level3, level3_d1 :  std_logic_vector(14 downto 0);
   -- timing of level3: (c1, 1.526000ns)
signal count2, count2_d1 :  std_logic;
   -- timing of count2: (c1, 1.742875ns)
signal level2 :  std_logic_vector(14 downto 0);
   -- timing of level2: (c2, 0.107875ns)
signal count1 :  std_logic;
   -- timing of count1: (c2, 0.324750ns)
signal level1 :  std_logic_vector(14 downto 0);
   -- timing of level1: (c2, 0.539750ns)
signal count0 :  std_logic;
   -- timing of count0: (c2, 0.756625ns)
signal level0 :  std_logic_vector(14 downto 0);
   -- timing of level0: (c2, 0.971625ns)
signal sCount :  std_logic_vector(3 downto 0);
   -- timing of sCount: (c2, 0.756625ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   level2<= level3_d1(14 downto 0) when count2_d1='0' else level3_d1(10 downto 0) & (3 downto 0 => '0');
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c2, 1.228625ns)Y: (c0, 0.000000ns)Cin: (c2, 1.186625ns)
--  approx. output signal timings: R: (c2, 1.767625ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00376_fpadd_top
--                         (FPSub_5_10_Freq500_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c3, 0.347625ns)
...
entity flopoco_00376_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00376_fpadd_top is
...
signal sticky :  std_logic;
   -- timing of sticky: (c1, 0.379250ns)
...
signal cInSigAdd :  std_logic;
   -- timing of cInSigAdd: (c1, 0.594250ns)
signal fracAddResult :  std_logic_vector(13 downto 0);
   -- timing of fracAddResult: (c1, 1.092250ns)
signal fracSticky :  std_logic_vector(14 downto 0);
   -- timing of fracSticky: (c1, 1.092250ns)
signal nZerosNew :  std_logic_vector(3 downto 0);
   -- timing of nZerosNew: (c2, 0.756625ns)
signal shiftedFrac :  std_logic_vector(14 downto 0);
   -- timing of shiftedFrac: (c2, 0.971625ns)
...
signal updatedExp :  std_logic_vector(6 downto 0);
   -- timing of updatedExp: (c2, 1.228625ns)
signal eqdiffsign, eqdiffsign_d1 :  std_logic;
   -- timing of eqdiffsign: (c2, 0.756625ns)
signal expFrac :  std_logic_vector(17 downto 0);
   -- timing of expFrac: (c2, 1.228625ns)
signal stk :  std_logic;
   -- timing of stk: (c2, 0.971625ns)
signal rnd :  std_logic;
   -- timing of rnd: (c2, 0.971625ns)
signal lsb :  std_logic;
   -- timing of lsb: (c2, 0.971625ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c2, 1.186625ns)
signal RoundedExpFrac :  std_logic_vector(17 downto 0);
   -- timing of RoundedExpFrac: (c2, 1.767625ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c2, 1.767625ns)
signal fracR, fracR_d1 :  std_logic_vector(9 downto 0);
   -- timing of fracR: (c2, 1.767625ns)
signal expR, expR_d1 :  std_logic_vector(4 downto 0);
   -- timing of expR: (c2, 1.767625ns)
signal exExpExc, exExpExc_d1 :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c2, 1.767625ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c3, 0.132625ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c3, 0.347625ns)
signal signR2, signR2_d1 :  std_logic;
   -- timing of signR2: (c2, 0.971625ns)
signal computedR :  std_logic_vector(17 downto 0);
   -- timing of computedR: (c3, 0.347625ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
