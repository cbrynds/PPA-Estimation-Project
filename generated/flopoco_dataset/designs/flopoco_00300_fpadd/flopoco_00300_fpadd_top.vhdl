--------------------------------------------------------------------------------
--                RightShifterSticky32_by_max_34_Freq250_uid4
...
entity RightShifterSticky32_by_max_34_Freq250_uid4 is
...
architecture arch of RightShifterSticky32_by_max_34_Freq250_uid4 is
...
entity IntAdder_35_Freq250_uid6 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_35_Freq250_uid6 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_36_36_36_Freq250_uid8
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Count: (c1, 2.096250ns)R: (c1, 2.311250ns)
...
entity Normalizer_Z_36_36_36_Freq250_uid8 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_36_36_36_Freq250_uid8 is
signal level6, level6_d1 :  std_logic_vector(35 downto 0);
...
signal level5 :  std_logic_vector(35 downto 0);
   -- timing of level5: (c1, 0.146250ns)
signal count4 :  std_logic;
   -- timing of count4: (c1, 0.366875ns)
signal level4 :  std_logic_vector(35 downto 0);
   -- timing of level4: (c1, 0.581875ns)
signal count3 :  std_logic;
   -- timing of count3: (c1, 0.800625ns)
signal level3 :  std_logic_vector(35 downto 0);
   -- timing of level3: (c1, 1.015625ns)
signal count2 :  std_logic;
   -- timing of count2: (c1, 1.232500ns)
signal level2 :  std_logic_vector(35 downto 0);
   -- timing of level2: (c1, 1.447500ns)
signal count1 :  std_logic;
   -- timing of count1: (c1, 1.664375ns)
signal level1 :  std_logic_vector(35 downto 0);
   -- timing of level1: (c1, 1.879375ns)
signal count0 :  std_logic;
   -- timing of count0: (c1, 2.096250ns)
signal level0 :  std_logic_vector(35 downto 0);
   -- timing of level0: (c1, 2.311250ns)
signal sCount :  std_logic_vector(5 downto 0);
   -- timing of sCount: (c1, 2.096250ns)
begin
   process(clk)
      begin
   ...
   level5<= level6_d1(35 downto 0) when count5_d1='0' else level6_d1(3 downto 0) & (31 downto 0 => '0');
   ...
   R <= level0;
   sCount <= count5_d1 & count4 & count3 & count2 & count1 & count0;
   Count <= sCount;
end architecture;

--------------------------------------------------------------------------------
--                         IntAdder_42_Freq250_uid11
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca, Florent de Dinechin (2008-2016)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 2.594250ns)Y: (c0, 0.000000ns)Cin: (c1, 2.526250ns)
--  approx. output signal timings: R: (c1, 3.256250ns)
...
entity IntAdder_42_Freq250_uid11 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_42_Freq250_uid11 is
signal Rtmp :  std_logic_vector(41 downto 0);
   -- timing of Rtmp: (c1, 3.256250ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00300_fpadd_top
--                         (FPAdd_8_31_Freq250_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 3.686250ns)
...
entity flopoco_00300_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00300_fpadd_top is
   component RightShifterSticky32_by_max_34_Freq250_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(31 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(33 downto 0);
   ...
   component IntAdder_35_Freq250_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(34 downto 0);
             Y : in  std_logic_vector(34 downto 0);
             Cin : in  std_logic;
   ...
   component Normalizer_Z_36_36_36_Freq250_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(35 downto 0);
             Count : out  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(35 downto 0)   );
   ...
   component IntAdder_42_Freq250_uid11 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(41 downto 0);
             Y : in  std_logic_vector(41 downto 0);
             Cin : in  std_logic;
...
signal nZerosNew :  std_logic_vector(5 downto 0);
   -- timing of nZerosNew: (c1, 2.096250ns)
signal shiftedFrac :  std_logic_vector(35 downto 0);
   -- timing of shiftedFrac: (c1, 2.311250ns)
signal extendedExpInc, extendedExpInc_d1 :  std_logic_vector(8 downto 0);
   -- timing of extendedExpInc: (c0, 1.252000ns)
signal updatedExp :  std_logic_vector(9 downto 0);
   -- timing of updatedExp: (c1, 2.594250ns)
signal eqdiffsign :  std_logic;
   -- timing of eqdiffsign: (c1, 2.096250ns)
signal expFrac :  std_logic_vector(41 downto 0);
   -- timing of expFrac: (c1, 2.594250ns)
signal stk :  std_logic;
   -- timing of stk: (c1, 2.311250ns)
signal rnd :  std_logic;
   -- timing of rnd: (c1, 2.311250ns)
signal lsb :  std_logic;
   -- timing of lsb: (c1, 2.311250ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c1, 2.526250ns)
signal RoundedExpFrac :  std_logic_vector(41 downto 0);
   -- timing of RoundedExpFrac: (c1, 3.256250ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c1, 3.256250ns)
signal fracR :  std_logic_vector(30 downto 0);
   -- timing of fracR: (c1, 3.256250ns)
signal expR :  std_logic_vector(7 downto 0);
   -- timing of expR: (c1, 3.256250ns)
signal exExpExc :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c1, 3.256250ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c1, 3.471250ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c1, 3.686250ns)
signal signR2 :  std_logic;
   -- timing of signR2: (c1, 2.311250ns)
signal computedR :  std_logic_vector(41 downto 0);
   -- timing of computedR: (c1, 3.686250ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   RightShifterComponent: RightShifterSticky32_by_max_34_Freq250_uid4
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracY,
                 R => shiftedFracY,
   ...
   fracAdder: IntAdder_35_Freq250_uid6
      port map ( clk  => clk,
                 Cin => cInSigAdd,
                 X => fracXpad,
                 Y => fracYpadXorOp,
   ...
   LZCAndShifter: Normalizer_Z_36_36_36_Freq250_uid8
      port map ( clk  => clk,
                 X => fracSticky,
                 Count => nZerosNew,
                 R => shiftedFrac);
   ...
   roundingAdder: IntAdder_42_Freq250_uid11
      port map ( clk  => clk,
                 Cin => needToRound,
                 X => expFrac,
