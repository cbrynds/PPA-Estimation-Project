--------------------------------------------------------------------------------
--                  EuclideanDivTable_d7_alpha3_Freq150_uid7
...
entity EuclideanDivTable_d7_alpha3_Freq150_uid7 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(5 downto 0)   );
end entity;

architecture arch of EuclideanDivTable_d7_alpha3_Freq150_uid7 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_7_11_0_3_Freq150_uid3
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Q: (c0, 1.819000ns)R: (c0, 1.819000ns)
...
entity IntConstDiv_QR_7_11_0_3_Freq150_uid3 is
...
architecture arch of IntConstDiv_QR_7_11_0_3_Freq150_uid3 is
   component EuclideanDivTable_d7_alpha3_Freq150_uid7 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(5 downto 0)   );
   end component;
...
signal out3_copy8 :  std_logic_vector(5 downto 0);
   -- timing of out3_copy8: (c0, 0.507000ns)
signal q3 :  std_logic_vector(2 downto 0);
   -- timing of q3: (c0, 0.835000ns)
signal r3 :  std_logic_vector(2 downto 0);
   -- timing of r3: (c0, 0.835000ns)
signal x2 :  std_logic_vector(2 downto 0);
   -- timing of x2: (c0, 0.507000ns)
signal in2 :  std_logic_vector(5 downto 0);
   -- timing of in2: (c0, 0.835000ns)
signal out2 :  std_logic_vector(5 downto 0);
   -- timing of out2: (c0, 1.163000ns)
signal out2_copy9 :  std_logic_vector(5 downto 0);
   -- timing of out2_copy9: (c0, 0.835000ns)
signal q2 :  std_logic_vector(2 downto 0);
   -- timing of q2: (c0, 1.163000ns)
signal r2 :  std_logic_vector(2 downto 0);
   -- timing of r2: (c0, 1.163000ns)
signal x1 :  std_logic_vector(2 downto 0);
   -- timing of x1: (c0, 0.507000ns)
signal in1 :  std_logic_vector(5 downto 0);
   -- timing of in1: (c0, 1.163000ns)
signal out1 :  std_logic_vector(5 downto 0);
   -- timing of out1: (c0, 1.491000ns)
signal out1_copy10 :  std_logic_vector(5 downto 0);
   -- timing of out1_copy10: (c0, 1.163000ns)
signal q1 :  std_logic_vector(2 downto 0);
   -- timing of q1: (c0, 1.491000ns)
signal r1 :  std_logic_vector(2 downto 0);
   -- timing of r1: (c0, 1.491000ns)
signal x0 :  std_logic_vector(2 downto 0);
   -- timing of x0: (c0, 0.507000ns)
signal in0 :  std_logic_vector(5 downto 0);
   -- timing of in0: (c0, 1.491000ns)
signal out0 :  std_logic_vector(5 downto 0);
   -- timing of out0: (c0, 1.819000ns)
signal out0_copy11 :  std_logic_vector(5 downto 0);
   -- timing of out0_copy11: (c0, 1.491000ns)
signal q0 :  std_logic_vector(2 downto 0);
   -- timing of q0: (c0, 1.819000ns)
signal r0 :  std_logic_vector(2 downto 0);
   -- timing of r0: (c0, 1.819000ns)
signal tempQ :  std_logic_vector(11 downto 0);
   -- timing of tempQ: (c0, 1.819000ns)
begin
   r4 <= "000";
   x3 <= "0" & X(10 downto 9);
   in3 <= r4 & x3;
   table3: EuclideanDivTable_d7_alpha3_Freq150_uid7
      port map ( X => in3,
                 Y => out3_copy8);
   ...
   x2 <= X(8 downto 6);
   in2 <= r3 & x2;
   table2: EuclideanDivTable_d7_alpha3_Freq150_uid7
      port map ( X => in2,
                 Y => out2_copy9);
   ...
   x1 <= X(5 downto 3);
   in1 <= r2 & x1;
   table1: EuclideanDivTable_d7_alpha3_Freq150_uid7
      port map ( X => in1,
                 Y => out1_copy10);
   ...
   x0 <= X(2 downto 0);
   in0 <= r1 & x0;
   table0: EuclideanDivTable_d7_alpha3_Freq150_uid7
      port map ( X => in0,
                 Y => out0_copy11);
...
--------------------------------------------------------------------------------
--                        flopoco_00102_fpconstdiv_top
--                       (FPConstDiv_8_7_8_7_7_0_0_150)
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.000000ns)
--  approx. output signal timings: R: (c0, 1.819000ns)
...
entity flopoco_00102_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00102_fpconstdiv_top is
   component IntConstDiv_QR_7_11_0_3_Freq150_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(10 downto 0);
             Q : out  std_logic_vector(8 downto 0);
             R : out  std_logic_vector(2 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_7_11_0_3_Freq150_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
