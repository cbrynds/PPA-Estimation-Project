--------------------------------------------------------------------------------
--                    RightShifter8_by_max_28_Freq400_uid4
...
entity RightShifter8_by_max_28_Freq400_uid4 is
...
architecture arch of RightShifter8_by_max_28_Freq400_uid4 is
...
--  approx. output signal timings: O: (c1, 0.119327ns)
...
entity LZC_20_Freq400_uid6 is
    port (clk : in std_logic;
          I : in  std_logic_vector(19 downto 0);
          O : out  std_logic_vector(4 downto 0)   );
end entity;

architecture arch of LZC_20_Freq400_uid6 is
...
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c1, 0.119327ns)
...
--------------------------------------------------------------------------------
--                    LeftShifter28_by_max_27_Freq400_uid8
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.953077ns)S: (c1, 0.119327ns)
--  approx. output signal timings: R: (c1, 1.687788ns)
...
entity LeftShifter28_by_max_27_Freq400_uid8 is
    port (clk : in std_logic;
...
architecture arch of LeftShifter28_by_max_27_Freq400_uid8 is
signal ps :  std_logic_vector(4 downto 0);
   -- timing of ps: (c1, 0.119327ns)
...
signal level1 :  std_logic_vector(28 downto 0);
   -- timing of level1: (c1, 0.119327ns)
signal level2 :  std_logic_vector(30 downto 0);
   -- timing of level2: (c1, 0.811250ns)
signal level3 :  std_logic_vector(34 downto 0);
   -- timing of level3: (c1, 0.811250ns)
signal level4 :  std_logic_vector(42 downto 0);
   -- timing of level4: (c1, 1.687788ns)
signal level5 :  std_logic_vector(58 downto 0);
   -- timing of level5: (c1, 1.687788ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
--------------------------------------------------------------------------------
--                        flopoco_00068_ieeefpfma_top
--                        (IEEEFPFMA_8_7_Freq400_uid2)
...
entity flopoco_00068_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00068_ieeefpfma_top is
   component RightShifter8_by_max_28_Freq400_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(7 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(35 downto 0)   );
   ...
   component LZC_20_Freq400_uid6 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(19 downto 0);
             O : out  std_logic_vector(4 downto 0)   );
   end component;

   component LeftShifter28_by_max_27_Freq400_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(27 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(54 downto 0)   );
...
signal tmpExpCompRes2 :  std_logic_vector(9 downto 0);
   -- timing of tmpExpCompRes2: (c1, 0.119327ns)
signal RisSubNormal :  std_logic;
   -- timing of RisSubNormal: (c1, 0.119327ns)
signal RisZero :  std_logic;
   -- timing of RisZero: (c1, 0.119327ns)
signal RisSubNormalOrZero :  std_logic;
   -- timing of RisSubNormalOrZero: (c1, 0.119327ns)
signal Rsgn :  std_logic;
   -- timing of Rsgn: (c1, 0.119327ns)
...
signal normShiftValue :  std_logic_vector(4 downto 0);
   -- timing of normShiftValue: (c1, 0.119327ns)
signal BigSumNormd :  std_logic_vector(54 downto 0);
   -- timing of BigSumNormd: (c1, 1.687788ns)
signal expTentative :  std_logic_vector(9 downto 0);
   -- timing of expTentative: (c1, 0.119327ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c1, 1.687788ns)
signal fracTentative :  std_logic_vector(10 downto 0);
   -- timing of fracTentative: (c1, 1.687788ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c1, 1.687788ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c1, 1.687788ns)
signal fracResultNormd :  std_logic_vector(6 downto 0);
   -- timing of fracResultNormd: (c1, 1.687788ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c1, 1.687788ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c1, 1.687788ns)
signal round :  std_logic;
   -- timing of round: (c1, 1.687788ns)
signal expUpdate :  std_logic_vector(9 downto 0);
   -- timing of expUpdate: (c1, 1.687788ns)
signal exponentResult1 :  std_logic_vector(9 downto 0);
   -- timing of exponentResult1: (c1, 1.687788ns)
signal resultBeforeRound :  std_logic_vector(16 downto 0);
   -- timing of resultBeforeRound: (c1, 1.687788ns)
signal resultRounded :  std_logic_vector(16 downto 0);
   -- timing of resultRounded: (c1, 1.687788ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c1, 1.687788ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c1, 1.687788ns)
...
begin
   ...
   RightShifterComponent: RightShifter8_by_max_28_Freq400_uid4
      port map ( clk  => clk,
                 S => ShiftValue,
                 X => Csig,
                 R => CsigShifted);
   ...
   IEEEFPFMA_8_7_Freq400_uid2LeadingZeroCounter: LZC_20_Freq400_uid6
      port map ( clk  => clk,
   ...
   NormalizationShifter: LeftShifter28_by_max_27_Freq400_uid8
      port map ( clk  => clk,
                 S => normShiftValue,
                 X => BigSumAbs,
                 R => BigSumNormd);
