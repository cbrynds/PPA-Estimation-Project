...
entity IntDualSub_34_Freq400_uid4 is
...
architecture arch of IntDualSub_34_Freq400_uid4 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_33_33_33_Freq400_uid6
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Count: (c1, 1.375250ns)R: (c1, 1.590250ns)
...
entity Normalizer_Z_33_33_33_Freq400_uid6 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_33_33_33_Freq400_uid6 is
...
signal count3 :  std_logic;
   -- timing of count3: (c1, 0.079625ns)
signal level3 :  std_logic_vector(32 downto 0);
   -- timing of level3: (c1, 0.294625ns)
signal count2 :  std_logic;
   -- timing of count2: (c1, 0.511500ns)
signal level2 :  std_logic_vector(32 downto 0);
   -- timing of level2: (c1, 0.726500ns)
signal count1 :  std_logic;
   -- timing of count1: (c1, 0.943375ns)
signal level1 :  std_logic_vector(32 downto 0);
   -- timing of level1: (c1, 1.158375ns)
signal count0 :  std_logic;
   -- timing of count0: (c1, 1.375250ns)
signal level0 :  std_logic_vector(32 downto 0);
   -- timing of level0: (c1, 1.590250ns)
signal sCount :  std_logic_vector(5 downto 0);
   -- timing of sCount: (c1, 1.375250ns)
begin
   process(clk)
      begin
   ...
   count3<= '1' when level4_d1(32 downto 25) = (32 downto 25=>'0') else '0';
...
--------------------------------------------------------------------------------
--                RightShifterSticky32_by_max_34_Freq400_uid8
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity RightShifterSticky32_by_max_34_Freq400_uid8 is
    port (clk : in std_logic;
...
architecture arch of RightShifterSticky32_by_max_34_Freq400_uid8 is
...
--  approx. output signal timings: R: (c1, 0.987250ns)
...
entity IntAdder_35_Freq400_uid10 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_35_Freq400_uid10 is
signal Rtmp :  std_logic_vector(34 downto 0);
   -- timing of Rtmp: (c1, 0.987250ns)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 1.625250ns)Y: (c0, 0.000000ns)Cin: (c1, 1.625250ns)
--  approx. output signal timings: R: (c1, 2.287250ns)
...
entity IntAdder_41_Freq400_uid13 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_41_Freq400_uid13 is
signal Rtmp :  std_logic_vector(40 downto 0);
   -- timing of Rtmp: (c1, 2.287250ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00466_fpadd_top
--                         (FPSub_8_31_Freq400_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c2, 0.007250ns)
...
entity flopoco_00466_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00466_fpadd_top is
   component IntDualSub_34_Freq400_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(33 downto 0);
             Y : in  std_logic_vector(33 downto 0);
             XmY : out  std_logic_vector(33 downto 0);
   ...
   component Normalizer_Z_33_33_33_Freq400_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(32 downto 0);
             Count : out  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(32 downto 0)   );
   ...
   component RightShifterSticky32_by_max_34_Freq400_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(31 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(33 downto 0);
   ...
   component IntAdder_35_Freq400_uid10 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(34 downto 0);
             Y : in  std_logic_vector(34 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_41_Freq400_uid13 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(40 downto 0);
             Y : in  std_logic_vector(40 downto 0);
             Cin : in  std_logic;
...
signal nZerosNew :  std_logic_vector(5 downto 0);
   -- timing of nZerosNew: (c1, 1.375250ns)
signal shiftedFrac :  std_logic_vector(32 downto 0);
   -- timing of shiftedFrac: (c1, 1.590250ns)
signal roundClose0 :  std_logic;
   -- timing of roundClose0: (c1, 1.590250ns)
signal resultCloseIsZero0 :  std_logic;
   -- timing of resultCloseIsZero0: (c1, 1.375250ns)
signal exponentResultClose :  std_logic_vector(9 downto 0);
   -- timing of exponentResultClose: (c1, 1.375250ns)
signal resultBeforeRoundClose :  std_logic_vector(40 downto 0);
   -- timing of resultBeforeRoundClose: (c1, 1.590250ns)
signal roundClose :  std_logic;
   -- timing of roundClose: (c1, 1.590250ns)
signal resultCloseIsZero :  std_logic;
   -- timing of resultCloseIsZero: (c1, 1.375250ns)
...
signal fracResultfar0 :  std_logic_vector(34 downto 0);
   -- timing of fracResultfar0: (c1, 0.987250ns)
signal fracResultFarNormStage :  std_logic_vector(34 downto 0);
   -- timing of fracResultFarNormStage: (c1, 0.987250ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c1, 0.987250ns)
signal fracResultFar1 :  std_logic_vector(30 downto 0);
   -- timing of fracResultFar1: (c1, 0.987250ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c1, 0.987250ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c1, 0.987250ns)
signal roundFar1 :  std_logic;
   -- timing of roundFar1: (c1, 0.987250ns)
signal expOperationSel :  std_logic_vector(1 downto 0);
   -- timing of expOperationSel: (c1, 0.987250ns)
signal exponentUpdate :  std_logic_vector(9 downto 0);
   -- timing of exponentUpdate: (c1, 0.987250ns)
...
signal exponentResultFar1 :  std_logic_vector(9 downto 0);
   -- timing of exponentResultFar1: (c1, 0.987250ns)
signal resultBeforeRoundFar :  std_logic_vector(40 downto 0);
   -- timing of resultBeforeRoundFar: (c1, 0.987250ns)
signal roundFar :  std_logic;
   -- timing of roundFar: (c1, 0.987250ns)
signal resultBeforeRound :  std_logic_vector(40 downto 0);
   -- timing of resultBeforeRound: (c1, 1.625250ns)
signal round :  std_logic;
   -- timing of round: (c1, 1.625250ns)
signal zeroFromClose :  std_logic;
   -- timing of zeroFromClose: (c1, 1.375250ns)
signal resultRounded :  std_logic_vector(40 downto 0);
   -- timing of resultRounded: (c1, 2.287250ns)
signal syncEffSub, syncEffSub_d1, syncEffSub_d2 :  std_logic;
   -- timing of syncEffSub: (c0, 0.748000ns)
signal syncX, syncX_d1, syncX_d2 :  std_logic_vector(41 downto 0);
...
signal UnderflowOverflow :  std_logic_vector(1 downto 0);
   -- timing of UnderflowOverflow: (c1, 2.287250ns)
signal resultNoExn, resultNoExn_d1 :  std_logic_vector(41 downto 0);
   -- timing of resultNoExn: (c1, 2.322250ns)
signal syncExnXY, syncExnXY_d1, syncExnXY_d2 :  std_logic_vector(3 downto 0);
   -- timing of syncExnXY: (c0, 0.713000ns)
signal exnR :  std_logic_vector(1 downto 0);
   -- timing of exnR: (c2, 0.007250ns)
signal sgnR :  std_logic;
   -- timing of sgnR: (c2, 0.007250ns)
signal expsigR :  std_logic_vector(38 downto 0);
   -- timing of expsigR: (c2, 0.007250ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
-- Close Path --
   ...
   FPSub_8_31_Freq400_uid2_DualSubClose: IntDualSub_34_Freq400_uid4
      port map ( clk  => clk,
                 X => fracXClose1,
                 Y => fracYClose1,
                 XmY => fracRClosexMy,
   ...
   norm: Normalizer_Z_33_33_33_Freq400_uid6
      port map ( clk  => clk,
                 X => fracRClose1,
                 Count => nZerosNew,
                 R => shiftedFrac);
...
-- Far Path --
   ...
   RightShifterComponent: RightShifterSticky32_by_max_34_Freq400_uid8
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracNewY,
                 R => shiftedFracY,
   ...
   -- far path adder
   FPSub_8_31_Freq400_uid2_fracAddFar: IntAdder_35_Freq400_uid10
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
...
-- Synchronization of both paths --
   ...
   -- final round adder
   FPSub_8_31_Freq400_uid2_finalRoundAdd: IntAdder_41_Freq400_uid13
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
   ...
   with syncExnXY_d2  select  -- remember that ExnX > ExnY 
      exnR <= resultNoExn_d1(41 downto 40) when "0101",
              "1" & syncEffSub_d2          when "1010",
              "11"                      when "1110",
              syncExnXY_d2(3 downto 2)     when others;
   -- Sign bit of the result
   with syncExnXY_d2  select 
      sgnR <= resultNoExn_d1(39)         when "0101",
              syncX_d2(39) and syncSignY_d2 when "0000",
              syncX_d2(39)               when others;
   -- Exponent and significand of the result
   with syncExnXY_d2  select   
      expsigR <= resultNoExn_d1(38 downto 0)   when "0101" ,
                 syncX_d2(38 downto  0)        when others; -- 0100, or at least one NaN or one infty 
   R <= exnR & sgnR & expsigR;
end architecture;
