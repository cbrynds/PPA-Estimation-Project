...
--------------------------------------------------------------------------------
--                          flopoco_00385_fpdiv_top
--                         (FPDiv_5_10_Freq400_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c4, 1.515010ns)
...
entity flopoco_00385_fpdiv_top is
...
architecture arch of flopoco_00385_fpdiv_top is
...
signal prescaledfY, prescaledfY_d1, prescaledfY_d2, prescaledfY_d3 :  std_logic_vector(12 downto 0);
...
begin
   ...
   sel2 <= w2(15 downto 11) & prescaledfY_d2(10 downto 9);
   ...
   sel1 <= w1(15 downto 11) & prescaledfY_d3(10 downto 9);
   ...
   round <= fRnorm(0); 
   expR1 <= expR0_d4 + ("000" & (3 downto 1 => '1') & mR(12)); -- add back bias
   -- final rounding
   ...
   R <= exnRfinal & sR_d4 & expfracR(14 downto 0);
end architecture;
