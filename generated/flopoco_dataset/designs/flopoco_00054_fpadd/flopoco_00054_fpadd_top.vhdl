...
entity IntDualSub_14_Freq300_uid4 is
...
architecture arch of IntDualSub_14_Freq300_uid4 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_13_13_13_Freq300_uid6
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity Normalizer_Z_13_13_13_Freq300_uid6 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_13_13_13_Freq300_uid6 is
...
--------------------------------------------------------------------------------
--                RightShifterSticky12_by_max_14_Freq300_uid8
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity RightShifterSticky12_by_max_14_Freq300_uid8 is
    port (clk : in std_logic;
...
architecture arch of RightShifterSticky12_by_max_14_Freq300_uid8 is
...
entity IntAdder_15_Freq300_uid10 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_15_Freq300_uid10 is
...
--  approx. output signal timings: R: (c1, 0.305042ns)
...
entity IntAdder_19_Freq300_uid13 is
    port (clk : in std_logic;
...
--------------------------------------------------------------------------------
--                          flopoco_00054_fpadd_top
--                         (FPSub_6_11_Freq300_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 0.375042ns)
...
entity flopoco_00054_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00054_fpadd_top is
   component IntDualSub_14_Freq300_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(13 downto 0);
             Y : in  std_logic_vector(13 downto 0);
             XmY : out  std_logic_vector(13 downto 0);
   ...
   component Normalizer_Z_13_13_13_Freq300_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(12 downto 0);
             Count : out  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(12 downto 0)   );
   ...
   component RightShifterSticky12_by_max_14_Freq300_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(11 downto 0);
             S : in  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(13 downto 0);
   ...
   component IntAdder_15_Freq300_uid10 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(14 downto 0);
             Y : in  std_logic_vector(14 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_19_Freq300_uid13 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(18 downto 0);
             Y : in  std_logic_vector(18 downto 0);
             Cin : in  std_logic;
...
signal inX :  std_logic_vector(19 downto 0);
   -- timing of inX: (c0, 0.000000ns)
signal inY :  std_logic_vector(19 downto 0);
...
signal resultBeforeRoundClose :  std_logic_vector(18 downto 0);
...
signal exponentResultfar0 :  std_logic_vector(7 downto 0);
...
signal resultBeforeRoundFar :  std_logic_vector(18 downto 0);
   -- timing of resultBeforeRoundFar: (c0, 2.741375ns)
signal roundFar :  std_logic;
   -- timing of roundFar: (c0, 2.741375ns)
signal resultBeforeRound :  std_logic_vector(18 downto 0);
...
signal resultRounded :  std_logic_vector(18 downto 0);
   -- timing of resultRounded: (c1, 0.305042ns)
signal syncEffSub, syncEffSub_d1 :  std_logic;
   -- timing of syncEffSub: (c0, 0.722000ns)
signal syncX, syncX_d1 :  std_logic_vector(19 downto 0);
...
signal UnderflowOverflow :  std_logic_vector(1 downto 0);
   -- timing of UnderflowOverflow: (c1, 0.305042ns)
signal resultNoExn :  std_logic_vector(19 downto 0);
   -- timing of resultNoExn: (c1, 0.340042ns)
signal syncExnXY, syncExnXY_d1 :  std_logic_vector(3 downto 0);
   -- timing of syncExnXY: (c0, 0.687000ns)
signal exnR :  std_logic_vector(1 downto 0);
   -- timing of exnR: (c1, 0.375042ns)
signal sgnR :  std_logic;
   -- timing of sgnR: (c1, 0.375042ns)
signal expsigR :  std_logic_vector(16 downto 0);
   -- timing of expsigR: (c1, 0.375042ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
-- Exponent difference and swap  --
   inX <= X;
   inY <= Y;
   exceptionXSuperiorY <= '1' when inX(19 downto 18) >= inY(19 downto 18) else '0';
   exceptionXEqualY <= '1' when inX(19 downto 18) = inY(19 downto 18) else '0';
   signedExponentX <= "0" & inX(16 downto 11);
   signedExponentY <= "0" & inY(16 downto 11);
   ...
   mY <= inY(19 downto 18) & not(inY(17)) & inY(16 downto 0);
...
-- Close Path --
   ...
   FPSub_6_11_Freq300_uid2_DualSubClose: IntDualSub_14_Freq300_uid4
      port map ( clk  => clk,
                 X => fracXClose1,
                 Y => fracYClose1,
                 XmY => fracRClosexMy,
   ...
   resSign <= '0' when selectClosePath='1' and fracRClose1 = (12 downto 0 => '0') else
             newX(17) xor (selectClosePath and fracSignClose);
   -- close path LZC + shifter
   norm: Normalizer_Z_13_13_13_Freq300_uid6
      port map ( clk  => clk,
                 X => fracRClose1,
                 Count => nZerosNew,
                 R => shiftedFrac);
   ...
   exponentResultClose <= ("00" & newX(16 downto 11)) - (CONV_STD_LOGIC_VECTOR(0,4) & nZerosNew);
   resultBeforeRoundClose <= exponentResultClose(7 downto 0) & shiftedFrac(11 downto 1);
   roundClose <= roundClose0;
   resultCloseIsZero <= resultCloseIsZero0;

-- Far Path --
   fracNewY <= '1' & newY(10 downto 0);
   RightShifterComponent: RightShifterSticky12_by_max_14_Freq300_uid8
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracNewY,
                 R => shiftedFracY,
   ...
   -- far path adder
   FPSub_6_11_Freq300_uid2_fracAddFar: IntAdder_15_Freq300_uid10
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   exponentResultfar0<="00" & (newX(16 downto 11));
...
-- Synchronization of both paths --
   ...
   -- final round adder
   FPSub_6_11_Freq300_uid2_finalRoundAdd: IntAdder_19_Freq300_uid13
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
   ...
   syncSignY <= pipeSignY;
   syncResSign <= resSign;
   UnderflowOverflow <= resultRounded(18 downto 17);
   with UnderflowOverflow  select 
   resultNoExn(19 downto 18) <=   (not zeroFromClose_d1) & "0" when "01", -- overflow
                                 "00" when "10" | "11",  -- underflow
                                 "0" &  not zeroFromClose_d1  when others; -- normal 
   resultNoExn(17 downto 0) <= syncResSign_d1 & resultRounded(16 downto 0);
   syncExnXY <= sdExnXY;
   -- Exception bits of the result
   with syncExnXY_d1  select  -- remember that ExnX > ExnY 
      exnR <= resultNoExn(19 downto 18) when "0101",
              "1" & syncEffSub_d1          when "1010",
              "11"                      when "1110",
              syncExnXY_d1(3 downto 2)     when others;
   -- Sign bit of the result
   with syncExnXY_d1  select 
      sgnR <= resultNoExn(17)         when "0101",
              syncX_d1(17) and syncSignY_d1 when "0000",
              syncX_d1(17)               when others;
   -- Exponent and significand of the result
   with syncExnXY_d1  select   
      expsigR <= resultNoExn(16 downto 0)   when "0101" ,
                 syncX_d1(16 downto  0)        when others; -- 0100, or at least one NaN or one infty 
   R <= exnR & sgnR & expsigR;
end architecture;
