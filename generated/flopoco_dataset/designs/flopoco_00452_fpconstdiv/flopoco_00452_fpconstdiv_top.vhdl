--------------------------------------------------------------------------------
--                    CBLKTable_l0_d5_alpha6_Freq400_uid7
...
entity CBLKTable_l0_d5_alpha6_Freq400_uid7 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(6 downto 0)   );
end entity;

architecture arch of CBLKTable_l0_d5_alpha6_Freq400_uid7 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l1_d5_alpha6_Freq400_uid21
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l1_d5_alpha6_Freq400_uid21 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(8 downto 0)   );
end entity;

architecture arch of CBLKTable_l1_d5_alpha6_Freq400_uid21 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l2_d5_alpha6_Freq400_uid30
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l2_d5_alpha6_Freq400_uid30 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(14 downto 0)   );
end entity;

architecture arch of CBLKTable_l2_d5_alpha6_Freq400_uid30 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l3_d5_alpha6_Freq400_uid37
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l3_d5_alpha6_Freq400_uid37 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(26 downto 0)   );
end entity;

architecture arch of CBLKTable_l3_d5_alpha6_Freq400_uid37 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l4_d5_alpha6_Freq400_uid43
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l4_d5_alpha6_Freq400_uid43 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(50 downto 0)   );
end entity;

architecture arch of CBLKTable_l4_d5_alpha6_Freq400_uid43 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_5_56_1_6_Freq400_uid3
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Q: (c1, 1.215000ns)R: (c0, 2.147000ns)
...
entity IntConstDiv_QR_5_56_1_6_Freq400_uid3 is
...
architecture arch of IntConstDiv_QR_5_56_1_6_Freq400_uid3 is
   component CBLKTable_l0_d5_alpha6_Freq400_uid7 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(6 downto 0)   );
   end component;

   component CBLKTable_l1_d5_alpha6_Freq400_uid21 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(8 downto 0)   );
   end component;

   component CBLKTable_l2_d5_alpha6_Freq400_uid30 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(14 downto 0)   );
   end component;

   component CBLKTable_l3_d5_alpha6_Freq400_uid37 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(26 downto 0)   );
   end component;

   component CBLKTable_l4_d5_alpha6_Freq400_uid43 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(50 downto 0)   );
   end component;
...
signal qs_l2_1, qs_l2_1_d1 :  std_logic_vector(23 downto 0);
...
signal qs_l2_2, qs_l2_2_d1 :  std_logic_vector(5 downto 0);
...
signal q_l3_0, q_l3_0_d1 :  std_logic_vector(47 downto 0);
   -- timing of q_l3_0: (c0, 1.819000ns)
signal qs_l3_0 :  std_logic_vector(47 downto 0);
   -- timing of qs_l3_0: (c1, 0.512000ns)
...
signal q_l3_1, q_l3_1_d1 :  std_logic_vector(5 downto 0);
   -- timing of q_l3_1: (c0, 1.819000ns)
signal qs_l3_1 :  std_logic_vector(5 downto 0);
   -- timing of qs_l3_1: (c1, 0.229000ns)
...
signal q_l4_0, q_l4_0_d1 :  std_logic_vector(53 downto 0);
   -- timing of q_l4_0: (c0, 2.147000ns)
signal qs_l4_0 :  std_logic_vector(53 downto 0);
   -- timing of qs_l4_0: (c1, 1.215000ns)
begin
   process(clk)
      begin
   ...
   x0 <= X(5 downto 0);
   table0: CBLKTable_l0_d5_alpha6_Freq400_uid7
      port map ( X => x0,
                 Y => out0_copy8);
   ...
   x1 <= X(11 downto 6);
   table1: CBLKTable_l0_d5_alpha6_Freq400_uid7
      port map ( X => x1,
                 Y => out1_copy9);
   ...
   x2 <= X(17 downto 12);
   table2: CBLKTable_l0_d5_alpha6_Freq400_uid7
      port map ( X => x2,
                 Y => out2_copy10);
   ...
   x3 <= X(23 downto 18);
   table3: CBLKTable_l0_d5_alpha6_Freq400_uid7
      port map ( X => x3,
                 Y => out3_copy11);
   ...
   x4 <= X(29 downto 24);
   table4: CBLKTable_l0_d5_alpha6_Freq400_uid7
      port map ( X => x4,
                 Y => out4_copy12);
   ...
   x5 <= X(35 downto 30);
   table5: CBLKTable_l0_d5_alpha6_Freq400_uid7
      port map ( X => x5,
                 Y => out5_copy13);
   ...
   x6 <= X(41 downto 36);
   table6: CBLKTable_l0_d5_alpha6_Freq400_uid7
      port map ( X => x6,
                 Y => out6_copy14);
   ...
   x7 <= X(47 downto 42);
   table7: CBLKTable_l0_d5_alpha6_Freq400_uid7
      port map ( X => x7,
                 Y => out7_copy15);
   ...
   x8 <= X(53 downto 48);
   table8: CBLKTable_l0_d5_alpha6_Freq400_uid7
      port map ( X => x8,
                 Y => out8_copy16);
   ...
   table_l1_1: CBLKTable_l1_d5_alpha6_Freq400_uid21
      port map ( X => in_l1_1,
                 Y => out_l1_1_copy23);
   ...
   table_l1_2: CBLKTable_l1_d5_alpha6_Freq400_uid21
      port map ( X => in_l1_2,
                 Y => out_l1_2_copy24);
   ...
   table_l1_3: CBLKTable_l1_d5_alpha6_Freq400_uid21
      port map ( X => in_l1_3,
                 Y => out_l1_3_copy25);
   ...
   table_l1_4: CBLKTable_l1_d5_alpha6_Freq400_uid21
      port map ( X => in_l1_4,
                 Y => out_l1_4_copy26);
   ...
   table_l2_0: CBLKTable_l2_d5_alpha6_Freq400_uid30
      port map ( X => in_l2_0,
                 Y => out_l2_0_copy31);
   ...
   table_l2_1: CBLKTable_l2_d5_alpha6_Freq400_uid30
      port map ( X => in_l2_1,
                 Y => out_l2_1_copy32);
   ...
   in_l2_2 <= "000" & r_l1_4;
   table_l2_2: CBLKTable_l2_d5_alpha6_Freq400_uid30
      port map ( X => in_l2_2,
                 Y => out_l2_2_copy33);
   ...
   table_l3_0: CBLKTable_l3_d5_alpha6_Freq400_uid37
      port map ( X => in_l3_0,
                 Y => out_l3_0_copy38);
   ...
   in_l3_1 <= "000" & r_l2_2;
   table_l3_1: CBLKTable_l3_d5_alpha6_Freq400_uid37
      port map ( X => in_l3_1,
                 Y => out_l3_1_copy39);
   ...
   qs_l3_1 <= q_l3_1_d1 + qs_l2_2_d1;  -- partial quotient so far
   in_l4_0 <= r_l3_1 & r_l3_0;
   table_l4_0: CBLKTable_l4_d5_alpha6_Freq400_uid43
      port map ( X => in_l4_0,
                 Y => out_l4_0_copy44);
   ...
   qs_l4_0 <= q_l4_0_d1 + (qs_l3_1 & qs_l3_0);  -- partial quotient so far
   Q <= qs_l4_0(53 downto 0);
   R <= r_l4_0;
end architecture;

--------------------------------------------------------------------------------
--                        flopoco_00452_fpconstdiv_top
--                    (FPConstDiv_11_52_11_52_5_1_M1_400)
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 1.215000ns)
...
entity flopoco_00452_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(11+52+2 downto 0);
          R : out  std_logic_vector(11+52+2 downto 0)   );
end entity;

architecture arch of flopoco_00452_fpconstdiv_top is
   component IntConstDiv_QR_5_56_1_6_Freq400_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(55 downto 0);
             Q : out  std_logic_vector(53 downto 0);
             R : out  std_logic_vector(2 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_5_56_1_6_Freq400_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
