...
--  approx. output signal timings: R: (c5, 0.573000ns)
...
entity flopoco_00204_fpdiv_top is
...
architecture arch of flopoco_00204_fpdiv_top is
...
signal Dx3, Dx3_d1, Dx3_d2, Dx3_d3, Dx3_d4 :  std_logic_vector(24 downto 0);
...
begin
   ...
   sel6 <= betaw6(26 downto 23) & D_d2(22 downto 22);
   ...
   sel4 <= betaw4(26 downto 23) & D_d3(22 downto 22);
   ...
   sel3 <= betaw3(26 downto 23) & D_d3(22 downto 22);
   ...
   sel2 <= betaw2(26 downto 23) & D_d4(22 downto 22);
   ...
   sel1 <= betaw1(26 downto 23) & D_d4(22 downto 22);
   ...
   qP1 <=      q1(1 downto 0);
   qM1 <=      q1(2) & "0";
   qP <= qP13_d4 & qP12_d4 & qP11_d4 & qP10_d3 & qP9_d3 & qP8_d3 & qP7_d2 & qP6_d2 & qP5_d1 & qP4_d1 & qP3_d1 & qP2 & qP1;
   qM <= qM13_d4(0) & qM12_d4 & qM11_d4 & qM10_d3 & qM9_d3 & qM8_d3 & qM7_d2 & qM6_d2 & qM5_d1 & qM4_d1 & qM3_d1 & qM2 & qM1 & qM0;
   quotient <= qP - qM;
   -- We need a mR in (0, -wf-2) format: 1+wF fraction bits, 1 round bit, and 1 guard bit for the normalisation,
   -- quotient is the truncation of the exact quotient to at least 2^(-wF-2) bits
   -- now discarding its possible known MSB zeroes, and dropping the possible extra LSB bit (due to radix 4) 
   mR <= quotient_d1(25 downto 0); 
   -- normalisation
