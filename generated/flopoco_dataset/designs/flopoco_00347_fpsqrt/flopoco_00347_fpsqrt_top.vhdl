...
entity flopoco_00347_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00347_fpsqrt_top is
...
signal d9 :  std_logic;
   -- timing of d9: (c2, 0.137000ns)
signal mR :  std_logic_vector(9 downto 0);
   -- timing of mR: (c2, 0.137000ns)
signal fR :  std_logic_vector(6 downto 0);
   -- timing of fR: (c2, 0.137000ns)
signal round :  std_logic;
   -- timing of round: (c2, 0.137000ns)
signal fRrnd :  std_logic_vector(6 downto 0);
   -- timing of fRrnd: (c2, 0.609000ns)
signal Rn2 :  std_logic_vector(14 downto 0);
   -- timing of Rn2: (c2, 0.609000ns)
