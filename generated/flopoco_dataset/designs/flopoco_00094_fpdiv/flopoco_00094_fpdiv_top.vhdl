...
--  approx. output signal timings: R: (c2, 0.679000ns)
...
entity flopoco_00094_fpdiv_top is
...
architecture arch of flopoco_00094_fpdiv_top is
...
signal q3 :  std_logic_vector(2 downto 0);
   -- timing of q3: (c1, 0.004000ns)
signal q3_copy8, q3_copy8_d1 :  std_logic_vector(2 downto 0);
   -- timing of q3_copy8: (c0, 2.139000ns)
signal absq3D :  std_logic_vector(10 downto 0);
   -- timing of absq3D: (c1, 0.004000ns)
signal w2 :  std_logic_vector(10 downto 0);
   -- timing of w2: (c1, 0.502000ns)
signal betaw2 :  std_logic_vector(10 downto 0);
   -- timing of betaw2: (c1, 0.502000ns)
signal sel2 :  std_logic_vector(8 downto 0);
   -- timing of sel2: (c1, 0.502000ns)
signal q2 :  std_logic_vector(2 downto 0);
   -- timing of q2: (c1, 0.717000ns)
signal q2_copy9 :  std_logic_vector(2 downto 0);
   -- timing of q2_copy9: (c1, 0.502000ns)
signal absq2D :  std_logic_vector(10 downto 0);
   -- timing of absq2D: (c1, 0.717000ns)
signal w1 :  std_logic_vector(10 downto 0);
   -- timing of w1: (c1, 1.215000ns)
signal betaw1 :  std_logic_vector(10 downto 0);
   -- timing of betaw1: (c1, 1.215000ns)
signal sel1 :  std_logic_vector(8 downto 0);
   -- timing of sel1: (c1, 1.215000ns)
signal q1 :  std_logic_vector(2 downto 0);
   -- timing of q1: (c1, 1.430000ns)
signal q1_copy10 :  std_logic_vector(2 downto 0);
   -- timing of q1_copy10: (c1, 1.215000ns)
signal absq1D :  std_logic_vector(10 downto 0);
   -- timing of absq1D: (c1, 1.430000ns)
signal w0 :  std_logic_vector(10 downto 0);
   -- timing of w0: (c1, 1.928000ns)
signal wfinal :  std_logic_vector(8 downto 0);
   -- timing of wfinal: (c1, 1.928000ns)
signal qM0 :  std_logic;
   -- timing of qM0: (c1, 1.928000ns)
...
signal qP3 :  std_logic_vector(1 downto 0);
   -- timing of qP3: (c1, 0.004000ns)
signal qM3 :  std_logic_vector(1 downto 0);
   -- timing of qM3: (c1, 0.004000ns)
signal qP2 :  std_logic_vector(1 downto 0);
   -- timing of qP2: (c1, 0.717000ns)
signal qM2 :  std_logic_vector(1 downto 0);
   -- timing of qM2: (c1, 0.717000ns)
signal qP1 :  std_logic_vector(1 downto 0);
   -- timing of qP1: (c1, 1.430000ns)
signal qM1 :  std_logic_vector(1 downto 0);
   -- timing of qM1: (c1, 1.430000ns)
signal qP, qP_d1 :  std_logic_vector(11 downto 0);
   -- timing of qP: (c1, 1.430000ns)
signal qM, qM_d1 :  std_logic_vector(11 downto 0);
   -- timing of qM: (c1, 1.928000ns)
signal quotient :  std_logic_vector(11 downto 0);
   -- timing of quotient: (c2, 0.076000ns)
signal mR :  std_logic_vector(9 downto 0);
   -- timing of mR: (c2, 0.111000ns)
signal fRnorm :  std_logic_vector(7 downto 0);
   -- timing of fRnorm: (c2, 0.146000ns)
signal round :  std_logic;
   -- timing of round: (c2, 0.181000ns)
signal expR1 :  std_logic_vector(9 downto 0);
   -- timing of expR1: (c2, 0.609000ns)
signal expfrac :  std_logic_vector(16 downto 0);
   -- timing of expfrac: (c2, 0.609000ns)
signal expfracR :  std_logic_vector(16 downto 0);
   -- timing of expfracR: (c2, 0.609000ns)
signal exnR :  std_logic_vector(1 downto 0);
   -- timing of exnR: (c2, 0.644000ns)
signal exnRfinal :  std_logic_vector(1 downto 0);
   -- timing of exnRfinal: (c2, 0.679000ns)
begin
   process(clk)
      begin
   ...
   SelFunctionTable3: selFunction_Freq400_uid4
      port map ( X => sel3,
                 Y => q3_copy8);
   q3 <= q3_copy8_d1; -- output copy to hold a pipeline register if needed
   ...
   sel2 <= betaw2(10 downto 5) & D_d1(6 downto 4);
   ...
   qP1 <=      q1(1 downto 0);
   qM1 <=      q1(2) & "0";
   qP <= qP6_d1 & qP5_d1 & qP4_d1 & qP3 & qP2 & qP1;
   qM <= qM6_d1(0) & qM5_d1 & qM4_d1 & qM3 & qM2 & qM1 & qM0;
   ...
   round <= fRnorm(0); 
   expR1 <= expR0_d2 + ("000" & (6 downto 1 => '1') & mR(9)); -- add back bias
   -- final rounding
