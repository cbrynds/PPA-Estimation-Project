...
--  approx. output signal timings: R: (c1, 2.717667ns)
...
entity flopoco_00142_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00142_fpsqrt_top is
...
signal R4s_l, R4s_l_d1 :  std_logic_vector(2 downto 0);
...
signal fR :  std_logic_vector(6 downto 0);
   -- timing of fR: (c1, 2.245667ns)
signal round :  std_logic;
   -- timing of round: (c1, 2.210667ns)
signal fRrnd :  std_logic_vector(6 downto 0);
   -- timing of fRrnd: (c1, 2.717667ns)
signal Rn2 :  std_logic_vector(14 downto 0);
   -- timing of Rn2: (c1, 2.717667ns)
