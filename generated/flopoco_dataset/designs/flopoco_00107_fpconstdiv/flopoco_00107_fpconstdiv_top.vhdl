--------------------------------------------------------------------------------
--                    CBLKTable_l0_d5_alpha4_Freq400_uid7
...
entity CBLKTable_l0_d5_alpha4_Freq400_uid7 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(4 downto 0)   );
end entity;

architecture arch of CBLKTable_l0_d5_alpha4_Freq400_uid7 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l1_d5_alpha4_Freq400_uid18
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l1_d5_alpha4_Freq400_uid18 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(6 downto 0)   );
end entity;

architecture arch of CBLKTable_l1_d5_alpha4_Freq400_uid18 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l2_d5_alpha4_Freq400_uid26
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l2_d5_alpha4_Freq400_uid26 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(10 downto 0)   );
end entity;

architecture arch of CBLKTable_l2_d5_alpha4_Freq400_uid26 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l3_d5_alpha4_Freq400_uid32
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l3_d5_alpha4_Freq400_uid32 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(18 downto 0)   );
end entity;

architecture arch of CBLKTable_l3_d5_alpha4_Freq400_uid32 is
...
begin
   with X  select  Y0 <= 
      ...
      "0000000000000000000" when "000101",
      "0000000000000000000" when "000110",
      "0000000000000000000" when "000111",
      "0011001100110011001" when "001000",
      "0011001100110011010" when "001001",
      "0011001100110011011" when "001010",
      "0011001100110011100" when "001011",
      "0011001100110100000" when "001100",
      "0011001100110011001" when "001101",
      "0011001100110011001" when "001110",
      "0011001100110011001" when "001111",
      "0110011001100110010" when "010000",
      "0110011001100110011" when "010001",
      "0110011001100110100" when "010010",
      "0110011001100111000" when "010011",
      "0110011001100111001" when "010100",
      "0110011001100110010" when "010101",
      "0110011001100110010" when "010110",
      "0110011001100110010" when "010111",
      "1001100110011001011" when "011000",
      "1001100110011001100" when "011001",
      "1001100110011010000" when "011010",
      "1001100110011010001" when "011011",
      "1001100110011010010" when "011100",
      "1001100110011001011" when "011101",
      "1001100110011001011" when "011110",
      "1001100110011001011" when "011111",
      "1100110011001100100" when "100000",
      "1100110011001101000" when "100001",
      "1100110011001101001" when "100010",
      "1100110011001101010" when "100011",
      "1100110011001101011" when "100100",
      "1100110011001100100" when "100101",
      "1100110011001100100" when "100110",
      "1100110011001100100" when "100111",
      "0000000000000000000" when "101000",
      "0000000000000000001" when "101001",
      "0000000000000000010" when "101010",
      "0000000000000000011" when "101011",
      "0000000000000000100" when "101100",
      "0000000000000000000" when "101101",
      "0000000000000000000" when "101110",
      "0000000000000000000" when "101111",
      "0000000000000000000" when "110000",
      "0000000000000000001" when "110001",
      "0000000000000000010" when "110010",
      "0000000000000000011" when "110011",
      "0000000000000000100" when "110100",
      "0000000000000000000" when "110101",
      "0000000000000000000" when "110110",
      "0000000000000000000" when "110111",
      ...
      "0000000000000000000" when "111101",
      "0000000000000000000" when "111110",
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_5_27_1_4_Freq400_uid3
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Q: (c1, 0.250000ns)R: (c0, 1.706000ns)
...
entity IntConstDiv_QR_5_27_1_4_Freq400_uid3 is
...
architecture arch of IntConstDiv_QR_5_27_1_4_Freq400_uid3 is
   component CBLKTable_l0_d5_alpha4_Freq400_uid7 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(4 downto 0)   );
   end component;

   component CBLKTable_l1_d5_alpha4_Freq400_uid18 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(6 downto 0)   );
   end component;

   component CBLKTable_l2_d5_alpha4_Freq400_uid26 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(10 downto 0)   );
   end component;

   component CBLKTable_l3_d5_alpha4_Freq400_uid32 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(18 downto 0)   );
   end component;
...
signal out_l1_0_copy19 :  std_logic_vector(6 downto 0);
...
signal out_l1_1_copy20 :  std_logic_vector(6 downto 0);
...
signal out_l1_2_copy21 :  std_logic_vector(6 downto 0);
...
signal out_l1_3_copy22 :  std_logic_vector(6 downto 0);
...
signal out_l2_0_copy27 :  std_logic_vector(10 downto 0);
   -- timing of out_l2_0_copy27: (c0, 1.050000ns)
...
signal qs_l2_0, qs_l2_0_d1 :  std_logic_vector(15 downto 0);
...
signal out_l2_1_copy28 :  std_logic_vector(10 downto 0);
   -- timing of out_l2_1_copy28: (c0, 1.050000ns)
...
signal qs_l2_1, qs_l2_1_d1 :  std_logic_vector(8 downto 0);
...
signal out_l3_0_copy33 :  std_logic_vector(18 downto 0);
   -- timing of out_l3_0_copy33: (c0, 1.378000ns)
...
signal qs_l3_0 :  std_logic_vector(24 downto 0);
   -- timing of qs_l3_0: (c1, 0.250000ns)
begin
   process(clk)
      begin
   ...
   x0 <= X(3 downto 0);
   table0: CBLKTable_l0_d5_alpha4_Freq400_uid7
      port map ( X => x0,
                 Y => out0_copy8);
   ...
   x1 <= X(7 downto 4);
   table1: CBLKTable_l0_d5_alpha4_Freq400_uid7
      port map ( X => x1,
                 Y => out1_copy9);
   ...
   x2 <= X(11 downto 8);
   table2: CBLKTable_l0_d5_alpha4_Freq400_uid7
      port map ( X => x2,
                 Y => out2_copy10);
   ...
   x3 <= X(15 downto 12);
   table3: CBLKTable_l0_d5_alpha4_Freq400_uid7
      port map ( X => x3,
                 Y => out3_copy11);
   ...
   x4 <= X(19 downto 16);
   table4: CBLKTable_l0_d5_alpha4_Freq400_uid7
      port map ( X => x4,
                 Y => out4_copy12);
   ...
   x5 <= X(23 downto 20);
   table5: CBLKTable_l0_d5_alpha4_Freq400_uid7
      port map ( X => x5,
                 Y => out5_copy13);
   ...
   x6 <= "0" & X(26 downto 24);
   table6: CBLKTable_l0_d5_alpha4_Freq400_uid7
      port map ( X => x6,
                 Y => out6_copy14);
   out6 <= out6_copy14; -- output copy to hold a pipeline register if needed
   qs_l0_6 <= out6(3 downto 3);
   r_l0_6 <= out6(2 downto 0);
   in_l1_0 <= r_l0_1 & r_l0_0;
   table_l1_0: CBLKTable_l1_d5_alpha4_Freq400_uid18
      port map ( X => in_l1_0,
                 Y => out_l1_0_copy19);
   ...
   table_l1_1: CBLKTable_l1_d5_alpha4_Freq400_uid18
      port map ( X => in_l1_1,
                 Y => out_l1_1_copy20);
   ...
   table_l1_2: CBLKTable_l1_d5_alpha4_Freq400_uid18
      port map ( X => in_l1_2,
                 Y => out_l1_2_copy21);
   ...
   in_l1_3 <= "000" & r_l0_6;
   table_l1_3: CBLKTable_l1_d5_alpha4_Freq400_uid18
      port map ( X => in_l1_3,
                 Y => out_l1_3_copy22);
   ...
   table_l2_0: CBLKTable_l2_d5_alpha4_Freq400_uid26
      port map ( X => in_l2_0,
                 Y => out_l2_0_copy27);
...
--------------------------------------------------------------------------------
--                        flopoco_00107_fpconstdiv_top
--                     (FPConstDiv_8_23_8_23_5_1_M1_400)
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 0.250000ns)
...
entity flopoco_00107_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+23+2 downto 0);
          R : out  std_logic_vector(8+23+2 downto 0)   );
end entity;

architecture arch of flopoco_00107_fpconstdiv_top is
   component IntConstDiv_QR_5_27_1_4_Freq400_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(26 downto 0);
             Q : out  std_logic_vector(24 downto 0);
             R : out  std_logic_vector(2 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_5_27_1_4_Freq400_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
