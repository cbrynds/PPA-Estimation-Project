--------------------------------------------------------------------------------
--                   RightShifter53_by_max_163_Freq300_uid4
...
--  approx. output signal timings: R: (c2, 2.924103ns)
...
entity RightShifter53_by_max_163_Freq300_uid4 is
...
architecture arch of RightShifter53_by_max_163_Freq300_uid4 is
...
-- Input signals: I
-- Output signals: O
--  approx. input signal timings: I: (c2, 2.924103ns)
--  approx. output signal timings: O: (c3, 2.148894ns)
...
entity LZC_110_Freq300_uid6 is
    port (clk : in std_logic;
          I : in  std_logic_vector(109 downto 0);
          O : out  std_logic_vector(6 downto 0)   );
end entity;

architecture arch of LZC_110_Freq300_uid6 is
signal level7, level7_d1 :  std_logic_vector(126 downto 0);
   -- timing of level7: (c2, 2.924103ns)
signal digit6, digit6_d1 :  std_logic;
   -- timing of digit6: (c2, 3.159728ns)
signal level6 :  std_logic_vector(62 downto 0);
   -- timing of level6: (c3, 0.191394ns)
signal digit5 :  std_logic;
   -- timing of digit5: (c3, 0.417644ns)
signal level5 :  std_logic_vector(30 downto 0);
   -- timing of level5: (c3, 0.632644ns)
signal digit4 :  std_logic;
   -- timing of digit4: (c3, 0.853269ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c3, 1.068269ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c3, 1.287019ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c3, 1.502019ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c3, 1.718894ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c3, 1.933894ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c3, 2.148894ns)
signal outHighBits :  std_logic_vector(4 downto 0);
   -- timing of outHighBits: (c3, 1.718894ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   with level2  select  lowBits <= 
      ...
      "01" when "011",
      "00" when others;
   outHighBits <= digit6_d1 & digit5 & digit4 & digit3 & digit2 & "";
   O <= outHighBits & lowBits ;
end architecture;

--------------------------------------------------------------------------------
--                   LeftShifter163_by_max_162_Freq300_uid8
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c2, 2.924103ns)S: (c3, 2.148894ns)
--  approx. output signal timings: R: (c8, 2.292228ns)
...
entity LeftShifter163_by_max_162_Freq300_uid8 is
    port (clk : in std_logic;
...
--------------------------------------------------------------------------------
--                        flopoco_00048_ieeefpfma_top
--                       (IEEEFPFMA_11_52_Freq300_uid2)
...
entity flopoco_00048_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00048_ieeefpfma_top is
   component RightShifter53_by_max_163_Freq300_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(52 downto 0);
             S : in  std_logic_vector(7 downto 0);
             R : out  std_logic_vector(215 downto 0)   );
   ...
   component LZC_110_Freq300_uid6 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(109 downto 0);
             O : out  std_logic_vector(6 downto 0)   );
   end component;

   component LeftShifter163_by_max_162_Freq300_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(162 downto 0);
             S : in  std_logic_vector(7 downto 0);
             R : out  std_logic_vector(324 downto 0)   );
...
signal normShiftValue :  std_logic_vector(7 downto 0);
   -- timing of normShiftValue: (c3, 2.148894ns)
signal BigSumNormd :  std_logic_vector(324 downto 0);
   -- timing of BigSumNormd: (c8, 2.292228ns)
signal expTentative, expTentative_d1, expTentative_d2, expTentative_d3, expTentative_d4, expTentative_d5 :  std_logic_vector(12 downto 0);
   -- timing of expTentative: (c3, 2.148894ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c8, 2.292228ns)
signal fracTentative :  std_logic_vector(55 downto 0);
   -- timing of fracTentative: (c8, 2.292228ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c8, 2.292228ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c8, 2.292228ns)
signal fracResultNormd :  std_logic_vector(51 downto 0);
   -- timing of fracResultNormd: (c8, 2.292228ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c8, 2.292228ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c8, 2.292228ns)
signal round :  std_logic;
   -- timing of round: (c8, 2.292228ns)
signal expUpdate :  std_logic_vector(12 downto 0);
   -- timing of expUpdate: (c8, 2.292228ns)
signal exponentResult1 :  std_logic_vector(12 downto 0);
   -- timing of exponentResult1: (c8, 2.292228ns)
signal resultBeforeRound :  std_logic_vector(64 downto 0);
   -- timing of resultBeforeRound: (c8, 2.292228ns)
signal resultRounded :  std_logic_vector(64 downto 0);
   -- timing of resultRounded: (c8, 2.292228ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c8, 2.292228ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c8, 2.292228ns)
signal Inf, Inf_d1, Inf_d2, Inf_d3, Inf_d4, Inf_d5, Inf_d6, Inf_d7, Inf_d8 :  std_logic_vector(62 downto 0);
   -- timing of Inf: (c0, 0.000000ns)
signal NaN, NaN_d1, NaN_d2, NaN_d3, NaN_d4, NaN_d5, NaN_d6, NaN_d7, NaN_d8 :  std_logic_vector(62 downto 0);
...
begin
   ...
   RightShifterComponent: RightShifter53_by_max_163_Freq300_uid4
      port map ( clk  => clk,
                 S => ShiftValue,
                 X => Csig,
                 R => CsigShifted);
   ...
   IEEEFPFMA_11_52_Freq300_uid2LeadingZeroCounter: LZC_110_Freq300_uid6
      port map ( clk  => clk,
   ...
   NormalizationShifter: LeftShifter163_by_max_162_Freq300_uid8
      port map ( clk  => clk,
                 S => normShiftValue,
                 X => BigSumAbs,
                 R => BigSumNormd);
   ...
   R <= 
           Rsgn_d5 & Inf_d8 when ((not RisNaN_d8) and finalRisInf)='1'
