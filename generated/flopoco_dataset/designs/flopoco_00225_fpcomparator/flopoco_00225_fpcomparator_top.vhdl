--------------------------------------------------------------------------------
--                     IntComparator_15_010_Freq400_uid4
...
entity IntComparator_15_010_Freq400_uid4 is
...
architecture arch of IntComparator_15_010_Freq400_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00225_fpcomparator_top
--                      (FPComparator_5_10_Freq400_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin (2021)
...
entity flopoco_00225_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00225_fpcomparator_top is
   component IntComparator_15_010_Freq400_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(14 downto 0);
             Y : in  std_logic_vector(14 downto 0);
             XeqY : out  std_logic   );
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_15_010_Freq400_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
