--------------------------------------------------------------------------------
--                     IntComparator_17_010_Freq150_uid4
...
--  approx. output signal timings: XeqY: (c0, 0.472000ns)
...
entity IntComparator_17_010_Freq150_uid4 is
...
architecture arch of IntComparator_17_010_Freq150_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00278_fpcomparator_top
...
--  approx. input signal timings: X: (c0, 0.000000ns)Y: (c0, 0.000000ns)
--  approx. output signal timings: unordered: (c0, 0.000000ns)XeqY: (c0, 0.687000ns)
...
entity flopoco_00278_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00278_fpcomparator_top is
   component IntComparator_17_010_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(16 downto 0);
             Y : in  std_logic_vector(16 downto 0);
             XeqY : out  std_logic   );
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_17_010_Freq150_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
