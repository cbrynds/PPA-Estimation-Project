...
--  approx. output signal timings: O: (c1, 1.773013ns)
...
signal digit5 :  std_logic;
   -- timing of digit5: (c1, 0.041763ns)
signal level5 :  std_logic_vector(30 downto 0);
   -- timing of level5: (c1, 0.256763ns)
signal digit4 :  std_logic;
   -- timing of digit4: (c1, 0.477388ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c1, 0.692388ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c1, 0.911138ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c1, 1.126138ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c1, 1.343013ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c1, 1.558013ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c1, 1.773013ns)
signal outHighBits :  std_logic_vector(3 downto 0);
   -- timing of outHighBits: (c1, 1.343013ns)
begin
   process(clk)
      begin
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c0, 2.998846ns)S: (c1, 1.773013ns)
--  approx. output signal timings: R: (c3, 0.805192ns)
...
entity flopoco_00257_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00257_ieeefpfma_top is
...
signal tmpExpCompRes2 :  std_logic_vector(9 downto 0);
   -- timing of tmpExpCompRes2: (c1, 1.773013ns)
signal RisSubNormal, RisSubNormal_d1, RisSubNormal_d2 :  std_logic;
   -- timing of RisSubNormal: (c1, 1.773013ns)
signal RisZero, RisZero_d1, RisZero_d2 :  std_logic;
   -- timing of RisZero: (c1, 1.773013ns)
signal RisSubNormalOrZero :  std_logic;
   -- timing of RisSubNormalOrZero: (c1, 1.773013ns)
signal Rsgn, Rsgn_d1, Rsgn_d2 :  std_logic;
   -- timing of Rsgn: (c1, 1.773013ns)
...
signal normShiftValue :  std_logic_vector(6 downto 0);
   -- timing of normShiftValue: (c1, 1.773013ns)
signal BigSumNormd :  std_logic_vector(150 downto 0);
   -- timing of BigSumNormd: (c3, 0.805192ns)
signal expTentative, expTentative_d1, expTentative_d2 :  std_logic_vector(9 downto 0);
   -- timing of expTentative: (c1, 1.773013ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c3, 0.805192ns)
signal fracTentative :  std_logic_vector(26 downto 0);
   -- timing of fracTentative: (c3, 0.805192ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c3, 0.805192ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c3, 0.805192ns)
signal fracResultNormd :  std_logic_vector(22 downto 0);
   -- timing of fracResultNormd: (c3, 0.805192ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c3, 0.805192ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c3, 0.805192ns)
signal round :  std_logic;
   -- timing of round: (c3, 0.805192ns)
signal expUpdate :  std_logic_vector(9 downto 0);
   -- timing of expUpdate: (c3, 0.805192ns)
signal exponentResult1 :  std_logic_vector(9 downto 0);
   -- timing of exponentResult1: (c3, 0.805192ns)
signal resultBeforeRound :  std_logic_vector(32 downto 0);
   -- timing of resultBeforeRound: (c3, 0.805192ns)
signal resultRounded :  std_logic_vector(32 downto 0);
   -- timing of resultRounded: (c3, 0.805192ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c3, 0.805192ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c3, 0.805192ns)
