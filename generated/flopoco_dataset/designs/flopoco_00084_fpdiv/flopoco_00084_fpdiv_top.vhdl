...
--  approx. output signal timings: R: (c3, 3.435000ns)
...
entity flopoco_00084_fpdiv_top is
...
architecture arch of flopoco_00084_fpdiv_top is
...
signal expR0, expR0_d1, expR0_d2, expR0_d3 :  std_logic_vector(11 downto 0);
...
signal D, D_d1, D_d2, D_d3 :  std_logic_vector(35 downto 0);
...
begin
   ...
   sel14 <= betaw14(38 downto 33) & D_d1(34 downto 32);
   ...
   sel13 <= betaw13(38 downto 33) & D_d1(34 downto 32);
   ...
   sel8 <= betaw8(38 downto 33) & D_d2(34 downto 32);
   ...
   sel7 <= betaw7(38 downto 33) & D_d2(34 downto 32);
   ...
   sel6 <= betaw6(38 downto 33) & D_d2(34 downto 32);
   ...
   sel5 <= betaw5(38 downto 33) & D_d2(34 downto 32);
   ...
   sel2 <= betaw2(38 downto 33) & D_d3(34 downto 32);
   ...
   sel1 <= betaw1(38 downto 33) & D_d3(34 downto 32);
   ...
   qP1 <=      q1(1 downto 0);
   qM1 <=      q1(2) & "0";
   qP <= qP20_d3 & qP19_d3 & qP18_d3 & qP17_d3 & qP16_d3 & qP15_d3 & qP14_d2 & qP13_d2 & qP12_d2 & qP11_d2 & qP10_d2 & qP9_d2 & qP8_d1 & qP7_d1 & qP6_d1 & qP5_d1 & qP4_d1 & qP3_d1 & qP2 & qP1;
   qM <= qM20_d3(0) & qM19_d3 & qM18_d3 & qM17_d3 & qM16_d3 & qM15_d3 & qM14_d2 & qM13_d2 & qM12_d2 & qM11_d2 & qM10_d2 & qM9_d2 & qM8_d1 & qM7_d1 & qM6_d1 & qM5_d1 & qM4_d1 & qM3_d1 & qM2 & qM1 & qM0;
   quotient <= qP - qM;
   ...
   round <= fRnorm(0); 
   expR1 <= expR0_d3 + ("000" & (8 downto 1 => '1') & mR(37)); -- add back bias
   -- final rounding
   ...
   R <= exnRfinal & sR_d3 & expfracR(44 downto 0);
end architecture;
