--------------------------------------------------------------------------------
--                RightShifterSticky53_by_max_55_Freq250_uid4
...
--  approx. output signal timings: R: (c0, 1.914750ns)Sticky: (c0, 2.801000ns)
...
entity RightShifterSticky53_by_max_55_Freq250_uid4 is
...
architecture arch of RightShifterSticky53_by_max_55_Freq250_uid4 is
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.836000ns)Y: (c0, 2.129750ns)Cin: (c0, 3.016000ns)
--  approx. output signal timings: R: (c0, 3.719000ns)
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_57_57_57_Freq250_uid8
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. input signal timings: X: (c0, 3.719000ns)
--  approx. output signal timings: Count: (c1, 2.260250ns)R: (c1, 2.475250ns)
...
entity Normalizer_Z_57_57_57_Freq250_uid8 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_57_57_57_Freq250_uid8 is
signal level6, level6_d1 :  std_logic_vector(56 downto 0);
   -- timing of level6: (c0, 3.719000ns)
signal count5 :  std_logic;
   -- timing of count5: (c1, 0.095250ns)
signal level5 :  std_logic_vector(56 downto 0);
   -- timing of level5: (c1, 0.310250ns)
signal count4 :  std_logic;
   -- timing of count4: (c1, 0.530875ns)
signal level4 :  std_logic_vector(56 downto 0);
   -- timing of level4: (c1, 0.745875ns)
signal count3 :  std_logic;
   -- timing of count3: (c1, 0.964625ns)
signal level3 :  std_logic_vector(56 downto 0);
   -- timing of level3: (c1, 1.179625ns)
signal count2 :  std_logic;
   -- timing of count2: (c1, 1.396500ns)
signal level2 :  std_logic_vector(56 downto 0);
   -- timing of level2: (c1, 1.611500ns)
signal count1 :  std_logic;
   -- timing of count1: (c1, 1.828375ns)
signal level1 :  std_logic_vector(56 downto 0);
   -- timing of level1: (c1, 2.043375ns)
signal count0 :  std_logic;
   -- timing of count0: (c1, 2.260250ns)
signal level0 :  std_logic_vector(56 downto 0);
   -- timing of level0: (c1, 2.475250ns)
signal sCount :  std_logic_vector(5 downto 0);
   -- timing of sCount: (c1, 2.260250ns)
begin
   process(clk)
      begin
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 2.758250ns)Y: (c0, 0.000000ns)Cin: (c1, 2.690250ns)
--  approx. output signal timings: R: (c1, 3.543250ns)
...
entity IntAdder_66_Freq250_uid11 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_66_Freq250_uid11 is
signal Rtmp :  std_logic_vector(65 downto 0);
   -- timing of Rtmp: (c1, 3.543250ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00064_fpadd_top
--                         (FPSub_11_52_Freq250_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c2, 0.123250ns)
...
entity flopoco_00064_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00064_fpadd_top is
   component RightShifterSticky53_by_max_55_Freq250_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(52 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(54 downto 0);
   ...
   component Normalizer_Z_57_57_57_Freq250_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(56 downto 0);
             Count : out  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(56 downto 0)   );
   ...
   component IntAdder_66_Freq250_uid11 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(65 downto 0);
             Y : in  std_logic_vector(65 downto 0);
             Cin : in  std_logic;
...
signal sticky :  std_logic;
   -- timing of sticky: (c0, 2.801000ns)
...
signal cInSigAdd :  std_logic;
   -- timing of cInSigAdd: (c0, 3.016000ns)
signal fracAddResult :  std_logic_vector(55 downto 0);
   -- timing of fracAddResult: (c0, 3.719000ns)
signal fracSticky :  std_logic_vector(56 downto 0);
   -- timing of fracSticky: (c0, 3.719000ns)
signal nZerosNew :  std_logic_vector(5 downto 0);
   -- timing of nZerosNew: (c1, 2.260250ns)
signal shiftedFrac :  std_logic_vector(56 downto 0);
   -- timing of shiftedFrac: (c1, 2.475250ns)
signal extendedExpInc, extendedExpInc_d1 :  std_logic_vector(11 downto 0);
   -- timing of extendedExpInc: (c0, 1.334000ns)
signal updatedExp :  std_logic_vector(12 downto 0);
   -- timing of updatedExp: (c1, 2.758250ns)
signal eqdiffsign, eqdiffsign_d1 :  std_logic;
   -- timing of eqdiffsign: (c1, 2.260250ns)
signal expFrac :  std_logic_vector(65 downto 0);
   -- timing of expFrac: (c1, 2.758250ns)
signal stk :  std_logic;
   -- timing of stk: (c1, 2.475250ns)
signal rnd :  std_logic;
   -- timing of rnd: (c1, 2.475250ns)
signal lsb :  std_logic;
   -- timing of lsb: (c1, 2.475250ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c1, 2.690250ns)
signal RoundedExpFrac :  std_logic_vector(65 downto 0);
   -- timing of RoundedExpFrac: (c1, 3.543250ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c1, 3.543250ns)
signal fracR, fracR_d1 :  std_logic_vector(51 downto 0);
   -- timing of fracR: (c1, 3.543250ns)
signal expR, expR_d1 :  std_logic_vector(10 downto 0);
   -- timing of expR: (c1, 3.543250ns)
signal exExpExc :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c1, 3.543250ns)
signal excRt2, excRt2_d1 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c1, 3.758250ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c2, 0.123250ns)
signal signR2, signR2_d1 :  std_logic;
   -- timing of signR2: (c1, 2.475250ns)
signal computedR :  std_logic_vector(65 downto 0);
   -- timing of computedR: (c2, 0.123250ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   mY <= Y(65 downto 64) & not(Y(63)) & Y(62 downto 0);
   ...
   RightShifterComponent: RightShifterSticky53_by_max_55_Freq250_uid4
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracY,
                 R => shiftedFracY,
   ...
   LZCAndShifter: Normalizer_Z_57_57_57_Freq250_uid8
      port map ( clk  => clk,
                 X => fracSticky,
                 Count => nZerosNew,
                 R => shiftedFrac);
   extendedExpInc<= ("0" & expX) + '1';
   updatedExp <= ("0" &extendedExpInc_d1) - ("0000000" & nZerosNew);
   ...
   roundingAdder: IntAdder_66_Freq250_uid11
      port map ( clk  => clk,
                 Cin => needToRound,
                 X => expFrac,
   ...
   excRt2<= "00" when "0000"|"0100"|"1000"|"1100"|"1001"|"1101",
      ...
      "11" when others;
   excR <= "00" when (eqdiffsign_d1='1' and EffSub_d2='1'  and not(excRt_d2="11")) else excRt2_d1;
