...
--  approx. output signal timings: O: (c1, 1.423250ns)
...
signal digit4 :  std_logic;
   -- timing of digit4: (c1, 0.127625ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c1, 0.342625ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c1, 0.561375ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c1, 0.776375ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c1, 0.993250ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c1, 1.208250ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c1, 1.423250ns)
signal outHighBits :  std_logic_vector(2 downto 0);
   -- timing of outHighBits: (c1, 0.993250ns)
begin
   process(clk)
      begin
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c0, 3.757000ns)S: (c1, 2.110250ns)
--  approx. output signal timings: R: (c1, 3.647942ns)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 3.647942ns)Y: (c0, 0.000000ns)Cin: (c2, 0.484942ns)
--  approx. output signal timings: R: (c2, 1.064942ns)
...
signal Rtmp :  std_logic_vector(30 downto 0);
   -- timing of Rtmp: (c2, 1.064942ns)
signal X_d1 :  std_logic_vector(30 downto 0);
   -- timing of X: (c1, 3.647942ns)
...
--  approx. output signal timings: R: (c2, 1.751942ns)
...
entity flopoco_00260_ieeefpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00260_ieeefpadd_top is
...
signal expSigR2 :  std_logic_vector(30 downto 0);
   -- timing of expSigR2: (c2, 1.751942ns)
signal signR :  std_logic;
   -- timing of signR: (c2, 1.751942ns)
signal computedR :  std_logic_vector(31 downto 0);
   -- timing of computedR: (c2, 1.751942ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
