...
--  approx. output signal timings: R: (c2, 0.366000ns)
...
entity flopoco_00104_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(5+10+2 downto 0);
          R : out  std_logic_vector(5+10+2 downto 0)   );
end entity;

architecture arch of flopoco_00104_fpsqrt_top is
...
signal fR, fR_d1 :  std_logic_vector(9 downto 0);
   -- timing of fR: (c1, 3.718000ns)
signal round, round_d1 :  std_logic;
   -- timing of round: (c1, 3.683000ns)
signal fRrnd :  std_logic_vector(9 downto 0);
   -- timing of fRrnd: (c2, 0.366000ns)
signal Rn2 :  std_logic_vector(14 downto 0);
   -- timing of Rn2: (c2, 0.366000ns)
