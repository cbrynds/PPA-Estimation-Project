--------------------------------------------------------------------------------
--                   RightShifter53_by_max_163_Freq250_uid4
...
--  approx. output signal timings: R: (c2, 1.590769ns)
...
entity RightShifter53_by_max_163_Freq250_uid4 is
...
architecture arch of RightShifter53_by_max_163_Freq250_uid4 is
...
-- Input signals: I
-- Output signals: O
--  approx. input signal timings: I: (c2, 1.590769ns)
--  approx. output signal timings: O: (c3, 0.148894ns)
...
entity LZC_110_Freq250_uid6 is
    port (clk : in std_logic;
          I : in  std_logic_vector(109 downto 0);
          O : out  std_logic_vector(6 downto 0)   );
end entity;

architecture arch of LZC_110_Freq250_uid6 is
signal level7 :  std_logic_vector(126 downto 0);
   -- timing of level7: (c2, 1.590769ns)
signal digit6 :  std_logic;
   -- timing of digit6: (c2, 1.826394ns)
signal level6 :  std_logic_vector(62 downto 0);
   -- timing of level6: (c2, 2.041394ns)
signal digit5 :  std_logic;
   -- timing of digit5: (c2, 2.267644ns)
signal level5 :  std_logic_vector(30 downto 0);
   -- timing of level5: (c2, 2.482644ns)
signal digit4 :  std_logic;
   -- timing of digit4: (c2, 2.703269ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c2, 2.918269ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c2, 3.137019ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c2, 3.352019ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c2, 3.568894ns)
signal level2, level2_d1 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c2, 3.783894ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c3, 0.148894ns)
signal outHighBits, outHighBits_d1 :  std_logic_vector(4 downto 0);
   -- timing of outHighBits: (c2, 3.568894ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
--------------------------------------------------------------------------------
--                   LeftShifter163_by_max_162_Freq250_uid8
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c2, 1.590769ns)S: (c3, 0.148894ns)
--  approx. output signal timings: R: (c7, 0.808894ns)
...
entity LeftShifter163_by_max_162_Freq250_uid8 is
    port (clk : in std_logic;
...
--------------------------------------------------------------------------------
--                        flopoco_00083_ieeefpfma_top
--                       (IEEEFPFMA_11_52_Freq250_uid2)
...
entity flopoco_00083_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00083_ieeefpfma_top is
   component RightShifter53_by_max_163_Freq250_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(52 downto 0);
             S : in  std_logic_vector(7 downto 0);
             R : out  std_logic_vector(215 downto 0)   );
   ...
   component LZC_110_Freq250_uid6 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(109 downto 0);
             O : out  std_logic_vector(6 downto 0)   );
   end component;

   component LeftShifter163_by_max_162_Freq250_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(162 downto 0);
             S : in  std_logic_vector(7 downto 0);
             R : out  std_logic_vector(324 downto 0)   );
...
signal normShiftValue :  std_logic_vector(7 downto 0);
   -- timing of normShiftValue: (c3, 0.148894ns)
signal BigSumNormd :  std_logic_vector(324 downto 0);
   -- timing of BigSumNormd: (c7, 0.808894ns)
signal expTentative, expTentative_d1, expTentative_d2, expTentative_d3, expTentative_d4 :  std_logic_vector(12 downto 0);
   -- timing of expTentative: (c3, 0.148894ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c7, 0.808894ns)
signal fracTentative :  std_logic_vector(55 downto 0);
   -- timing of fracTentative: (c7, 0.808894ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c7, 0.808894ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c7, 0.808894ns)
signal fracResultNormd :  std_logic_vector(51 downto 0);
   -- timing of fracResultNormd: (c7, 0.808894ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c7, 0.808894ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c7, 0.808894ns)
signal round :  std_logic;
   -- timing of round: (c7, 0.808894ns)
signal expUpdate :  std_logic_vector(12 downto 0);
   -- timing of expUpdate: (c7, 0.808894ns)
signal exponentResult1 :  std_logic_vector(12 downto 0);
   -- timing of exponentResult1: (c7, 0.808894ns)
signal resultBeforeRound :  std_logic_vector(64 downto 0);
   -- timing of resultBeforeRound: (c7, 0.808894ns)
signal resultRounded :  std_logic_vector(64 downto 0);
   -- timing of resultRounded: (c7, 0.808894ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c7, 0.808894ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c7, 0.808894ns)
...
begin
   ...
   RightShifterComponent: RightShifter53_by_max_163_Freq250_uid4
      port map ( clk  => clk,
                 S => ShiftValue,
                 X => Csig,
                 R => CsigShifted);
   ...
   IEEEFPFMA_11_52_Freq250_uid2LeadingZeroCounter: LZC_110_Freq250_uid6
      port map ( clk  => clk,
   ...
   NormalizationShifter: LeftShifter163_by_max_162_Freq250_uid8
      port map ( clk  => clk,
                 S => normShiftValue,
                 X => BigSumAbs,
                 R => BigSumNormd);
