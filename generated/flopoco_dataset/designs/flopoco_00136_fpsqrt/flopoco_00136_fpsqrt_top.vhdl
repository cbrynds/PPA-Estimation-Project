...
--  approx. output signal timings: R: (c1, 2.262333ns)
...
entity flopoco_00136_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(6+11+2 downto 0);
          R : out  std_logic_vector(6+11+2 downto 0)   );
end entity;

architecture arch of flopoco_00136_fpsqrt_top is
...
signal R9s_l, R9s_l_d1 :  std_logic_vector(1 downto 0);
...
signal fR :  std_logic_vector(10 downto 0);
   -- timing of fR: (c1, 1.764333ns)
signal round :  std_logic;
   -- timing of round: (c1, 1.729333ns)
signal fRrnd :  std_logic_vector(10 downto 0);
   -- timing of fRrnd: (c1, 2.262333ns)
signal Rn2 :  std_logic_vector(16 downto 0);
   -- timing of Rn2: (c1, 2.262333ns)
