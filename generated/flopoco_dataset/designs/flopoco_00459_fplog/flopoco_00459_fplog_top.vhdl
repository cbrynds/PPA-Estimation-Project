...
architecture arch of LZOC_7_Freq200_uid4 is
...
entity IntAdder_10_Freq200_uid12 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_10_Freq200_uid12 is
...
--  approx. output signal timings: R: (c0, 3.353077ns)
...
entity IntAdder_19_Freq200_uid30 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_19_Freq200_uid30 is
...
architecture arch of FixRealKCM_Freq200_uid20 is
   ...
   component IntAdder_19_Freq200_uid30 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(18 downto 0);
             Y : in  std_logic_vector(18 downto 0);
             Cin : in  std_logic;
...
signal FixRealKCM_Freq200_uid20_T0 :  std_logic_vector(18 downto 0);
   -- timing of FixRealKCM_Freq200_uid20_T0: (c0, 1.015000ns)
signal FixRealKCM_Freq200_uid20_T0_copy24 :  std_logic_vector(18 downto 0);
...
signal FixRealKCM_Freq200_uid20_A1 :  std_logic_vector(1 downto 0);
   -- timing of FixRealKCM_Freq200_uid20_A1: (c0, 0.687000ns)
signal FixRealKCM_Freq200_uid20_T1 :  std_logic_vector(12 downto 0);
   -- timing of FixRealKCM_Freq200_uid20_T1: (c0, 0.902000ns)
signal FixRealKCM_Freq200_uid20_T1_copy27 :  std_logic_vector(12 downto 0);
   -- timing of FixRealKCM_Freq200_uid20_T1_copy27: (c0, 0.687000ns)
...
-- This operator multiplies by log(2)
   ...
   bitheapFinalAdd_bh21: IntAdder_19_Freq200_uid30
      port map ( clk  => clk,
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 1.554000ns)Y: (c0, 3.353077ns)Cin: (c0, 0.215000ns)
--  approx. output signal timings: R: (c0, 3.892077ns)
...
entity IntAdder_23_Freq200_uid32 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_23_Freq200_uid32 is
signal Rtmp :  std_logic_vector(22 downto 0);
   -- timing of Rtmp: (c0, 3.892077ns)
begin
   Rtmp <= X + Y + Cin;
   R <= Rtmp;
end architecture;
...
--------------------------------------------------------------------------------
--                    Normalizer_Z_23_15_11_Freq200_uid34
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. input signal timings: X: (c0, 3.892077ns)
--  approx. output signal timings: Count: (c1, 0.556452ns)R: (c1, 0.771452ns)
...
entity Normalizer_Z_23_15_11_Freq200_uid34 is
    port (clk : in std_logic;
          X : in  std_logic_vector(22 downto 0);
...
architecture arch of Normalizer_Z_23_15_11_Freq200_uid34 is
signal level4 :  std_logic_vector(22 downto 0);
   -- timing of level4: (c0, 3.892077ns)
signal count3, count3_d1 :  std_logic;
   -- timing of count3: (c0, 4.110827ns)
signal level3 :  std_logic_vector(21 downto 0);
   -- timing of level3: (c0, 4.325827ns)
signal count2, count2_d1 :  std_logic;
   -- timing of count2: (c0, 4.542702ns)
signal level2, level2_d1 :  std_logic_vector(17 downto 0);
   -- timing of level2: (c0, 4.757702ns)
signal count1 :  std_logic;
   -- timing of count1: (c1, 0.124577ns)
signal level1 :  std_logic_vector(15 downto 0);
   -- timing of level1: (c1, 0.339577ns)
signal count0 :  std_logic;
   -- timing of count0: (c1, 0.556452ns)
signal level0 :  std_logic_vector(14 downto 0);
   -- timing of level0: (c1, 0.771452ns)
signal sCount :  std_logic_vector(3 downto 0);
   -- timing of sCount: (c1, 0.556452ns)
begin
   process(clk)
      begin
   ...
   level1<= level2_d1(17 downto 2) when count1='0' else level2_d1(15 downto 0);
...
--------------------------------------------------------------------------------
--                    RightShifter9_by_max_7_Freq200_uid36
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
entity RightShifter9_by_max_7_Freq200_uid36 is
    port (clk : in std_logic;
...
architecture arch of RightShifter9_by_max_7_Freq200_uid36 is
signal ps :  std_logic_vector(2 downto 0);
   -- timing of ps: (c0, 1.589000ns)
...
entity IntAdder_13_Freq200_uid38 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_13_Freq200_uid38 is
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.771452ns)Y: (c1, 0.771452ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 1.269452ns)
...
entity IntAdder_15_Freq200_uid41 is
    port (clk : in std_logic;
          X : in  std_logic_vector(14 downto 0);
          Y : in  std_logic_vector(14 downto 0);
          Cin : in  std_logic;
...
architecture arch of IntAdder_15_Freq200_uid41 is
signal Rtmp :  std_logic_vector(14 downto 0);
   -- timing of Rtmp: (c1, 1.269452ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00459_fplog_top
--                  (FPLogIterative_8_7_12_200_Freq200_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00459_fplog_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00459_fplog_top is
   component LZOC_7_Freq200_uid4 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(6 downto 0);
             OZB : in  std_logic;
             O : out  std_logic_vector(2 downto 0)   );
   ...
   component IntAdder_10_Freq200_uid12 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(9 downto 0);
             Y : in  std_logic_vector(9 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_23_Freq200_uid32 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(22 downto 0);
             Y : in  std_logic_vector(22 downto 0);
             Cin : in  std_logic;
   ...
   component Normalizer_Z_23_15_11_Freq200_uid34 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(22 downto 0);
             Count : out  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(14 downto 0)   );
   ...
   component RightShifter9_by_max_7_Freq200_uid36 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(8 downto 0);
             S : in  std_logic_vector(2 downto 0);
             R : out  std_logic_vector(15 downto 0)   );
   ...
   component IntAdder_13_Freq200_uid38 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(12 downto 0);
             Y : in  std_logic_vector(12 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_15_Freq200_uid41 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(14 downto 0);
             Y : in  std_logic_vector(14 downto 0);
             Cin : in  std_logic;
...
signal LogF_normal :  std_logic_vector(14 downto 0);
   -- timing of LogF_normal: (c0, 3.353077ns)
...
begin
   ...
   addFinalLog1p_normalAdder: IntAdder_10_Freq200_uid12
      port map ( clk  => clk,
                 Cin => '1',
                 X => Zfinal,
                 Y => addFinalLog1pY,
   ...
   adderLogF_normal: IntAdder_15_Freq200_uid18
      port map ( clk  => clk,
                 Cin => '0',
                 X => almostLog,
                 Y => adderLogF_normalY,
   ...
   lnadder: IntAdder_23_Freq200_uid32
      port map ( clk  => clk,
                 Cin => sR,
                 X => lnaddX,
                 Y => lnaddY,
                 R => Log_normal);
   final_norm: Normalizer_Z_23_15_11_Freq200_uid34
      port map ( clk  => clk,
                 X => Log_normal,
                 Count => E_normal,
                 R => Log_normal_normd);
   Z2o2_small_bs <= Z2o2_full_dummy(17 downto 9);
   ao_rshift: RightShifter9_by_max_7_Freq200_uid36
      port map ( clk  => clk,
                 S => shiftvalinR,
                 X => Z2o2_small_bs,
                 R => Z2o2_small_s);
   ...
   nsRCin <= not ( sR );
   log_small_adder: IntAdder_13_Freq200_uid38
      port map ( clk  => clk,
                 Cin => nsRCin,
                 X => Z_small,
                 Y => Log_smallY,
   ...
   finalRoundAdder: IntAdder_15_Freq200_uid41
      port map ( clk  => clk,
                 Cin => '0',
                 X => fraX,
                 Y => fraY,
