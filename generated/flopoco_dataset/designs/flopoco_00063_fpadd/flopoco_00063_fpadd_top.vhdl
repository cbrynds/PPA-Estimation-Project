--------------------------------------------------------------------------------
--                RightShifterSticky11_by_max_13_Freq400_uid4
...
entity RightShifterSticky11_by_max_13_Freq400_uid4 is
...
architecture arch of RightShifterSticky11_by_max_13_Freq400_uid4 is
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.713000ns)Y: (c0, 1.789875ns)Cin: (c1, 0.094250ns)
--  approx. output signal timings: R: (c1, 0.592250ns)
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_15_15_15_Freq400_uid8
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. input signal timings: X: (c1, 0.592250ns)
--  approx. output signal timings: Count: (c1, 2.106625ns)R: (c1, 2.321625ns)
...
entity Normalizer_Z_15_15_15_Freq400_uid8 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_15_15_15_Freq400_uid8 is
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c1, 0.592250ns)
signal count3 :  std_logic;
   -- timing of count3: (c1, 0.811000ns)
signal level3 :  std_logic_vector(14 downto 0);
   -- timing of level3: (c1, 1.026000ns)
signal count2 :  std_logic;
   -- timing of count2: (c1, 1.242875ns)
signal level2 :  std_logic_vector(14 downto 0);
   -- timing of level2: (c1, 1.457875ns)
signal count1 :  std_logic;
   -- timing of count1: (c1, 1.674750ns)
signal level1 :  std_logic_vector(14 downto 0);
   -- timing of level1: (c1, 1.889750ns)
signal count0 :  std_logic;
   -- timing of count0: (c1, 2.106625ns)
signal level0 :  std_logic_vector(14 downto 0);
   -- timing of level0: (c1, 2.321625ns)
signal sCount :  std_logic_vector(3 downto 0);
   -- timing of sCount: (c1, 2.106625ns)
begin
   level4 <= X ;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c2, 0.228625ns)Y: (c0, 0.000000ns)Cin: (c2, 0.186625ns)
--  approx. output signal timings: R: (c2, 0.767625ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00063_fpadd_top
--                         (FPSub_5_10_Freq400_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c2, 1.197625ns)
...
entity flopoco_00063_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00063_fpadd_top is
   component RightShifterSticky11_by_max_13_Freq400_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(10 downto 0);
             S : in  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(12 downto 0);
   ...
   component Normalizer_Z_15_15_15_Freq400_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(14 downto 0);
             Count : out  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(14 downto 0)   );
...
signal updatedExp :  std_logic_vector(6 downto 0);
   -- timing of updatedExp: (c2, 0.228625ns)
signal eqdiffsign, eqdiffsign_d1 :  std_logic;
   -- timing of eqdiffsign: (c1, 2.106625ns)
signal expFrac :  std_logic_vector(17 downto 0);
   -- timing of expFrac: (c2, 0.228625ns)
signal stk, stk_d1 :  std_logic;
   -- timing of stk: (c1, 2.321625ns)
signal rnd, rnd_d1 :  std_logic;
   -- timing of rnd: (c1, 2.321625ns)
signal lsb, lsb_d1 :  std_logic;
   -- timing of lsb: (c1, 2.321625ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c2, 0.186625ns)
signal RoundedExpFrac :  std_logic_vector(17 downto 0);
   -- timing of RoundedExpFrac: (c2, 0.767625ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c2, 0.767625ns)
signal fracR :  std_logic_vector(9 downto 0);
   -- timing of fracR: (c2, 0.767625ns)
signal expR :  std_logic_vector(4 downto 0);
   -- timing of expR: (c2, 0.767625ns)
signal exExpExc :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c2, 0.767625ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c2, 0.982625ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c2, 1.197625ns)
signal signR2, signR2_d1 :  std_logic;
   -- timing of signR2: (c1, 2.321625ns)
signal computedR :  std_logic_vector(17 downto 0);
   -- timing of computedR: (c2, 1.197625ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   RightShifterComponent: RightShifterSticky11_by_max_13_Freq400_uid4
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracY,
                 R => shiftedFracY,
   ...
   LZCAndShifter: Normalizer_Z_15_15_15_Freq400_uid8
      port map ( clk  => clk,
                 X => fracSticky,
                 Count => nZerosNew,
                 R => shiftedFrac);
   extendedExpInc<= ("0" & expX) + '1';
   updatedExp <= ("0" &extendedExpInc_d2) - ("000" & nZerosNew_d1);
