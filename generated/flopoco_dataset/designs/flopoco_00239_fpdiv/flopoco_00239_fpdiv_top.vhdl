...
--------------------------------------------------------------------------------
--                          flopoco_00239_fpdiv_top
--                         (FPDiv_6_11_Freq200_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c2, 1.368856ns)
...
entity flopoco_00239_fpdiv_top is
...
architecture arch of flopoco_00239_fpdiv_top is
...
begin
   ...
   qP0 <= q0(2 downto 0);
   qM0 <= q0(3)  & "00";
   qP <= qP5_d2 & qP4_d2 & qP3_d2 & qP2_d1 & qP1_d1 & qP0;
   qM <= qM5_d2(1 downto 0) & qM4_d2 & qM3_d2 & qM2_d1 & qM1_d1 & qM0 & "0";
   quotient <= qP - qM;
