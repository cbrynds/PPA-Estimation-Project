--------------------------------------------------------------------------------
--                    CBLKTable_l0_d3_alpha3_Freq300_uid7
...
entity CBLKTable_l0_d3_alpha3_Freq300_uid7 is
    port (X : in  std_logic_vector(2 downto 0);
          Y : out  std_logic_vector(3 downto 0)   );
end entity;

architecture arch of CBLKTable_l0_d3_alpha3_Freq300_uid7 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l1_d3_alpha3_Freq300_uid20
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l1_d3_alpha3_Freq300_uid20 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(4 downto 0)   );
end entity;

architecture arch of CBLKTable_l1_d3_alpha3_Freq300_uid20 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l2_d3_alpha3_Freq300_uid29
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l2_d3_alpha3_Freq300_uid29 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(7 downto 0)   );
end entity;

architecture arch of CBLKTable_l2_d3_alpha3_Freq300_uid29 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l3_d3_alpha3_Freq300_uid36
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l3_d3_alpha3_Freq300_uid36 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(13 downto 0)   );
end entity;

architecture arch of CBLKTable_l3_d3_alpha3_Freq300_uid36 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l4_d3_alpha3_Freq300_uid42
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l4_d3_alpha3_Freq300_uid42 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(25 downto 0)   );
end entity;

architecture arch of CBLKTable_l4_d3_alpha3_Freq300_uid42 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_3_26_1_3_Freq300_uid3
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Q: (c0, 3.026000ns)R: (c0, 1.582000ns)
...
entity IntConstDiv_QR_3_26_1_3_Freq300_uid3 is
...
architecture arch of IntConstDiv_QR_3_26_1_3_Freq300_uid3 is
   component CBLKTable_l0_d3_alpha3_Freq300_uid7 is
      port ( X : in  std_logic_vector(2 downto 0);
             Y : out  std_logic_vector(3 downto 0)   );
   end component;

   component CBLKTable_l1_d3_alpha3_Freq300_uid20 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(4 downto 0)   );
   end component;

   component CBLKTable_l2_d3_alpha3_Freq300_uid29 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(7 downto 0)   );
   end component;

   component CBLKTable_l3_d3_alpha3_Freq300_uid36 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(13 downto 0)   );
   end component;

   component CBLKTable_l4_d3_alpha3_Freq300_uid42 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(25 downto 0)   );
   end component;
...
signal out_l1_0_copy21 :  std_logic_vector(4 downto 0);
...
signal out_l1_1_copy22 :  std_logic_vector(4 downto 0);
...
signal out_l1_2_copy23 :  std_logic_vector(4 downto 0);
...
signal out_l1_3_copy24 :  std_logic_vector(4 downto 0);
...
signal out_l1_4_copy25 :  std_logic_vector(4 downto 0);
...
signal out_l2_0_copy30 :  std_logic_vector(7 downto 0);
...
signal out_l2_1_copy31 :  std_logic_vector(7 downto 0);
...
signal out_l2_2_copy32 :  std_logic_vector(7 downto 0);
...
signal out_l3_0_copy37 :  std_logic_vector(13 downto 0);
...
signal out_l3_1_copy38 :  std_logic_vector(13 downto 0);
...
signal out_l4_0_copy43 :  std_logic_vector(25 downto 0);
...
signal qs_l4_0 :  std_logic_vector(24 downto 0);
   -- timing of qs_l4_0: (c0, 3.026000ns)
begin
   x0 <= X(2 downto 0);
   table0: CBLKTable_l0_d3_alpha3_Freq300_uid7
      port map ( X => x0,
                 Y => out0_copy8);
   ...
   x1 <= X(5 downto 3);
   table1: CBLKTable_l0_d3_alpha3_Freq300_uid7
      port map ( X => x1,
                 Y => out1_copy9);
   ...
   x2 <= X(8 downto 6);
   table2: CBLKTable_l0_d3_alpha3_Freq300_uid7
      port map ( X => x2,
                 Y => out2_copy10);
   ...
   x3 <= X(11 downto 9);
   table3: CBLKTable_l0_d3_alpha3_Freq300_uid7
      port map ( X => x3,
                 Y => out3_copy11);
   ...
   x4 <= X(14 downto 12);
   table4: CBLKTable_l0_d3_alpha3_Freq300_uid7
      port map ( X => x4,
                 Y => out4_copy12);
   ...
   x5 <= X(17 downto 15);
   table5: CBLKTable_l0_d3_alpha3_Freq300_uid7
      port map ( X => x5,
                 Y => out5_copy13);
   ...
   x6 <= X(20 downto 18);
   table6: CBLKTable_l0_d3_alpha3_Freq300_uid7
      port map ( X => x6,
                 Y => out6_copy14);
   ...
   x7 <= X(23 downto 21);
   table7: CBLKTable_l0_d3_alpha3_Freq300_uid7
      port map ( X => x7,
                 Y => out7_copy15);
   ...
   x8 <= "0" & X(25 downto 24);
   table8: CBLKTable_l0_d3_alpha3_Freq300_uid7
      port map ( X => x8,
                 Y => out8_copy16);
   ...
   table_l1_0: CBLKTable_l1_d3_alpha3_Freq300_uid20
      port map ( X => in_l1_0,
                 Y => out_l1_0_copy21);
   ...
   table_l1_1: CBLKTable_l1_d3_alpha3_Freq300_uid20
      port map ( X => in_l1_1,
                 Y => out_l1_1_copy22);
   ...
   table_l1_2: CBLKTable_l1_d3_alpha3_Freq300_uid20
      port map ( X => in_l1_2,
                 Y => out_l1_2_copy23);
   ...
   table_l1_3: CBLKTable_l1_d3_alpha3_Freq300_uid20
      port map ( X => in_l1_3,
                 Y => out_l1_3_copy24);
   ...
   in_l1_4 <= "00" & r_l0_8;
   table_l1_4: CBLKTable_l1_d3_alpha3_Freq300_uid20
      port map ( X => in_l1_4,
                 Y => out_l1_4_copy25);
   ...
   table_l2_0: CBLKTable_l2_d3_alpha3_Freq300_uid29
      port map ( X => in_l2_0,
                 Y => out_l2_0_copy30);
   ...
   table_l2_1: CBLKTable_l2_d3_alpha3_Freq300_uid29
      port map ( X => in_l2_1,
                 Y => out_l2_1_copy31);
   ...
   in_l2_2 <= "00" & r_l1_4;
   table_l2_2: CBLKTable_l2_d3_alpha3_Freq300_uid29
      port map ( X => in_l2_2,
                 Y => out_l2_2_copy32);
   ...
   table_l3_0: CBLKTable_l3_d3_alpha3_Freq300_uid36
      port map ( X => in_l3_0,
                 Y => out_l3_0_copy37);
   ...
   in_l3_1 <= "00" & r_l2_2;
   table_l3_1: CBLKTable_l3_d3_alpha3_Freq300_uid36
      port map ( X => in_l3_1,
                 Y => out_l3_1_copy38);
...
--------------------------------------------------------------------------------
--                        flopoco_00027_fpconstdiv_top
--                      (FPConstDiv_8_23_8_23_3_1_1_300)
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.000000ns)
--  approx. output signal timings: R: (c0, 3.026000ns)
...
entity flopoco_00027_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+23+2 downto 0);
          R : out  std_logic_vector(8+23+2 downto 0)   );
end entity;

architecture arch of flopoco_00027_fpconstdiv_top is
   component IntConstDiv_QR_3_26_1_3_Freq300_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(25 downto 0);
             Q : out  std_logic_vector(24 downto 0);
             R : out  std_logic_vector(1 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_3_26_1_3_Freq300_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
