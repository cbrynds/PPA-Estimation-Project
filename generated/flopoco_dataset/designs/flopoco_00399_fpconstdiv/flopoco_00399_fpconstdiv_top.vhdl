...
--------------------------------------------------------------------------------
--                    CBLKTable_l1_d7_alpha3_Freq500_uid15
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l1_d7_alpha3_Freq500_uid15 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(5 downto 0)   );
end entity;

architecture arch of CBLKTable_l1_d7_alpha3_Freq500_uid15 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l2_d7_alpha3_Freq500_uid21
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l2_d7_alpha3_Freq500_uid21 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(8 downto 0)   );
end entity;

architecture arch of CBLKTable_l2_d7_alpha3_Freq500_uid21 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_7_11_1_3_Freq500_uid3
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity IntConstDiv_QR_7_11_1_3_Freq500_uid3 is
...
architecture arch of IntConstDiv_QR_7_11_1_3_Freq500_uid3 is
   component CBLKTable_l0_d7_alpha3_Freq500_uid7 is
      port ( X : in  std_logic_vector(2 downto 0);
             Y : out  std_logic_vector(3 downto 0)   );
   end component;

   component CBLKTable_l1_d7_alpha3_Freq500_uid15 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(5 downto 0)   );
   end component;

   component CBLKTable_l2_d7_alpha3_Freq500_uid21 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(8 downto 0)   );
   end component;
...
signal qs_l1_1, qs_l1_1_d1 :  std_logic_vector(2 downto 0);
...
begin
   ...
   table_l1_0: CBLKTable_l1_d7_alpha3_Freq500_uid15
      port map ( X => in_l1_0,
                 Y => out_l1_0_copy16);
   ...
   table_l1_1: CBLKTable_l1_d7_alpha3_Freq500_uid15
      port map ( X => in_l1_1,
                 Y => out_l1_1_copy17);
   ...
   table_l2_0: CBLKTable_l2_d7_alpha3_Freq500_uid21
      port map ( X => in_l2_0,
                 Y => out_l2_0_copy22);
...
--------------------------------------------------------------------------------
--                        flopoco_00399_fpconstdiv_top
--                       (FPConstDiv_8_7_8_7_7_1_2_500)
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00399_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00399_fpconstdiv_top is
   component IntConstDiv_QR_7_11_1_3_Freq500_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(10 downto 0);
             Q : out  std_logic_vector(8 downto 0);
             R : out  std_logic_vector(2 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_7_11_1_3_Freq500_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
