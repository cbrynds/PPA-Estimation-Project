...
--  approx. output signal timings: O: (c1, 1.106346ns)
...
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c1, 0.025721ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c1, 0.244471ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c1, 0.459471ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c1, 0.676346ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c1, 0.891346ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c1, 1.106346ns)
signal outHighBits :  std_logic_vector(3 downto 0);
   -- timing of outHighBits: (c1, 0.676346ns)
begin
   process(clk)
      begin
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c0, 2.998846ns)S: (c1, 1.106346ns)
--  approx. output signal timings: R: (c2, 2.655192ns)
...
entity flopoco_00281_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00281_ieeefpfma_top is
...
signal tmpExpCompRes2 :  std_logic_vector(9 downto 0);
   -- timing of tmpExpCompRes2: (c1, 1.106346ns)
signal RisSubNormal, RisSubNormal_d1 :  std_logic;
   -- timing of RisSubNormal: (c1, 1.106346ns)
signal RisZero, RisZero_d1 :  std_logic;
   -- timing of RisZero: (c1, 1.106346ns)
signal RisSubNormalOrZero :  std_logic;
   -- timing of RisSubNormalOrZero: (c1, 1.106346ns)
signal Rsgn, Rsgn_d1 :  std_logic;
   -- timing of Rsgn: (c1, 1.106346ns)
...
signal normShiftValue :  std_logic_vector(6 downto 0);
   -- timing of normShiftValue: (c1, 1.106346ns)
signal BigSumNormd :  std_logic_vector(150 downto 0);
   -- timing of BigSumNormd: (c2, 2.655192ns)
signal expTentative, expTentative_d1 :  std_logic_vector(9 downto 0);
   -- timing of expTentative: (c1, 1.106346ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c2, 2.655192ns)
signal fracTentative :  std_logic_vector(26 downto 0);
   -- timing of fracTentative: (c2, 2.655192ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c2, 2.655192ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c2, 2.655192ns)
signal fracResultNormd :  std_logic_vector(22 downto 0);
   -- timing of fracResultNormd: (c2, 2.655192ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c2, 2.655192ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c2, 2.655192ns)
signal round :  std_logic;
   -- timing of round: (c2, 2.655192ns)
signal expUpdate :  std_logic_vector(9 downto 0);
   -- timing of expUpdate: (c2, 2.655192ns)
signal exponentResult1 :  std_logic_vector(9 downto 0);
   -- timing of exponentResult1: (c2, 2.655192ns)
signal resultBeforeRound :  std_logic_vector(32 downto 0);
   -- timing of resultBeforeRound: (c2, 2.655192ns)
signal resultRounded :  std_logic_vector(32 downto 0);
   -- timing of resultRounded: (c2, 2.655192ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c2, 2.655192ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c2, 2.655192ns)
