--------------------------------------------------------------------------------
--                   RightShifter24_by_max_76_Freq400_uid4
...
--  approx. output signal timings: R: (c1, 0.648846ns)
...
entity RightShifter24_by_max_76_Freq400_uid4 is
...
architecture arch of RightShifter24_by_max_76_Freq400_uid4 is
...
signal level6 :  std_logic_vector(86 downto 0);
   -- timing of level6: (c1, 0.648846ns)
signal level7 :  std_logic_vector(150 downto 0);
   -- timing of level7: (c1, 0.648846ns)
begin
   process(clk)
      begin
...
-- Input signals: I
-- Output signals: O
--  approx. input signal timings: I: (c1, 0.648846ns)
--  approx. output signal timings: O: (c2, 0.256346ns)
...
entity LZC_52_Freq400_uid6 is
    port (clk : in std_logic;
          I : in  std_logic_vector(51 downto 0);
          O : out  std_logic_vector(5 downto 0)   );
end entity;

architecture arch of LZC_52_Freq400_uid6 is
signal level6 :  std_logic_vector(62 downto 0);
   -- timing of level6: (c1, 0.648846ns)
signal digit5 :  std_logic;
   -- timing of digit5: (c1, 0.875096ns)
signal level5 :  std_logic_vector(30 downto 0);
   -- timing of level5: (c1, 1.090096ns)
signal digit4 :  std_logic;
   -- timing of digit4: (c1, 1.310721ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c1, 1.525721ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c1, 1.744471ns)
signal level3, level3_d1 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c1, 1.959471ns)
signal digit2, digit2_d1 :  std_logic;
   -- timing of digit2: (c1, 2.176346ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c2, 0.041346ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c2, 0.256346ns)
signal outHighBits, outHighBits_d1 :  std_logic_vector(3 downto 0);
   -- timing of outHighBits: (c1, 2.176346ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
--------------------------------------------------------------------------------
--                    LeftShifter76_by_max_75_Freq400_uid8
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.648846ns)S: (c2, 0.256346ns)
--  approx. output signal timings: R: (c4, 0.955192ns)
...
entity LeftShifter76_by_max_75_Freq400_uid8 is
    port (clk : in std_logic;
...
--------------------------------------------------------------------------------
--                        flopoco_00103_ieeefpfma_top
--                       (IEEEFPFMA_8_23_Freq400_uid2)
...
entity flopoco_00103_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00103_ieeefpfma_top is
   component RightShifter24_by_max_76_Freq400_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(23 downto 0);
             S : in  std_logic_vector(6 downto 0);
             R : out  std_logic_vector(99 downto 0)   );
   ...
   component LZC_52_Freq400_uid6 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(51 downto 0);
             O : out  std_logic_vector(5 downto 0)   );
   end component;

   component LeftShifter76_by_max_75_Freq400_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(75 downto 0);
             S : in  std_logic_vector(6 downto 0);
             R : out  std_logic_vector(150 downto 0)   );
...
signal tmpExpCompRes2 :  std_logic_vector(9 downto 0);
   -- timing of tmpExpCompRes2: (c2, 0.256346ns)
signal RisSubNormal, RisSubNormal_d1, RisSubNormal_d2 :  std_logic;
   -- timing of RisSubNormal: (c2, 0.256346ns)
signal RisZero, RisZero_d1, RisZero_d2 :  std_logic;
   -- timing of RisZero: (c2, 0.256346ns)
signal RisSubNormalOrZero :  std_logic;
   -- timing of RisSubNormalOrZero: (c2, 0.256346ns)
signal Rsgn, Rsgn_d1, Rsgn_d2 :  std_logic;
   -- timing of Rsgn: (c2, 0.256346ns)
...
signal normShiftValue :  std_logic_vector(6 downto 0);
   -- timing of normShiftValue: (c2, 0.256346ns)
signal BigSumNormd :  std_logic_vector(150 downto 0);
   -- timing of BigSumNormd: (c4, 0.955192ns)
signal expTentative, expTentative_d1, expTentative_d2 :  std_logic_vector(9 downto 0);
   -- timing of expTentative: (c2, 0.256346ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c4, 0.955192ns)
signal fracTentative :  std_logic_vector(26 downto 0);
   -- timing of fracTentative: (c4, 0.955192ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c4, 0.955192ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c4, 0.955192ns)
signal fracResultNormd :  std_logic_vector(22 downto 0);
   -- timing of fracResultNormd: (c4, 0.955192ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c4, 0.955192ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c4, 0.955192ns)
signal round :  std_logic;
   -- timing of round: (c4, 0.955192ns)
signal expUpdate :  std_logic_vector(9 downto 0);
   -- timing of expUpdate: (c4, 0.955192ns)
signal exponentResult1 :  std_logic_vector(9 downto 0);
   -- timing of exponentResult1: (c4, 0.955192ns)
signal resultBeforeRound :  std_logic_vector(32 downto 0);
   -- timing of resultBeforeRound: (c4, 0.955192ns)
signal resultRounded :  std_logic_vector(32 downto 0);
   -- timing of resultRounded: (c4, 0.955192ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c4, 0.955192ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c4, 0.955192ns)
...
begin
   ...
   RightShifterComponent: RightShifter24_by_max_76_Freq400_uid4
      port map ( clk  => clk,
                 S => ShiftValue,
                 X => Csig,
                 R => CsigShifted);
   ...
   IEEEFPFMA_8_23_Freq400_uid2LeadingZeroCounter: LZC_52_Freq400_uid6
      port map ( clk  => clk,
   ...
   NormalizationShifter: LeftShifter76_by_max_75_Freq400_uid8
      port map ( clk  => clk,
                 S => normShiftValue,
                 X => BigSumAbs,
                 R => BigSumNormd);
