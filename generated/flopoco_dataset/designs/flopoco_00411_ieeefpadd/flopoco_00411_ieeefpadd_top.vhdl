--------------------------------------------------------------------------------
--                RightShifterSticky55_by_max_54_Freq400_uid4
...
--  approx. output signal timings: R: (c1, 0.275000ns)Sticky: (c1, 1.161250ns)
...
entity RightShifterSticky55_by_max_54_Freq400_uid4 is
...
architecture arch of RightShifterSticky55_by_max_54_Freq400_uid4 is
...
signal stk4 :  std_logic;
   -- timing of stk4: (c1, 0.076875ns)
signal level4, level4_d1 :  std_logic_vector(54 downto 0);
   -- timing of level4: (c0, 2.195000ns)
signal stk3 :  std_logic;
   -- timing of stk3: (c1, 0.295625ns)
signal level3, level3_d1 :  std_logic_vector(54 downto 0);
   -- timing of level3: (c0, 2.195000ns)
signal stk2 :  std_logic;
   -- timing of stk2: (c1, 0.512500ns)
signal level2 :  std_logic_vector(54 downto 0);
   -- timing of level2: (c1, 0.060000ns)
signal stk1 :  std_logic;
   -- timing of stk1: (c1, 0.729375ns)
signal level1 :  std_logic_vector(54 downto 0);
   -- timing of level1: (c1, 0.060000ns)
signal stk0 :  std_logic;
   -- timing of stk0: (c1, 0.946250ns)
signal level0 :  std_logic_vector(54 downto 0);
   -- timing of level0: (c1, 0.275000ns)
signal stk :  std_logic;
   -- timing of stk: (c1, 1.161250ns)
begin
   process(clk)
      begin
   ...
   level2 <=  level3_d1 when  ps_d1(2)='0'    else (3 downto 0 => '0') & level3_d1(54 downto 4);
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 1.010000ns)Y: (c1, 0.490000ns)Cin: (c1, 1.161250ns)
--  approx. output signal timings: R: (c1, 1.864250ns)
...
-- Input signals: I
-- Output signals: O
--  approx. input signal timings: I: (c1, 1.864250ns)
--  approx. output signal timings: O: (c2, 1.471750ns)
...
entity LZC_55_Freq400_uid8 is
    port (clk : in std_logic;
          I : in  std_logic_vector(54 downto 0);
          O : out  std_logic_vector(5 downto 0)   );
end entity;

architecture arch of LZC_55_Freq400_uid8 is
signal level6 :  std_logic_vector(62 downto 0);
   -- timing of level6: (c1, 1.864250ns)
signal digit5, digit5_d1 :  std_logic;
   -- timing of digit5: (c1, 2.090500ns)
signal level5, level5_d1 :  std_logic_vector(30 downto 0);
   -- timing of level5: (c1, 2.305500ns)
signal digit4 :  std_logic;
   -- timing of digit4: (c2, 0.176125ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c2, 0.391125ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c2, 0.609875ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c2, 0.824875ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c2, 1.041750ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c2, 1.256750ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c2, 1.471750ns)
signal outHighBits :  std_logic_vector(3 downto 0);
   -- timing of outHighBits: (c2, 1.041750ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
--------------------------------------------------------------------------------
--                   LeftShifter56_by_max_55_Freq400_uid10
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c1, 1.864250ns)S: (c2, 2.158750ns)
--  approx. output signal timings: R: (c4, 1.934519ns)
...
entity LeftShifter56_by_max_55_Freq400_uid10 is
    port (clk : in std_logic;
          X : in  std_logic_vector(55 downto 0);
          S : in  std_logic_vector(5 downto 0);
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c4, 1.934519ns)Y: (c0, 0.000000ns)Cin: (c5, 0.297519ns)
--  approx. output signal timings: R: (c5, 1.041519ns)
...
entity IntAdder_63_Freq400_uid13 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_63_Freq400_uid13 is
signal Rtmp :  std_logic_vector(62 downto 0);
   -- timing of Rtmp: (c5, 1.041519ns)
signal X_d1 :  std_logic_vector(62 downto 0);
   -- timing of X: (c4, 1.934519ns)
signal Y_d1, Y_d2, Y_d3, Y_d4, Y_d5 :  std_logic_vector(62 downto 0);
...
--------------------------------------------------------------------------------
--                        flopoco_00411_ieeefpadd_top
--                       (IEEEFPAdd_11_52_Freq400_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c5, 1.728519ns)
...
entity flopoco_00411_ieeefpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00411_ieeefpadd_top is
   component RightShifterSticky55_by_max_54_Freq400_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(54 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(54 downto 0);
   ...
   component LZC_55_Freq400_uid8 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(54 downto 0);
             O : out  std_logic_vector(5 downto 0)   );
   end component;

   component LeftShifter56_by_max_55_Freq400_uid10 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(55 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(110 downto 0)   );
   ...
   component IntAdder_63_Freq400_uid13 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(62 downto 0);
             Y : in  std_logic_vector(62 downto 0);
             Cin : in  std_logic;
...
signal shiftedSignificandY :  std_logic_vector(54 downto 0);
   -- timing of shiftedSignificandY: (c1, 0.275000ns)
signal stickyLow, stickyLow_d1, stickyLow_d2, stickyLow_d3, stickyLow_d4 :  std_logic;
   -- timing of stickyLow: (c1, 1.161250ns)
signal summandY :  std_logic_vector(55 downto 0);
   -- timing of summandY: (c1, 0.490000ns)
signal summandX :  std_logic_vector(55 downto 0);
   -- timing of summandX: (c0, 1.010000ns)
signal carryIn :  std_logic;
   -- timing of carryIn: (c1, 1.161250ns)
signal significandZ :  std_logic_vector(55 downto 0);
   -- timing of significandZ: (c1, 1.864250ns)
signal z1, z1_d1 :  std_logic;
   -- timing of z1: (c1, 1.864250ns)
signal z0, z0_d1 :  std_logic;
   -- timing of z0: (c1, 1.864250ns)
signal lzcZInput :  std_logic_vector(54 downto 0);
   -- timing of lzcZInput: (c1, 1.864250ns)
signal lzc :  std_logic_vector(5 downto 0);
   -- timing of lzc: (c2, 1.471750ns)
signal leftShiftVal :  std_logic_vector(5 downto 0);
   -- timing of leftShiftVal: (c2, 2.158750ns)
signal normalizedSignificand, normalizedSignificand_d1 :  std_logic_vector(110 downto 0);
   -- timing of normalizedSignificand: (c4, 1.934519ns)
signal significandPreRound :  std_logic_vector(51 downto 0);
   -- timing of significandPreRound: (c4, 1.934519ns)
signal lsb, lsb_d1 :  std_logic;
   -- timing of lsb: (c4, 1.934519ns)
signal roundBit, roundBit_d1 :  std_logic;
   -- timing of roundBit: (c4, 1.934519ns)
signal stickyBit :  std_logic;
   -- timing of stickyBit: (c5, 0.082519ns)
signal deltaExp :  std_logic_vector(10 downto 0);
   -- timing of deltaExp: (c2, 1.471750ns)
signal fullCancellation, fullCancellation_d1, fullCancellation_d2, fullCancellation_d3 :  std_logic;
   -- timing of fullCancellation: (c2, 1.943750ns)
signal expPreRound, expPreRound_d1, expPreRound_d2 :  std_logic_vector(10 downto 0);
   -- timing of expPreRound: (c2, 1.969750ns)
signal expSigPreRound :  std_logic_vector(62 downto 0);
   -- timing of expSigPreRound: (c4, 1.934519ns)
signal roundUpBit :  std_logic;
   -- timing of roundUpBit: (c5, 0.297519ns)
signal expSigR :  std_logic_vector(62 downto 0);
   -- timing of expSigR: (c5, 1.041519ns)
signal resultIsZero :  std_logic;
   -- timing of resultIsZero: (c5, 1.513519ns)
signal resultIsInf :  std_logic;
   -- timing of resultIsInf: (c5, 1.513519ns)
signal constInf, constInf_d1, constInf_d2, constInf_d3, constInf_d4, constInf_d5 :  std_logic_vector(62 downto 0);
   -- timing of constInf: (c0, 0.000000ns)
signal constNaN, constNaN_d1, constNaN_d2, constNaN_d3, constNaN_d4, constNaN_d5 :  std_logic_vector(62 downto 0);
   -- timing of constNaN: (c0, 0.000000ns)
signal expSigR2 :  std_logic_vector(62 downto 0);
   -- timing of expSigR2: (c5, 1.728519ns)
signal signR :  std_logic;
   -- timing of signR: (c5, 1.728519ns)
signal computedR :  std_logic_vector(63 downto 0);
   -- timing of computedR: (c5, 1.728519ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   RightShifterComponent: RightShifterSticky55_by_max_54_Freq400_uid4
      port map ( clk  => clk,
   ...
   IEEEFPAdd_11_52_Freq400_uid2LeadingZeroCounter: LZC_55_Freq400_uid8
      port map ( clk  => clk,
                 I => lzcZInput,
                 O => lzc);
   leftShiftVal <= 
      lzc when ((z1_d1='1') or (z1_d1='0' and z0_d1='1' and xExpFieldZero_d2='1') or (z1_d1='0' and z0_d1='0' and xExpFieldZero_d2='0' and lzc<=expNewX_d2)  or (xExpFieldZero_d2='0' and lzc>=55) ) 
      else (expNewX_d2(5 downto 0)) when (xExpFieldZero_d2='0' and (lzc < 55) and (("00000"&lzc)>=expNewX_d2)) 
       else "00000"&'1';
   LeftShifterComponent: LeftShifter56_by_max_55_Freq400_uid10
      port map ( clk  => clk,
                 S => leftShiftVal,
                 X => significandZ,
   ...
   deltaExp <=    -- value to subtract to exponent for normalization
      "00000000000" when ( (z1_d1='0' and z0_d1='1' and xExpFieldZero_d2='0')
          or  (z1_d1='0' and z0_d1='0' and xExpFieldZero_d2='1') )
      else "11111111111" when ( (z1_d1='1')  or  (z1_d1='0' and z0_d1='1' and xExpFieldZero_d2='1'))
      else ("00000" & lzc)-'1' when (z1_d1='0' and z0_d1='0' and xExpFieldZero_d2='0' and lzc<=expNewX_d2 and lzc<55)      else expNewX_d2;
   fullCancellation <= '1' when (lzc>=55) else '0';
   expPreRound <= expNewX_d2 - deltaExp; -- we may have a first overflow here
   expSigPreRound <= expPreRound_d2 & significandPreRound; 
   ...
   roundingAdder: IntAdder_63_Freq400_uid13
      port map ( clk  => clk,
                 Cin => roundUpBit,
                 X => expSigPreRound,
                 ...
                 R => expSigR);
   -- Final packing
   resultIsZero <= '1' when (fullCancellation_d3='1' and expSigR(62 downto 52)="00000000000") else '0';
   resultIsInf <= '1' when resultIsNaN_d5='0' and (((xIsInfinity_d5='1' and yIsInfinity_d5='1'  and EffSub_d5='0')  or (xIsInfinity_d5='0' and yIsInfinity_d5='1')  or (xIsInfinity_d5='1' and yIsInfinity_d5='0')  or  (expSigR(62 downto 52)="11111111111"))) else '0';
   ...
   expSigR2 <= constInf_d5 when resultIsInf='1' else constNaN_d5 when resultIsNaN_d5='1' else expSigR;
