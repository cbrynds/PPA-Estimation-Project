...
--------------------------------------------------------------------------------
--                          flopoco_00247_fpdiv_top
--                          (FPDiv_8_7_Freq150_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 1.868160ns)
...
entity flopoco_00247_fpdiv_top is
...
architecture arch of flopoco_00247_fpdiv_top is
...
signal prescaledfY, prescaledfY_d1 :  std_logic_vector(9 downto 0);
...
begin
   ...
   sel2 <= w2(12 downto 8) & prescaledfY(7 downto 6);
   ...
   w1fulla <= 
      w2pad - ("0000" & prescaledfY)			when "01",
      w2pad + ("0000" & prescaledfY)			when "11",
      w2pad + ("000" & prescaledfY & "0")		when "10",
      w2pad							when others;
   ...
   sel1 <= w1(12 downto 8) & prescaledfY(7 downto 6);
   ...
   w0fulla <= 
      w1pad_d1 - ("0000" & prescaledfY_d1)			when "01",
      w1pad_d1 + ("0000" & prescaledfY_d1)			when "11",
      w1pad_d1 + ("000" & prescaledfY_d1 & "0")		when "10",
   ...
   qP0 <= q0(2 downto 0);
   qM0 <= q0(3)  & "00";
   qP <= qP4_d1 & qP3_d1 & qP2_d1 & qP1_d1 & qP0;
   qM <= qM4_d1(1 downto 0) & qM3_d1 & qM2_d1 & qM1_d1 & qM0 & "0";
   quotient <= qP - qM;
