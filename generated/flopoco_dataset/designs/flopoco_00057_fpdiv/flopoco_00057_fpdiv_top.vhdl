...
--  approx. output signal timings: R: (c5, 0.563000ns)
...
entity flopoco_00057_fpdiv_top is
...
architecture arch of flopoco_00057_fpdiv_top is
...
signal D, D_d1, D_d2, D_d3, D_d4 :  std_logic_vector(23 downto 0);
...
begin
   ...
   sel6 <= betaw6(26 downto 21) & D_d2(22 downto 20);
   ...
   sel3 <= betaw3(26 downto 21) & D_d3(22 downto 20);
   ...
   qP1 <=      q1(1 downto 0);
   qM1 <=      q1(2) & "0";
   qP <= qP14_d4 & qP13_d4 & qP12_d4 & qP11_d3 & qP10_d3 & qP9_d3 & qP8_d2 & qP7_d2 & qP6_d2 & qP5_d1 & qP4_d1 & qP3_d1 & qP2 & qP1;
   qM <= qM14_d4(0) & qM13_d4 & qM12_d4 & qM11_d3 & qM10_d3 & qM9_d3 & qM8_d2 & qM7_d2 & qM6_d2 & qM5_d1 & qM4_d1 & qM3_d1 & qM2 & qM1 & qM0;
   quotient <= qP - qM;
   ...
   round <= fRnorm(0); 
   expR1 <= expR0_d5 + ("000" & (6 downto 1 => '1') & mR_d1(25)); -- add back bias
   -- final rounding
