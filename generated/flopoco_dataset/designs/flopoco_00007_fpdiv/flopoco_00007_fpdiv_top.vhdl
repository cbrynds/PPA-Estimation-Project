...
--  approx. output signal timings: R: (c6, 0.242692ns)
...
entity flopoco_00007_fpdiv_top is
...
architecture arch of flopoco_00007_fpdiv_top is
...
signal expR0, expR0_d1, expR0_d2, expR0_d3, expR0_d4, expR0_d5, expR0_d6 :  std_logic_vector(6 downto 0);
...
signal Dx3, Dx3_d1, Dx3_d2, Dx3_d3, Dx3_d4, Dx3_d5 :  std_logic_vector(11 downto 0);
...
begin
   ...
   sel5 <= betaw5(13 downto 10) & D_d1(9 downto 9);
   ...
   sel4 <= betaw4(13 downto 10) & D_d2(9 downto 9);
   ...
   sel3 <= betaw3(13 downto 10) & D_d3(9 downto 9);
   ...
   sel2 <= betaw2(13 downto 10) & D_d4(9 downto 9);
   ...
   sel1 <= betaw1(13 downto 10) & D_d4(9 downto 9);
   ...
   qP1 <=      q1(1 downto 0);
   qM1 <=      q1(2) & "0";
   qP <= qP7_d4 & qP6_d3 & qP5_d3 & qP4_d2 & qP3_d1 & qP2 & qP1;
   qM <= qM7_d5(0) & qM6_d4 & qM5_d4 & qM4_d3 & qM3_d2 & qM2_d1 & qM1_d1 & qM0;
   quotient <= qP_d1 - qM;
   ...
   round <= fRnorm(0); 
   expR1 <= expR0_d6 + ("000" & (3 downto 1 => '1') & mR_d1(12)); -- add back bias
   -- final rounding
   expfrac <= expR1 & fRnorm_d1(10 downto 1) ;
   expfracR <= expfrac + ((16 downto 1 => '0') & round_d1);
   ...
   R <= exnRfinal & sR_d6 & expfracR(14 downto 0);
end architecture;
