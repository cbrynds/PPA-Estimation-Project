--------------------------------------------------------------------------------
--                   RightShifter53_by_max_163_Freq200_uid4
...
--  approx. output signal timings: R: (c1, 4.440769ns)
...
entity RightShifter53_by_max_163_Freq200_uid4 is
...
architecture arch of RightShifter53_by_max_163_Freq200_uid4 is
...
signal level8 :  std_logic_vector(307 downto 0);
   -- timing of level8: (c1, 4.440769ns)
begin
   process(clk)
      begin
...
-- Input signals: I
-- Output signals: O
--  approx. input signal timings: I: (c1, 4.440769ns)
--  approx. output signal timings: O: (c2, 1.998894ns)
...
entity LZC_110_Freq200_uid6 is
    port (clk : in std_logic;
          I : in  std_logic_vector(109 downto 0);
          O : out  std_logic_vector(6 downto 0)   );
end entity;

architecture arch of LZC_110_Freq200_uid6 is
signal level7, level7_d1 :  std_logic_vector(126 downto 0);
   -- timing of level7: (c1, 4.440769ns)
signal digit6, digit6_d1 :  std_logic;
   -- timing of digit6: (c1, 4.676394ns)
signal level6 :  std_logic_vector(62 downto 0);
   -- timing of level6: (c2, 0.041394ns)
signal digit5 :  std_logic;
   -- timing of digit5: (c2, 0.267644ns)
signal level5 :  std_logic_vector(30 downto 0);
   -- timing of level5: (c2, 0.482644ns)
signal digit4 :  std_logic;
   -- timing of digit4: (c2, 0.703269ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c2, 0.918269ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c2, 1.137019ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c2, 1.352019ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c2, 1.568894ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c2, 1.783894ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c2, 1.998894ns)
signal outHighBits :  std_logic_vector(4 downto 0);
   -- timing of outHighBits: (c2, 1.568894ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
--------------------------------------------------------------------------------
--                   LeftShifter163_by_max_162_Freq200_uid8
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c1, 4.440769ns)S: (c2, 1.998894ns)
--  approx. output signal timings: R: (c5, 3.508894ns)
...
entity LeftShifter163_by_max_162_Freq200_uid8 is
    port (clk : in std_logic;
...
--------------------------------------------------------------------------------
--                        flopoco_00236_ieeefpfma_top
--                       (IEEEFPFMA_11_52_Freq200_uid2)
...
entity flopoco_00236_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00236_ieeefpfma_top is
   component RightShifter53_by_max_163_Freq200_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(52 downto 0);
             S : in  std_logic_vector(7 downto 0);
             R : out  std_logic_vector(215 downto 0)   );
   ...
   component LZC_110_Freq200_uid6 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(109 downto 0);
             O : out  std_logic_vector(6 downto 0)   );
   end component;

   component LeftShifter163_by_max_162_Freq200_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(162 downto 0);
             S : in  std_logic_vector(7 downto 0);
             R : out  std_logic_vector(324 downto 0)   );
...
signal normShiftValue :  std_logic_vector(7 downto 0);
   -- timing of normShiftValue: (c2, 1.998894ns)
signal BigSumNormd :  std_logic_vector(324 downto 0);
   -- timing of BigSumNormd: (c5, 3.508894ns)
signal expTentative, expTentative_d1, expTentative_d2, expTentative_d3 :  std_logic_vector(12 downto 0);
   -- timing of expTentative: (c2, 1.998894ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c5, 3.508894ns)
signal fracTentative :  std_logic_vector(55 downto 0);
   -- timing of fracTentative: (c5, 3.508894ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c5, 3.508894ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c5, 3.508894ns)
signal fracResultNormd :  std_logic_vector(51 downto 0);
   -- timing of fracResultNormd: (c5, 3.508894ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c5, 3.508894ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c5, 3.508894ns)
signal round :  std_logic;
   -- timing of round: (c5, 3.508894ns)
signal expUpdate :  std_logic_vector(12 downto 0);
   -- timing of expUpdate: (c5, 3.508894ns)
signal exponentResult1 :  std_logic_vector(12 downto 0);
   -- timing of exponentResult1: (c5, 3.508894ns)
signal resultBeforeRound :  std_logic_vector(64 downto 0);
   -- timing of resultBeforeRound: (c5, 3.508894ns)
signal resultRounded :  std_logic_vector(64 downto 0);
   -- timing of resultRounded: (c5, 3.508894ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c5, 3.508894ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c5, 3.508894ns)
...
begin
   ...
   RightShifterComponent: RightShifter53_by_max_163_Freq200_uid4
      port map ( clk  => clk,
                 S => ShiftValue,
                 X => Csig,
                 R => CsigShifted);
   ...
   IEEEFPFMA_11_52_Freq200_uid2LeadingZeroCounter: LZC_110_Freq200_uid6
      port map ( clk  => clk,
   ...
   NormalizationShifter: LeftShifter163_by_max_162_Freq200_uid8
      port map ( clk  => clk,
                 S => normShiftValue,
                 X => BigSumAbs,
                 R => BigSumNormd);
