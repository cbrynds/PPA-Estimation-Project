...
--  approx. output signal timings: R: (c9, 1.300000ns)
...
entity flopoco_00053_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+23+2 downto 0);
          R : out  std_logic_vector(8+23+2 downto 0)   );
end entity;

architecture arch of flopoco_00053_fpsqrt_top is
...
signal R2s_l, R2s_l_d1 :  std_logic_vector(20 downto 0);
...
signal R5s_l, R5s_l_d1 :  std_logic_vector(17 downto 0);
...
signal R6s_l :  std_logic_vector(16 downto 0);
...
signal R7s_l, R7s_l_d1 :  std_logic_vector(15 downto 0);
...
signal R15s_l, R15s_l_d1 :  std_logic_vector(7 downto 0);
...
signal R18s_l, R18s_l_d1 :  std_logic_vector(4 downto 0);
...
signal fR :  std_logic_vector(22 downto 0);
   -- timing of fR: (c9, 0.761000ns)
signal round :  std_logic;
   -- timing of round: (c9, 0.726000ns)
signal fRrnd :  std_logic_vector(22 downto 0);
   -- timing of fRrnd: (c9, 1.300000ns)
signal Rn2 :  std_logic_vector(30 downto 0);
   -- timing of Rn2: (c9, 1.300000ns)
