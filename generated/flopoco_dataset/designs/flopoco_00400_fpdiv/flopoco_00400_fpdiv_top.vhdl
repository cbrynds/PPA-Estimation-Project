...
--  approx. output signal timings: R: (c9, 1.520067ns)
...
entity flopoco_00400_fpdiv_top is
...
architecture arch of flopoco_00400_fpdiv_top is
...
signal prescaledfY, prescaledfY_d1, prescaledfY_d2, prescaledfY_d3, prescaledfY_d4, prescaledfY_d5, prescaledfY_d6, prescaledfY_d7, prescaledfY_d8 :  std_logic_vector(25 downto 0);
...
begin
   ...
   w7fulla <= 
      w8pad - ("0000" & prescaledfY_d1)			when "01",
      w8pad + ("0000" & prescaledfY_d1)			when "11",
      w8pad + ("000" & prescaledfY_d1 & "0")		when "10",
      w8pad							when others;
   ...
   w6fulla <= 
      w7pad - ("0000" & prescaledfY_d2)			when "01",
      w7pad + ("0000" & prescaledfY_d2)			when "11",
      w7pad + ("000" & prescaledfY_d2 & "0")		when "10",
      w7pad							when others;
   ...
   sel6 <= w6(28 downto 24) & prescaledfY_d3(23 downto 22);
   ...
   sel5 <= w5(28 downto 24) & prescaledfY_d4(23 downto 22);
   ...
   w4fulla <= 
      w5pad - ("0000" & prescaledfY_d4)			when "01",
      w5pad + ("0000" & prescaledfY_d4)			when "11",
      w5pad + ("000" & prescaledfY_d4 & "0")		when "10",
      w5pad							when others;
   ...
   sel4 <= w4(28 downto 24) & prescaledfY_d5(23 downto 22);
   ...
   sel3 <= w3(28 downto 24) & prescaledfY_d6(23 downto 22);
   ...
   w2fulla <= 
      w3pad - ("0000" & prescaledfY_d6)			when "01",
      w3pad + ("0000" & prescaledfY_d6)			when "11",
      w3pad + ("000" & prescaledfY_d6 & "0")		when "10",
      w3pad							when others;
   ...
   sel2 <= w2(28 downto 24) & prescaledfY_d7(23 downto 22);
   ...
   w1fulla <= 
      w2pad - ("0000" & prescaledfY_d7)			when "01",
      w2pad + ("0000" & prescaledfY_d7)			when "11",
      w2pad + ("000" & prescaledfY_d7 & "0")		when "10",
      w2pad							when others;
   ...
   sel1 <= w1(28 downto 24) & prescaledfY_d8(23 downto 22);
   ...
   w0fulla <= 
      w1pad - ("0000" & prescaledfY_d8)			when "01",
      w1pad + ("0000" & prescaledfY_d8)			when "11",
      w1pad + ("000" & prescaledfY_d8 & "0")		when "10",
      w1pad							when others;
   ...
   qP0 <= q0(2 downto 0);
   qM0 <= q0(3)  & "00";
   qP <= qP9_d9 & qP8_d8 & qP7_d7 & qP6_d6 & qP5_d5 & qP4_d4 & qP3_d3 & qP2_d2 & qP1_d1 & qP0;
   qM <= qM9_d9(1 downto 0) & qM8_d8 & qM7_d7 & qM6_d6 & qM5_d5 & qM4_d4 & qM3_d3 & qM2_d2 & qM1_d1 & qM0 & "0";
   quotient <= qP - qM;
   ...
   round <= fRnorm(0); 
   expR1 <= expR0_d9 + ("000" & (6 downto 1 => '1') & mR(25)); -- add back bias
   -- final rounding
