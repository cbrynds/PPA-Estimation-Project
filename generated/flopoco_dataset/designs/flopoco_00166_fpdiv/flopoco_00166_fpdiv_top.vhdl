...
--------------------------------------------------------------------------------
--                          flopoco_00166_fpdiv_top
--                          (FPDiv_8_7_Freq500_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c4, 0.984827ns)
...
entity flopoco_00166_fpdiv_top is
...
architecture arch of flopoco_00166_fpdiv_top is
...
signal prescaledfY, prescaledfY_d1, prescaledfY_d2, prescaledfY_d3 :  std_logic_vector(9 downto 0);
...
signal w3fulla, w3fulla_d1 :  std_logic_vector(13 downto 0);
   -- timing of w3fulla: (c0, 1.641769ns)
signal fYdec3, fYdec3_d1 :  std_logic_vector(13 downto 0);
   -- timing of fYdec3: (c0, 1.178769ns)
signal w3full :  std_logic_vector(13 downto 0);
   -- timing of w3full: (c1, 0.289769ns)
signal w3 :  std_logic_vector(12 downto 0);
   -- timing of w3: (c1, 0.289769ns)
signal sel3 :  std_logic_vector(6 downto 0);
   -- timing of sel3: (c1, 0.289769ns)
signal q3, q3_d1 :  std_logic_vector(3 downto 0);
   -- timing of q3: (c1, 0.504769ns)
signal q3_copy6 :  std_logic_vector(3 downto 0);
   -- timing of q3_copy6: (c1, 0.289769ns)
signal w3pad :  std_logic_vector(13 downto 0);
   -- timing of w3pad: (c1, 0.289769ns)
signal w2fulla, w2fulla_d1 :  std_logic_vector(13 downto 0);
   -- timing of w2fulla: (c1, 1.433538ns)
signal fYdec2, fYdec2_d1 :  std_logic_vector(13 downto 0);
   -- timing of fYdec2: (c1, 0.970538ns)
signal w2full :  std_logic_vector(13 downto 0);
   -- timing of w2full: (c2, 0.081538ns)
signal w2 :  std_logic_vector(12 downto 0);
   -- timing of w2: (c2, 0.081538ns)
signal sel2 :  std_logic_vector(6 downto 0);
   -- timing of sel2: (c2, 0.081538ns)
signal q2 :  std_logic_vector(3 downto 0);
   -- timing of q2: (c2, 0.296538ns)
signal q2_copy7 :  std_logic_vector(3 downto 0);
   -- timing of q2_copy7: (c2, 0.081538ns)
signal w2pad :  std_logic_vector(13 downto 0);
   -- timing of w2pad: (c2, 0.081538ns)
signal w1fulla :  std_logic_vector(13 downto 0);
   -- timing of w1fulla: (c2, 1.225308ns)
signal fYdec1 :  std_logic_vector(13 downto 0);
   -- timing of fYdec1: (c2, 0.762308ns)
signal w1full :  std_logic_vector(13 downto 0);
   -- timing of w1full: (c2, 1.723308ns)
signal w1 :  std_logic_vector(12 downto 0);
   -- timing of w1: (c2, 1.723308ns)
signal sel1 :  std_logic_vector(6 downto 0);
   -- timing of sel1: (c2, 1.723308ns)
signal q1 :  std_logic_vector(3 downto 0);
   -- timing of q1: (c3, 0.088308ns)
signal q1_copy8, q1_copy8_d1 :  std_logic_vector(3 downto 0);
   -- timing of q1_copy8: (c2, 1.723308ns)
signal w1pad, w1pad_d1 :  std_logic_vector(13 downto 0);
   -- timing of w1pad: (c2, 1.723308ns)
signal w0fulla :  std_logic_vector(13 downto 0);
   -- timing of w0fulla: (c3, 1.017077ns)
signal fYdec0 :  std_logic_vector(13 downto 0);
   -- timing of fYdec0: (c3, 0.554077ns)
signal w0full :  std_logic_vector(13 downto 0);
   -- timing of w0full: (c3, 1.515077ns)
signal w0 :  std_logic_vector(12 downto 0);
   -- timing of w0: (c3, 1.515077ns)
signal q0 :  std_logic_vector(3 downto 0);
   -- timing of q0: (c3, 1.733827ns)
...
signal qP3, qP3_d1, qP3_d2 :  std_logic_vector(2 downto 0);
   -- timing of qP3: (c1, 0.504769ns)
signal qM3, qM3_d1, qM3_d2 :  std_logic_vector(2 downto 0);
   -- timing of qM3: (c1, 0.504769ns)
signal qP2, qP2_d1 :  std_logic_vector(2 downto 0);
   -- timing of qP2: (c2, 0.296538ns)
signal qM2, qM2_d1 :  std_logic_vector(2 downto 0);
   -- timing of qM2: (c2, 0.296538ns)
signal qP1 :  std_logic_vector(2 downto 0);
   -- timing of qP1: (c3, 0.088308ns)
signal qM1 :  std_logic_vector(2 downto 0);
   -- timing of qM1: (c3, 0.088308ns)
signal qP0 :  std_logic_vector(2 downto 0);
   -- timing of qP0: (c3, 1.733827ns)
signal qM0 :  std_logic_vector(2 downto 0);
   -- timing of qM0: (c3, 1.733827ns)
signal qP, qP_d1 :  std_logic_vector(14 downto 0);
   -- timing of qP: (c3, 1.733827ns)
signal qM, qM_d1 :  std_logic_vector(14 downto 0);
   -- timing of qM: (c3, 1.733827ns)
signal quotient :  std_logic_vector(14 downto 0);
   -- timing of quotient: (c4, 0.381827ns)
signal mR :  std_logic_vector(9 downto 0);
   -- timing of mR: (c4, 0.416827ns)
signal fRnorm :  std_logic_vector(7 downto 0);
   -- timing of fRnorm: (c4, 0.451827ns)
signal round :  std_logic;
   -- timing of round: (c4, 0.486827ns)
signal expR1 :  std_logic_vector(9 downto 0);
   -- timing of expR1: (c4, 0.914827ns)
signal expfrac :  std_logic_vector(16 downto 0);
   -- timing of expfrac: (c4, 0.914827ns)
signal expfracR :  std_logic_vector(16 downto 0);
   -- timing of expfracR: (c4, 0.914827ns)
signal exnR :  std_logic_vector(1 downto 0);
   -- timing of exnR: (c4, 0.949827ns)
signal exnRfinal :  std_logic_vector(1 downto 0);
   -- timing of exnRfinal: (c4, 0.984827ns)
begin
   process(clk)
      begin
   ...
   sel3 <= w3(12 downto 8) & prescaledfY_d1(7 downto 6);
   SelFunctionTable3: selFunction7_4_Freq500_uid4
      port map ( X => sel3,
                 Y => q3_copy6);
   q3 <= q3_copy6; -- output copy to hold a pipeline register if needed
   w3pad <= w3 & '0';
   ...
   sel2 <= w2(12 downto 8) & prescaledfY_d2(7 downto 6);
   ...
   SelFunctionTable1: selFunction7_4_Freq500_uid4
      port map ( X => sel1,
                 Y => q1_copy8);
   q1 <= q1_copy8_d1; -- output copy to hold a pipeline register if needed
   w1pad <= w1 & '0';
   ...
   qP0 <= q0(2 downto 0);
   qM0 <= q0(3)  & "00";
   qP <= qP4_d3 & qP3_d2 & qP2_d1 & qP1 & qP0;
   qM <= qM4_d3(1 downto 0) & qM3_d2 & qM2_d1 & qM1 & qM0 & "0";
   ...
   round <= fRnorm(0); 
   expR1 <= expR0_d4 + ("000" & (6 downto 1 => '1') & mR(9)); -- add back bias
   -- final rounding
