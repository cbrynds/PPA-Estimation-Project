--------------------------------------------------------------------------------
--                    CBLKTable_l0_d7_alpha4_Freq200_uid7
...
entity CBLKTable_l0_d7_alpha4_Freq200_uid7 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(4 downto 0)   );
end entity;

architecture arch of CBLKTable_l0_d7_alpha4_Freq200_uid7 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l1_d7_alpha4_Freq200_uid21
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l1_d7_alpha4_Freq200_uid21 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(6 downto 0)   );
end entity;

architecture arch of CBLKTable_l1_d7_alpha4_Freq200_uid21 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l2_d7_alpha4_Freq200_uid30
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l2_d7_alpha4_Freq200_uid30 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(10 downto 0)   );
end entity;

architecture arch of CBLKTable_l2_d7_alpha4_Freq200_uid30 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l3_d7_alpha4_Freq200_uid37
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l3_d7_alpha4_Freq200_uid37 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(18 downto 0)   );
end entity;

architecture arch of CBLKTable_l3_d7_alpha4_Freq200_uid37 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l4_d7_alpha4_Freq200_uid43
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l4_d7_alpha4_Freq200_uid43 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(34 downto 0)   );
end entity;

architecture arch of CBLKTable_l4_d7_alpha4_Freq200_uid43 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_7_39_1_4_Freq200_uid3
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Q: (c0, 3.221000ns)R: (c0, 2.034000ns)
...
entity IntConstDiv_QR_7_39_1_4_Freq200_uid3 is
...
architecture arch of IntConstDiv_QR_7_39_1_4_Freq200_uid3 is
   component CBLKTable_l0_d7_alpha4_Freq200_uid7 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(4 downto 0)   );
   end component;

   component CBLKTable_l1_d7_alpha4_Freq200_uid21 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(6 downto 0)   );
   end component;

   component CBLKTable_l2_d7_alpha4_Freq200_uid30 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(10 downto 0)   );
   end component;

   component CBLKTable_l3_d7_alpha4_Freq200_uid37 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(18 downto 0)   );
   end component;

   component CBLKTable_l4_d7_alpha4_Freq200_uid43 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(34 downto 0)   );
   end component;
...
signal qs_l0_9 :  std_logic_vector(0 downto 0);
...
signal out_l1_0_copy22 :  std_logic_vector(6 downto 0);
   -- timing of out_l1_0_copy22: (c0, 0.722000ns)
...
signal out_l1_1_copy23 :  std_logic_vector(6 downto 0);
   -- timing of out_l1_1_copy23: (c0, 0.722000ns)
...
signal out_l1_2_copy24 :  std_logic_vector(6 downto 0);
   -- timing of out_l1_2_copy24: (c0, 0.722000ns)
...
signal out_l1_3_copy25 :  std_logic_vector(6 downto 0);
   -- timing of out_l1_3_copy25: (c0, 0.722000ns)
...
signal out_l1_4_copy26 :  std_logic_vector(6 downto 0);
   -- timing of out_l1_4_copy26: (c0, 0.722000ns)
signal r_l1_4 :  std_logic_vector(2 downto 0);
   -- timing of r_l1_4: (c0, 1.050000ns)
signal q_l1_4 :  std_logic_vector(4 downto 0);
   -- timing of q_l1_4: (c0, 1.050000ns)
signal qs_l1_4 :  std_logic_vector(4 downto 0);
...
signal out_l2_0_copy31 :  std_logic_vector(10 downto 0);
   -- timing of out_l2_0_copy31: (c0, 1.050000ns)
...
signal out_l2_1_copy32 :  std_logic_vector(10 downto 0);
   -- timing of out_l2_1_copy32: (c0, 1.050000ns)
...
signal out_l2_2_copy33 :  std_logic_vector(10 downto 0);
   -- timing of out_l2_2_copy33: (c0, 1.050000ns)
signal r_l2_2 :  std_logic_vector(2 downto 0);
   -- timing of r_l2_2: (c0, 1.378000ns)
signal q_l2_2 :  std_logic_vector(4 downto 0);
   -- timing of q_l2_2: (c0, 1.378000ns)
signal qs_l2_2 :  std_logic_vector(4 downto 0);
...
signal out_l3_0_copy38 :  std_logic_vector(18 downto 0);
   -- timing of out_l3_0_copy38: (c0, 1.378000ns)
...
signal out_l3_1_copy39 :  std_logic_vector(18 downto 0);
   -- timing of out_l3_1_copy39: (c0, 1.378000ns)
signal r_l3_1 :  std_logic_vector(2 downto 0);
   -- timing of r_l3_1: (c0, 1.706000ns)
signal q_l3_1 :  std_logic_vector(4 downto 0);
   -- timing of q_l3_1: (c0, 1.706000ns)
signal qs_l3_1 :  std_logic_vector(4 downto 0);
...
signal out_l4_0_copy44 :  std_logic_vector(34 downto 0);
   -- timing of out_l4_0_copy44: (c0, 1.706000ns)
...
signal qs_l4_0 :  std_logic_vector(36 downto 0);
   -- timing of qs_l4_0: (c0, 3.221000ns)
begin
   x0 <= X(3 downto 0);
   table0: CBLKTable_l0_d7_alpha4_Freq200_uid7
      port map ( X => x0,
                 Y => out0_copy8);
   ...
   x1 <= X(7 downto 4);
   table1: CBLKTable_l0_d7_alpha4_Freq200_uid7
      port map ( X => x1,
                 Y => out1_copy9);
   ...
   x2 <= X(11 downto 8);
   table2: CBLKTable_l0_d7_alpha4_Freq200_uid7
      port map ( X => x2,
                 Y => out2_copy10);
   ...
   x3 <= X(15 downto 12);
   table3: CBLKTable_l0_d7_alpha4_Freq200_uid7
      port map ( X => x3,
                 Y => out3_copy11);
   ...
   x4 <= X(19 downto 16);
   table4: CBLKTable_l0_d7_alpha4_Freq200_uid7
      port map ( X => x4,
                 Y => out4_copy12);
   ...
   x5 <= X(23 downto 20);
   table5: CBLKTable_l0_d7_alpha4_Freq200_uid7
      port map ( X => x5,
                 Y => out5_copy13);
   ...
   x6 <= X(27 downto 24);
   table6: CBLKTable_l0_d7_alpha4_Freq200_uid7
      port map ( X => x6,
                 Y => out6_copy14);
   ...
   x7 <= X(31 downto 28);
   table7: CBLKTable_l0_d7_alpha4_Freq200_uid7
      port map ( X => x7,
                 Y => out7_copy15);
   ...
   x8 <= X(35 downto 32);
   table8: CBLKTable_l0_d7_alpha4_Freq200_uid7
      port map ( X => x8,
                 Y => out8_copy16);
   ...
   x9 <= "0" & X(38 downto 36);
   table9: CBLKTable_l0_d7_alpha4_Freq200_uid7
      port map ( X => x9,
                 Y => out9_copy17);
   out9 <= out9_copy17; -- output copy to hold a pipeline register if needed
   qs_l0_9 <= out9(3 downto 3);
   r_l0_9 <= out9(2 downto 0);
   in_l1_0 <= r_l0_1 & r_l0_0;
   table_l1_0: CBLKTable_l1_d7_alpha4_Freq200_uid21
      port map ( X => in_l1_0,
                 Y => out_l1_0_copy22);
   ...
   table_l1_1: CBLKTable_l1_d7_alpha4_Freq200_uid21
      port map ( X => in_l1_1,
                 Y => out_l1_1_copy23);
   ...
   table_l1_2: CBLKTable_l1_d7_alpha4_Freq200_uid21
      port map ( X => in_l1_2,
                 Y => out_l1_2_copy24);
   ...
   table_l1_3: CBLKTable_l1_d7_alpha4_Freq200_uid21
      port map ( X => in_l1_3,
                 Y => out_l1_3_copy25);
   ...
   table_l2_1: CBLKTable_l2_d7_alpha4_Freq200_uid30
      port map ( X => in_l2_1,
                 Y => out_l2_1_copy32);
...
--------------------------------------------------------------------------------
--                        flopoco_00028_fpconstdiv_top
--                     (FPConstDiv_10_35_10_35_7_1_2_200)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.000000ns)
--  approx. output signal timings: R: (c0, 3.221000ns)
...
entity flopoco_00028_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(10+35+2 downto 0);
          R : out  std_logic_vector(10+35+2 downto 0)   );
end entity;

architecture arch of flopoco_00028_fpconstdiv_top is
   component IntConstDiv_QR_7_39_1_4_Freq200_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(38 downto 0);
             Q : out  std_logic_vector(36 downto 0);
             R : out  std_logic_vector(2 downto 0)   );
...
begin
   ...
   r_exp0 <=  ('0' & x_exp) - ( CONV_STD_LOGIC_VECTOR(5, 11)) + (not mltd);
   underflow <=  r_exp0(10);
   ...
   intconstdiv: IntConstDiv_QR_7_39_1_4_Freq200_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
