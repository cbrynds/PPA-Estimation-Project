...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_3_14_0_4_Freq200_uid3
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity IntConstDiv_QR_3_14_0_4_Freq200_uid3 is
...
architecture arch of IntConstDiv_QR_3_14_0_4_Freq200_uid3 is
...
begin
   ...
   in3 <= r4 & x3;
   table3: EuclideanDivTable_d3_alpha4_Freq200_uid7
      port map ( X => in3,
                 Y => out3_copy8);
...
entity flopoco_00369_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(6+11+2 downto 0);
          R : out  std_logic_vector(6+11+2 downto 0)   );
end entity;

architecture arch of flopoco_00369_fpconstdiv_top is
   component IntConstDiv_QR_3_14_0_4_Freq200_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(13 downto 0);
             Q : out  std_logic_vector(12 downto 0);
             R : out  std_logic_vector(1 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_3_14_0_4_Freq200_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
