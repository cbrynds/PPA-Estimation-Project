...
entity LZOC_11_Freq300_uid4 is
...
architecture arch of LZOC_11_Freq300_uid4 is
...
--------------------------------------------------------------------------------
--                     LeftShifter7_by_max_7_Freq300_uid6
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity LeftShifter7_by_max_7_Freq300_uid6 is
    port (clk : in std_logic;
...
architecture arch of LeftShifter7_by_max_7_Freq300_uid6 is
...
--  approx. output signal timings: R: (c1, 0.389513ns)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.215000ns)Y: (c1, 0.389513ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 0.928513ns)
...
entity IntAdder_21_Freq300_uid18 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_21_Freq300_uid18 is
signal Rtmp :  std_logic_vector(20 downto 0);
   -- timing of Rtmp: (c1, 0.928513ns)
signal X_d1 :  std_logic_vector(20 downto 0);
   -- timing of X: (c0, 0.215000ns)
...
signal FixRealKCM_Freq300_uid20_T0 :  std_logic_vector(20 downto 0);
   -- timing of FixRealKCM_Freq300_uid20_T0: (c0, 1.015000ns)
signal FixRealKCM_Freq300_uid20_T0_copy24 :  std_logic_vector(20 downto 0);
...
-- This operator multiplies by log(2)
   FixRealKCM_Freq300_uid20_A0 <= X(5 downto 0);-- input address  m=5  l=0
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 1.015000ns)Y: (c1, 0.928513ns)Cin: (c0, 0.215000ns)
--  approx. output signal timings: R: (c1, 1.508513ns)
...
--------------------------------------------------------------------------------
--                    Normalizer_Z_27_21_11_Freq300_uid29
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. input signal timings: X: (c1, 1.508513ns)
--  approx. output signal timings: Count: (c1, 3.022888ns)R: (c2, 0.054554ns)
...
entity Normalizer_Z_27_21_11_Freq300_uid29 is
    port (clk : in std_logic;
          X : in  std_logic_vector(26 downto 0);
...
architecture arch of Normalizer_Z_27_21_11_Freq300_uid29 is
signal level4 :  std_logic_vector(26 downto 0);
   -- timing of level4: (c1, 1.508513ns)
signal count3 :  std_logic;
   -- timing of count3: (c1, 1.727263ns)
signal level3 :  std_logic_vector(26 downto 0);
   -- timing of level3: (c1, 1.942263ns)
signal count2 :  std_logic;
   -- timing of count2: (c1, 2.159138ns)
signal level2 :  std_logic_vector(23 downto 0);
   -- timing of level2: (c1, 2.374138ns)
signal count1 :  std_logic;
   -- timing of count1: (c1, 2.591013ns)
signal level1, level1_d1 :  std_logic_vector(21 downto 0);
   -- timing of level1: (c1, 2.806013ns)
signal count0, count0_d1 :  std_logic;
   -- timing of count0: (c1, 3.022888ns)
signal level0 :  std_logic_vector(20 downto 0);
   -- timing of level0: (c2, 0.054554ns)
signal sCount :  std_logic_vector(3 downto 0);
   -- timing of sCount: (c1, 3.022888ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
--------------------------------------------------------------------------------
--                   RightShifter11_by_max_9_Freq300_uid31
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
--  approx. output signal timings: R: (c1, 0.721897ns)
...
entity RightShifter11_by_max_9_Freq300_uid31 is
    port (clk : in std_logic;
...
architecture arch of RightShifter11_by_max_9_Freq300_uid31 is
...
signal level2 :  std_logic_vector(13 downto 0);
   -- timing of level2: (c1, 0.106897ns)
signal level3 :  std_logic_vector(17 downto 0);
   -- timing of level3: (c1, 0.106897ns)
signal level4 :  std_logic_vector(25 downto 0);
   -- timing of level4: (c1, 0.721897ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 2.644846ns)Y: (c1, 0.721897ns)Cin: (c0, 0.215000ns)
--  approx. output signal timings: R: (c1, 1.260897ns)
...
entity IntAdder_17_Freq300_uid33 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_17_Freq300_uid33 is
signal Rtmp :  std_logic_vector(16 downto 0);
   -- timing of Rtmp: (c1, 1.260897ns)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c2, 0.054554ns)Y: (c2, 0.054554ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c2, 0.593554ns)
...
entity IntAdder_17_Freq300_uid36 is
    port (clk : in std_logic;
          X : in  std_logic_vector(16 downto 0);
          Y : in  std_logic_vector(16 downto 0);
          Cin : in  std_logic;
...
architecture arch of IntAdder_17_Freq300_uid36 is
signal Rtmp :  std_logic_vector(16 downto 0);
   -- timing of Rtmp: (c2, 0.593554ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00346_fplog_top
--                 (FPLogIterative_6_11_14_300_Freq300_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00346_fplog_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(6+11+2 downto 0);
          R : out  std_logic_vector(6+11+2 downto 0)   );
end entity;

architecture arch of flopoco_00346_fplog_top is
   component LZOC_11_Freq300_uid4 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(10 downto 0);
             OZB : in  std_logic;
             O : out  std_logic_vector(3 downto 0)   );
   ...
   component LeftShifter7_by_max_7_Freq300_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(6 downto 0);
             S : in  std_logic_vector(2 downto 0);
             R : out  std_logic_vector(13 downto 0)   );
   ...
   component IntAdder_21_Freq300_uid18 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(20 downto 0);
             Y : in  std_logic_vector(20 downto 0);
             Cin : in  std_logic;
   ...
   component Normalizer_Z_27_21_11_Freq300_uid29 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(26 downto 0);
             Count : out  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(20 downto 0)   );
   ...
   component RightShifter11_by_max_9_Freq300_uid31 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(10 downto 0);
             S : in  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(19 downto 0)   );
   ...
   component IntAdder_17_Freq300_uid33 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(16 downto 0);
             Y : in  std_logic_vector(16 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_17_Freq300_uid36 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(16 downto 0);
             Y : in  std_logic_vector(16 downto 0);
             Cin : in  std_logic;
...
signal Log1p_normal :  std_logic_vector(13 downto 0);
   -- timing of Log1p_normal: (c1, 0.389513ns)
...
signal adderLogF_normalY :  std_logic_vector(20 downto 0);
   -- timing of adderLogF_normalY: (c1, 0.389513ns)
signal LogF_normal :  std_logic_vector(20 downto 0);
   -- timing of LogF_normal: (c1, 0.928513ns)
...
begin
   ...
   small_lshift: LeftShifter7_by_max_7_Freq300_uid6
      port map ( clk  => clk,
                 S => shiftvalinL,
                 X => absZ0,
   ...
   addFinalLog1p_normalAdder: IntAdder_14_Freq300_uid12
      port map ( clk  => clk,
                 Cin => '1',
                 X => Zfinal,
                 Y => addFinalLog1pY,
   ...
   adderLogF_normal: IntAdder_21_Freq300_uid18
      port map ( clk  => clk,
                 Cin => '0',
                 X => almostLog,
                 Y => adderLogF_normalY,
   ...
   lnadder: IntAdder_27_Freq300_uid27
      port map ( clk  => clk,
                 Cin => sR,
                 X => lnaddX,
                 Y => lnaddY,
                 R => Log_normal);
   final_norm: Normalizer_Z_27_21_11_Freq300_uid29
      port map ( clk  => clk,
                 X => Log_normal,
                 Count => E_normal,
                 R => Log_normal_normd);
   Z2o2_small_bs <= Z2o2_full_dummy(21 downto 11);
   ao_rshift: RightShifter11_by_max_9_Freq300_uid31
      port map ( clk  => clk,
                 S => shiftvalinR,
                 X => Z2o2_small_bs,
                 R => Z2o2_small_s);
   ...
   nsRCin <= not ( sR );
   log_small_adder: IntAdder_17_Freq300_uid33
      port map ( clk  => clk,
                 Cin => nsRCin,
                 X => Z_small,
                 Y => Log_smallY,
   ...
   finalRoundAdder: IntAdder_17_Freq300_uid36
      port map ( clk  => clk,
                 Cin => '0',
                 X => fraX,
                 Y => fraY,
