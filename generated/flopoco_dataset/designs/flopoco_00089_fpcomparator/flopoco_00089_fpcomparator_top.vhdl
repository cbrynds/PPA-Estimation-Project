--------------------------------------------------------------------------------
--                     IntComparator_63_010_Freq200_uid4
...
entity IntComparator_63_010_Freq200_uid4 is
...
architecture arch of IntComparator_63_010_Freq200_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00089_fpcomparator_top
--                     (FPComparator_11_52_Freq200_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin (2021)
...
entity flopoco_00089_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00089_fpcomparator_top is
   component IntComparator_63_010_Freq200_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(62 downto 0);
             Y : in  std_logic_vector(62 downto 0);
             XeqY : out  std_logic   );
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_63_010_Freq200_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
