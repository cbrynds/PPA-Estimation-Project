...
--  approx. output signal timings: Count: (c1, 2.108500ns)R: (c1, 2.323500ns)
...
signal level4 :  std_logic_vector(11 downto 0);
   -- timing of level4: (c1, 0.594125ns)
signal count3 :  std_logic;
   -- timing of count3: (c1, 0.812875ns)
signal level3 :  std_logic_vector(11 downto 0);
   -- timing of level3: (c1, 1.027875ns)
signal count2 :  std_logic;
   -- timing of count2: (c1, 1.244750ns)
signal level2 :  std_logic_vector(11 downto 0);
   -- timing of level2: (c1, 1.459750ns)
signal count1 :  std_logic;
   -- timing of count1: (c1, 1.676625ns)
signal level1 :  std_logic_vector(11 downto 0);
   -- timing of level1: (c1, 1.891625ns)
signal count0 :  std_logic;
   -- timing of count0: (c1, 2.108500ns)
signal level0 :  std_logic_vector(11 downto 0);
   -- timing of level0: (c1, 2.323500ns)
signal sCount :  std_logic_vector(3 downto 0);
   -- timing of sCount: (c1, 2.108500ns)
begin
   level4 <= X ;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c2, 0.256500ns)Y: (c0, 0.000000ns)Cin: (c2, 0.188500ns)
--  approx. output signal timings: R: (c2, 0.795500ns)
...
--  approx. output signal timings: R: (c2, 1.225500ns)
...
entity flopoco_00424_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00424_fpadd_top is
...
signal nZerosNew, nZerosNew_d1 :  std_logic_vector(3 downto 0);
   -- timing of nZerosNew: (c1, 2.108500ns)
signal shiftedFrac, shiftedFrac_d1 :  std_logic_vector(11 downto 0);
   -- timing of shiftedFrac: (c1, 2.323500ns)
...
signal updatedExp :  std_logic_vector(9 downto 0);
   -- timing of updatedExp: (c2, 0.256500ns)
signal eqdiffsign, eqdiffsign_d1 :  std_logic;
   -- timing of eqdiffsign: (c1, 2.108500ns)
signal expFrac :  std_logic_vector(17 downto 0);
   -- timing of expFrac: (c2, 0.256500ns)
signal stk, stk_d1 :  std_logic;
   -- timing of stk: (c1, 2.323500ns)
signal rnd, rnd_d1 :  std_logic;
   -- timing of rnd: (c1, 2.323500ns)
signal lsb, lsb_d1 :  std_logic;
   -- timing of lsb: (c1, 2.323500ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c2, 0.188500ns)
signal RoundedExpFrac :  std_logic_vector(17 downto 0);
   -- timing of RoundedExpFrac: (c2, 0.795500ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c2, 0.795500ns)
signal fracR :  std_logic_vector(6 downto 0);
   -- timing of fracR: (c2, 0.795500ns)
signal expR :  std_logic_vector(7 downto 0);
   -- timing of expR: (c2, 0.795500ns)
signal exExpExc :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c2, 0.795500ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c2, 1.010500ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c2, 1.225500ns)
signal signR2, signR2_d1 :  std_logic;
   -- timing of signR2: (c1, 2.323500ns)
signal computedR :  std_logic_vector(17 downto 0);
   -- timing of computedR: (c2, 1.225500ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   updatedExp <= ("0" &extendedExpInc_d2) - ("000000" & nZerosNew_d1);
