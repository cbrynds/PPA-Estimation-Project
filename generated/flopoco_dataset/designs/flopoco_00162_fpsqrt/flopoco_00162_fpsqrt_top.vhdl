...
--  approx. output signal timings: R: (c2, 1.129000ns)
...
entity flopoco_00162_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(5+10+2 downto 0);
          R : out  std_logic_vector(5+10+2 downto 0)   );
end entity;

architecture arch of flopoco_00162_fpsqrt_top is
...
signal T4s_l, T4s_l_d1 :  std_logic_vector(5 downto 0);
...
signal T9s_l, T9s_l_d1 :  std_logic_vector(0 downto 0);
...
signal d12 :  std_logic;
   -- timing of d12: (c2, 0.631000ns)
signal mR :  std_logic_vector(12 downto 0);
   -- timing of mR: (c2, 0.631000ns)
signal fR :  std_logic_vector(9 downto 0);
   -- timing of fR: (c2, 0.631000ns)
signal round :  std_logic;
   -- timing of round: (c2, 0.631000ns)
signal fRrnd :  std_logic_vector(9 downto 0);
   -- timing of fRrnd: (c2, 1.129000ns)
signal Rn2 :  std_logic_vector(14 downto 0);
   -- timing of Rn2: (c2, 1.129000ns)
