...
entity LogTable0_Freq300_uid14 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(15 downto 0)   );
end entity;

architecture arch of LogTable0_Freq300_uid14 is
...
architecture arch of LZOC_7_Freq300_uid4 is
...
--  approx. output signal timings: R: (c0, 1.927077ns)
...
signal level2 :  std_logic_vector(7 downto 0);
   -- timing of level2: (c0, 1.927077ns)
signal level3 :  std_logic_vector(11 downto 0);
   -- timing of level3: (c0, 1.927077ns)
begin
   ps<= S;
   level0<= X;
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 1.041000ns)Y: (c0, 2.357077ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c0, 2.855077ns)
...
entity IntAdder_10_Freq300_uid12 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_10_Freq300_uid12 is
signal Rtmp :  std_logic_vector(9 downto 0);
   -- timing of Rtmp: (c0, 2.855077ns)
begin
   Rtmp <= X + Y + Cin;
   R <= Rtmp;
end architecture;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.328000ns)Y: (c0, 2.855077ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 0.169744ns)
...
entity IntAdder_15_Freq300_uid18 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_15_Freq300_uid18 is
...
signal Y_1, Y_1_d1 :  std_logic_vector(15 downto 0);
   -- timing of Y_1: (c0, 2.855077ns)
signal S_1 :  std_logic_vector(15 downto 0);
   -- timing of S_1: (c1, 0.169744ns)
signal R_1 :  std_logic_vector(14 downto 0);
   -- timing of R_1: (c1, 0.169744ns)
begin
   process(clk)
      begin
...
entity IntAdder_19_Freq300_uid30 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_19_Freq300_uid30 is
...
architecture arch of FixRealKCM_Freq300_uid20 is
   ...
   component IntAdder_19_Freq300_uid30 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(18 downto 0);
             Y : in  std_logic_vector(18 downto 0);
             Cin : in  std_logic;
...
signal FixRealKCM_Freq300_uid20_A0 :  std_logic_vector(5 downto 0);
   -- timing of FixRealKCM_Freq300_uid20_A0: (c0, 0.687000ns)
signal FixRealKCM_Freq300_uid20_T0 :  std_logic_vector(18 downto 0);
   -- timing of FixRealKCM_Freq300_uid20_T0: (c0, 1.015000ns)
signal FixRealKCM_Freq300_uid20_T0_copy24 :  std_logic_vector(18 downto 0);
   -- timing of FixRealKCM_Freq300_uid20_T0_copy24: (c0, 0.687000ns)
...
signal FixRealKCM_Freq300_uid20_A1 :  std_logic_vector(1 downto 0);
   -- timing of FixRealKCM_Freq300_uid20_A1: (c0, 0.687000ns)
signal FixRealKCM_Freq300_uid20_T1 :  std_logic_vector(12 downto 0);
   -- timing of FixRealKCM_Freq300_uid20_T1: (c0, 0.902000ns)
signal FixRealKCM_Freq300_uid20_T1_copy27 :  std_logic_vector(12 downto 0);
   -- timing of FixRealKCM_Freq300_uid20_T1_copy27: (c0, 0.687000ns)
...
-- This operator multiplies by log(2)
   ...
   bitheapFinalAdd_bh21: IntAdder_19_Freq300_uid30
      port map ( clk  => clk,
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 1.554000ns)Y: (c1, 0.169744ns)Cin: (c0, 0.215000ns)
--  approx. output signal timings: R: (c1, 0.708744ns)
...
entity IntAdder_23_Freq300_uid32 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_23_Freq300_uid32 is
signal Rtmp :  std_logic_vector(22 downto 0);
   -- timing of Rtmp: (c1, 0.708744ns)
signal X_d1 :  std_logic_vector(22 downto 0);
   -- timing of X: (c0, 1.554000ns)
...
--------------------------------------------------------------------------------
--                    Normalizer_Z_23_15_11_Freq300_uid34
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. input signal timings: X: (c1, 0.708744ns)
--  approx. output signal timings: Count: (c1, 2.223119ns)R: (c1, 2.438119ns)
...
entity Normalizer_Z_23_15_11_Freq300_uid34 is
    port (clk : in std_logic;
          X : in  std_logic_vector(22 downto 0);
...
architecture arch of Normalizer_Z_23_15_11_Freq300_uid34 is
signal level4 :  std_logic_vector(22 downto 0);
   -- timing of level4: (c1, 0.708744ns)
signal count3 :  std_logic;
   -- timing of count3: (c1, 0.927494ns)
signal level3 :  std_logic_vector(21 downto 0);
   -- timing of level3: (c1, 1.142494ns)
signal count2 :  std_logic;
   -- timing of count2: (c1, 1.359369ns)
signal level2 :  std_logic_vector(17 downto 0);
   -- timing of level2: (c1, 1.574369ns)
signal count1 :  std_logic;
   -- timing of count1: (c1, 1.791244ns)
signal level1 :  std_logic_vector(15 downto 0);
   -- timing of level1: (c1, 2.006244ns)
signal count0 :  std_logic;
   -- timing of count0: (c1, 2.223119ns)
signal level0 :  std_logic_vector(14 downto 0);
   -- timing of level0: (c1, 2.438119ns)
signal sCount :  std_logic_vector(3 downto 0);
   -- timing of sCount: (c1, 2.223119ns)
begin
   level4 <= X ;
   ...
   level0<= level1(15 downto 1) when count0='0' else level1(14 downto 0);
...
--------------------------------------------------------------------------------
--                    RightShifter9_by_max_7_Freq300_uid36
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c0, 2.142077ns)S: (c0, 1.589000ns)
--  approx. output signal timings: R: (c0, 2.541692ns)
...
entity RightShifter9_by_max_7_Freq300_uid36 is
    port (clk : in std_logic;
...
architecture arch of RightShifter9_by_max_7_Freq300_uid36 is
signal ps :  std_logic_vector(2 downto 0);
   -- timing of ps: (c0, 1.589000ns)
signal level0 :  std_logic_vector(8 downto 0);
   -- timing of level0: (c0, 2.142077ns)
signal level1 :  std_logic_vector(9 downto 0);
   -- timing of level1: (c0, 2.142077ns)
signal level2 :  std_logic_vector(11 downto 0);
   -- timing of level2: (c0, 2.541692ns)
signal level3 :  std_logic_vector(15 downto 0);
   -- timing of level3: (c0, 2.541692ns)
begin
   ps<= S;
   level0<= X;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 1.927077ns)Y: (c0, 2.541692ns)Cin: (c0, 0.215000ns)
--  approx. output signal timings: R: (c0, 3.039692ns)
...
entity IntAdder_13_Freq300_uid38 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_13_Freq300_uid38 is
signal Rtmp :  std_logic_vector(12 downto 0);
   -- timing of Rtmp: (c0, 3.039692ns)
begin
   Rtmp <= X + Y + Cin;
   R <= Rtmp;
end architecture;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 2.438119ns)Y: (c1, 2.438119ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 2.936119ns)
...
entity IntAdder_15_Freq300_uid41 is
    port (clk : in std_logic;
          X : in  std_logic_vector(14 downto 0);
          Y : in  std_logic_vector(14 downto 0);
          Cin : in  std_logic;
...
architecture arch of IntAdder_15_Freq300_uid41 is
signal Rtmp :  std_logic_vector(14 downto 0);
   -- timing of Rtmp: (c1, 2.936119ns)
signal Cin_d1 :  std_logic;
...
--------------------------------------------------------------------------------
--                          flopoco_00205_fplog_top
--                  (FPLogIterative_8_7_0_300_Freq300_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00205_fplog_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00205_fplog_top is
   component LZOC_7_Freq300_uid4 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(6 downto 0);
             OZB : in  std_logic;
             O : out  std_logic_vector(2 downto 0)   );
   ...
   component IntAdder_10_Freq300_uid12 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(9 downto 0);
             Y : in  std_logic_vector(9 downto 0);
             Cin : in  std_logic;
   ...
   component LogTable0_Freq300_uid14 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(15 downto 0)   );
   end component;

   component IntAdder_15_Freq300_uid18 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(14 downto 0);
             Y : in  std_logic_vector(14 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_23_Freq300_uid32 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(22 downto 0);
             Y : in  std_logic_vector(22 downto 0);
             Cin : in  std_logic;
   ...
   component Normalizer_Z_23_15_11_Freq300_uid34 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(22 downto 0);
             Count : out  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(14 downto 0)   );
   ...
   component RightShifter9_by_max_7_Freq300_uid36 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(8 downto 0);
             S : in  std_logic_vector(2 downto 0);
             R : out  std_logic_vector(15 downto 0)   );
   ...
   component IntAdder_13_Freq300_uid38 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(12 downto 0);
             Y : in  std_logic_vector(12 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_15_Freq300_uid41 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(14 downto 0);
             Y : in  std_logic_vector(14 downto 0);
             Cin : in  std_logic;
...
signal lzo :  std_logic_vector(2 downto 0);
...
signal small_absZ0_normd_full :  std_logic_vector(9 downto 0);
   -- timing of small_absZ0_normd_full: (c0, 1.927077ns)
signal small_absZ0_normd :  std_logic_vector(4 downto 0);
   -- timing of small_absZ0_normd: (c0, 1.927077ns)
...
signal adderLogF_normalY :  std_logic_vector(14 downto 0);
   -- timing of adderLogF_normalY: (c0, 2.855077ns)
signal LogF_normal :  std_logic_vector(14 downto 0);
   -- timing of LogF_normal: (c1, 0.169744ns)
...
begin
   ...
   addFinalLog1p_normalAdder: IntAdder_10_Freq300_uid12
      port map ( clk  => clk,
                 Cin => '1',
                 X => Zfinal,
                 Y => addFinalLog1pY,
   ...
   LogTable0: LogTable0_Freq300_uid14
      port map ( X => A0,
                 Y => L0_copy15);
   ...
   adderLogF_normal: IntAdder_15_Freq300_uid18
      port map ( clk  => clk,
                 Cin => '0',
                 X => almostLog,
                 Y => adderLogF_normalY,
   ...
   lnadder: IntAdder_23_Freq300_uid32
      port map ( clk  => clk,
                 Cin => sR,
                 X => lnaddX,
                 Y => lnaddY,
                 R => Log_normal);
   final_norm: Normalizer_Z_23_15_11_Freq300_uid34
      port map ( clk  => clk,
                 X => Log_normal,
                 Count => E_normal,
                 R => Log_normal_normd);
   Z2o2_small_bs <= Z2o2_full_dummy(17 downto 9);
   ao_rshift: RightShifter9_by_max_7_Freq300_uid36
      port map ( clk  => clk,
                 S => shiftvalinR,
                 X => Z2o2_small_bs,
                 R => Z2o2_small_s);
   ...
   nsRCin <= not ( sR );
   log_small_adder: IntAdder_13_Freq300_uid38
      port map ( clk  => clk,
                 Cin => nsRCin,
                 X => Z_small,
                 Y => Log_smallY,
   ...
   ufl <= '0';
   E_small <=  ("0" & (wE-2 downto 2 => '1') & E0_sub)  -  ((wE-1 downto 3 => '0') & lzo) ;
   ...
   ER <= E_small_d1(7 downto 0) when small_d1='1'
      else E0offset_d1 - ((7 downto 4 => '0') & E_normal);
   ...
   finalRoundAdder: IntAdder_15_Freq300_uid41
      port map ( clk  => clk,
                 Cin => '0',
                 X => fraX,
                 Y => fraY,
