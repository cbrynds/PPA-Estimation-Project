--------------------------------------------------------------------------------
--                       flopoco_00070_fpconstmult_top
--                  (FPConstMult_1b1_6_11_7_15_Freq400_uid2)
...
entity flopoco_00070_fpconstmult_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(6+11+2 downto 0);
          R : out  std_logic_vector(7+15+2 downto 0)   );
end entity;

architecture arch of flopoco_00070_fpconstmult_top is
...
signal r_frac :  std_logic_vector(14 downto 0);
...
signal expfrac_rnd :  std_logic_vector(22 downto 0);
...
begin
   ...
   r_frac <= X(10 downto 0)  &  (3 downto 0 => '0');
   norm <= '0';
   ...
   r_exp_rnd <= expfrac_rnd(22 downto 15);
   ...
   R <= r_exn & r_sgn & (expfrac_rnd(21 downto 0));
end architecture;
