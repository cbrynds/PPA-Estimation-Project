--------------------------------------------------------------------------------
--                     IntComparator_39_101_Freq300_uid4
...
--  approx. output signal timings: XltY: (c0, 0.539000ns)XgtY: (c0, 0.539000ns)
...
entity IntComparator_39_101_Freq300_uid4 is
...
architecture arch of IntComparator_39_101_Freq300_uid4 is
...
--  approx. input signal timings: X: (c0, 0.000000ns)Y: (c0, 0.000000ns)
--  approx. output signal timings: unordered: (c0, 0.000000ns)XltY: (c0, 0.754000ns)
...
architecture arch of flopoco_00473_fpcomparator_top is
   component IntComparator_39_101_Freq300_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(38 downto 0);
             Y : in  std_logic_vector(38 downto 0);
             XltY : out  std_logic;
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_39_101_Freq300_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
