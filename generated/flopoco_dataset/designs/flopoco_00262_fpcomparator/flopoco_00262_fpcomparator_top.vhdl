...
--------------------------------------------------------------------------------
--                       flopoco_00262_fpcomparator_top
--                      (FPComparator_5_10_Freq200_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin (2021)
...
--  approx. input signal timings: X: (c0, 0.000000ns)Y: (c0, 0.000000ns)
--  approx. output signal timings: unordered: (c0, 0.000000ns)XltY: (c0, 0.687000ns)XeqY: (c0, 0.687000ns)
...
entity flopoco_00262_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00262_fpcomparator_top is
