--------------------------------------------------------------------------------
--                       flopoco_00421_fpconstmult_top
--                  (FPConstMult_1b1_8_23_8_25_Freq400_uid2)
...
entity flopoco_00421_fpconstmult_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+23+2 downto 0);
          R : out  std_logic_vector(8+25+2 downto 0)   );
end entity;

architecture arch of flopoco_00421_fpconstmult_top is
...
signal r_frac :  std_logic_vector(24 downto 0);
...
begin
   ...
   r_frac <= X(22 downto 0)  &  (1 downto 0 => '0');
   norm <= '0';
