...
--  approx. output signal timings: R: (c1, 0.548846ns)
...
signal level6 :  std_logic_vector(73 downto 0);
   -- timing of level6: (c1, 0.548846ns)
begin
   process(clk)
      begin
...
-- Input signals: I
-- Output signals: O
--  approx. input signal timings: I: (c1, 0.548846ns)
--  approx. output signal timings: O: (c2, 0.215096ns)
...
signal level5 :  std_logic_vector(30 downto 0);
   -- timing of level5: (c1, 0.548846ns)
signal digit4 :  std_logic;
   -- timing of digit4: (c1, 0.769471ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c1, 0.984471ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c1, 1.203221ns)
signal level3, level3_d1 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c1, 1.418221ns)
signal digit2, digit2_d1 :  std_logic;
   -- timing of digit2: (c1, 1.635096ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c2, 0.000096ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c2, 0.215096ns)
signal outHighBits, outHighBits_d1 :  std_logic_vector(2 downto 0);
   -- timing of outHighBits: (c1, 1.635096ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.548846ns)S: (c2, 0.215096ns)
--  approx. output signal timings: R: (c4, 0.113942ns)
...
entity flopoco_00199_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00199_ieeefpfma_top is
...
signal tmpExpCompRes2 :  std_logic_vector(6 downto 0);
   -- timing of tmpExpCompRes2: (c2, 0.215096ns)
signal RisSubNormal, RisSubNormal_d1, RisSubNormal_d2 :  std_logic;
   -- timing of RisSubNormal: (c2, 0.215096ns)
signal RisZero, RisZero_d1, RisZero_d2 :  std_logic;
   -- timing of RisZero: (c2, 0.215096ns)
signal RisSubNormalOrZero :  std_logic;
   -- timing of RisSubNormalOrZero: (c2, 0.215096ns)
signal Rsgn, Rsgn_d1, Rsgn_d2 :  std_logic;
   -- timing of Rsgn: (c2, 0.215096ns)
...
signal normShiftValue :  std_logic_vector(5 downto 0);
   -- timing of normShiftValue: (c2, 0.215096ns)
signal BigSumNormd :  std_logic_vector(72 downto 0);
   -- timing of BigSumNormd: (c4, 0.113942ns)
signal expTentative, expTentative_d1, expTentative_d2 :  std_logic_vector(6 downto 0);
   -- timing of expTentative: (c2, 0.215096ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c4, 0.113942ns)
signal fracTentative :  std_logic_vector(13 downto 0);
   -- timing of fracTentative: (c4, 0.113942ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c4, 0.113942ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c4, 0.113942ns)
signal fracResultNormd :  std_logic_vector(9 downto 0);
   -- timing of fracResultNormd: (c4, 0.113942ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c4, 0.113942ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c4, 0.113942ns)
signal round :  std_logic;
   -- timing of round: (c4, 0.113942ns)
signal expUpdate :  std_logic_vector(6 downto 0);
   -- timing of expUpdate: (c4, 0.113942ns)
signal exponentResult1 :  std_logic_vector(6 downto 0);
   -- timing of exponentResult1: (c4, 0.113942ns)
signal resultBeforeRound :  std_logic_vector(16 downto 0);
   -- timing of resultBeforeRound: (c4, 0.113942ns)
signal resultRounded :  std_logic_vector(16 downto 0);
   -- timing of resultRounded: (c4, 0.113942ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c4, 0.113942ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c4, 0.113942ns)
