...
--  approx. output signal timings: R: (c2, 1.079000ns)
...
entity flopoco_00442_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(6+11+2 downto 0);
          R : out  std_logic_vector(6+11+2 downto 0)   );
end entity;

architecture arch of flopoco_00442_fpsqrt_top is
...
signal fR :  std_logic_vector(10 downto 0);
   -- timing of fR: (c2, 0.581000ns)
signal round :  std_logic;
   -- timing of round: (c2, 0.546000ns)
signal fRrnd :  std_logic_vector(10 downto 0);
   -- timing of fRrnd: (c2, 1.079000ns)
signal Rn2 :  std_logic_vector(16 downto 0);
   -- timing of Rn2: (c2, 1.079000ns)
