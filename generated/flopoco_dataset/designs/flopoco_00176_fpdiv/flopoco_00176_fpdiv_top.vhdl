...
--------------------------------------------------------------------------------
--                          flopoco_00176_fpdiv_top
--                         (FPDiv_6_11_Freq500_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c5, 1.818856ns)
...
entity flopoco_00176_fpdiv_top is
...
architecture arch of flopoco_00176_fpdiv_top is
...
signal expR0, expR0_d1, expR0_d2, expR0_d3, expR0_d4, expR0_d5 :  std_logic_vector(7 downto 0);
...
signal prescaledfY, prescaledfY_d1, prescaledfY_d2, prescaledfY_d3, prescaledfY_d4 :  std_logic_vector(13 downto 0);
...
signal w4fulla, w4fulla_d1 :  std_logic_vector(17 downto 0);
   -- timing of w4fulla: (c0, 1.805846ns)
signal fYdec4, fYdec4_d1 :  std_logic_vector(17 downto 0);
   -- timing of fYdec4: (c0, 1.301846ns)
signal w4full :  std_logic_vector(17 downto 0);
   -- timing of w4full: (c1, 0.494846ns)
signal w4 :  std_logic_vector(16 downto 0);
   -- timing of w4: (c1, 0.494846ns)
signal sel4 :  std_logic_vector(6 downto 0);
   -- timing of sel4: (c1, 0.494846ns)
signal q4, q4_d1 :  std_logic_vector(3 downto 0);
   -- timing of q4: (c1, 0.709846ns)
signal q4_copy6 :  std_logic_vector(3 downto 0);
   -- timing of q4_copy6: (c1, 0.494846ns)
signal w4pad :  std_logic_vector(17 downto 0);
   -- timing of w4pad: (c1, 0.494846ns)
signal w3fulla, w3fulla_d1 :  std_logic_vector(17 downto 0);
   -- timing of w3fulla: (c1, 1.802692ns)
signal fYdec3, fYdec3_d1 :  std_logic_vector(17 downto 0);
   -- timing of fYdec3: (c1, 1.298692ns)
signal w3full :  std_logic_vector(17 downto 0);
   -- timing of w3full: (c2, 0.491692ns)
signal w3 :  std_logic_vector(16 downto 0);
   -- timing of w3: (c2, 0.491692ns)
signal sel3 :  std_logic_vector(6 downto 0);
   -- timing of sel3: (c2, 0.491692ns)
signal q3, q3_d1 :  std_logic_vector(3 downto 0);
   -- timing of q3: (c2, 0.706692ns)
signal q3_copy7 :  std_logic_vector(3 downto 0);
   -- timing of q3_copy7: (c2, 0.491692ns)
signal w3pad :  std_logic_vector(17 downto 0);
   -- timing of w3pad: (c2, 0.491692ns)
signal w2fulla, w2fulla_d1 :  std_logic_vector(17 downto 0);
   -- timing of w2fulla: (c2, 1.799538ns)
signal fYdec2, fYdec2_d1 :  std_logic_vector(17 downto 0);
   -- timing of fYdec2: (c2, 1.295538ns)
signal w2full :  std_logic_vector(17 downto 0);
   -- timing of w2full: (c3, 0.488538ns)
signal w2 :  std_logic_vector(16 downto 0);
   -- timing of w2: (c3, 0.488538ns)
signal sel2 :  std_logic_vector(6 downto 0);
   -- timing of sel2: (c3, 0.488538ns)
signal q2, q2_d1 :  std_logic_vector(3 downto 0);
   -- timing of q2: (c3, 0.703538ns)
signal q2_copy8 :  std_logic_vector(3 downto 0);
   -- timing of q2_copy8: (c3, 0.488538ns)
signal w2pad :  std_logic_vector(17 downto 0);
   -- timing of w2pad: (c3, 0.488538ns)
signal w1fulla, w1fulla_d1 :  std_logic_vector(17 downto 0);
   -- timing of w1fulla: (c3, 1.796385ns)
signal fYdec1, fYdec1_d1 :  std_logic_vector(17 downto 0);
   -- timing of fYdec1: (c3, 1.292385ns)
signal w1full :  std_logic_vector(17 downto 0);
   -- timing of w1full: (c4, 0.485385ns)
signal w1 :  std_logic_vector(16 downto 0);
   -- timing of w1: (c4, 0.485385ns)
signal sel1 :  std_logic_vector(6 downto 0);
   -- timing of sel1: (c4, 0.485385ns)
signal q1, q1_d1 :  std_logic_vector(3 downto 0);
   -- timing of q1: (c4, 0.700385ns)
signal q1_copy9 :  std_logic_vector(3 downto 0);
   -- timing of q1_copy9: (c4, 0.485385ns)
signal w1pad :  std_logic_vector(17 downto 0);
   -- timing of w1pad: (c4, 0.485385ns)
signal w0fulla, w0fulla_d1 :  std_logic_vector(17 downto 0);
   -- timing of w0fulla: (c4, 1.793231ns)
signal fYdec0, fYdec0_d1 :  std_logic_vector(17 downto 0);
   -- timing of fYdec0: (c4, 1.289231ns)
signal w0full :  std_logic_vector(17 downto 0);
   -- timing of w0full: (c5, 0.482231ns)
signal w0 :  std_logic_vector(16 downto 0);
   -- timing of w0: (c5, 0.482231ns)
signal q0 :  std_logic_vector(3 downto 0);
   -- timing of q0: (c5, 0.702856ns)
...
begin
   ...
   sel4 <= w4(16 downto 12) & prescaledfY_d1(11 downto 10);
   ...
   sel3 <= w3(16 downto 12) & prescaledfY_d2(11 downto 10);
   ...
   sel2 <= w2(16 downto 12) & prescaledfY_d3(11 downto 10);
   ...
   sel1 <= w1(16 downto 12) & prescaledfY_d4(11 downto 10);
   ...
   w0fulla <= 
      w1pad - ("0000" & prescaledfY_d4)			when "01",
      w1pad + ("0000" & prescaledfY_d4)			when "11",
      w1pad + ("000" & prescaledfY_d4 & "0")		when "10",
      w1pad							when others;
   ...
   qP0 <= q0(2 downto 0);
   qM0 <= q0(3)  & "00";
   qP <= qP5_d5 & qP4_d4 & qP3_d3 & qP2_d2 & qP1_d1 & qP0;
   qM <= qM5_d5(1 downto 0) & qM4_d4 & qM3_d3 & qM2_d2 & qM1_d1 & qM0 & "0";
   quotient <= qP - qM;
   ...
   round <= fRnorm(0); 
   expR1 <= expR0_d5 + ("000" & (4 downto 1 => '1') & mR(13)); -- add back bias
   -- final rounding
   ...
   R <= exnRfinal & sR_d5 & expfracR(16 downto 0);
end architecture;
