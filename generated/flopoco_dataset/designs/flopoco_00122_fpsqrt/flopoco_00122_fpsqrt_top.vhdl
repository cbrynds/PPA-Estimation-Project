...
--  approx. output signal timings: R: (c5, 2.033333ns)
...
entity flopoco_00122_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+23+2 downto 0);
          R : out  std_logic_vector(8+23+2 downto 0)   );
end entity;

architecture arch of flopoco_00122_fpsqrt_top is
...
signal R4s_l, R4s_l_d1 :  std_logic_vector(18 downto 0);
...
signal R9s_l, R9s_l_d1 :  std_logic_vector(13 downto 0);
...
signal R17s_l, R17s_l_d1 :  std_logic_vector(5 downto 0);
...
signal R21s_l, R21s_l_d1 :  std_logic_vector(1 downto 0);
...
signal fR :  std_logic_vector(22 downto 0);
   -- timing of fR: (c5, 1.494333ns)
signal round :  std_logic;
   -- timing of round: (c5, 1.459333ns)
signal fRrnd :  std_logic_vector(22 downto 0);
   -- timing of fRrnd: (c5, 2.033333ns)
signal Rn2 :  std_logic_vector(30 downto 0);
   -- timing of Rn2: (c5, 2.033333ns)
