...
--  approx. output signal timings: R: (c6, 4.037000ns)
...
entity flopoco_00307_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(11+52+2 downto 0);
          R : out  std_logic_vector(11+52+2 downto 0)   );
end entity;

architecture arch of flopoco_00307_fpsqrt_top is
...
signal R31s_l :  std_logic_vector(20 downto 0);
   -- timing of R31s_l: (c3, 3.688000ns)
...
begin
   ...
   S42 <= S41 & d42; 
   R42_h <= T42_d1(43 downto 0)   when d42_d1= '1' else
   ...
   T43 <= R42s_h - ("0" & S42_d1 & "01"); -- tentative subtraction 
   ...
   T50 <= R49s_h_d1 - ("0" & S49_d1 & "01"); -- tentative subtraction 
   d50 <= not T50(52); -- next digit
   S50 <= S49_d1 & d50; 
   R50_h <= T50(51 downto 0)   when d50= '1' else
          R49s_h_d1(51 downto 0); 
   R50 <= R50_h & R49s_l_d1; 
   -- Step 51
   R50s <= R50 & "0";
