...
--  approx. output signal timings: R: (c1, 1.477000ns)
...
entity flopoco_00282_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(6+11+2 downto 0);
          R : out  std_logic_vector(6+11+2 downto 0)   );
end entity;

architecture arch of flopoco_00282_fpsqrt_top is
...
signal d13 :  std_logic;
   -- timing of d13: (c1, 0.979000ns)
signal mR :  std_logic_vector(13 downto 0);
   -- timing of mR: (c1, 0.979000ns)
signal fR :  std_logic_vector(10 downto 0);
   -- timing of fR: (c1, 0.979000ns)
signal round :  std_logic;
   -- timing of round: (c1, 0.979000ns)
signal fRrnd :  std_logic_vector(10 downto 0);
   -- timing of fRrnd: (c1, 1.477000ns)
signal Rn2 :  std_logic_vector(16 downto 0);
   -- timing of Rn2: (c1, 1.477000ns)
