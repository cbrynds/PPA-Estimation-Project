...
entity IntAdder_19_Freq150_uid9 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_19_Freq150_uid9 is
...
entity flopoco_00327_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00327_fpadd_top is
   ...
   component IntAdder_19_Freq150_uid9 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(18 downto 0);
             Y : in  std_logic_vector(18 downto 0);
             Cin : in  std_logic;
...
-- Far Path --
   ...
   -- far path adder
   FPAdd_6_11_Freq150_uid2_fracAddFar: IntAdder_15_Freq150_uid6
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   -- final round adder
   FPAdd_6_11_Freq150_uid2_finalRoundAdd: IntAdder_19_Freq150_uid9
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
