...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 3.419250ns)Y: (c0, 0.000000ns)Cin: (c0, 3.419250ns)
--  approx. output signal timings: R: (c0, 4.204250ns)
...
entity IntAdder_65_Freq200_uid9 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_65_Freq200_uid9 is
signal Rtmp :  std_logic_vector(64 downto 0);
   -- timing of Rtmp: (c0, 4.204250ns)
begin
   Rtmp <= X + Y + Cin;
   R <= Rtmp;
end architecture;
...
--  approx. output signal timings: R: (c0, 4.274250ns)
...
entity flopoco_00144_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00144_fpadd_top is
   ...
   component IntAdder_65_Freq200_uid9 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(64 downto 0);
             Y : in  std_logic_vector(64 downto 0);
             Cin : in  std_logic;
...
-- Far Path --
   ...
   -- far path adder
   FPAdd_11_52_Freq200_uid2_fracAddFar: IntAdder_56_Freq200_uid6
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   -- final round adder
   FPAdd_11_52_Freq200_uid2_finalRoundAdd: IntAdder_65_Freq200_uid9
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
