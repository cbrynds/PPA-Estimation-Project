...
--  approx. output signal timings: R: (c11, 0.787000ns)
...
entity flopoco_00153_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(11+52+2 downto 0);
          R : out  std_logic_vector(11+52+2 downto 0)   );
end entity;

architecture arch of flopoco_00153_fpsqrt_top is
...
signal eRn1, eRn1_d1, eRn1_d2, eRn1_d3, eRn1_d4, eRn1_d5, eRn1_d6, eRn1_d7, eRn1_d8, eRn1_d9, eRn1_d10, eRn1_d11 :  std_logic_vector(10 downto 0);
...
signal R13s_l :  std_logic_vector(38 downto 0);
...
signal R30s_l, R30s_l_d1 :  std_logic_vector(21 downto 0);
...
signal R31s_l :  std_logic_vector(20 downto 0);
   -- timing of R31s_l: (c6, 0.138000ns)
...
begin
   ...
   T36 <= R35s_h_d1 - ("0" & S35_d1 & "01"); -- tentative subtraction 
   d36 <= not T36(38); -- next digit
   S36 <= S35_d1 & d36; 
   R36_h <= T36(37 downto 0)   when d36= '1' else
          R35s_h_d1(37 downto 0); 
   R36 <= R36_h & R35s_l_d1; 
   -- Step 37
   R36s <= R36 & "0";
   ...
   S40 <= S39 & d40; 
   R40_h <= T40_d1(41 downto 0)   when d40_d1= '1' else
   ...
   T41 <= R40s_h - ("0" & S40_d1 & "01"); -- tentative subtraction 
