...
--  approx. output signal timings: R: (c0, 6.327000ns)
...
entity flopoco_00487_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(6+11+2 downto 0);
          R : out  std_logic_vector(6+11+2 downto 0)   );
end entity;

architecture arch of flopoco_00487_fpsqrt_top is
...
signal eRn1 :  std_logic_vector(5 downto 0);
...
signal d13 :  std_logic;
   -- timing of d13: (c0, 5.829000ns)
signal mR :  std_logic_vector(13 downto 0);
   -- timing of mR: (c0, 5.829000ns)
signal fR :  std_logic_vector(10 downto 0);
   -- timing of fR: (c0, 5.829000ns)
signal round :  std_logic;
   -- timing of round: (c0, 5.829000ns)
signal fRrnd :  std_logic_vector(10 downto 0);
   -- timing of fRrnd: (c0, 6.327000ns)
signal Rn2 :  std_logic_vector(16 downto 0);
   -- timing of Rn2: (c0, 6.327000ns)
