...
--  approx. output signal timings: R: (c1, 0.997276ns)
...
entity flopoco_00181_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00181_ieeefpfma_top is
...
signal BigSumNormd :  std_logic_vector(72 downto 0);
   -- timing of BigSumNormd: (c1, 0.997276ns)
signal expTentative, expTentative_d1 :  std_logic_vector(6 downto 0);
   -- timing of expTentative: (c0, 3.915096ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c1, 0.997276ns)
signal fracTentative :  std_logic_vector(13 downto 0);
   -- timing of fracTentative: (c1, 0.997276ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c1, 0.997276ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c1, 0.997276ns)
signal fracResultNormd :  std_logic_vector(9 downto 0);
   -- timing of fracResultNormd: (c1, 0.997276ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c1, 0.997276ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c1, 0.997276ns)
signal round :  std_logic;
   -- timing of round: (c1, 0.997276ns)
signal expUpdate :  std_logic_vector(6 downto 0);
   -- timing of expUpdate: (c1, 0.997276ns)
signal exponentResult1 :  std_logic_vector(6 downto 0);
   -- timing of exponentResult1: (c1, 0.997276ns)
signal resultBeforeRound :  std_logic_vector(16 downto 0);
   -- timing of resultBeforeRound: (c1, 0.997276ns)
signal resultRounded :  std_logic_vector(16 downto 0);
   -- timing of resultRounded: (c1, 0.997276ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c1, 0.997276ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c1, 0.997276ns)
