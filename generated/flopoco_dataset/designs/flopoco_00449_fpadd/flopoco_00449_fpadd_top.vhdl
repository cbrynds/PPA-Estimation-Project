...
--  approx. output signal timings: Count: (c2, 0.758500ns)R: (c2, 0.973500ns)
...
signal level4 :  std_logic_vector(11 downto 0);
   -- timing of level4: (c1, 1.094125ns)
signal count3, count3_d1 :  std_logic;
   -- timing of count3: (c1, 1.312875ns)
signal level3, level3_d1 :  std_logic_vector(11 downto 0);
   -- timing of level3: (c1, 1.527875ns)
signal count2, count2_d1 :  std_logic;
   -- timing of count2: (c1, 1.744750ns)
signal level2 :  std_logic_vector(11 downto 0);
   -- timing of level2: (c2, 0.109750ns)
signal count1 :  std_logic;
   -- timing of count1: (c2, 0.326625ns)
signal level1 :  std_logic_vector(11 downto 0);
   -- timing of level1: (c2, 0.541625ns)
signal count0 :  std_logic;
   -- timing of count0: (c2, 0.758500ns)
signal level0 :  std_logic_vector(11 downto 0);
   -- timing of level0: (c2, 0.973500ns)
signal sCount :  std_logic_vector(3 downto 0);
   -- timing of sCount: (c2, 0.758500ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c2, 1.256500ns)Y: (c0, 0.000000ns)Cin: (c2, 1.188500ns)
--  approx. output signal timings: R: (c2, 1.795500ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00449_fpadd_top
--                          (FPSub_8_7_Freq500_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c3, 0.375500ns)
...
entity flopoco_00449_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00449_fpadd_top is
...
signal nZerosNew :  std_logic_vector(3 downto 0);
   -- timing of nZerosNew: (c2, 0.758500ns)
signal shiftedFrac :  std_logic_vector(11 downto 0);
   -- timing of shiftedFrac: (c2, 0.973500ns)
...
signal updatedExp :  std_logic_vector(9 downto 0);
   -- timing of updatedExp: (c2, 1.256500ns)
signal eqdiffsign, eqdiffsign_d1 :  std_logic;
   -- timing of eqdiffsign: (c2, 0.758500ns)
signal expFrac :  std_logic_vector(17 downto 0);
   -- timing of expFrac: (c2, 1.256500ns)
signal stk :  std_logic;
   -- timing of stk: (c2, 0.973500ns)
signal rnd :  std_logic;
   -- timing of rnd: (c2, 0.973500ns)
signal lsb :  std_logic;
   -- timing of lsb: (c2, 0.973500ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c2, 1.188500ns)
signal RoundedExpFrac :  std_logic_vector(17 downto 0);
   -- timing of RoundedExpFrac: (c2, 1.795500ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c2, 1.795500ns)
signal fracR, fracR_d1 :  std_logic_vector(6 downto 0);
   -- timing of fracR: (c2, 1.795500ns)
signal expR, expR_d1 :  std_logic_vector(7 downto 0);
   -- timing of expR: (c2, 1.795500ns)
signal exExpExc, exExpExc_d1 :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c2, 1.795500ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c3, 0.160500ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c3, 0.375500ns)
signal signR2, signR2_d1 :  std_logic;
   -- timing of signR2: (c2, 0.973500ns)
signal computedR :  std_logic_vector(17 downto 0);
   -- timing of computedR: (c3, 0.375500ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
