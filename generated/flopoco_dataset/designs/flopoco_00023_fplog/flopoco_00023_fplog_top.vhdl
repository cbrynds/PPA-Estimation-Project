...
entity InvA0Table_Freq250_uid8 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(6 downto 0)   );
end entity;

architecture arch of InvA0Table_Freq250_uid8 is
...
entity LogTable0_Freq250_uid38 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(58 downto 0)   );
end entity;

architecture arch of LogTable0_Freq250_uid38 is
...
entity LogTable1_Freq250_uid41 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(54 downto 0)   );
end entity;

architecture arch of LogTable1_Freq250_uid41 is
...
entity LogTable2_Freq250_uid47 is
    port (X : in  std_logic_vector(4 downto 0);
          Y : out  std_logic_vector(51 downto 0)   );
end entity;

architecture arch of LogTable2_Freq250_uid47 is
...
entity LogTable3_Freq250_uid53 is
    port (X : in  std_logic_vector(4 downto 0);
          Y : out  std_logic_vector(47 downto 0)   );
end entity;

architecture arch of LogTable3_Freq250_uid53 is
...
entity LogTable4_Freq250_uid59 is
    port (X : in  std_logic_vector(4 downto 0);
          Y : out  std_logic_vector(43 downto 0)   );
end entity;

architecture arch of LogTable4_Freq250_uid59 is
...
--------------------------------------------------------------------------------
--                 FixRealKCM_Freq250_uid68_T0_Freq250_uid71
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity FixRealKCM_Freq250_uid68_T0_Freq250_uid71 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(49 downto 0)   );
end entity;

architecture arch of FixRealKCM_Freq250_uid68_T0_Freq250_uid71 is
...
--------------------------------------------------------------------------------
--                 FixRealKCM_Freq250_uid68_T1_Freq250_uid74
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity FixRealKCM_Freq250_uid68_T1_Freq250_uid74 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(43 downto 0)   );
end entity;

architecture arch of FixRealKCM_Freq250_uid68_T1_Freq250_uid74 is
signal Y0 :  std_logic_vector(43 downto 0);
   -- timing of Y0: (c0, 0.215000ns)
signal Y1 :  std_logic_vector(43 downto 0);
   -- timing of Y1: (c0, 0.215000ns)
...
--  approx. output signal timings: O: (c0, 3.204000ns)
...
entity LZOC_35_Freq250_uid4 is
...
architecture arch of LZOC_35_Freq250_uid4 is
...
signal digit3 :  std_logic;
   -- timing of digit3: (c0, 2.087000ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c0, 2.302000ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c0, 2.774000ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c0, 2.989000ns)
signal z :  std_logic_vector(2 downto 0);
   -- timing of z: (c0, 3.204000ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c0, 3.204000ns)
signal outHighBits :  std_logic_vector(3 downto 0);
   -- timing of outHighBits: (c0, 2.774000ns)
begin
   sozb <= OZB;
...
--------------------------------------------------------------------------------
--                    LeftShifter18_by_max_18_Freq250_uid6
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.754000ns)S: (c0, 3.676000ns)
--  approx. output signal timings: R: (c1, 1.086769ns)
...
entity LeftShifter18_by_max_18_Freq250_uid6 is
    port (clk : in std_logic;
...
--  approx. output signal timings: R: (c0, 2.082000ns)
...
entity IntAdder_44_Freq250_uid12 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_44_Freq250_uid12 is
signal Rtmp :  std_logic_vector(43 downto 0);
   -- timing of Rtmp: (c0, 2.082000ns)
begin
   Rtmp <= X + Y + Cin;
   R <= Rtmp;
end architecture;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 2.082000ns)Y: (c0, 2.297000ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c0, 2.959000ns)
...
entity IntAdder_44_Freq250_uid15 is
    port (clk : in std_logic;
          X : in  std_logic_vector(43 downto 0);
          Y : in  std_logic_vector(43 downto 0);
          Cin : in  std_logic;
...
architecture arch of IntAdder_44_Freq250_uid15 is
signal Rtmp :  std_logic_vector(43 downto 0);
   -- timing of Rtmp: (c0, 2.959000ns)
begin
   Rtmp <= X + Y + Cin;
   R <= Rtmp;
end architecture;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 2.959000ns)Y: (c0, 2.959000ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c0, 3.621000ns)
...
entity IntAdder_48_Freq250_uid18 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_48_Freq250_uid18 is
signal Rtmp :  std_logic_vector(47 downto 0);
   -- timing of Rtmp: (c0, 3.621000ns)
begin
   Rtmp <= X + Y + Cin;
   R <= Rtmp;
end architecture;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 3.621000ns)Y: (c1, 0.242000ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 0.904000ns)
...
entity IntAdder_48_Freq250_uid21 is
    port (clk : in std_logic;
          X : in  std_logic_vector(47 downto 0);
          Y : in  std_logic_vector(47 downto 0);
          Cin : in  std_logic;
...
architecture arch of IntAdder_48_Freq250_uid21 is
signal Rtmp :  std_logic_vector(47 downto 0);
   -- timing of Rtmp: (c1, 0.904000ns)
signal X_d1 :  std_logic_vector(47 downto 0);
   -- timing of X: (c0, 3.621000ns)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.904000ns)Y: (c1, 0.904000ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 1.566000ns)
...
entity IntAdder_44_Freq250_uid24 is
    port (clk : in std_logic;
          X : in  std_logic_vector(43 downto 0);
          Y : in  std_logic_vector(43 downto 0);
          Cin : in  std_logic;
...
architecture arch of IntAdder_44_Freq250_uid24 is
signal Rtmp :  std_logic_vector(43 downto 0);
   -- timing of Rtmp: (c1, 1.566000ns)
signal Cin_d1 :  std_logic;
   -- timing of Cin: (c0, 0.000000ns)
begin
   process(clk)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 1.566000ns)Y: (c1, 1.996000ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 2.658000ns)
...
entity IntAdder_44_Freq250_uid27 is
    port (clk : in std_logic;
          X : in  std_logic_vector(43 downto 0);
          Y : in  std_logic_vector(43 downto 0);
          Cin : in  std_logic;
...
architecture arch of IntAdder_44_Freq250_uid27 is
signal Rtmp :  std_logic_vector(43 downto 0);
   -- timing of Rtmp: (c1, 2.658000ns)
signal Cin_d1 :  std_logic;
   -- timing of Cin: (c0, 0.000000ns)
begin
   process(clk)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 2.658000ns)Y: (c1, 2.658000ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 3.279000ns)
...
entity IntAdder_40_Freq250_uid30 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_40_Freq250_uid30 is
signal Rtmp :  std_logic_vector(39 downto 0);
   -- timing of Rtmp: (c1, 3.279000ns)
signal Cin_d1 :  std_logic;
   -- timing of Cin: (c0, 0.000000ns)
begin
   process(clk)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 3.279000ns)Y: (c1, 3.709000ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c2, 0.521000ns)
...
entity IntAdder_40_Freq250_uid33 is
    port (clk : in std_logic;
          X : in  std_logic_vector(39 downto 0);
          Y : in  std_logic_vector(39 downto 0);
          Cin : in  std_logic;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c2, 0.521000ns)Y: (c2, 0.951000ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c2, 1.572000ns)
...
entity IntAdder_40_Freq250_uid36 is
    port (clk : in std_logic;
          X : in  std_logic_vector(39 downto 0);
          Y : in  std_logic_vector(39 downto 0);
          Cin : in  std_logic;
...
architecture arch of IntAdder_40_Freq250_uid36 is
signal Rtmp :  std_logic_vector(39 downto 0);
   -- timing of Rtmp: (c2, 1.572000ns)
...
--  approx. output signal timings: R: (c0, 2.164000ns)
...
entity IntAdder_59_Freq250_uid45 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_59_Freq250_uid45 is
signal Rtmp :  std_logic_vector(58 downto 0);
   -- timing of Rtmp: (c0, 2.164000ns)
begin
   Rtmp <= X + Y + Cin;
   R <= Rtmp;
end architecture;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 2.164000ns)Y: (c0, 3.174000ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 0.525000ns)
...
entity IntAdder_59_Freq250_uid51 is
    port (clk : in std_logic;
          X : in  std_logic_vector(58 downto 0);
          Y : in  std_logic_vector(58 downto 0);
          Cin : in  std_logic;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.525000ns)Y: (c1, 1.119000ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 1.863000ns)
...
entity IntAdder_59_Freq250_uid57 is
    port (clk : in std_logic;
          X : in  std_logic_vector(58 downto 0);
          Y : in  std_logic_vector(58 downto 0);
          Cin : in  std_logic;
...
architecture arch of IntAdder_59_Freq250_uid57 is
signal Rtmp :  std_logic_vector(58 downto 0);
   -- timing of Rtmp: (c1, 1.863000ns)
signal Cin_d1 :  std_logic;
   -- timing of Cin: (c0, 0.000000ns)
begin
   process(clk)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 1.863000ns)Y: (c1, 2.873000ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 3.617000ns)
...
entity IntAdder_59_Freq250_uid63 is
    port (clk : in std_logic;
          X : in  std_logic_vector(58 downto 0);
          Y : in  std_logic_vector(58 downto 0);
          Cin : in  std_logic;
...
architecture arch of IntAdder_59_Freq250_uid63 is
signal Rtmp :  std_logic_vector(58 downto 0);
   -- timing of Rtmp: (c1, 3.617000ns)
signal Cin_d1 :  std_logic;
   -- timing of Cin: (c0, 0.000000ns)
begin
   process(clk)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 3.617000ns)Y: (c2, 1.572000ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c2, 2.316000ns)
...
entity IntAdder_59_Freq250_uid66 is
    port (clk : in std_logic;
          X : in  std_logic_vector(58 downto 0);
          Y : in  std_logic_vector(58 downto 0);
          Cin : in  std_logic;
...
architecture arch of IntAdder_59_Freq250_uid66 is
signal Rtmp :  std_logic_vector(58 downto 0);
   -- timing of Rtmp: (c2, 2.316000ns)
signal X_d1 :  std_logic_vector(58 downto 0);
   -- timing of X: (c1, 3.617000ns)
signal Cin_d1, Cin_d2 :  std_logic;
   -- timing of Cin: (c0, 0.000000ns)
begin
   process(clk)
...
entity IntAdder_50_Freq250_uid78 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_50_Freq250_uid78 is
...
entity FixRealKCM_Freq250_uid68 is
    port (clk : in std_logic;
          X : in  std_logic_vector(9 downto 0);
          R : out  std_logic_vector(49 downto 0)   );
end entity;

architecture arch of FixRealKCM_Freq250_uid68 is
   component FixRealKCM_Freq250_uid68_T0_Freq250_uid71 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(49 downto 0)   );
   end component;

   component FixRealKCM_Freq250_uid68_T1_Freq250_uid74 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(43 downto 0)   );
   end component;

   component IntAdder_50_Freq250_uid78 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(49 downto 0);
             Y : in  std_logic_vector(49 downto 0);
             Cin : in  std_logic;
...
signal FixRealKCM_Freq250_uid68_A0 :  std_logic_vector(5 downto 0);
   -- timing of FixRealKCM_Freq250_uid68_A0: (c0, 0.713000ns)
signal FixRealKCM_Freq250_uid68_T0 :  std_logic_vector(49 downto 0);
   -- timing of FixRealKCM_Freq250_uid68_T0: (c0, 1.041000ns)
signal FixRealKCM_Freq250_uid68_T0_copy72 :  std_logic_vector(49 downto 0);
   -- timing of FixRealKCM_Freq250_uid68_T0_copy72: (c0, 0.713000ns)
...
signal FixRealKCM_Freq250_uid68_A1 :  std_logic_vector(3 downto 0);
   -- timing of FixRealKCM_Freq250_uid68_A1: (c0, 0.713000ns)
signal FixRealKCM_Freq250_uid68_T1 :  std_logic_vector(43 downto 0);
   -- timing of FixRealKCM_Freq250_uid68_T1: (c0, 0.928000ns)
signal FixRealKCM_Freq250_uid68_T1_copy75 :  std_logic_vector(43 downto 0);
   -- timing of FixRealKCM_Freq250_uid68_T1_copy75: (c0, 0.713000ns)
...
-- This operator multiplies by log(2)
   FixRealKCM_Freq250_uid68_A0 <= X(9 downto 4);-- input address  m=9  l=4
   FixRealKCM_Freq250_uid68_Table0: FixRealKCM_Freq250_uid68_T0_Freq250_uid71
      port map ( X => FixRealKCM_Freq250_uid68_A0,
                 Y => FixRealKCM_Freq250_uid68_T0_copy72);
   FixRealKCM_Freq250_uid68_T0 <= FixRealKCM_Freq250_uid68_T0_copy72; -- output copy to hold a pipeline register if needed
   bh69_w0_0 <= FixRealKCM_Freq250_uid68_T0(0);
   bh69_w1_0 <= FixRealKCM_Freq250_uid68_T0(1);
   bh69_w2_0 <= FixRealKCM_Freq250_uid68_T0(2);
   bh69_w3_0 <= FixRealKCM_Freq250_uid68_T0(3);
   bh69_w4_0 <= FixRealKCM_Freq250_uid68_T0(4);
   bh69_w5_0 <= FixRealKCM_Freq250_uid68_T0(5);
   bh69_w6_0 <= FixRealKCM_Freq250_uid68_T0(6);
   bh69_w7_0 <= FixRealKCM_Freq250_uid68_T0(7);
   bh69_w8_0 <= FixRealKCM_Freq250_uid68_T0(8);
   bh69_w9_0 <= FixRealKCM_Freq250_uid68_T0(9);
   bh69_w10_0 <= FixRealKCM_Freq250_uid68_T0(10);
   bh69_w11_0 <= FixRealKCM_Freq250_uid68_T0(11);
   bh69_w12_0 <= FixRealKCM_Freq250_uid68_T0(12);
   bh69_w13_0 <= FixRealKCM_Freq250_uid68_T0(13);
   bh69_w14_0 <= FixRealKCM_Freq250_uid68_T0(14);
   bh69_w15_0 <= FixRealKCM_Freq250_uid68_T0(15);
   bh69_w16_0 <= FixRealKCM_Freq250_uid68_T0(16);
   bh69_w17_0 <= FixRealKCM_Freq250_uid68_T0(17);
   bh69_w18_0 <= FixRealKCM_Freq250_uid68_T0(18);
   bh69_w19_0 <= FixRealKCM_Freq250_uid68_T0(19);
   bh69_w20_0 <= FixRealKCM_Freq250_uid68_T0(20);
   bh69_w21_0 <= FixRealKCM_Freq250_uid68_T0(21);
   bh69_w22_0 <= FixRealKCM_Freq250_uid68_T0(22);
   bh69_w23_0 <= FixRealKCM_Freq250_uid68_T0(23);
   bh69_w24_0 <= FixRealKCM_Freq250_uid68_T0(24);
   bh69_w25_0 <= FixRealKCM_Freq250_uid68_T0(25);
   bh69_w26_0 <= FixRealKCM_Freq250_uid68_T0(26);
   bh69_w27_0 <= FixRealKCM_Freq250_uid68_T0(27);
   bh69_w28_0 <= FixRealKCM_Freq250_uid68_T0(28);
   bh69_w29_0 <= FixRealKCM_Freq250_uid68_T0(29);
   bh69_w30_0 <= FixRealKCM_Freq250_uid68_T0(30);
   bh69_w31_0 <= FixRealKCM_Freq250_uid68_T0(31);
   bh69_w32_0 <= FixRealKCM_Freq250_uid68_T0(32);
   bh69_w33_0 <= FixRealKCM_Freq250_uid68_T0(33);
   bh69_w34_0 <= FixRealKCM_Freq250_uid68_T0(34);
   bh69_w35_0 <= FixRealKCM_Freq250_uid68_T0(35);
   bh69_w36_0 <= FixRealKCM_Freq250_uid68_T0(36);
   bh69_w37_0 <= FixRealKCM_Freq250_uid68_T0(37);
   bh69_w38_0 <= FixRealKCM_Freq250_uid68_T0(38);
   bh69_w39_0 <= FixRealKCM_Freq250_uid68_T0(39);
   bh69_w40_0 <= FixRealKCM_Freq250_uid68_T0(40);
   bh69_w41_0 <= FixRealKCM_Freq250_uid68_T0(41);
   bh69_w42_0 <= FixRealKCM_Freq250_uid68_T0(42);
   bh69_w43_0 <= FixRealKCM_Freq250_uid68_T0(43);
   bh69_w44_0 <= FixRealKCM_Freq250_uid68_T0(44);
   bh69_w45_0 <= FixRealKCM_Freq250_uid68_T0(45);
   bh69_w46_0 <= FixRealKCM_Freq250_uid68_T0(46);
   bh69_w47_0 <= FixRealKCM_Freq250_uid68_T0(47);
   bh69_w48_0 <= FixRealKCM_Freq250_uid68_T0(48);
   bh69_w49_0 <= FixRealKCM_Freq250_uid68_T0(49);
   FixRealKCM_Freq250_uid68_A1 <= X(3 downto 0);-- input address  m=3  l=0
   FixRealKCM_Freq250_uid68_Table1: FixRealKCM_Freq250_uid68_T1_Freq250_uid74
      port map ( X => FixRealKCM_Freq250_uid68_A1,
                 Y => FixRealKCM_Freq250_uid68_T1_copy75);
   FixRealKCM_Freq250_uid68_T1 <= FixRealKCM_Freq250_uid68_T1_copy75; -- output copy to hold a pipeline register if needed
   bh69_w0_1 <= FixRealKCM_Freq250_uid68_T1(0);
   bh69_w1_1 <= FixRealKCM_Freq250_uid68_T1(1);
   bh69_w2_1 <= FixRealKCM_Freq250_uid68_T1(2);
   bh69_w3_1 <= FixRealKCM_Freq250_uid68_T1(3);
   bh69_w4_1 <= FixRealKCM_Freq250_uid68_T1(4);
   bh69_w5_1 <= FixRealKCM_Freq250_uid68_T1(5);
   bh69_w6_1 <= FixRealKCM_Freq250_uid68_T1(6);
   bh69_w7_1 <= FixRealKCM_Freq250_uid68_T1(7);
   bh69_w8_1 <= FixRealKCM_Freq250_uid68_T1(8);
   bh69_w9_1 <= FixRealKCM_Freq250_uid68_T1(9);
   bh69_w10_1 <= FixRealKCM_Freq250_uid68_T1(10);
   bh69_w11_1 <= FixRealKCM_Freq250_uid68_T1(11);
   bh69_w12_1 <= FixRealKCM_Freq250_uid68_T1(12);
   bh69_w13_1 <= FixRealKCM_Freq250_uid68_T1(13);
   bh69_w14_1 <= FixRealKCM_Freq250_uid68_T1(14);
   bh69_w15_1 <= FixRealKCM_Freq250_uid68_T1(15);
   bh69_w16_1 <= FixRealKCM_Freq250_uid68_T1(16);
   bh69_w17_1 <= FixRealKCM_Freq250_uid68_T1(17);
   bh69_w18_1 <= FixRealKCM_Freq250_uid68_T1(18);
   bh69_w19_1 <= FixRealKCM_Freq250_uid68_T1(19);
   bh69_w20_1 <= FixRealKCM_Freq250_uid68_T1(20);
   bh69_w21_1 <= FixRealKCM_Freq250_uid68_T1(21);
   bh69_w22_1 <= FixRealKCM_Freq250_uid68_T1(22);
   bh69_w23_1 <= FixRealKCM_Freq250_uid68_T1(23);
   bh69_w24_1 <= FixRealKCM_Freq250_uid68_T1(24);
   bh69_w25_1 <= FixRealKCM_Freq250_uid68_T1(25);
   bh69_w26_1 <= FixRealKCM_Freq250_uid68_T1(26);
   bh69_w27_1 <= FixRealKCM_Freq250_uid68_T1(27);
   bh69_w28_1 <= FixRealKCM_Freq250_uid68_T1(28);
   bh69_w29_1 <= FixRealKCM_Freq250_uid68_T1(29);
   bh69_w30_1 <= FixRealKCM_Freq250_uid68_T1(30);
   bh69_w31_1 <= FixRealKCM_Freq250_uid68_T1(31);
   bh69_w32_1 <= FixRealKCM_Freq250_uid68_T1(32);
   bh69_w33_1 <= FixRealKCM_Freq250_uid68_T1(33);
   bh69_w34_1 <= FixRealKCM_Freq250_uid68_T1(34);
   bh69_w35_1 <= FixRealKCM_Freq250_uid68_T1(35);
   bh69_w36_1 <= FixRealKCM_Freq250_uid68_T1(36);
   bh69_w37_1 <= FixRealKCM_Freq250_uid68_T1(37);
   bh69_w38_1 <= FixRealKCM_Freq250_uid68_T1(38);
   bh69_w39_1 <= FixRealKCM_Freq250_uid68_T1(39);
   bh69_w40_1 <= FixRealKCM_Freq250_uid68_T1(40);
   bh69_w41_1 <= FixRealKCM_Freq250_uid68_T1(41);
   bh69_w42_1 <= FixRealKCM_Freq250_uid68_T1(42);
   bh69_w43_1 <= FixRealKCM_Freq250_uid68_T1(43);
   ...
   bitheapFinalAdd_bh69: IntAdder_50_Freq250_uid78
      port map ( clk  => clk,
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 1.744000ns)Y: (c2, 2.316000ns)Cin: (c0, 0.215000ns)
--  approx. output signal timings: R: (c2, 3.101000ns)
...
entity IntAdder_69_Freq250_uid80 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_69_Freq250_uid80 is
signal Rtmp :  std_logic_vector(68 downto 0);
   -- timing of Rtmp: (c2, 3.101000ns)
signal X_d1, X_d2 :  std_logic_vector(68 downto 0);
...
--------------------------------------------------------------------------------
--                    Normalizer_Z_69_59_27_Freq250_uid82
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. input signal timings: X: (c2, 3.101000ns)
--  approx. output signal timings: Count: (c3, 1.201000ns)R: (c3, 1.416000ns)
...
entity Normalizer_Z_69_59_27_Freq250_uid82 is
    port (clk : in std_logic;
          X : in  std_logic_vector(68 downto 0);
...
architecture arch of Normalizer_Z_69_59_27_Freq250_uid82 is
signal level5 :  std_logic_vector(68 downto 0);
   -- timing of level5: (c2, 3.101000ns)
signal count4, count4_d1 :  std_logic;
   -- timing of count4: (c2, 3.321625ns)
signal level4, level4_d1 :  std_logic_vector(68 downto 0);
   -- timing of level4: (c2, 3.536625ns)
signal count3, count3_d1 :  std_logic;
   -- timing of count3: (c2, 3.755375ns)
signal level3 :  std_logic_vector(65 downto 0);
   -- timing of level3: (c3, 0.120375ns)
signal count2 :  std_logic;
   -- timing of count2: (c3, 0.337250ns)
signal level2 :  std_logic_vector(61 downto 0);
   -- timing of level2: (c3, 0.552250ns)
signal count1 :  std_logic;
   -- timing of count1: (c3, 0.769125ns)
signal level1 :  std_logic_vector(59 downto 0);
   -- timing of level1: (c3, 0.984125ns)
signal count0 :  std_logic;
   -- timing of count0: (c3, 1.201000ns)
signal level0 :  std_logic_vector(58 downto 0);
   -- timing of level0: (c3, 1.416000ns)
signal sCount :  std_logic_vector(4 downto 0);
   -- timing of sCount: (c3, 1.201000ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   level3<= level4_d1(68 downto 3) when count3_d1='0' else level4_d1(60 downto 0) & (4 downto 0 => '0');
...
--------------------------------------------------------------------------------
--                   RightShifter23_by_max_22_Freq250_uid84
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c2, 0.736000ns)S: (c0, 3.676000ns)
--  approx. output signal timings: R: (c2, 2.150615ns)
...
entity RightShifter23_by_max_22_Freq250_uid84 is
    port (clk : in std_logic;
...
architecture arch of RightShifter23_by_max_22_Freq250_uid84 is
signal ps, ps_d1, ps_d2 :  std_logic_vector(4 downto 0);
   -- timing of ps: (c0, 3.676000ns)
signal level0 :  std_logic_vector(22 downto 0);
   -- timing of level0: (c2, 0.736000ns)
signal level1 :  std_logic_vector(23 downto 0);
   -- timing of level1: (c2, 0.736000ns)
signal level2 :  std_logic_vector(25 downto 0);
   -- timing of level2: (c2, 1.351000ns)
signal level3 :  std_logic_vector(29 downto 0);
   -- timing of level3: (c2, 1.351000ns)
signal level4 :  std_logic_vector(37 downto 0);
   -- timing of level4: (c2, 2.150615ns)
signal level5 :  std_logic_vector(53 downto 0);
   -- timing of level5: (c2, 2.150615ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 1.086769ns)Y: (c2, 2.150615ns)Cin: (c0, 0.215000ns)
--  approx. output signal timings: R: (c2, 2.812615ns)
...
entity IntAdder_42_Freq250_uid86 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_42_Freq250_uid86 is
signal Rtmp :  std_logic_vector(41 downto 0);
   -- timing of Rtmp: (c2, 2.812615ns)
signal X_d1 :  std_logic_vector(41 downto 0);
   -- timing of X: (c1, 1.086769ns)
signal Cin_d1, Cin_d2 :  std_logic;
   -- timing of Cin: (c0, 0.215000ns)
begin
   process(clk)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c3, 1.416000ns)Y: (c3, 1.416000ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c3, 2.078000ns)
...
entity IntAdder_45_Freq250_uid89 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_45_Freq250_uid89 is
signal Rtmp :  std_logic_vector(44 downto 0);
   -- timing of Rtmp: (c3, 2.078000ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00023_fplog_top
--                 (FPLogIterative_10_35_6_250_Freq250_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00023_fplog_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(10+35+2 downto 0);
          R : out  std_logic_vector(10+35+2 downto 0)   );
end entity;

architecture arch of flopoco_00023_fplog_top is
   component LZOC_35_Freq250_uid4 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(34 downto 0);
             OZB : in  std_logic;
             O : out  std_logic_vector(5 downto 0)   );
   ...
   component LeftShifter18_by_max_18_Freq250_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(17 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(35 downto 0)   );
   ...
   component InvA0Table_Freq250_uid8 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(6 downto 0)   );
   end component;

   component IntAdder_44_Freq250_uid12 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(43 downto 0);
             Y : in  std_logic_vector(43 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_44_Freq250_uid15 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(43 downto 0);
             Y : in  std_logic_vector(43 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_48_Freq250_uid18 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(47 downto 0);
             Y : in  std_logic_vector(47 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_48_Freq250_uid21 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(47 downto 0);
             Y : in  std_logic_vector(47 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_44_Freq250_uid24 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(43 downto 0);
             Y : in  std_logic_vector(43 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_44_Freq250_uid27 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(43 downto 0);
             Y : in  std_logic_vector(43 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_40_Freq250_uid30 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(39 downto 0);
             Y : in  std_logic_vector(39 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_40_Freq250_uid33 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(39 downto 0);
             Y : in  std_logic_vector(39 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_40_Freq250_uid36 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(39 downto 0);
             Y : in  std_logic_vector(39 downto 0);
             Cin : in  std_logic;
   ...
   component LogTable0_Freq250_uid38 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(58 downto 0)   );
   end component;

   component LogTable1_Freq250_uid41 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(54 downto 0)   );
   end component;

   component IntAdder_59_Freq250_uid45 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(58 downto 0);
             Y : in  std_logic_vector(58 downto 0);
             Cin : in  std_logic;
   ...
   component LogTable2_Freq250_uid47 is
      port ( X : in  std_logic_vector(4 downto 0);
             Y : out  std_logic_vector(51 downto 0)   );
   end component;

   component IntAdder_59_Freq250_uid51 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(58 downto 0);
             Y : in  std_logic_vector(58 downto 0);
             Cin : in  std_logic;
   ...
   component LogTable3_Freq250_uid53 is
      port ( X : in  std_logic_vector(4 downto 0);
             Y : out  std_logic_vector(47 downto 0)   );
   end component;

   component IntAdder_59_Freq250_uid57 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(58 downto 0);
             Y : in  std_logic_vector(58 downto 0);
             Cin : in  std_logic;
   ...
   component LogTable4_Freq250_uid59 is
      port ( X : in  std_logic_vector(4 downto 0);
             Y : out  std_logic_vector(43 downto 0)   );
   end component;

   component IntAdder_59_Freq250_uid63 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(58 downto 0);
             Y : in  std_logic_vector(58 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_59_Freq250_uid66 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(58 downto 0);
             Y : in  std_logic_vector(58 downto 0);
             Cin : in  std_logic;
   ...
   component FixRealKCM_Freq250_uid68 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(9 downto 0);
             R : out  std_logic_vector(49 downto 0)   );
   end component;

   component IntAdder_69_Freq250_uid80 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(68 downto 0);
             Y : in  std_logic_vector(68 downto 0);
             Cin : in  std_logic;
   ...
   component Normalizer_Z_69_59_27_Freq250_uid82 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(68 downto 0);
             Count : out  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(58 downto 0)   );
   ...
   component RightShifter23_by_max_22_Freq250_uid84 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(22 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(44 downto 0)   );
   ...
   component IntAdder_42_Freq250_uid86 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(41 downto 0);
             Y : in  std_logic_vector(41 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_45_Freq250_uid89 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(44 downto 0);
             Y : in  std_logic_vector(44 downto 0);
             Cin : in  std_logic;
...
signal ZM1 :  std_logic_vector(37 downto 0);
   -- timing of ZM1: (c0, 1.205000ns)
signal P1 :  std_logic_vector(41 downto 0);
   -- timing of P1: (c0, 2.082000ns)
...
signal E_small, E_small_d1 :  std_logic_vector(9 downto 0);
   -- timing of E_small: (c2, 2.812615ns)
signal Log_small_normd, Log_small_normd_d1 :  std_logic_vector(39 downto 0);
   -- timing of Log_small_normd: (c2, 2.812615ns)
signal E0offset, E0offset_d1, E0offset_d2, E0offset_d3 :  std_logic_vector(9 downto 0);
   -- timing of E0offset: (c0, 0.000000ns)
signal ER :  std_logic_vector(9 downto 0);
   -- timing of ER: (c3, 1.201000ns)
signal Log_g :  std_logic_vector(39 downto 0);
   -- timing of Log_g: (c3, 1.416000ns)
signal round :  std_logic;
   -- timing of round: (c3, 1.416000ns)
signal fraX :  std_logic_vector(44 downto 0);
   -- timing of fraX: (c3, 1.416000ns)
signal fraY :  std_logic_vector(44 downto 0);
   -- timing of fraY: (c3, 1.416000ns)
signal EFR :  std_logic_vector(44 downto 0);
   -- timing of EFR: (c3, 2.078000ns)
signal Rexn :  std_logic_vector(2 downto 0);
   -- timing of Rexn: (c3, 1.631000ns)
...
begin
   ...
   small_lshift: LeftShifter18_by_max_18_Freq250_uid6
      port map ( clk  => clk,
                 S => shiftvalinL,
                 X => absZ0,
   ...
   A0 <= X(34 downto 29);
   -- First inv table
   InvA0Table: InvA0Table_Freq250_uid8
      port map ( X => A0,
                 Y => InvA0_copy9);
   ...
   addIter1_1: IntAdder_44_Freq250_uid12
      port map ( clk  => clk,
                 Cin => '0',
                 X => addXIter1,
                 Y => EiY1,
   ...
   addIter2_1: IntAdder_44_Freq250_uid15
      port map ( clk  => clk,
                 Cin => '1',
                 X => EiYPB1,
                 Y => Pp1,
   ...
   addIter1_2: IntAdder_48_Freq250_uid18
      port map ( clk  => clk,
                 Cin => '0',
                 X => addXIter2,
                 Y => EiY2,
   ...
   addIter2_2: IntAdder_48_Freq250_uid21
      port map ( clk  => clk,
                 Cin => '1',
                 X => EiYPB2,
                 Y => Pp2,
   ...
   addXIter3 <= "0" & B3;
   addIter1_3: IntAdder_44_Freq250_uid24
      port map ( clk  => clk,
                 Cin => '0',
                 X => addXIter3,
                 Y => EiY3,
   ...
   addIter2_3: IntAdder_44_Freq250_uid27
      port map ( clk  => clk,
                 Cin => '1',
                 X => EiYPB3,
                 Y => Pp3,
   ...
   addXIter4 <= "0" & B4;
   addIter1_4: IntAdder_40_Freq250_uid30
      port map ( clk  => clk,
                 Cin => '0',
                 X => addXIter4,
                 Y => EiY4,
                 R => EiYPB4);
   Pp4 <= (10 downto 0 => '1') & not(P4(33 downto 5));
   addIter2_4: IntAdder_40_Freq250_uid33
      port map ( clk  => clk,
                 Cin => '1',
                 X => EiYPB4,
                 Y => Pp4,
                 R => Z5);
   Zfinal <= Z5;
   squarerIn <= Zfinal(sfinal-1 downto sfinal-23) when doRR_d2='1'
                    else (small_absZ0_normd_d1 & (4 downto 0 => '0'));  
   ...
   addFinalLog1p_normalAdder: IntAdder_40_Freq250_uid36
      port map ( clk  => clk,
                 Cin => '1',
                 X => Zfinal,
                 Y => addFinalLog1pY,
   ...
   adderLogF_normal: IntAdder_59_Freq250_uid66
      port map ( clk  => clk,
                 Cin => '0',
                 X => almostLog,
                 Y => adderLogF_normalY,
                 R => LogF_normal);
   MulLog2: FixRealKCM_Freq250_uid68
      port map ( clk  => clk,
                 X => absE,
                 R => absELog2);
   ...
   lnadder: IntAdder_69_Freq250_uid80
      port map ( clk  => clk,
                 Cin => sR,
                 X => lnaddX,
                 Y => lnaddY,
                 R => Log_normal);
   final_norm: Normalizer_Z_69_59_27_Freq250_uid82
      port map ( clk  => clk,
                 X => Log_normal,
                 Count => E_normal,
                 R => Log_normal_normd);
   Z2o2_small_bs <= Z2o2_full_dummy(45 downto 23);
   ao_rshift: RightShifter23_by_max_22_Freq250_uid84
      port map ( clk  => clk,
                 S => shiftvalinR,
                 X => Z2o2_small_bs,
                 R => Z2o2_small_s);
   ...
   nsRCin <= not ( sR );
   log_small_adder: IntAdder_42_Freq250_uid86
      port map ( clk  => clk,
                 Cin => nsRCin,
                 X => Z_small,
                 Y => Log_smallY,
   ...
   ER <= E_small_d1(9 downto 0) when small_d2='1'
      else E0offset_d3 - ((9 downto 5 => '0') & E_normal);
   ...
   finalRoundAdder: IntAdder_45_Freq250_uid89
      port map ( clk  => clk,
                 Cin => '0',
                 X => fraX,
                 Y => fraY,
