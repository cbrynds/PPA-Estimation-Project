--------------------------------------------------------------------------------
--                RightShifterSticky24_by_max_26_Freq150_uid4
...
entity RightShifterSticky24_by_max_26_Freq150_uid4 is
...
architecture arch of RightShifterSticky24_by_max_26_Freq150_uid4 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_28_28_28_Freq150_uid8
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Count: (c0, 5.237750ns)R: (c0, 5.452750ns)
...
entity Normalizer_Z_28_28_28_Freq150_uid8 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_28_28_28_Freq150_uid8 is
...
signal level1 :  std_logic_vector(27 downto 0);
   -- timing of level1: (c0, 5.020875ns)
signal count0 :  std_logic;
   -- timing of count0: (c0, 5.237750ns)
signal level0 :  std_logic_vector(27 downto 0);
   -- timing of level0: (c0, 5.452750ns)
signal sCount :  std_logic_vector(4 downto 0);
   -- timing of sCount: (c0, 5.237750ns)
begin
   level5 <= X ;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 5.735750ns)Y: (c0, 0.000000ns)Cin: (c0, 5.667750ns)
--  approx. output signal timings: R: (c0, 6.356750ns)
...
entity IntAdder_34_Freq150_uid11 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_34_Freq150_uid11 is
signal Rtmp :  std_logic_vector(33 downto 0);
   -- timing of Rtmp: (c0, 6.356750ns)
begin
   Rtmp <= X + Y + Cin;
   R <= Rtmp;
end architecture;
...
--------------------------------------------------------------------------------
--                          flopoco_00401_fpadd_top
--                         (FPSub_8_23_Freq150_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 0.270083ns)
...
entity flopoco_00401_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00401_fpadd_top is
   component RightShifterSticky24_by_max_26_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(23 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(25 downto 0);
   ...
   component Normalizer_Z_28_28_28_Freq150_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(27 downto 0);
             Count : out  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(27 downto 0)   );
   ...
   component IntAdder_34_Freq150_uid11 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(33 downto 0);
             Y : in  std_logic_vector(33 downto 0);
             Cin : in  std_logic;
...
signal nZerosNew :  std_logic_vector(4 downto 0);
   -- timing of nZerosNew: (c0, 5.237750ns)
signal shiftedFrac :  std_logic_vector(27 downto 0);
   -- timing of shiftedFrac: (c0, 5.452750ns)
signal extendedExpInc :  std_logic_vector(8 downto 0);
   -- timing of extendedExpInc: (c0, 1.252000ns)
signal updatedExp :  std_logic_vector(9 downto 0);
   -- timing of updatedExp: (c0, 5.735750ns)
signal eqdiffsign, eqdiffsign_d1 :  std_logic;
   -- timing of eqdiffsign: (c0, 5.237750ns)
signal expFrac :  std_logic_vector(33 downto 0);
   -- timing of expFrac: (c0, 5.735750ns)
signal stk :  std_logic;
   -- timing of stk: (c0, 5.452750ns)
signal rnd :  std_logic;
   -- timing of rnd: (c0, 5.452750ns)
signal lsb :  std_logic;
   -- timing of lsb: (c0, 5.452750ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c0, 5.667750ns)
signal RoundedExpFrac :  std_logic_vector(33 downto 0);
   -- timing of RoundedExpFrac: (c0, 6.356750ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c0, 6.356750ns)
signal fracR, fracR_d1 :  std_logic_vector(22 downto 0);
   -- timing of fracR: (c0, 6.356750ns)
signal expR, expR_d1 :  std_logic_vector(7 downto 0);
   -- timing of expR: (c0, 6.356750ns)
signal exExpExc, exExpExc_d1 :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c0, 6.356750ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c1, 0.055083ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c1, 0.270083ns)
signal signR2, signR2_d1 :  std_logic;
   -- timing of signR2: (c0, 5.452750ns)
signal computedR :  std_logic_vector(33 downto 0);
   -- timing of computedR: (c1, 0.270083ns)
begin
   process(clk)
      begin
   ...
   RightShifterComponent: RightShifterSticky24_by_max_26_Freq150_uid4
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracY,
                 R => shiftedFracY,
   ...
   LZCAndShifter: Normalizer_Z_28_28_28_Freq150_uid8
      port map ( clk  => clk,
                 X => fracSticky,
                 Count => nZerosNew,
                 R => shiftedFrac);
   ...
   roundingAdder: IntAdder_34_Freq150_uid11
      port map ( clk  => clk,
                 Cin => needToRound,
                 X => expFrac,
