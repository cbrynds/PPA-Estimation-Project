--------------------------------------------------------------------------------
--                RightShifterSticky36_by_max_38_Freq150_uid4
...
entity RightShifterSticky36_by_max_38_Freq150_uid4 is
...
architecture arch of RightShifterSticky36_by_max_38_Freq150_uid4 is
...
entity IntAdder_39_Freq150_uid6 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_39_Freq150_uid6 is
...
entity IntAdder_47_Freq150_uid9 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_47_Freq150_uid9 is
...
--------------------------------------------------------------------------------
--                          flopoco_00383_fpadd_top
--                         (FPAdd_10_35_Freq150_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00383_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00383_fpadd_top is
   component RightShifterSticky36_by_max_38_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(35 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(37 downto 0);
   ...
   component IntAdder_39_Freq150_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(38 downto 0);
             Y : in  std_logic_vector(38 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_47_Freq150_uid9 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(46 downto 0);
             Y : in  std_logic_vector(46 downto 0);
             Cin : in  std_logic;
...
-- Far Path --
   ...
   RightShifterComponent: RightShifterSticky36_by_max_38_Freq150_uid4
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracNewY,
                 R => shiftedFracY,
   ...
   -- far path adder
   FPAdd_10_35_Freq150_uid2_fracAddFar: IntAdder_39_Freq150_uid6
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   -- final round adder
   FPAdd_10_35_Freq150_uid2_finalRoundAdd: IntAdder_47_Freq150_uid9
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
