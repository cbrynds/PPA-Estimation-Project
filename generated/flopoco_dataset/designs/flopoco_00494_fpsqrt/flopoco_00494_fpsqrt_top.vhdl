...
--  approx. output signal timings: R: (c1, 1.125667ns)
...
entity flopoco_00494_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00494_fpsqrt_top is
...
signal T6s_l, T6s_l_d1 :  std_logic_vector(0 downto 0);
...
signal d9 :  std_logic;
   -- timing of d9: (c1, 0.653667ns)
signal mR :  std_logic_vector(9 downto 0);
   -- timing of mR: (c1, 0.653667ns)
signal fR :  std_logic_vector(6 downto 0);
   -- timing of fR: (c1, 0.653667ns)
signal round :  std_logic;
   -- timing of round: (c1, 0.653667ns)
signal fRrnd :  std_logic_vector(6 downto 0);
   -- timing of fRrnd: (c1, 1.125667ns)
signal Rn2 :  std_logic_vector(14 downto 0);
   -- timing of Rn2: (c1, 1.125667ns)
