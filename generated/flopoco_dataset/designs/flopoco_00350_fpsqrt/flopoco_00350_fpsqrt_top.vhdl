...
--  approx. output signal timings: R: (c0, 5.901000ns)
...
entity flopoco_00350_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00350_fpsqrt_top is
...
signal fR :  std_logic_vector(6 downto 0);
   -- timing of fR: (c0, 5.429000ns)
signal round :  std_logic;
   -- timing of round: (c0, 5.394000ns)
signal fRrnd :  std_logic_vector(6 downto 0);
   -- timing of fRrnd: (c0, 5.901000ns)
signal Rn2 :  std_logic_vector(14 downto 0);
   -- timing of Rn2: (c0, 5.901000ns)
