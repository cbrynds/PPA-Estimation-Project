...
entity flopoco_00293_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00293_fpadd_top is
...
-- Far Path --
   ...
   -- far path adder
   FPAdd_8_7_Freq150_uid2_fracAddFar: IntAdder_11_Freq150_uid6
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   -- final round adder
   FPAdd_8_7_Freq150_uid2_finalRoundAdd: IntAdder_17_Freq150_uid9
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
                 Y => "00000000000000000",
