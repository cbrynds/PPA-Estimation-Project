...
--------------------------------------------------------------------------------
--                          flopoco_00222_fpadd_top
--                         (FPAdd_6_11_Freq300_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00222_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00222_fpadd_top is
...
-- Close Path --
   ...
   FPAdd_6_11_Freq300_uid2_DualSubClose: IntDualSub_14_Freq300_uid4
      port map ( clk  => clk,
                 X => fracXClose1,
                 Y => fracYClose1,
                 XmY => fracRClosexMy,
...
-- Far Path --
   ...
   -- far path adder
   FPAdd_6_11_Freq300_uid2_fracAddFar: IntAdder_15_Freq300_uid10
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
...
-- Synchronization of both paths --
   ...
   -- final round adder
   FPAdd_6_11_Freq300_uid2_finalRoundAdd: IntAdder_19_Freq300_uid13
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
