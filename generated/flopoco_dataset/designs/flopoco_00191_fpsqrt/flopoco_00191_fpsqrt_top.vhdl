...
--  approx. output signal timings: R: (c9, 0.826000ns)
...
entity flopoco_00191_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+31+2 downto 0);
          R : out  std_logic_vector(8+31+2 downto 0)   );
end entity;

architecture arch of flopoco_00191_fpsqrt_top is
...
signal T3s_l, T3s_l_d1 :  std_logic_vector(27 downto 0);
...
signal T7s_l, T7s_l_d1 :  std_logic_vector(23 downto 0);
...
signal T11s_l, T11s_l_d1 :  std_logic_vector(19 downto 0);
...
signal T18s_l, T18s_l_d1 :  std_logic_vector(12 downto 0);
...
signal d33 :  std_logic;
   -- timing of d33: (c9, 0.246000ns)
signal mR :  std_logic_vector(33 downto 0);
   -- timing of mR: (c9, 0.246000ns)
signal fR :  std_logic_vector(30 downto 0);
   -- timing of fR: (c9, 0.246000ns)
signal round :  std_logic;
   -- timing of round: (c9, 0.246000ns)
signal fRrnd :  std_logic_vector(30 downto 0);
   -- timing of fRrnd: (c9, 0.826000ns)
signal Rn2 :  std_logic_vector(38 downto 0);
   -- timing of Rn2: (c9, 0.826000ns)
...
begin
   ...
   mR <= S31_d1 & d33; -- result significand
