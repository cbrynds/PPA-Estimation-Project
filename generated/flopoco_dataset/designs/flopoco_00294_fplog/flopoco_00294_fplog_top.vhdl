...
--------------------------------------------------------------------------------
--                     LeftShifter7_by_max_7_Freq500_uid6
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 0.794846ns)
...
entity LeftShifter7_by_max_7_Freq500_uid6 is
    port (clk : in std_logic;
...
architecture arch of LeftShifter7_by_max_7_Freq500_uid6 is
signal ps :  std_logic_vector(2 downto 0);
   -- timing of ps: (c1, 0.426000ns)
signal level0, level0_d1 :  std_logic_vector(6 downto 0);
...
signal level2 :  std_logic_vector(9 downto 0);
   -- timing of level2: (c1, 0.794846ns)
signal level3 :  std_logic_vector(13 downto 0);
   -- timing of level3: (c1, 0.794846ns)
begin
   process(clk)
      begin
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.969000ns)Y: (c1, 1.224846ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 1.722846ns)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.215000ns)Y: (c1, 1.722846ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c2, 0.411846ns)
...
entity IntAdder_21_Freq500_uid18 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_21_Freq500_uid18 is
...
signal Y_1, Y_1_d1 :  std_logic_vector(21 downto 0);
   -- timing of Y_1: (c1, 1.722846ns)
signal S_1 :  std_logic_vector(21 downto 0);
   -- timing of S_1: (c2, 0.411846ns)
signal R_1 :  std_logic_vector(20 downto 0);
   -- timing of R_1: (c2, 0.411846ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
signal FixRealKCM_Freq500_uid20_T0 :  std_logic_vector(20 downto 0);
   -- timing of FixRealKCM_Freq500_uid20_T0: (c0, 1.015000ns)
signal FixRealKCM_Freq500_uid20_T0_copy24 :  std_logic_vector(20 downto 0);
...
-- This operator multiplies by log(2)
   FixRealKCM_Freq500_uid20_A0 <= X(5 downto 0);-- input address  m=5  l=0
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 1.015000ns)Y: (c2, 0.411846ns)Cin: (c0, 0.215000ns)
--  approx. output signal timings: R: (c2, 0.991846ns)
...
entity IntAdder_27_Freq500_uid27 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_27_Freq500_uid27 is
signal Rtmp :  std_logic_vector(26 downto 0);
   -- timing of Rtmp: (c2, 0.991846ns)
...
--------------------------------------------------------------------------------
--                    Normalizer_Z_27_21_11_Freq500_uid29
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. input signal timings: X: (c2, 0.991846ns)
--  approx. output signal timings: Count: (c3, 0.656221ns)R: (c3, 0.871221ns)
...
entity Normalizer_Z_27_21_11_Freq500_uid29 is
    port (clk : in std_logic;
          X : in  std_logic_vector(26 downto 0);
...
architecture arch of Normalizer_Z_27_21_11_Freq500_uid29 is
signal level4 :  std_logic_vector(26 downto 0);
   -- timing of level4: (c2, 0.991846ns)
signal count3, count3_d1 :  std_logic;
   -- timing of count3: (c2, 1.210596ns)
signal level3, level3_d1 :  std_logic_vector(26 downto 0);
   -- timing of level3: (c2, 1.425596ns)
signal count2, count2_d1 :  std_logic;
   -- timing of count2: (c2, 1.642471ns)
signal level2 :  std_logic_vector(23 downto 0);
   -- timing of level2: (c3, 0.007471ns)
signal count1 :  std_logic;
   -- timing of count1: (c3, 0.224346ns)
signal level1 :  std_logic_vector(21 downto 0);
   -- timing of level1: (c3, 0.439346ns)
signal count0 :  std_logic;
   -- timing of count0: (c3, 0.656221ns)
signal level0 :  std_logic_vector(20 downto 0);
   -- timing of level0: (c3, 0.871221ns)
signal sCount :  std_logic_vector(3 downto 0);
   -- timing of sCount: (c3, 0.656221ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   level2<= level3_d1(26 downto 3) when count2_d1='0' else level3_d1(22 downto 0) & (0 downto 0 => '0');
...
--------------------------------------------------------------------------------
--                   RightShifter11_by_max_9_Freq500_uid31
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c1, 1.009846ns)S: (c1, 0.426000ns)
--  approx. output signal timings: R: (c2, 0.205231ns)
...
entity RightShifter11_by_max_9_Freq500_uid31 is
    port (clk : in std_logic;
...
architecture arch of RightShifter11_by_max_9_Freq500_uid31 is
signal ps, ps_d1 :  std_logic_vector(3 downto 0);
   -- timing of ps: (c1, 0.426000ns)
signal level0 :  std_logic_vector(10 downto 0);
   -- timing of level0: (c1, 1.009846ns)
signal level1 :  std_logic_vector(11 downto 0);
   -- timing of level1: (c1, 1.009846ns)
signal level2 :  std_logic_vector(13 downto 0);
   -- timing of level2: (c1, 1.440231ns)
signal level3, level3_d1 :  std_logic_vector(17 downto 0);
   -- timing of level3: (c1, 1.440231ns)
signal level4 :  std_logic_vector(25 downto 0);
   -- timing of level4: (c2, 0.205231ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.794846ns)Y: (c2, 0.205231ns)Cin: (c0, 0.215000ns)
--  approx. output signal timings: R: (c2, 0.744231ns)
...
entity IntAdder_17_Freq500_uid33 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_17_Freq500_uid33 is
signal Rtmp :  std_logic_vector(16 downto 0);
   -- timing of Rtmp: (c2, 0.744231ns)
signal X_d1 :  std_logic_vector(16 downto 0);
   -- timing of X: (c1, 0.794846ns)
signal Cin_d1, Cin_d2 :  std_logic;
   -- timing of Cin: (c0, 0.215000ns)
begin
   process(clk)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c3, 0.871221ns)Y: (c3, 0.871221ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c3, 1.410221ns)
...
entity IntAdder_17_Freq500_uid36 is
    port (clk : in std_logic;
          X : in  std_logic_vector(16 downto 0);
          Y : in  std_logic_vector(16 downto 0);
          Cin : in  std_logic;
...
architecture arch of IntAdder_17_Freq500_uid36 is
signal Rtmp :  std_logic_vector(16 downto 0);
   -- timing of Rtmp: (c3, 1.410221ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00294_fplog_top
--                 (FPLogIterative_6_11_14_500_Freq500_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00294_fplog_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(6+11+2 downto 0);
          R : out  std_logic_vector(6+11+2 downto 0)   );
end entity;

architecture arch of flopoco_00294_fplog_top is
   ...
   component LeftShifter7_by_max_7_Freq500_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(6 downto 0);
             S : in  std_logic_vector(2 downto 0);
             R : out  std_logic_vector(13 downto 0)   );
   ...
   component IntAdder_21_Freq500_uid18 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(20 downto 0);
             Y : in  std_logic_vector(20 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_27_Freq500_uid27 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(26 downto 0);
             Y : in  std_logic_vector(26 downto 0);
             Cin : in  std_logic;
   ...
   component Normalizer_Z_27_21_11_Freq500_uid29 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(26 downto 0);
             Count : out  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(20 downto 0)   );
   ...
   component RightShifter11_by_max_9_Freq500_uid31 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(10 downto 0);
             S : in  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(19 downto 0)   );
   ...
   component IntAdder_17_Freq500_uid33 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(16 downto 0);
             Y : in  std_logic_vector(16 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_17_Freq500_uid36 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(16 downto 0);
             Y : in  std_logic_vector(16 downto 0);
             Cin : in  std_logic;
...
signal small_absZ0_normd_full :  std_logic_vector(13 downto 0);
   -- timing of small_absZ0_normd_full: (c1, 0.794846ns)
signal small_absZ0_normd :  std_logic_vector(6 downto 0);
   -- timing of small_absZ0_normd: (c1, 0.794846ns)
...
signal adderLogF_normalY :  std_logic_vector(20 downto 0);
   -- timing of adderLogF_normalY: (c1, 1.722846ns)
signal LogF_normal :  std_logic_vector(20 downto 0);
   -- timing of LogF_normal: (c2, 0.411846ns)
...
signal E_small, E_small_d1 :  std_logic_vector(5 downto 0);
   -- timing of E_small: (c2, 0.744231ns)
signal Log_small_normd, Log_small_normd_d1 :  std_logic_vector(14 downto 0);
   -- timing of Log_small_normd: (c2, 0.744231ns)
...
begin
   ...
   small_lshift: LeftShifter7_by_max_7_Freq500_uid6
      port map ( clk  => clk,
                 S => shiftvalinL,
                 X => absZ0,
   ...
   Z1 <= P0(13 downto 0);
   Zfinal <= Z1;
   squarerIn <= Zfinal_d1(sfinal-1 downto sfinal-11) when doRR='1'
   ...
   addFinalLog1p_normalAdder: IntAdder_14_Freq500_uid12
      port map ( clk  => clk,
                 Cin => '1',
                 X => Zfinal,
                 Y => addFinalLog1pY,
   ...
   adderLogF_normal: IntAdder_21_Freq500_uid18
      port map ( clk  => clk,
                 Cin => '0',
                 X => almostLog,
                 Y => adderLogF_normalY,
   ...
   lnadder: IntAdder_27_Freq500_uid27
      port map ( clk  => clk,
                 Cin => sR,
                 X => lnaddX,
                 Y => lnaddY,
                 R => Log_normal);
   final_norm: Normalizer_Z_27_21_11_Freq500_uid29
      port map ( clk  => clk,
                 X => Log_normal,
                 Count => E_normal,
                 R => Log_normal_normd);
   Z2o2_small_bs <= Z2o2_full_dummy(21 downto 11);
   ao_rshift: RightShifter11_by_max_9_Freq500_uid31
      port map ( clk  => clk,
                 S => shiftvalinR,
                 X => Z2o2_small_bs,
                 R => Z2o2_small_s);
   ...
   nsRCin <= not ( sR );
   log_small_adder: IntAdder_17_Freq500_uid33
      port map ( clk  => clk,
                 Cin => nsRCin,
                 X => Z_small,
                 Y => Log_smallY,
   ...
   finalRoundAdder: IntAdder_17_Freq500_uid36
      port map ( clk  => clk,
                 Cin => '0',
                 X => fraX,
                 Y => fraY,
