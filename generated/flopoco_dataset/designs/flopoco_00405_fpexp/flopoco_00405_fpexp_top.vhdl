...
entity IntAdder_10_Freq250_uid18 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_10_Freq250_uid18 is
...
architecture arch of FixRealKCM_Freq250_uid8 is
   ...
   component IntAdder_10_Freq250_uid18 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(9 downto 0);
             Y : in  std_logic_vector(9 downto 0);
             Cin : in  std_logic;
...
signal FixRealKCM_Freq250_uid8_A0 :  std_logic_vector(5 downto 0);
   -- timing of FixRealKCM_Freq250_uid8_A0: (c0, 1.732769ns)
signal FixRealKCM_Freq250_uid8_T0 :  std_logic_vector(9 downto 0);
   -- timing of FixRealKCM_Freq250_uid8_T0: (c0, 2.060769ns)
signal FixRealKCM_Freq250_uid8_T0_copy12 :  std_logic_vector(9 downto 0);
   -- timing of FixRealKCM_Freq250_uid8_T0_copy12: (c0, 1.732769ns)
...
signal FixRealKCM_Freq250_uid8_A1 :  std_logic_vector(1 downto 0);
   -- timing of FixRealKCM_Freq250_uid8_A1: (c0, 1.732769ns)
signal FixRealKCM_Freq250_uid8_T1 :  std_logic_vector(3 downto 0);
   -- timing of FixRealKCM_Freq250_uid8_T1: (c0, 1.947769ns)
signal FixRealKCM_Freq250_uid8_T1_copy15 :  std_logic_vector(3 downto 0);
   -- timing of FixRealKCM_Freq250_uid8_T1_copy15: (c0, 1.732769ns)
...
-- This operator multiplies by 1/log(2)
   FixRealKCM_Freq250_uid8_A0 <= X(7 downto 2);-- input address  m=4  l=-1
   ...
   FixRealKCM_Freq250_uid8_A1 <= X(1 downto 0);-- input address  m=-2  l=-3
   ...
   bitheapFinalAdd_bh9: IntAdder_10_Freq250_uid18
      port map ( clk  => clk,
...
signal FixRealKCM_Freq250_uid20_A0 :  std_logic_vector(5 downto 0);
   -- timing of FixRealKCM_Freq250_uid20_A0: (c0, 2.558769ns)
signal FixRealKCM_Freq250_uid20_T0 :  std_logic_vector(16 downto 0);
   -- timing of FixRealKCM_Freq250_uid20_T0: (c0, 2.886769ns)
signal FixRealKCM_Freq250_uid20_T0_copy24 :  std_logic_vector(16 downto 0);
   -- timing of FixRealKCM_Freq250_uid20_T0_copy24: (c0, 2.558769ns)
...
-- This operator multiplies by log(2)
   FixRealKCM_Freq250_uid20_A0 <= X(5 downto 0);-- input address  m=5  l=0
...
entity IntAdder_11_Freq250_uid28 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_11_Freq250_uid28 is
...
--------------------------------------------------------------------------------
--                      FixFunctionByTable_Freq250_uid30
...
--  approx. output signal timings: Y: (c2, 0.716019ns)
...
entity FixFunctionByTable_Freq250_uid30 is
    port (clk : in std_logic;
          X : in  std_logic_vector(10 downto 0);
          Y : out  std_logic_vector(13 downto 0)   );
end entity;

architecture arch of FixFunctionByTable_Freq250_uid30 is
signal Y0, Y0_d1 :  std_logic_vector(13 downto 0);
   -- timing of Y0: (c1, 0.534769ns)
signal Y1 :  std_logic_vector(13 downto 0);
   -- timing of Y1: (c2, 0.716019ns)
signal X_d1 :  std_logic_vector(10 downto 0);
   -- timing of X: (c0, 3.384769ns)
begin
   process(clk)
      begin
...
--  approx. output signal timings: expY: (c2, 0.716019ns)K: (c0, 3.030769ns)
...
entity Exp_6_11_Freq250_uid6 is
    port (clk : in std_logic;
...
architecture arch of Exp_6_11_Freq250_uid6 is
   ...
   component IntAdder_11_Freq250_uid28 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(10 downto 0);
             Y : in  std_logic_vector(10 downto 0);
             Cin : in  std_logic;
   ...
   component FixFunctionByTable_Freq250_uid30 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(10 downto 0);
             Y : out  std_logic_vector(13 downto 0)   );
   end component;
...
ufixX <= unsigned(ufixX_i);
   ...
   theYAdder: IntAdder_11_Freq250_uid28
      port map ( clk  => clk,
                 Cin => '1',
                 X => subOp1,
                 Y => subOp2,
   ...
   ExpYTable: FixFunctionByTable_Freq250_uid30
      port map ( clk  => clk,
                 X => Y,
                 Y => expY);
end architecture;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c2, 0.931019ns)Y: (c2, 0.716019ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c2, 1.470019ns)
...
entity IntAdder_19_Freq250_uid33 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_19_Freq250_uid33 is
signal Rtmp :  std_logic_vector(18 downto 0);
   -- timing of Rtmp: (c2, 1.470019ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00405_fpexp_top
--                         (FPExp_6_11_Freq250_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: F. de Dinechin, Bogdan Pasca, Orégane Desrentes (2008-2025)
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.000000ns)
--  approx. output signal timings: R: (c2, 1.685019ns)
...
entity flopoco_00405_fpexp_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(6+17+2 downto 0);
          R : out  std_logic_vector(6+11+2 downto 0)   );
end entity;

architecture arch of flopoco_00405_fpexp_top is
   ...
   component Exp_6_11_Freq250_uid6 is
      port ( clk : in std_logic;
             ufixX_i : in  std_logic_vector(15 downto 0);
             XSign : in  std_logic;
             expY : out  std_logic_vector(13 downto 0);
   ...
   component IntAdder_19_Freq250_uid33 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(18 downto 0);
             Y : in  std_logic_vector(18 downto 0);
             Cin : in  std_logic;
...
signal ufl :  std_logic;
   -- timing of ufl: (c2, 1.685019ns)
signal Rexn :  std_logic_vector(1 downto 0);
   -- timing of Rexn: (c2, 1.685019ns)
constant g: positive := 0;
constant wE: positive := 6;
constant wF: positive := 11;
...
begin
   ...
   exp_helper: Exp_6_11_Freq250_uid6
      port map ( clk  => clk,
                 XSign => XSign,
   ...
   roundedExpSigOperandAdder: IntAdder_19_Freq250_uid33
      port map ( clk  => clk,
                 Cin => '0',
                 X => preRoundBiasSig,
                 Y => roundNormAddend,
