...
--------------------------------------------------------------------------------
--                          flopoco_00492_fpdiv_top
--                         (FPDiv_5_10_Freq500_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c5, 1.665010ns)
...
entity flopoco_00492_fpdiv_top is
...
architecture arch of flopoco_00492_fpdiv_top is
...
signal expR0, expR0_d1, expR0_d2, expR0_d3, expR0_d4, expR0_d5 :  std_logic_vector(6 downto 0);
...
signal prescaledfY, prescaledfY_d1, prescaledfY_d2, prescaledfY_d3, prescaledfY_d4 :  std_logic_vector(12 downto 0);
...
begin
   ...
   sel4 <= w4(15 downto 11) & prescaledfY_d1(10 downto 9);
   ...
   sel3 <= w3(15 downto 11) & prescaledfY_d2(10 downto 9);
   ...
   sel2 <= w2(15 downto 11) & prescaledfY_d3(10 downto 9);
   ...
   sel1 <= w1(15 downto 11) & prescaledfY_d4(10 downto 9);
   ...
   round <= fRnorm(0); 
   expR1 <= expR0_d5 + ("000" & (3 downto 1 => '1') & mR(12)); -- add back bias
   -- final rounding
   ...
   R <= exnRfinal & sR_d5 & expfracR(14 downto 0);
end architecture;
