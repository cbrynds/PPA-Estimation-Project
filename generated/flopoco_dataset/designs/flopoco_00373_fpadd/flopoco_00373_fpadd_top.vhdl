--------------------------------------------------------------------------------
--                RightShifterSticky11_by_max_13_Freq250_uid4
...
entity RightShifterSticky11_by_max_13_Freq250_uid4 is
...
architecture arch of RightShifterSticky11_by_max_13_Freq250_uid4 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_15_15_15_Freq250_uid8
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Count: (c1, 0.606625ns)R: (c1, 0.821625ns)
...
entity Normalizer_Z_15_15_15_Freq250_uid8 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_15_15_15_Freq250_uid8 is
...
signal count1 :  std_logic;
   -- timing of count1: (c1, 0.174750ns)
signal level1 :  std_logic_vector(14 downto 0);
   -- timing of level1: (c1, 0.389750ns)
signal count0 :  std_logic;
   -- timing of count0: (c1, 0.606625ns)
signal level0 :  std_logic_vector(14 downto 0);
   -- timing of level0: (c1, 0.821625ns)
signal sCount :  std_logic_vector(3 downto 0);
   -- timing of sCount: (c1, 0.606625ns)
begin
   process(clk)
      begin
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 1.078625ns)Y: (c0, 0.000000ns)Cin: (c1, 1.036625ns)
--  approx. output signal timings: R: (c1, 1.617625ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00373_fpadd_top
--                         (FPAdd_5_10_Freq250_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 2.047625ns)
...
entity flopoco_00373_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00373_fpadd_top is
   component RightShifterSticky11_by_max_13_Freq250_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(10 downto 0);
             S : in  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(12 downto 0);
   ...
   component Normalizer_Z_15_15_15_Freq250_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(14 downto 0);
             Count : out  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(14 downto 0)   );
...
signal nZerosNew :  std_logic_vector(3 downto 0);
   -- timing of nZerosNew: (c1, 0.606625ns)
signal shiftedFrac :  std_logic_vector(14 downto 0);
   -- timing of shiftedFrac: (c1, 0.821625ns)
...
signal updatedExp :  std_logic_vector(6 downto 0);
   -- timing of updatedExp: (c1, 1.078625ns)
signal eqdiffsign :  std_logic;
   -- timing of eqdiffsign: (c1, 0.606625ns)
signal expFrac :  std_logic_vector(17 downto 0);
   -- timing of expFrac: (c1, 1.078625ns)
signal stk :  std_logic;
   -- timing of stk: (c1, 0.821625ns)
signal rnd :  std_logic;
   -- timing of rnd: (c1, 0.821625ns)
signal lsb :  std_logic;
   -- timing of lsb: (c1, 0.821625ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c1, 1.036625ns)
signal RoundedExpFrac :  std_logic_vector(17 downto 0);
   -- timing of RoundedExpFrac: (c1, 1.617625ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c1, 1.617625ns)
signal fracR :  std_logic_vector(9 downto 0);
   -- timing of fracR: (c1, 1.617625ns)
signal expR :  std_logic_vector(4 downto 0);
   -- timing of expR: (c1, 1.617625ns)
signal exExpExc :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c1, 1.617625ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c1, 1.832625ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c1, 2.047625ns)
signal signR2 :  std_logic;
   -- timing of signR2: (c1, 0.821625ns)
signal computedR :  std_logic_vector(17 downto 0);
   -- timing of computedR: (c1, 2.047625ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   RightShifterComponent: RightShifterSticky11_by_max_13_Freq250_uid4
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracY,
                 R => shiftedFracY,
   ...
   LZCAndShifter: Normalizer_Z_15_15_15_Freq250_uid8
      port map ( clk  => clk,
                 X => fracSticky,
                 Count => nZerosNew,
                 R => shiftedFrac);
