...
--------------------------------------------------------------------------------
--                    LeftShifter18_by_max_15_Freq250_uid4
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity LeftShifter18_by_max_15_Freq250_uid4 is
...
architecture arch of LeftShifter18_by_max_15_Freq250_uid4 is
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 2.086769ns)Y: (c0, 2.086769ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c0, 2.584769ns)
...
signal FixRealKCM_Freq250_uid8_A0 :  std_logic_vector(5 downto 0);
   -- timing of FixRealKCM_Freq250_uid8_A0: (c0, 1.758769ns)
signal FixRealKCM_Freq250_uid8_T0 :  std_logic_vector(11 downto 0);
   -- timing of FixRealKCM_Freq250_uid8_T0: (c0, 2.086769ns)
signal FixRealKCM_Freq250_uid8_T0_copy12 :  std_logic_vector(11 downto 0);
   -- timing of FixRealKCM_Freq250_uid8_T0_copy12: (c0, 1.758769ns)
signal bh9_w0_0 :  std_logic;
   -- timing of bh9_w0_0: (c0, 2.086769ns)
signal bh9_w1_0 :  std_logic;
   -- timing of bh9_w1_0: (c0, 2.086769ns)
signal bh9_w2_0 :  std_logic;
   -- timing of bh9_w2_0: (c0, 2.086769ns)
signal bh9_w3_0 :  std_logic;
   -- timing of bh9_w3_0: (c0, 2.086769ns)
signal bh9_w4_0 :  std_logic;
   -- timing of bh9_w4_0: (c0, 2.086769ns)
signal bh9_w5_0 :  std_logic;
   -- timing of bh9_w5_0: (c0, 2.086769ns)
signal bh9_w6_0 :  std_logic;
   -- timing of bh9_w6_0: (c0, 2.086769ns)
signal bh9_w7_0 :  std_logic;
   -- timing of bh9_w7_0: (c0, 2.086769ns)
signal bh9_w8_0 :  std_logic;
   -- timing of bh9_w8_0: (c0, 2.086769ns)
signal bh9_w9_0 :  std_logic;
   -- timing of bh9_w9_0: (c0, 2.086769ns)
signal bh9_w10_0 :  std_logic;
   -- timing of bh9_w10_0: (c0, 2.086769ns)
signal bh9_w11_0 :  std_logic;
   -- timing of bh9_w11_0: (c0, 2.086769ns)
signal FixRealKCM_Freq250_uid8_A1 :  std_logic_vector(3 downto 0);
   -- timing of FixRealKCM_Freq250_uid8_A1: (c0, 1.758769ns)
signal FixRealKCM_Freq250_uid8_T1 :  std_logic_vector(5 downto 0);
   -- timing of FixRealKCM_Freq250_uid8_T1: (c0, 1.973769ns)
signal FixRealKCM_Freq250_uid8_T1_copy15 :  std_logic_vector(5 downto 0);
   -- timing of FixRealKCM_Freq250_uid8_T1_copy15: (c0, 1.758769ns)
signal bh9_w0_1 :  std_logic;
   -- timing of bh9_w0_1: (c0, 1.973769ns)
signal bh9_w1_1 :  std_logic;
   -- timing of bh9_w1_1: (c0, 1.973769ns)
signal bh9_w2_1 :  std_logic;
   -- timing of bh9_w2_1: (c0, 1.973769ns)
signal bh9_w3_1 :  std_logic;
   -- timing of bh9_w3_1: (c0, 1.973769ns)
signal bh9_w4_1 :  std_logic;
   -- timing of bh9_w4_1: (c0, 1.973769ns)
signal bh9_w5_1 :  std_logic;
   -- timing of bh9_w5_1: (c0, 1.973769ns)
signal bitheapFinalAdd_bh9_In0 :  std_logic_vector(11 downto 0);
   -- timing of bitheapFinalAdd_bh9_In0: (c0, 2.086769ns)
signal bitheapFinalAdd_bh9_In1 :  std_logic_vector(11 downto 0);
   -- timing of bitheapFinalAdd_bh9_In1: (c0, 2.086769ns)
...
signal bitheapFinalAdd_bh9_Out :  std_logic_vector(11 downto 0);
   -- timing of bitheapFinalAdd_bh9_Out: (c0, 2.584769ns)
signal bitheapResult_bh9 :  std_logic_vector(11 downto 0);
   -- timing of bitheapResult_bh9: (c0, 2.584769ns)
signal OutRes :  std_logic_vector(11 downto 0);
   -- timing of OutRes: (c0, 2.584769ns)
begin
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 2.912769ns)Y: (c0, 2.799769ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c0, 3.451769ns)
...
-- Input signals: X
-- Output signals: R
--  approx. input signal timings: X: (c0, 2.584769ns)
--  approx. output signal timings: R: (c0, 3.451769ns)
...
signal FixRealKCM_Freq250_uid20_A0 :  std_logic_vector(5 downto 0);
   -- timing of FixRealKCM_Freq250_uid20_A0: (c0, 2.584769ns)
signal FixRealKCM_Freq250_uid20_T0 :  std_logic_vector(16 downto 0);
   -- timing of FixRealKCM_Freq250_uid20_T0: (c0, 2.912769ns)
signal FixRealKCM_Freq250_uid20_T0_copy24 :  std_logic_vector(16 downto 0);
   -- timing of FixRealKCM_Freq250_uid20_T0_copy24: (c0, 2.584769ns)
signal bh21_w0_0 :  std_logic;
   -- timing of bh21_w0_0: (c0, 2.912769ns)
signal bh21_w1_0 :  std_logic;
   -- timing of bh21_w1_0: (c0, 2.912769ns)
signal bh21_w2_0 :  std_logic;
   -- timing of bh21_w2_0: (c0, 2.912769ns)
signal bh21_w3_0 :  std_logic;
   -- timing of bh21_w3_0: (c0, 2.912769ns)
signal bh21_w4_0 :  std_logic;
   -- timing of bh21_w4_0: (c0, 2.912769ns)
signal bh21_w5_0 :  std_logic;
   -- timing of bh21_w5_0: (c0, 2.912769ns)
signal bh21_w6_0 :  std_logic;
   -- timing of bh21_w6_0: (c0, 2.912769ns)
signal bh21_w7_0 :  std_logic;
   -- timing of bh21_w7_0: (c0, 2.912769ns)
signal bh21_w8_0 :  std_logic;
   -- timing of bh21_w8_0: (c0, 2.912769ns)
signal bh21_w9_0 :  std_logic;
   -- timing of bh21_w9_0: (c0, 2.912769ns)
signal bh21_w10_0 :  std_logic;
   -- timing of bh21_w10_0: (c0, 2.912769ns)
signal bh21_w11_0 :  std_logic;
   -- timing of bh21_w11_0: (c0, 2.912769ns)
signal bh21_w12_0 :  std_logic;
   -- timing of bh21_w12_0: (c0, 2.912769ns)
signal bh21_w13_0 :  std_logic;
   -- timing of bh21_w13_0: (c0, 2.912769ns)
signal bh21_w14_0 :  std_logic;
   -- timing of bh21_w14_0: (c0, 2.912769ns)
signal bh21_w15_0 :  std_logic;
   -- timing of bh21_w15_0: (c0, 2.912769ns)
signal bh21_w16_0 :  std_logic;
   -- timing of bh21_w16_0: (c0, 2.912769ns)
signal FixRealKCM_Freq250_uid20_A1 :  std_logic_vector(1 downto 0);
   -- timing of FixRealKCM_Freq250_uid20_A1: (c0, 2.584769ns)
signal FixRealKCM_Freq250_uid20_T1 :  std_logic_vector(10 downto 0);
   -- timing of FixRealKCM_Freq250_uid20_T1: (c0, 2.799769ns)
signal FixRealKCM_Freq250_uid20_T1_copy27 :  std_logic_vector(10 downto 0);
   -- timing of FixRealKCM_Freq250_uid20_T1_copy27: (c0, 2.584769ns)
signal bh21_w0_1 :  std_logic;
   -- timing of bh21_w0_1: (c0, 2.799769ns)
signal bh21_w1_1 :  std_logic;
   -- timing of bh21_w1_1: (c0, 2.799769ns)
signal bh21_w2_1 :  std_logic;
   -- timing of bh21_w2_1: (c0, 2.799769ns)
signal bh21_w3_1 :  std_logic;
   -- timing of bh21_w3_1: (c0, 2.799769ns)
signal bh21_w4_1 :  std_logic;
   -- timing of bh21_w4_1: (c0, 2.799769ns)
signal bh21_w5_1 :  std_logic;
   -- timing of bh21_w5_1: (c0, 2.799769ns)
signal bh21_w6_1 :  std_logic;
   -- timing of bh21_w6_1: (c0, 2.799769ns)
signal bh21_w7_1 :  std_logic;
   -- timing of bh21_w7_1: (c0, 2.799769ns)
signal bh21_w8_1 :  std_logic;
   -- timing of bh21_w8_1: (c0, 2.799769ns)
signal bh21_w9_1 :  std_logic;
   -- timing of bh21_w9_1: (c0, 2.799769ns)
signal bh21_w10_1 :  std_logic;
   -- timing of bh21_w10_1: (c0, 2.799769ns)
signal bitheapFinalAdd_bh21_In0 :  std_logic_vector(16 downto 0);
   -- timing of bitheapFinalAdd_bh21_In0: (c0, 2.912769ns)
signal bitheapFinalAdd_bh21_In1 :  std_logic_vector(16 downto 0);
   -- timing of bitheapFinalAdd_bh21_In1: (c0, 2.799769ns)
...
signal bitheapFinalAdd_bh21_Out :  std_logic_vector(16 downto 0);
   -- timing of bitheapFinalAdd_bh21_Out: (c0, 3.451769ns)
signal bitheapResult_bh21 :  std_logic_vector(16 downto 0);
   -- timing of bitheapResult_bh21: (c0, 3.451769ns)
signal OutRes :  std_logic_vector(16 downto 0);
   -- timing of OutRes: (c0, 3.451769ns)
begin
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 1.973769ns)Y: (c0, 3.451769ns)Cin: (c0, 0.000000ns)
--  approx. output signal timings: R: (c1, 0.099769ns)
...
signal Rtmp :  std_logic_vector(8 downto 0);
   -- timing of Rtmp: (c1, 0.099769ns)
signal X_d1 :  std_logic_vector(8 downto 0);
   -- timing of X: (c0, 1.973769ns)
signal Y_d1 :  std_logic_vector(8 downto 0);
   -- timing of Y: (c0, 3.451769ns)
...
--  approx. output signal timings: expY: (c0, 0.000000ns)K: (c0, 3.082769ns)
...
signal absK :  std_logic_vector(7 downto 0);
   -- timing of absK: (c0, 2.584769ns)
signal minusAbsK :  std_logic_vector(8 downto 0);
   -- timing of minusAbsK: (c0, 3.082769ns)
signal absKLog2 :  std_logic_vector(16 downto 0);
   -- timing of absKLog2: (c0, 3.451769ns)
signal subOp1 :  std_logic_vector(8 downto 0);
   -- timing of subOp1: (c0, 1.973769ns)
signal subOp2 :  std_logic_vector(8 downto 0);
   -- timing of subOp2: (c0, 3.451769ns)
signal Y :  std_logic_vector(8 downto 0);
   -- timing of Y: (c1, 0.099769ns)
...
entity flopoco_00457_fpexp_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+17+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00457_fpexp_top is
   component LeftShifter18_by_max_15_Freq250_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(17 downto 0);
             S : in  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(32 downto 0)   );
...
begin
   ...
   mantissa_shift: LeftShifter18_by_max_15_Freq250_uid4
      port map ( clk  => clk,
                 S => shiftValIn,
