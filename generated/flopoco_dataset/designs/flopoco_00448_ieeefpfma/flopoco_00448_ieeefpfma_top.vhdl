--------------------------------------------------------------------------------
--                   RightShifter24_by_max_76_Freq150_uid4
...
--  approx. output signal timings: R: (c0, 2.998846ns)
...
entity RightShifter24_by_max_76_Freq150_uid4 is
...
architecture arch of RightShifter24_by_max_76_Freq150_uid4 is
...
signal level2 :  std_logic_vector(26 downto 0);
   -- timing of level2: (c0, 0.630385ns)
signal level3 :  std_logic_vector(30 downto 0);
   -- timing of level3: (c0, 0.630385ns)
signal level4 :  std_logic_vector(38 downto 0);
   -- timing of level4: (c0, 1.445385ns)
signal level5 :  std_logic_vector(54 downto 0);
   -- timing of level5: (c0, 1.445385ns)
signal level6 :  std_logic_vector(86 downto 0);
   -- timing of level6: (c0, 2.998846ns)
signal level7 :  std_logic_vector(150 downto 0);
   -- timing of level7: (c0, 2.998846ns)
begin
   ps<= S;
   level0<= X;
...
-- Input signals: I
-- Output signals: O
--  approx. input signal timings: I: (c0, 2.998846ns)
--  approx. output signal timings: O: (c0, 4.956346ns)
...
entity LZC_52_Freq150_uid6 is
    port (clk : in std_logic;
          I : in  std_logic_vector(51 downto 0);
          O : out  std_logic_vector(5 downto 0)   );
end entity;

architecture arch of LZC_52_Freq150_uid6 is
signal level6 :  std_logic_vector(62 downto 0);
   -- timing of level6: (c0, 2.998846ns)
signal digit5 :  std_logic;
   -- timing of digit5: (c0, 3.225096ns)
signal level5 :  std_logic_vector(30 downto 0);
   -- timing of level5: (c0, 3.440096ns)
signal digit4 :  std_logic;
   -- timing of digit4: (c0, 3.660721ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c0, 3.875721ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c0, 4.094471ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c0, 4.309471ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c0, 4.526346ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c0, 4.741346ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c0, 4.956346ns)
signal outHighBits :  std_logic_vector(3 downto 0);
   -- timing of outHighBits: (c0, 4.526346ns)
begin
...
--------------------------------------------------------------------------------
--                    LeftShifter76_by_max_75_Freq150_uid8
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c0, 2.998846ns)S: (c0, 4.956346ns)
--  approx. output signal timings: R: (c1, 3.838526ns)
...
entity LeftShifter76_by_max_75_Freq150_uid8 is
    port (clk : in std_logic;
...
--------------------------------------------------------------------------------
--                        flopoco_00448_ieeefpfma_top
--                       (IEEEFPFMA_8_23_Freq150_uid2)
...
entity flopoco_00448_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00448_ieeefpfma_top is
   component RightShifter24_by_max_76_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(23 downto 0);
             S : in  std_logic_vector(6 downto 0);
             R : out  std_logic_vector(99 downto 0)   );
   ...
   component LZC_52_Freq150_uid6 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(51 downto 0);
             O : out  std_logic_vector(5 downto 0)   );
   end component;

   component LeftShifter76_by_max_75_Freq150_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(75 downto 0);
             S : in  std_logic_vector(6 downto 0);
             R : out  std_logic_vector(150 downto 0)   );
...
signal CsigShifted :  std_logic_vector(99 downto 0);
   -- timing of CsigShifted: (c0, 2.998846ns)
signal sticky1, sticky1_d1 :  std_logic;
   -- timing of sticky1: (c0, 2.998846ns)
signal CsigShiftedT :  std_logic_vector(75 downto 0);
   -- timing of CsigShiftedT: (c0, 2.998846ns)
...
signal tmpExpCompRes2 :  std_logic_vector(9 downto 0);
   -- timing of tmpExpCompRes2: (c0, 4.956346ns)
signal RisSubNormal, RisSubNormal_d1 :  std_logic;
   -- timing of RisSubNormal: (c0, 4.956346ns)
signal RisZero, RisZero_d1 :  std_logic;
   -- timing of RisZero: (c0, 4.956346ns)
signal RisSubNormalOrZero :  std_logic;
   -- timing of RisSubNormalOrZero: (c0, 4.956346ns)
signal Rsgn, Rsgn_d1 :  std_logic;
   -- timing of Rsgn: (c0, 4.956346ns)
...
signal normShiftValue :  std_logic_vector(6 downto 0);
   -- timing of normShiftValue: (c0, 4.956346ns)
signal BigSumNormd :  std_logic_vector(150 downto 0);
   -- timing of BigSumNormd: (c1, 3.838526ns)
signal expTentative, expTentative_d1 :  std_logic_vector(9 downto 0);
   -- timing of expTentative: (c0, 4.956346ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c1, 3.838526ns)
signal fracTentative :  std_logic_vector(26 downto 0);
   -- timing of fracTentative: (c1, 3.838526ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c1, 3.838526ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c1, 3.838526ns)
signal fracResultNormd :  std_logic_vector(22 downto 0);
   -- timing of fracResultNormd: (c1, 3.838526ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c1, 3.838526ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c1, 3.838526ns)
signal round :  std_logic;
   -- timing of round: (c1, 3.838526ns)
signal expUpdate :  std_logic_vector(9 downto 0);
   -- timing of expUpdate: (c1, 3.838526ns)
signal exponentResult1 :  std_logic_vector(9 downto 0);
   -- timing of exponentResult1: (c1, 3.838526ns)
signal resultBeforeRound :  std_logic_vector(32 downto 0);
   -- timing of resultBeforeRound: (c1, 3.838526ns)
signal resultRounded :  std_logic_vector(32 downto 0);
   -- timing of resultRounded: (c1, 3.838526ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c1, 3.838526ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c1, 3.838526ns)
...
begin
   ...
   RightShifterComponent: RightShifter24_by_max_76_Freq150_uid4
      port map ( clk  => clk,
                 S => ShiftValue,
                 X => Csig,
                 R => CsigShifted);
   ...
   IEEEFPFMA_8_23_Freq150_uid2LeadingZeroCounter: LZC_52_Freq150_uid6
      port map ( clk  => clk,
   ...
   NormalizationShifter: LeftShifter76_by_max_75_Freq150_uid8
      port map ( clk  => clk,
                 S => normShiftValue,
                 X => BigSumAbs,
                 R => BigSumNormd);
