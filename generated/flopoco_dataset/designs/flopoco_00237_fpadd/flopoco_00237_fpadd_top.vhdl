...
entity IntDualSub_13_Freq150_uid4 is
...
architecture arch of IntDualSub_13_Freq150_uid4 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_12_12_12_Freq150_uid6
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity Normalizer_Z_12_12_12_Freq150_uid6 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_12_12_12_Freq150_uid6 is
...
--------------------------------------------------------------------------------
--                RightShifterSticky11_by_max_13_Freq150_uid8
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity RightShifterSticky11_by_max_13_Freq150_uid8 is
    port (clk : in std_logic;
...
architecture arch of RightShifterSticky11_by_max_13_Freq150_uid8 is
...
entity IntAdder_14_Freq150_uid10 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_14_Freq150_uid10 is
...
entity IntAdder_17_Freq150_uid13 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_17_Freq150_uid13 is
...
--------------------------------------------------------------------------------
--                          flopoco_00237_fpadd_top
--                         (FPSub_5_10_Freq150_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00237_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00237_fpadd_top is
   component IntDualSub_13_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(12 downto 0);
             Y : in  std_logic_vector(12 downto 0);
             XmY : out  std_logic_vector(12 downto 0);
   ...
   component Normalizer_Z_12_12_12_Freq150_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(11 downto 0);
             Count : out  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(11 downto 0)   );
   ...
   component RightShifterSticky11_by_max_13_Freq150_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(10 downto 0);
             S : in  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(12 downto 0);
   ...
   component IntAdder_14_Freq150_uid10 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(13 downto 0);
             Y : in  std_logic_vector(13 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_17_Freq150_uid13 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(16 downto 0);
             Y : in  std_logic_vector(16 downto 0);
             Cin : in  std_logic;
...
-- Close Path --
   ...
   FPSub_5_10_Freq150_uid2_DualSubClose: IntDualSub_13_Freq150_uid4
      port map ( clk  => clk,
                 X => fracXClose1,
                 Y => fracYClose1,
                 XmY => fracRClosexMy,
   ...
   norm: Normalizer_Z_12_12_12_Freq150_uid6
      port map ( clk  => clk,
                 X => fracRClose1,
                 Count => nZerosNew,
                 R => shiftedFrac);
...
-- Far Path --
   ...
   RightShifterComponent: RightShifterSticky11_by_max_13_Freq150_uid8
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracNewY,
                 R => shiftedFracY,
   ...
   -- far path adder
   FPSub_5_10_Freq150_uid2_fracAddFar: IntAdder_14_Freq150_uid10
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
...
-- Synchronization of both paths --
   ...
   -- final round adder
   FPSub_5_10_Freq150_uid2_finalRoundAdd: IntAdder_17_Freq150_uid13
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
                 Y => "00000000000000000",
