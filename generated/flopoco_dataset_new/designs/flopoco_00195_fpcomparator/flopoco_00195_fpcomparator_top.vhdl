--------------------------------------------------------------------------------
--                     IntComparator_17_111_Freq500_uid4
...
--  approx. output signal timings: XltY: (c0, 0.498000ns)XeqY: (c0, 0.472000ns)XgtY: (c0, 0.498000ns)
...
entity IntComparator_17_111_Freq500_uid4 is
...
architecture arch of IntComparator_17_111_Freq500_uid4 is
signal XltYi :  std_logic;
   -- timing of XltYi: (c0, 0.498000ns)
signal XeqYi :  std_logic;
   -- timing of XeqYi: (c0, 0.472000ns)
signal XgtYi :  std_logic;
   -- timing of XgtYi: (c0, 0.498000ns)
begin
...
--------------------------------------------------------------------------------
--                       flopoco_00195_fpcomparator_top
--                      (FPComparator_6_11_Freq500_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin (2021)
...
--  approx. input signal timings: X: (c0, 0.000000ns)Y: (c0, 0.000000ns)
--  approx. output signal timings: unordered: (c0, 0.000000ns)XltY: (c0, 0.713000ns)XeqY: (c0, 0.687000ns)XgtY: (c0, 0.713000ns)XleY: (c0, 0.713000ns)XgeY: (c0, 0.713000ns)
...
entity flopoco_00195_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00195_fpcomparator_top is
   component IntComparator_17_111_Freq500_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(16 downto 0);
             Y : in  std_logic_vector(16 downto 0);
             XltY : out  std_logic;
...
signal ExpFracX :  std_logic_vector(16 downto 0);
   -- timing of ExpFracX: (c0, 0.000000ns)
signal ExpFracY :  std_logic_vector(16 downto 0);
...
signal ExpFracXeqExpFracY :  std_logic;
   -- timing of ExpFracXeqExpFracY: (c0, 0.472000ns)
signal ExpFracXltExpFracY :  std_logic;
   -- timing of ExpFracXltExpFracY: (c0, 0.498000ns)
signal ExpFracXgtExpFracY :  std_logic;
   -- timing of ExpFracXgtExpFracY: (c0, 0.498000ns)
signal sameSign :  std_logic;
   -- timing of sameSign: (c0, 0.000000ns)
signal XeqYNum :  std_logic;
   -- timing of XeqYNum: (c0, 0.687000ns)
signal XltYNum :  std_logic;
   -- timing of XltYNum: (c0, 0.713000ns)
signal XgtYNum :  std_logic;
   -- timing of XgtYNum: (c0, 0.713000ns)
signal unorderedR :  std_logic;
   -- timing of unorderedR: (c0, 0.000000ns)
signal XltYR :  std_logic;
   -- timing of XltYR: (c0, 0.713000ns)
signal XeqYR :  std_logic;
   -- timing of XeqYR: (c0, 0.687000ns)
signal XgtYR :  std_logic;
   -- timing of XgtYR: (c0, 0.713000ns)
signal XleYR :  std_logic;
   -- timing of XleYR: (c0, 0.713000ns)
signal XgeYR :  std_logic;
   -- timing of XgeYR: (c0, 0.713000ns)
begin
   excX <= X(19 downto 18);
   excY <= Y(19 downto 18);
   signX <= X(17);
   signY <= Y(17);
   ExpFracX <= X(16 downto 0);
   ExpFracY <= Y(16 downto 0);
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_17_111_Freq500_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
