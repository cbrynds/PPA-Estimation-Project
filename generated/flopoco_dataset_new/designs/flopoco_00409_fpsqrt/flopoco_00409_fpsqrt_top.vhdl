...
--  approx. output signal timings: R: (c4, 0.020667ns)
...
entity flopoco_00409_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+23+2 downto 0);
          R : out  std_logic_vector(8+23+2 downto 0)   );
end entity;

architecture arch of flopoco_00409_fpsqrt_top is
...
signal d25 :  std_logic;
   -- timing of d25: (c3, 2.665000ns)
signal mR :  std_logic_vector(25 downto 0);
   -- timing of mR: (c3, 2.665000ns)
signal fR, fR_d1 :  std_logic_vector(22 downto 0);
   -- timing of fR: (c3, 2.665000ns)
signal round, round_d1 :  std_logic;
   -- timing of round: (c3, 2.665000ns)
signal fRrnd :  std_logic_vector(22 downto 0);
   -- timing of fRrnd: (c4, 0.020667ns)
signal Rn2 :  std_logic_vector(30 downto 0);
   -- timing of Rn2: (c4, 0.020667ns)
