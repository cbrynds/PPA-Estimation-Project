...
--  approx. output signal timings: R: (c2, 4.442667ns)
...
entity flopoco_00407_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+31+2 downto 0);
          R : out  std_logic_vector(8+31+2 downto 0)   );
end entity;

architecture arch of flopoco_00407_fpsqrt_top is
...
signal T25s_l, T25s_l_d1 :  std_logic_vector(5 downto 0);
...
signal d33 :  std_logic;
   -- timing of d33: (c2, 3.862667ns)
signal mR :  std_logic_vector(33 downto 0);
   -- timing of mR: (c2, 3.862667ns)
signal fR :  std_logic_vector(30 downto 0);
   -- timing of fR: (c2, 3.862667ns)
signal round :  std_logic;
   -- timing of round: (c2, 3.862667ns)
signal fRrnd :  std_logic_vector(30 downto 0);
   -- timing of fRrnd: (c2, 4.442667ns)
signal Rn2 :  std_logic_vector(38 downto 0);
   -- timing of Rn2: (c2, 4.442667ns)
