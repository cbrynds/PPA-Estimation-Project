--------------------------------------------------------------------------------
--                   RightShifter53_by_max_163_Freq500_uid4
...
--  approx. output signal timings: R: (c5, 0.040769ns)
...
entity RightShifter53_by_max_163_Freq500_uid4 is
...
architecture arch of RightShifter53_by_max_163_Freq500_uid4 is
...
signal level2 :  std_logic_vector(55 downto 0);
   -- timing of level2: (c0, 1.076538ns)
signal level3, level3_d1 :  std_logic_vector(59 downto 0);
   -- timing of level3: (c0, 1.076538ns)
signal level4 :  std_logic_vector(67 downto 0);
   -- timing of level4: (c1, 0.487692ns)
signal level5, level5_d1 :  std_logic_vector(83 downto 0);
   -- timing of level5: (c1, 0.487692ns)
signal level6 :  std_logic_vector(115 downto 0);
   -- timing of level6: (c2, 0.637308ns)
signal level7, level7_d1, level7_d2, level7_d3 :  std_logic_vector(179 downto 0);
   -- timing of level7: (c2, 0.637308ns)
signal level8 :  std_logic_vector(307 downto 0);
   -- timing of level8: (c5, 0.040769ns)
begin
   process(clk)
      begin
   ...
   level8 <=  (127 downto 0 => '0') & level7_d3 when ps_d5(7) = '1' else    level7_d3 & (127 downto 0 => '0');
   R <= level8(307 downto 92);
end architecture;

--------------------------------------------------------------------------------
--                            LZC_110_Freq500_uid6
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
-- Input signals: I
-- Output signals: O
--  approx. input signal timings: I: (c5, 0.040769ns)
--  approx. output signal timings: O: (c6, 0.598894ns)
...
entity LZC_110_Freq500_uid6 is
    port (clk : in std_logic;
          I : in  std_logic_vector(109 downto 0);
          O : out  std_logic_vector(6 downto 0)   );
end entity;

architecture arch of LZC_110_Freq500_uid6 is
signal level7 :  std_logic_vector(126 downto 0);
   -- timing of level7: (c5, 0.040769ns)
signal digit6, digit6_d1 :  std_logic;
   -- timing of digit6: (c5, 0.276394ns)
signal level6 :  std_logic_vector(62 downto 0);
   -- timing of level6: (c5, 0.491394ns)
signal digit5, digit5_d1 :  std_logic;
   -- timing of digit5: (c5, 0.717644ns)
signal level5 :  std_logic_vector(30 downto 0);
   -- timing of level5: (c5, 0.932644ns)
signal digit4, digit4_d1 :  std_logic;
   -- timing of digit4: (c5, 1.153269ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c5, 1.368269ns)
signal digit3, digit3_d1 :  std_logic;
   -- timing of digit3: (c5, 1.587019ns)
signal level3, level3_d1 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c5, 1.802019ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c6, 0.168894ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c6, 0.383894ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c6, 0.598894ns)
signal outHighBits :  std_logic_vector(4 downto 0);
   -- timing of outHighBits: (c6, 0.168894ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   with level2  select  lowBits <= 
      ...
      "01" when "011",
      "00" when others;
   outHighBits <= digit6_d1 & digit5_d1 & digit4_d1 & digit3_d1 & digit2 & "";
   O <= outHighBits & lowBits ;
end architecture;

--------------------------------------------------------------------------------
--                   LeftShifter163_by_max_162_Freq500_uid8
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c5, 0.040769ns)S: (c6, 0.598894ns)
--  approx. output signal timings: R: (c15, 0.008894ns)
...
entity LeftShifter163_by_max_162_Freq500_uid8 is
    port (clk : in std_logic;
...
architecture arch of LeftShifter163_by_max_162_Freq500_uid8 is
signal ps, ps_d1, ps_d2, ps_d3, ps_d4, ps_d5, ps_d6, ps_d7, ps_d8, ps_d9 :  std_logic_vector(7 downto 0);
   -- timing of ps: (c6, 0.598894ns)
signal level0, level0_d1 :  std_logic_vector(162 downto 0);
   -- timing of level0: (c5, 0.040769ns)
signal level1, level1_d1 :  std_logic_vector(163 downto 0);
   -- timing of level1: (c6, 0.598894ns)
signal level2 :  std_logic_vector(165 downto 0);
   -- timing of level2: (c7, 1.517740ns)
signal level3, level3_d1, level3_d2 :  std_logic_vector(169 downto 0);
   -- timing of level3: (c7, 1.517740ns)
signal level4 :  std_logic_vector(177 downto 0);
   -- timing of level4: (c9, 0.771202ns)
signal level5, level5_d1, level5_d2 :  std_logic_vector(193 downto 0);
   -- timing of level5: (c9, 0.771202ns)
signal level6 :  std_logic_vector(225 downto 0);
   -- timing of level6: (c11, 0.763125ns)
signal level7, level7_d1, level7_d2, level7_d3, level7_d4 :  std_logic_vector(289 downto 0);
   -- timing of level7: (c11, 0.763125ns)
signal level8 :  std_logic_vector(417 downto 0);
   -- timing of level8: (c15, 0.008894ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   level6<= level5_d2 & (31 downto 0 => '0') when ps_d5(5)= '1' else     (31 downto 0 => '0') & level5_d2;
   level7<= level6 & (63 downto 0 => '0') when ps_d5(6)= '1' else     (63 downto 0 => '0') & level6;
   level8<= level7_d4 & (127 downto 0 => '0') when ps_d9(7)= '1' else     (127 downto 0 => '0') & level7_d4;
   R <= level8(324 downto 0);
end architecture;

--------------------------------------------------------------------------------
--                        flopoco_00051_ieeefpfma_top
--                       (IEEEFPFMA_11_52_Freq500_uid2)
...
entity flopoco_00051_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00051_ieeefpfma_top is
   component RightShifter53_by_max_163_Freq500_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(52 downto 0);
             S : in  std_logic_vector(7 downto 0);
             R : out  std_logic_vector(215 downto 0)   );
   ...
   component LZC_110_Freq500_uid6 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(109 downto 0);
             O : out  std_logic_vector(6 downto 0)   );
   end component;

   component LeftShifter163_by_max_162_Freq500_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(162 downto 0);
             S : in  std_logic_vector(7 downto 0);
             R : out  std_logic_vector(324 downto 0)   );
...
signal Asgn, Asgn_d1, Asgn_d2, Asgn_d3, Asgn_d4, Asgn_d5, Asgn_d6 :  std_logic;
...
signal AisZero, AisZero_d1, AisZero_d2, AisZero_d3, AisZero_d4, AisZero_d5, AisZero_d6 :  std_logic;
   -- timing of AisZero: (c0, 0.000000ns)
signal AisInf :  std_logic;
   -- timing of AisInf: (c0, 0.000000ns)
signal AisNaN :  std_logic;
   -- timing of AisNaN: (c0, 0.000000ns)
signal Bsgn, Bsgn_d1, Bsgn_d2, Bsgn_d3, Bsgn_d4, Bsgn_d5, Bsgn_d6 :  std_logic;
...
signal BisZero, BisZero_d1, BisZero_d2, BisZero_d3, BisZero_d4, BisZero_d5, BisZero_d6 :  std_logic;
...
signal AexpPlusBexp, AexpPlusBexp_d1, AexpPlusBexp_d2, AexpPlusBexp_d3, AexpPlusBexp_d4, AexpPlusBexp_d5, AexpPlusBexp_d6 :  std_logic_vector(11 downto 0);
   -- timing of AexpPlusBexp: (c0, 0.000000ns)
signal Csgn, Csgn_d1, Csgn_d2, Csgn_d3, Csgn_d4, Csgn_d5, Csgn_d6 :  std_logic;
...
signal CisNormal, CisNormal_d1, CisNormal_d2, CisNormal_d3, CisNormal_d4, CisNormal_d5, CisNormal_d6 :  std_logic;
   -- timing of CisNormal: (c0, 0.000000ns)
signal CisInfOrNaN :  std_logic;
   -- timing of CisInfOrNaN: (c0, 0.000000ns)
signal ChasNonNullSig :  std_logic;
   -- timing of ChasNonNullSig: (c0, 0.000000ns)
signal CisZero, CisZero_d1, CisZero_d2, CisZero_d3, CisZero_d4, CisZero_d5, CisZero_d6 :  std_logic;
...
signal Cexp, Cexp_d1, Cexp_d2, Cexp_d3, Cexp_d4, Cexp_d5, Cexp_d6 :  std_logic_vector(10 downto 0);
   -- timing of Cexp: (c0, 0.000000ns)
signal effectiveSub, effectiveSub_d1, effectiveSub_d2, effectiveSub_d3, effectiveSub_d4, effectiveSub_d5 :  std_logic;
...
signal expDiffSmall, expDiffSmall_d1, expDiffSmall_d2, expDiffSmall_d3, expDiffSmall_d4, expDiffSmall_d5, expDiffSmall_d6 :  std_logic;
...
signal ShiftValue, ShiftValue_d1, ShiftValue_d2, ShiftValue_d3, ShiftValue_d4, ShiftValue_d5, ShiftValue_d6 :  std_logic_vector(7 downto 0);
   -- timing of ShiftValue: (c0, 0.000000ns)
signal CsigShifted :  std_logic_vector(215 downto 0);
   -- timing of CsigShifted: (c5, 0.040769ns)
signal sticky1, sticky1_d1, sticky1_d2, sticky1_d3, sticky1_d4, sticky1_d5, sticky1_d6, sticky1_d7, sticky1_d8, sticky1_d9, sticky1_d10 :  std_logic;
   -- timing of sticky1: (c5, 0.040769ns)
signal CsigShiftedT :  std_logic_vector(162 downto 0);
   -- timing of CsigShiftedT: (c5, 0.040769ns)
signal P :  std_logic_vector(105 downto 0);
   -- timing of P: (c0, 0.000000ns)
signal Paligned, Paligned_d1, Paligned_d2, Paligned_d3, Paligned_d4, Paligned_d5 :  std_logic_vector(162 downto 0);
   -- timing of Paligned: (c0, 0.000000ns)
signal CsigInverted :  std_logic_vector(163 downto 0);
   -- timing of CsigInverted: (c5, 0.040769ns)
signal BigSum :  std_logic_vector(163 downto 0);
   -- timing of BigSum: (c5, 0.040769ns)
signal BigSum2 :  std_logic_vector(163 downto 0);
   -- timing of BigSum2: (c5, 0.040769ns)
signal RsgnTentative, RsgnTentative_d1 :  std_logic;
   -- timing of RsgnTentative: (c5, 0.040769ns)
signal BigSumAbs :  std_logic_vector(162 downto 0);
   -- timing of BigSumAbs: (c5, 0.040769ns)
signal BigSumAbsLowerBits :  std_logic_vector(109 downto 0);
   -- timing of BigSumAbsLowerBits: (c5, 0.040769ns)
signal L :  std_logic_vector(6 downto 0);
   -- timing of L: (c6, 0.598894ns)
signal tmpExpCompRes1, tmpExpCompRes1_d1, tmpExpCompRes1_d2, tmpExpCompRes1_d3, tmpExpCompRes1_d4, tmpExpCompRes1_d5, tmpExpCompRes1_d6 :  std_logic_vector(12 downto 0);
   -- timing of tmpExpCompRes1: (c0, 0.000000ns)
signal tmpExpCompRes2 :  std_logic_vector(12 downto 0);
   -- timing of tmpExpCompRes2: (c6, 0.598894ns)
signal RisSubNormal, RisSubNormal_d1, RisSubNormal_d2, RisSubNormal_d3, RisSubNormal_d4, RisSubNormal_d5, RisSubNormal_d6, RisSubNormal_d7, RisSubNormal_d8, RisSubNormal_d9 :  std_logic;
   -- timing of RisSubNormal: (c6, 0.598894ns)
signal RisZero, RisZero_d1, RisZero_d2, RisZero_d3, RisZero_d4, RisZero_d5, RisZero_d6, RisZero_d7, RisZero_d8, RisZero_d9 :  std_logic;
   -- timing of RisZero: (c6, 0.598894ns)
signal RisSubNormalOrZero :  std_logic;
   -- timing of RisSubNormalOrZero: (c6, 0.598894ns)
signal Rsgn, Rsgn_d1, Rsgn_d2, Rsgn_d3, Rsgn_d4, Rsgn_d5, Rsgn_d6, Rsgn_d7, Rsgn_d8, Rsgn_d9 :  std_logic;
   -- timing of Rsgn: (c6, 0.598894ns)
signal shiftValueCaseSubnormal, shiftValueCaseSubnormal_d1, shiftValueCaseSubnormal_d2, shiftValueCaseSubnormal_d3, shiftValueCaseSubnormal_d4, shiftValueCaseSubnormal_d5, shiftValueCaseSubnormal_d6 :  std_logic_vector(11 downto 0);
   -- timing of shiftValueCaseSubnormal: (c0, 0.000000ns)
signal normShiftValue :  std_logic_vector(7 downto 0);
   -- timing of normShiftValue: (c6, 0.598894ns)
signal BigSumNormd :  std_logic_vector(324 downto 0);
   -- timing of BigSumNormd: (c15, 0.008894ns)
signal expTentative, expTentative_d1, expTentative_d2, expTentative_d3, expTentative_d4, expTentative_d5, expTentative_d6, expTentative_d7, expTentative_d8, expTentative_d9 :  std_logic_vector(12 downto 0);
   -- timing of expTentative: (c6, 0.598894ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c15, 0.008894ns)
signal fracTentative :  std_logic_vector(55 downto 0);
   -- timing of fracTentative: (c15, 0.008894ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c15, 0.008894ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c15, 0.008894ns)
signal fracResultNormd :  std_logic_vector(51 downto 0);
   -- timing of fracResultNormd: (c15, 0.008894ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c15, 0.008894ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c15, 0.008894ns)
signal round :  std_logic;
   -- timing of round: (c15, 0.008894ns)
signal expUpdate :  std_logic_vector(12 downto 0);
   -- timing of expUpdate: (c15, 0.008894ns)
signal exponentResult1 :  std_logic_vector(12 downto 0);
   -- timing of exponentResult1: (c15, 0.008894ns)
signal resultBeforeRound :  std_logic_vector(64 downto 0);
   -- timing of resultBeforeRound: (c15, 0.008894ns)
signal resultRounded :  std_logic_vector(64 downto 0);
   -- timing of resultRounded: (c15, 0.008894ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c15, 0.008894ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c15, 0.008894ns)
...
signal negateAB_d1, negateAB_d2, negateAB_d3, negateAB_d4, negateAB_d5, negateAB_d6 :  std_logic;
   -- timing of negateAB: (c0, 0.000000ns)
signal negateC_d1, negateC_d2, negateC_d3, negateC_d4, negateC_d5, negateC_d6 :  std_logic;
...
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
            ...
            effectiveSub_d5 <=  effectiveSub_d4;
            ...
            RisSubNormal_d9 <=  RisSubNormal_d8;
            RisZero_d1 <=  RisZero;
            ...
            expTentative_d9 <=  expTentative_d8;
            Inf_d1 <=  Inf;
            Inf_d2 <=  Inf_d1;
            Inf_d3 <=  Inf_d2;
            Inf_d4 <=  Inf_d3;
   ...
   RightShifterComponent: RightShifter53_by_max_163_Freq500_uid4
      port map ( clk  => clk,
                 S => ShiftValue,
                 X => Csig,
                 R => CsigShifted);
   ...
   Paligned <= (54 downto 0 => '0') & P & "00";
    ...
    -- The sum at last 
   CsigInverted <= ('0' &CsigShiftedT) when effectiveSub_d5='0'  else ('1' & not CsigShiftedT);
   BigSum <= CsigInverted + ('0' & Paligned_d5) + effectiveSub_d5;  -- P +/-CeffectiveSub is a carry in
   BigSum2 <= CsigShiftedT - ('0' & Paligned_d5);
   RsgnTentative <= Asgn_d5 xor Bsgn_d5 xor negateAB_d5 xor BigSum(163);
   BigSumAbs <= BigSum(162 downto 0) when (BigSum2(163) or not effectiveSub_d5)='1' else BigSum2(162 downto 0);
   BigSumAbsLowerBits <= BigSumAbs(109 downto 0);
   IEEEFPFMA_11_52_Freq500_uid2LeadingZeroCounter: LZC_110_Freq500_uid6
      port map ( clk  => clk,
                 I => BigSumAbsLowerBits,
                 O => L);
   tmpExpCompRes1 <= (AexpPlusBexp(11) & AexpPlusBexp) + "0010000000001";
   tmpExpCompRes2 <= tmpExpCompRes1_d6 - ((12 downto 7 => '0') & L);
   RisSubNormal <= (expDiffSmall_d6 or not CisNormal_d6) and  tmpExpCompRes2(12);
   RisZero <= expDiffSmall_d6 when L="1101110"  else '0';
   RisSubNormalOrZero <= RisSubNormal or RisZero;
   Rsgn <=      (Asgn_d6 xor Bsgn_d6 xor negateAB_d6) and (Csgn_d6 xor negateC_d6) when ((AisZero_d6 or BisZero_d6) and CisZero_d6)='1'  -- negative only for -0 + -0 
      else '0' when RisZero='1'  -- covers 1-1 = +0
      else RsgnTentative_d1;  -- covers to underflow to zero case
   shiftValueCaseSubnormal <= AexpPlusBexp + "010000110110";
   normShiftValue <= 
           L + "00110110" when (expDiffSmall_d6 and not RisSubNormal)='1'
      else shiftValueCaseSubnormal_d6(7 downto 0) when (expDiffSmall_d6 and RisSubNormal)='1'
      else ShiftValue_d6; -- undo inital shift
   NormalizationShifter: LeftShifter163_by_max_162_Freq500_uid8
      port map ( clk  => clk,
                 S => normShiftValue,
                 X => BigSumAbs,
                 R => BigSumNormd);
   ...
   expTentative <= 
      ...
      else (AexpPlusBexp_d6(11) & AexpPlusBexp_d6 - ((12 downto 7 => '0') & L))  + "0000000000011" when (expDiffSmall_d6 and not RisSubNormal)='1'
      else (Cexp_d6(10) & Cexp_d6(10) & Cexp_d6) + "0000000000001" ;
   ...
   fracLeadingBits <= "01" when RisSubNormal_d9='1' else  fracLeadingBitsNormal;
   fracResultNormd <=
   ...
   fracResultStickyBit <=
           sticky1_d10 or sticky2	 when fracLeadingBits = "00" 
      else fracTentative(0) or sticky1_d10 or sticky2    when fracLeadingBits = "01" 
      else fracTentative(1) or fracTentative(0) or  sticky1_d10 or sticky2;
   round <= fracResultRoundBit and (fracResultStickyBit or fracResultNormd(0));
   expUpdate <= "0001111111101" when RisZero_d9 = '1'       -- bias - 2
   ...
   exponentResult1 <= expTentative_d9 + expUpdate;
   ...
   R <= 
           Rsgn_d9 & Inf_d15 when ((not RisNaN_d15) and finalRisInf)='1'
      else '0'  & NaN_d15 when RisNaN_d15='1'
      else Rsgn_d9 & resultRounded(62 downto 0);
end architecture;
