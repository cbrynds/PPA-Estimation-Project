--------------------------------------------------------------------------------
--                     IntComparator_63_101_Freq150_uid4
...
--  approx. output signal timings: XltY: (c0, 0.580000ns)XgtY: (c0, 0.580000ns)
...
entity IntComparator_63_101_Freq150_uid4 is
...
architecture arch of IntComparator_63_101_Freq150_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00365_fpcomparator_top
...
--  approx. input signal timings: X: (c0, 0.000000ns)Y: (c0, 0.000000ns)
--  approx. output signal timings: unordered: (c0, 0.000000ns)XltY: (c0, 0.795000ns)
...
entity flopoco_00365_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00365_fpcomparator_top is
   component IntComparator_63_101_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(62 downto 0);
             Y : in  std_logic_vector(62 downto 0);
             XltY : out  std_logic;
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_63_101_Freq150_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
