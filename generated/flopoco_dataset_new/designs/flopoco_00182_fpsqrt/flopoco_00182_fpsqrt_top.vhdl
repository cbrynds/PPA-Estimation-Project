...
--  approx. output signal timings: R: (c4, 0.666000ns)
...
entity flopoco_00182_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(5+10+2 downto 0);
          R : out  std_logic_vector(5+10+2 downto 0)   );
end entity;

architecture arch of flopoco_00182_fpsqrt_top is
...
signal eRn1, eRn1_d1, eRn1_d2, eRn1_d3, eRn1_d4 :  std_logic_vector(4 downto 0);
...
signal R10 :  std_logic_vector(12 downto 0);
   -- timing of R10: (c3, 1.485000ns)
signal R10s :  std_logic_vector(13 downto 0);
...
signal fR :  std_logic_vector(9 downto 0);
   -- timing of fR: (c4, 0.168000ns)
signal round :  std_logic;
   -- timing of round: (c4, 0.133000ns)
signal fRrnd :  std_logic_vector(9 downto 0);
   -- timing of fRrnd: (c4, 0.666000ns)
signal Rn2 :  std_logic_vector(14 downto 0);
   -- timing of Rn2: (c4, 0.666000ns)
...
begin
   ...
   d0 <= '1';
   S0 <= "1";
   R0 <= "00" & fracX & "0" when X(10) = '1' else   -- parity of EX-E0 is opposite to that of EX
          fracX(9) & (not fracX(9)) & fracX(8 downto 0) & "00"; -- pre-normalization
   -- Step 1
   R0s <= R0 & "0";
   R0s_h <= R0s(13 downto 10);
   R0s_l <= R0s(9 downto 0);
   ...
   -- Step 2
   R1s <= R1 & "0";
   R1s_h <= R1s(13 downto 9);
   R1s_l <= R1s(8 downto 0);
   ...
   -- Step 3
   R2s <= R2 & "0";
   R2s_h <= R2s(13 downto 8);
   R2s_l <= R2s(7 downto 0);
   ...
   -- Step 4
   R3s <= R3 & "0";
   R3s_h <= R3s(13 downto 7);
   R3s_l <= R3s(6 downto 0);
   ...
   -- Step 5
   R4s <= R4 & "0";
   R4s_h <= R4s(13 downto 6);
   R4s_l <= R4s(5 downto 0);
   ...
   -- Step 6
   R5s <= R5 & "0";
   R5s_h <= R5s(13 downto 5);
   R5s_l <= R5s(4 downto 0);
   ...
   -- Step 7
   R6s <= R6 & "0";
   R6s_h <= R6s(13 downto 4);
   R6s_l <= R6s(3 downto 0);
   ...
   -- Step 8
   R7s <= R7 & "0";
   R7s_h <= R7s(13 downto 3);
   R7s_l <= R7s(2 downto 0);
   ...
   -- Step 9
   R8s <= R8 & "0";
   R8s_h <= R8s(13 downto 2);
   R8s_l <= R8s(1 downto 0);
   ...
   -- Step 10
   R9s <= R9 & "0";
   R9s_h <= R9s(13 downto 1);
   R9s_l <= R9s(0 downto 0);
   ...
   R11 <= R11_h; 
   fR <= S11(10 downto 1);-- removing leading 1
   round <= d11; -- round bit
