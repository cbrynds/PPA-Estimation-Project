--------------------------------------------------------------------------------
--                RightShifterSticky36_by_max_38_Freq200_uid4
...
entity RightShifterSticky36_by_max_38_Freq200_uid4 is
...
architecture arch of RightShifterSticky36_by_max_38_Freq200_uid4 is
...
entity IntAdder_39_Freq200_uid6 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_39_Freq200_uid6 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_40_40_40_Freq200_uid8
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity Normalizer_Z_40_40_40_Freq200_uid8 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_40_40_40_Freq200_uid8 is
...
entity IntAdder_48_Freq200_uid11 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_48_Freq200_uid11 is
...
--------------------------------------------------------------------------------
--                          flopoco_00234_fpadd_top
--                         (FPSub_10_35_Freq200_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00234_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00234_fpadd_top is
   component RightShifterSticky36_by_max_38_Freq200_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(35 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(37 downto 0);
   ...
   component IntAdder_39_Freq200_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(38 downto 0);
             Y : in  std_logic_vector(38 downto 0);
             Cin : in  std_logic;
   ...
   component Normalizer_Z_40_40_40_Freq200_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(39 downto 0);
             Count : out  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(39 downto 0)   );
   ...
   component IntAdder_48_Freq200_uid11 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(47 downto 0);
             Y : in  std_logic_vector(47 downto 0);
             Cin : in  std_logic;
...
signal mY :  std_logic_vector(47 downto 0);
...
signal extendedExpInc, extendedExpInc_d1 :  std_logic_vector(10 downto 0);
...
begin
   ...
   mY <= Y(47 downto 46) & not(Y(45)) & Y(44 downto 0);
   ...
   RightShifterComponent: RightShifterSticky36_by_max_38_Freq200_uid4
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracY,
                 R => shiftedFracY,
   ...
   fracAdder: IntAdder_39_Freq200_uid6
      port map ( clk  => clk,
                 Cin => cInSigAdd,
                 X => fracXpad,
                 Y => fracYpadXorOp,
   ...
   LZCAndShifter: Normalizer_Z_40_40_40_Freq200_uid8
      port map ( clk  => clk,
                 X => fracSticky,
                 Count => nZerosNew,
                 R => shiftedFrac);
   ...
   roundingAdder: IntAdder_48_Freq200_uid11
      port map ( clk  => clk,
                 Cin => needToRound,
                 X => expFrac,
