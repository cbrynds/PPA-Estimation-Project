...
--  approx. output signal timings: R: (c2, 2.412333ns)
...
entity flopoco_00415_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(6+11+2 downto 0);
          R : out  std_logic_vector(6+11+2 downto 0)   );
end entity;

architecture arch of flopoco_00415_fpsqrt_top is
...
signal R4s_l, R4s_l_d1 :  std_logic_vector(6 downto 0);
...
signal fR :  std_logic_vector(10 downto 0);
   -- timing of fR: (c2, 1.914333ns)
signal round :  std_logic;
   -- timing of round: (c2, 1.879333ns)
signal fRrnd :  std_logic_vector(10 downto 0);
   -- timing of fRrnd: (c2, 2.412333ns)
signal Rn2 :  std_logic_vector(16 downto 0);
   -- timing of Rn2: (c2, 2.412333ns)
