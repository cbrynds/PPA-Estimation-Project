...
--  approx. output signal timings: R: (c5, 0.224000ns)
...
entity flopoco_00403_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+31+2 downto 0);
          R : out  std_logic_vector(8+31+2 downto 0)   );
end entity;

architecture arch of flopoco_00403_fpsqrt_top is
...
signal R6s_l, R6s_l_d1 :  std_logic_vector(24 downto 0);
...
signal fR, fR_d1 :  std_logic_vector(30 downto 0);
   -- timing of fR: (c4, 4.494000ns)
signal round, round_d1 :  std_logic;
   -- timing of round: (c4, 4.459000ns)
signal fRrnd :  std_logic_vector(30 downto 0);
   -- timing of fRrnd: (c5, 0.224000ns)
signal Rn2 :  std_logic_vector(38 downto 0);
   -- timing of Rn2: (c5, 0.224000ns)
