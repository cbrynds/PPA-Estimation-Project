--------------------------------------------------------------------------------
--                    CBLKTable_l0_d5_alpha3_Freq500_uid7
...
entity CBLKTable_l0_d5_alpha3_Freq500_uid7 is
    port (X : in  std_logic_vector(2 downto 0);
          Y : out  std_logic_vector(3 downto 0)   );
end entity;

architecture arch of CBLKTable_l0_d5_alpha3_Freq500_uid7 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l1_d5_alpha3_Freq500_uid15
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l1_d5_alpha3_Freq500_uid15 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(5 downto 0)   );
end entity;

architecture arch of CBLKTable_l1_d5_alpha3_Freq500_uid15 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l2_d5_alpha3_Freq500_uid21
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l2_d5_alpha3_Freq500_uid21 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(8 downto 0)   );
end entity;

architecture arch of CBLKTable_l2_d5_alpha3_Freq500_uid21 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_5_11_1_3_Freq500_uid3
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity IntConstDiv_QR_5_11_1_3_Freq500_uid3 is
...
architecture arch of IntConstDiv_QR_5_11_1_3_Freq500_uid3 is
   component CBLKTable_l0_d5_alpha3_Freq500_uid7 is
      port ( X : in  std_logic_vector(2 downto 0);
             Y : out  std_logic_vector(3 downto 0)   );
   end component;

   component CBLKTable_l1_d5_alpha3_Freq500_uid15 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(5 downto 0)   );
   end component;

   component CBLKTable_l2_d5_alpha3_Freq500_uid21 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(8 downto 0)   );
   end component;
...
begin
   ...
   x0 <= X(2 downto 0);
   table0: CBLKTable_l0_d5_alpha3_Freq500_uid7
      port map ( X => x0,
                 Y => out0_copy8);
   ...
   x1 <= X(5 downto 3);
   table1: CBLKTable_l0_d5_alpha3_Freq500_uid7
      port map ( X => x1,
                 Y => out1_copy9);
   ...
   x2 <= X(8 downto 6);
   table2: CBLKTable_l0_d5_alpha3_Freq500_uid7
      port map ( X => x2,
                 Y => out2_copy10);
   ...
   table_l1_1: CBLKTable_l1_d5_alpha3_Freq500_uid15
      port map ( X => in_l1_1,
                 Y => out_l1_1_copy17);
   ...
   table_l2_0: CBLKTable_l2_d5_alpha3_Freq500_uid21
      port map ( X => in_l2_0,
                 Y => out_l2_0_copy22);
...
entity flopoco_00150_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00150_fpconstdiv_top is
   component IntConstDiv_QR_5_11_1_3_Freq500_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(10 downto 0);
             Q : out  std_logic_vector(8 downto 0);
             R : out  std_logic_vector(2 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_5_11_1_3_Freq500_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
