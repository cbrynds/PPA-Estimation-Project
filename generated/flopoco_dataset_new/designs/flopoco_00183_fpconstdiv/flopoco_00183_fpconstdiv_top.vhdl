...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_5_14_0_4_Freq250_uid3
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity IntConstDiv_QR_5_14_0_4_Freq250_uid3 is
...
architecture arch of IntConstDiv_QR_5_14_0_4_Freq250_uid3 is
...
--------------------------------------------------------------------------------
--                        flopoco_00183_fpconstdiv_top
--                      (FPConstDiv_5_10_5_10_5_0_0_250)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00183_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(5+10+2 downto 0);
          R : out  std_logic_vector(5+10+2 downto 0)   );
end entity;

architecture arch of flopoco_00183_fpconstdiv_top is
   component IntConstDiv_QR_5_14_0_4_Freq250_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(13 downto 0);
             Q : out  std_logic_vector(11 downto 0);
             R : out  std_logic_vector(2 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_5_14_0_4_Freq250_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
