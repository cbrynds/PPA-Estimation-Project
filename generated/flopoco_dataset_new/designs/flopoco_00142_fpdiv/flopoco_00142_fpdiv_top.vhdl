...
--  approx. output signal timings: R: (c2, 2.018160ns)
...
entity flopoco_00142_fpdiv_top is
...
architecture arch of flopoco_00142_fpdiv_top is
...
signal w2fulla :  std_logic_vector(13 downto 0);
   -- timing of w2fulla: (c1, 0.100205ns)
...
begin
   ...
   sel1 <= w1(12 downto 8) & prescaledfY_d1(7 downto 6);
   ...
   w0fulla <= 
      w1pad_d1 - ("0000" & prescaledfY_d2)			when "01",
      w1pad_d1 + ("0000" & prescaledfY_d2)			when "11",
      w1pad_d1 + ("000" & prescaledfY_d2 & "0")		when "10",
   ...
   qP0 <= q0(2 downto 0);
   qM0 <= q0(3)  & "00";
   qP <= qP4_d2 & qP3_d2 & qP2_d1 & qP1_d1 & qP0;
   qM <= qM4_d2(1 downto 0) & qM3_d2 & qM2_d1 & qM1_d1 & qM0 & "0";
   quotient <= qP - qM;
