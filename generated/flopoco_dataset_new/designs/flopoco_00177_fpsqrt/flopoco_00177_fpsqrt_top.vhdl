...
--  approx. output signal timings: R: (c2, 1.201000ns)
...
entity flopoco_00177_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00177_fpsqrt_top is
...
signal R3s_l, R3s_l_d1 :  std_logic_vector(3 downto 0);
...
signal fR :  std_logic_vector(6 downto 0);
   -- timing of fR: (c2, 0.729000ns)
signal round :  std_logic;
   -- timing of round: (c2, 0.694000ns)
signal fRrnd :  std_logic_vector(6 downto 0);
   -- timing of fRrnd: (c2, 1.201000ns)
signal Rn2 :  std_logic_vector(14 downto 0);
   -- timing of Rn2: (c2, 1.201000ns)
