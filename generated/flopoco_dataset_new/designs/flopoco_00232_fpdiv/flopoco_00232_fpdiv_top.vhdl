...
--  approx. output signal timings: R: (c1, 2.970000ns)
...
entity flopoco_00232_fpdiv_top is
...
architecture arch of flopoco_00232_fpdiv_top is
...
signal D, D_d1 :  std_logic_vector(11 downto 0);
...
begin
   ...
   sel4 <= betaw4(14 downto 9) & D(10 downto 8);
   ...
   sel3 <= betaw3(14 downto 9) & D(10 downto 8);
   ...
   sel1 <= betaw1(14 downto 9) & D_d1(10 downto 8);
   ...
   qP1 <=      q1(1 downto 0);
   qM1 <=      q1(2) & "0";
   qP <= qP8_d1 & qP7_d1 & qP6_d1 & qP5_d1 & qP4_d1 & qP3_d1 & qP2 & qP1;
   qM <= qM8_d1(0) & qM7_d1 & qM6_d1 & qM5_d1 & qM4_d1 & qM3_d1 & qM2 & qM1 & qM0;
   quotient <= qP - qM;
