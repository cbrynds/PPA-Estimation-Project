...
--  approx. output signal timings: R: (c1, 1.148846ns)
...
signal level6 :  std_logic_vector(86 downto 0);
   -- timing of level6: (c1, 1.148846ns)
signal level7 :  std_logic_vector(150 downto 0);
   -- timing of level7: (c1, 1.148846ns)
begin
   process(clk)
      begin
...
-- Input signals: I
-- Output signals: O
--  approx. input signal timings: I: (c1, 1.148846ns)
--  approx. output signal timings: O: (c2, 1.256346ns)
...
signal digit5, digit5_d1 :  std_logic;
   -- timing of digit5: (c1, 1.375096ns)
signal level5, level5_d1 :  std_logic_vector(30 downto 0);
   -- timing of level5: (c1, 1.590096ns)
signal digit4, digit4_d1 :  std_logic;
   -- timing of digit4: (c1, 1.810721ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c2, 0.175721ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c2, 0.394471ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c2, 0.609471ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c2, 0.826346ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c2, 1.041346ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c2, 1.256346ns)
signal outHighBits :  std_logic_vector(3 downto 0);
   -- timing of outHighBits: (c2, 0.826346ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c1, 1.148846ns)S: (c2, 1.256346ns)
--  approx. output signal timings: R: (c5, 1.105192ns)
...
entity flopoco_00000_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00000_ieeefpfma_top is
...
signal normShiftValue :  std_logic_vector(6 downto 0);
   -- timing of normShiftValue: (c2, 1.256346ns)
signal BigSumNormd :  std_logic_vector(150 downto 0);
   -- timing of BigSumNormd: (c5, 1.105192ns)
signal expTentative, expTentative_d1, expTentative_d2, expTentative_d3 :  std_logic_vector(9 downto 0);
   -- timing of expTentative: (c2, 1.256346ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c5, 1.105192ns)
signal fracTentative :  std_logic_vector(26 downto 0);
   -- timing of fracTentative: (c5, 1.105192ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c5, 1.105192ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c5, 1.105192ns)
signal fracResultNormd :  std_logic_vector(22 downto 0);
   -- timing of fracResultNormd: (c5, 1.105192ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c5, 1.105192ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c5, 1.105192ns)
signal round :  std_logic;
   -- timing of round: (c5, 1.105192ns)
signal expUpdate :  std_logic_vector(9 downto 0);
   -- timing of expUpdate: (c5, 1.105192ns)
signal exponentResult1 :  std_logic_vector(9 downto 0);
   -- timing of exponentResult1: (c5, 1.105192ns)
signal resultBeforeRound :  std_logic_vector(32 downto 0);
   -- timing of resultBeforeRound: (c5, 1.105192ns)
signal resultRounded :  std_logic_vector(32 downto 0);
   -- timing of resultRounded: (c5, 1.105192ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c5, 1.105192ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c5, 1.105192ns)
