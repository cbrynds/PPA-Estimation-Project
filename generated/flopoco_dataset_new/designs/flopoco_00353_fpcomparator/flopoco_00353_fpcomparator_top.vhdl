--------------------------------------------------------------------------------
--                     IntComparator_39_111_Freq300_uid4
...
entity IntComparator_39_111_Freq300_uid4 is
...
architecture arch of IntComparator_39_111_Freq300_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00353_fpcomparator_top
--                      (FPComparator_8_31_Freq300_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin (2021)
...
--  approx. input signal timings: X: (c0, 0.000000ns)Y: (c0, 0.000000ns)
--  approx. output signal timings: unordered: (c0, 0.000000ns)XltY: (c0, 0.754000ns)XeqY: (c0, 0.713000ns)XgtY: (c0, 0.754000ns)
...
entity flopoco_00353_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00353_fpcomparator_top is
   component IntComparator_39_111_Freq300_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(38 downto 0);
             Y : in  std_logic_vector(38 downto 0);
             XltY : out  std_logic;
...
signal ExpFracX :  std_logic_vector(38 downto 0);
   -- timing of ExpFracX: (c0, 0.000000ns)
signal ExpFracY :  std_logic_vector(38 downto 0);
...
begin
   ...
   signX <= X(39);
   signY <= Y(39);
   ExpFracX <= X(38 downto 0);
   ExpFracY <= Y(38 downto 0);
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_39_111_Freq300_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
