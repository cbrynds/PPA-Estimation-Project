...
--------------------------------------------------------------------------------
--                     Normalizer_Z_36_36_36_Freq400_uid8
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity Normalizer_Z_36_36_36_Freq400_uid8 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_36_36_36_Freq400_uid8 is
...
--  approx. output signal timings: R: (c3, 0.513250ns)
...
entity IntAdder_42_Freq400_uid11 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_42_Freq400_uid11 is
...
signal S_1 :  std_logic_vector(10 downto 0);
   -- timing of S_1: (c3, 0.513250ns)
signal R_1 :  std_logic_vector(9 downto 0);
   -- timing of R_1: (c3, 0.513250ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   R_0 <= S_0(31 downto 0);
   Cin_1 <= S_0(32);
   X_1 <= '0' & X(41 downto 32);
   Y_1 <= '0' & Y(41 downto 32);
...
--  approx. output signal timings: R: (c3, 0.943250ns)
...
entity flopoco_00221_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00221_fpadd_top is
   ...
   component Normalizer_Z_36_36_36_Freq400_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(35 downto 0);
             Count : out  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(35 downto 0)   );
   ...
   component IntAdder_42_Freq400_uid11 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(41 downto 0);
             Y : in  std_logic_vector(41 downto 0);
             Cin : in  std_logic;
...
signal RoundedExpFrac :  std_logic_vector(41 downto 0);
   -- timing of RoundedExpFrac: (c3, 0.513250ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c3, 0.513250ns)
signal fracR :  std_logic_vector(30 downto 0);
   -- timing of fracR: (c3, 0.513250ns)
signal expR :  std_logic_vector(7 downto 0);
   -- timing of expR: (c3, 0.513250ns)
signal exExpExc :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c3, 0.513250ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c3, 0.728250ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c3, 0.943250ns)
signal signR2, signR2_d1 :  std_logic;
   -- timing of signR2: (c2, 1.461250ns)
signal computedR :  std_logic_vector(41 downto 0);
   -- timing of computedR: (c3, 0.943250ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   fracAdder: IntAdder_35_Freq400_uid6
      port map ( clk  => clk,
                 Cin => cInSigAdd,
                 X => fracXpad,
                 Y => fracYpadXorOp,
   ...
   LZCAndShifter: Normalizer_Z_36_36_36_Freq400_uid8
      port map ( clk  => clk,
                 X => fracSticky,
                 Count => nZerosNew,
                 R => shiftedFrac);
   extendedExpInc<= ("0" & expX) + '1';
   updatedExp <= ("0" &extendedExpInc_d2) - ("0000" & nZerosNew);
   ...
   roundingAdder: IntAdder_42_Freq400_uid11
      port map ( clk  => clk,
                 Cin => needToRound,
                 X => expFrac,
