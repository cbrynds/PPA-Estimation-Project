...
entity IntDualSub_55_Freq250_uid4 is
...
architecture arch of IntDualSub_55_Freq250_uid4 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_54_54_54_Freq250_uid6
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Count: (c0, 3.807250ns)R: (c1, 0.172250ns)
...
entity Normalizer_Z_54_54_54_Freq250_uid6 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_54_54_54_Freq250_uid6 is
...
signal count3 :  std_logic;
   -- timing of count3: (c0, 2.511625ns)
signal level3 :  std_logic_vector(53 downto 0);
   -- timing of level3: (c0, 2.726625ns)
signal count2 :  std_logic;
   -- timing of count2: (c0, 2.943500ns)
signal level2 :  std_logic_vector(53 downto 0);
   -- timing of level2: (c0, 3.158500ns)
signal count1 :  std_logic;
   -- timing of count1: (c0, 3.375375ns)
signal level1, level1_d1 :  std_logic_vector(53 downto 0);
   -- timing of level1: (c0, 3.590375ns)
signal count0, count0_d1 :  std_logic;
   -- timing of count0: (c0, 3.807250ns)
signal level0 :  std_logic_vector(53 downto 0);
   -- timing of level0: (c1, 0.172250ns)
signal sCount :  std_logic_vector(5 downto 0);
   -- timing of sCount: (c0, 3.807250ns)
begin
   process(clk)
      begin
   ...
   count3<= '1' when level4(53 downto 46) = (53 downto 46=>'0') else '0';
   ...
   level0<= level1_d1(53 downto 0) when count0_d1='0' else level1_d1(52 downto 0) & (0 downto 0 => '0');
...
--------------------------------------------------------------------------------
--                RightShifterSticky53_by_max_55_Freq250_uid8
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity RightShifterSticky53_by_max_55_Freq250_uid8 is
    port (clk : in std_logic;
...
architecture arch of RightShifterSticky53_by_max_55_Freq250_uid8 is
...
--  approx. output signal timings: R: (c0, 3.419250ns)
...
entity IntAdder_56_Freq250_uid10 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_56_Freq250_uid10 is
signal Rtmp :  std_logic_vector(55 downto 0);
   -- timing of Rtmp: (c0, 3.419250ns)
begin
   Rtmp <= X + Y + Cin;
   R <= Rtmp;
end architecture;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.207250ns)Y: (c0, 0.000000ns)Cin: (c1, 0.207250ns)
--  approx. output signal timings: R: (c1, 0.992250ns)
...
entity IntAdder_65_Freq250_uid13 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_65_Freq250_uid13 is
signal Rtmp :  std_logic_vector(64 downto 0);
   -- timing of Rtmp: (c1, 0.992250ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00396_fpadd_top
--                         (FPAdd_11_52_Freq250_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 1.062250ns)
...
entity flopoco_00396_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00396_fpadd_top is
   component IntDualSub_55_Freq250_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(54 downto 0);
             Y : in  std_logic_vector(54 downto 0);
             XmY : out  std_logic_vector(54 downto 0);
   ...
   component Normalizer_Z_54_54_54_Freq250_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(53 downto 0);
             Count : out  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(53 downto 0)   );
   ...
   component RightShifterSticky53_by_max_55_Freq250_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(52 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(54 downto 0);
   ...
   component IntAdder_56_Freq250_uid10 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(55 downto 0);
             Y : in  std_logic_vector(55 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_65_Freq250_uid13 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(64 downto 0);
             Y : in  std_logic_vector(64 downto 0);
             Cin : in  std_logic;
...
signal nZerosNew :  std_logic_vector(5 downto 0);
   -- timing of nZerosNew: (c0, 3.807250ns)
signal shiftedFrac :  std_logic_vector(53 downto 0);
   -- timing of shiftedFrac: (c1, 0.172250ns)
signal roundClose0 :  std_logic;
   -- timing of roundClose0: (c1, 0.172250ns)
signal resultCloseIsZero0 :  std_logic;
   -- timing of resultCloseIsZero0: (c0, 3.807250ns)
signal exponentResultClose, exponentResultClose_d1 :  std_logic_vector(12 downto 0);
   -- timing of exponentResultClose: (c0, 3.807250ns)
signal resultBeforeRoundClose :  std_logic_vector(64 downto 0);
   -- timing of resultBeforeRoundClose: (c1, 0.172250ns)
signal roundClose :  std_logic;
   -- timing of roundClose: (c1, 0.172250ns)
signal resultCloseIsZero :  std_logic;
   -- timing of resultCloseIsZero: (c0, 3.807250ns)
...
signal fracResultfar0 :  std_logic_vector(55 downto 0);
   -- timing of fracResultfar0: (c0, 3.419250ns)
signal fracResultFarNormStage :  std_logic_vector(55 downto 0);
   -- timing of fracResultFarNormStage: (c0, 3.419250ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c0, 3.419250ns)
signal fracResultFar1 :  std_logic_vector(51 downto 0);
   -- timing of fracResultFar1: (c0, 3.419250ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c0, 3.419250ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c0, 3.419250ns)
signal roundFar1 :  std_logic;
   -- timing of roundFar1: (c0, 3.419250ns)
signal expOperationSel :  std_logic_vector(1 downto 0);
   -- timing of expOperationSel: (c0, 3.419250ns)
signal exponentUpdate :  std_logic_vector(12 downto 0);
   -- timing of exponentUpdate: (c0, 3.419250ns)
signal exponentResultfar0 :  std_logic_vector(12 downto 0);
   -- timing of exponentResultfar0: (c0, 0.713000ns)
signal exponentResultFar1 :  std_logic_vector(12 downto 0);
   -- timing of exponentResultFar1: (c0, 3.419250ns)
signal resultBeforeRoundFar, resultBeforeRoundFar_d1 :  std_logic_vector(64 downto 0);
   -- timing of resultBeforeRoundFar: (c0, 3.419250ns)
signal roundFar, roundFar_d1 :  std_logic;
   -- timing of roundFar: (c0, 3.419250ns)
signal resultBeforeRound :  std_logic_vector(64 downto 0);
   -- timing of resultBeforeRound: (c1, 0.207250ns)
signal round :  std_logic;
   -- timing of round: (c1, 0.207250ns)
signal zeroFromClose, zeroFromClose_d1 :  std_logic;
   -- timing of zeroFromClose: (c0, 3.807250ns)
signal resultRounded :  std_logic_vector(64 downto 0);
   -- timing of resultRounded: (c1, 0.992250ns)
...
-- Close Path --
   ...
   FPAdd_11_52_Freq250_uid2_DualSubClose: IntDualSub_55_Freq250_uid4
      port map ( clk  => clk,
                 X => fracXClose1,
                 Y => fracYClose1,
                 XmY => fracRClosexMy,
   ...
   norm: Normalizer_Z_54_54_54_Freq250_uid6
      port map ( clk  => clk,
                 X => fracRClose1,
                 Count => nZerosNew,
                 R => shiftedFrac);
   ...
   exponentResultClose <= ("00" & newX(62 downto 52)) - (CONV_STD_LOGIC_VECTOR(0,7) & nZerosNew);
   resultBeforeRoundClose <= exponentResultClose_d1(12 downto 0) & shiftedFrac(52 downto 1);
   roundClose <= roundClose0;
   resultCloseIsZero <= resultCloseIsZero0;

-- Far Path --
   fracNewY <= '1' & newY(51 downto 0);
   RightShifterComponent: RightShifterSticky53_by_max_55_Freq250_uid8
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracNewY,
                 R => shiftedFracY,
   ...
   -- far path adder
   FPAdd_11_52_Freq250_uid2_fracAddFar: IntAdder_56_Freq250_uid10
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
...
-- Synchronization of both paths --
   ...
   -- final round adder
   FPAdd_11_52_Freq250_uid2_finalRoundAdd: IntAdder_65_Freq250_uid13
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
