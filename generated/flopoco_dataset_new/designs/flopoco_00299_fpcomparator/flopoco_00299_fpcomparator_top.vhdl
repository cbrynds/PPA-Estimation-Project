--------------------------------------------------------------------------------
--                     IntComparator_31_111_Freq200_uid4
...
--  approx. output signal timings: XltY: (c0, 0.498000ns)XeqY: (c0, 0.498000ns)XgtY: (c0, 0.498000ns)
...
entity IntComparator_31_111_Freq200_uid4 is
...
architecture arch of IntComparator_31_111_Freq200_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00299_fpcomparator_top
--                      (FPComparator_8_23_Freq200_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin (2021)
...
-- Target frequency (MHz): 200
-- Input signals: X Y
-- Output signals: unordered XltY XeqY XgtY
--  approx. input signal timings: X: (c0, 0.000000ns)Y: (c0, 0.000000ns)
--  approx. output signal timings: unordered: (c0, 0.000000ns)XltY: (c0, 0.713000ns)XeqY: (c0, 0.713000ns)XgtY: (c0, 0.713000ns)
...
entity flopoco_00299_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00299_fpcomparator_top is
   component IntComparator_31_111_Freq200_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(30 downto 0);
             Y : in  std_logic_vector(30 downto 0);
             XltY : out  std_logic;
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_31_111_Freq200_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
