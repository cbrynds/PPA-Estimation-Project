...
--------------------------------------------------------------------------------
--                    CBLKTable_l1_d5_alpha6_Freq400_uid13
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l1_d5_alpha6_Freq400_uid13 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(8 downto 0)   );
end entity;

architecture arch of CBLKTable_l1_d5_alpha6_Freq400_uid13 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_5_11_1_6_Freq400_uid3
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Q: (c0, 1.661000ns)R: (c0, 1.163000ns)
...
entity IntConstDiv_QR_5_11_1_6_Freq400_uid3 is
...
architecture arch of IntConstDiv_QR_5_11_1_6_Freq400_uid3 is
   component CBLKTable_l0_d5_alpha6_Freq400_uid7 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(6 downto 0)   );
   end component;

   component CBLKTable_l1_d5_alpha6_Freq400_uid13 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(8 downto 0)   );
   end component;
...
signal out_l1_0_copy14 :  std_logic_vector(8 downto 0);
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.000000ns)
--  approx. output signal timings: R: (c0, 1.661000ns)
...
entity flopoco_00428_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00428_fpconstdiv_top is
   component IntConstDiv_QR_5_11_1_6_Freq400_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(10 downto 0);
             Q : out  std_logic_vector(8 downto 0);
             R : out  std_logic_vector(2 downto 0)   );
...
signal quotient :  std_logic_vector(8 downto 0);
   -- timing of quotient: (c0, 1.661000ns)
signal remainder :  std_logic_vector(2 downto 0);
   -- timing of remainder: (c0, 1.163000ns)
signal r_frac :  std_logic_vector(6 downto 0);
   -- timing of r_frac: (c0, 1.661000ns)
begin
   ...
   intconstdiv: IntConstDiv_QR_5_11_1_6_Freq400_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
