--------------------------------------------------------------------------------
--                RightShifterSticky55_by_max_54_Freq250_uid4
...
entity RightShifterSticky55_by_max_54_Freq250_uid4 is
...
architecture arch of RightShifterSticky55_by_max_54_Freq250_uid4 is
...
--  approx. output signal timings: R: (c1, 0.405250ns)
...
entity IntAdder_56_Freq250_uid6 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_56_Freq250_uid6 is
signal Cin_1, Cin_1_d1 :  std_logic;
   -- timing of Cin_1: (c0, 3.511250ns)
signal X_1, X_1_d1 :  std_logic_vector(56 downto 0);
   -- timing of X_1: (c0, 1.010000ns)
signal Y_1, Y_1_d1 :  std_logic_vector(56 downto 0);
   -- timing of Y_1: (c0, 2.840000ns)
signal S_1 :  std_logic_vector(56 downto 0);
   -- timing of S_1: (c1, 0.405250ns)
signal R_1 :  std_logic_vector(55 downto 0);
   -- timing of R_1: (c1, 0.405250ns)
begin
   process(clk)
      begin
...
-- Input signals: I
-- Output signals: O
--  approx. input signal timings: I: (c1, 0.405250ns)
--  approx. output signal timings: O: (c1, 2.362750ns)
...
entity LZC_55_Freq250_uid8 is
    port (clk : in std_logic;
          I : in  std_logic_vector(54 downto 0);
          O : out  std_logic_vector(5 downto 0)   );
end entity;

architecture arch of LZC_55_Freq250_uid8 is
signal level6 :  std_logic_vector(62 downto 0);
   -- timing of level6: (c1, 0.405250ns)
signal digit5 :  std_logic;
   -- timing of digit5: (c1, 0.631500ns)
signal level5 :  std_logic_vector(30 downto 0);
   -- timing of level5: (c1, 0.846500ns)
signal digit4 :  std_logic;
   -- timing of digit4: (c1, 1.067125ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c1, 1.282125ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c1, 1.500875ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c1, 1.715875ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c1, 1.932750ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c1, 2.147750ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c1, 2.362750ns)
signal outHighBits :  std_logic_vector(3 downto 0);
   -- timing of outHighBits: (c1, 1.932750ns)
begin
...
--------------------------------------------------------------------------------
--                   LeftShifter56_by_max_55_Freq250_uid10
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.405250ns)S: (c1, 3.049750ns)
--  approx. output signal timings: R: (c2, 3.675519ns)
...
entity LeftShifter56_by_max_55_Freq250_uid10 is
    port (clk : in std_logic;
          X : in  std_logic_vector(55 downto 0);
          S : in  std_logic_vector(5 downto 0);
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c2, 3.675519ns)Y: (c0, 0.000000ns)Cin: (c3, 0.538519ns)
--  approx. output signal timings: R: (c3, 1.282519ns)
...
entity IntAdder_63_Freq250_uid13 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_63_Freq250_uid13 is
signal Rtmp :  std_logic_vector(62 downto 0);
   -- timing of Rtmp: (c3, 1.282519ns)
signal X_d1 :  std_logic_vector(62 downto 0);
   -- timing of X: (c2, 3.675519ns)
signal Y_d1, Y_d2, Y_d3 :  std_logic_vector(62 downto 0);
...
--------------------------------------------------------------------------------
--                        flopoco_00164_ieeefpadd_top
--                       (IEEEFPAdd_11_52_Freq250_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c3, 1.969519ns)
...
entity flopoco_00164_ieeefpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00164_ieeefpadd_top is
   component RightShifterSticky55_by_max_54_Freq250_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(54 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(54 downto 0);
   ...
   component IntAdder_56_Freq250_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(55 downto 0);
             Y : in  std_logic_vector(55 downto 0);
             Cin : in  std_logic;
   ...
   component LZC_55_Freq250_uid8 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(54 downto 0);
             O : out  std_logic_vector(5 downto 0)   );
   end component;

   component LeftShifter56_by_max_55_Freq250_uid10 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(55 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(110 downto 0)   );
   ...
   component IntAdder_63_Freq250_uid13 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(62 downto 0);
             Y : in  std_logic_vector(62 downto 0);
             Cin : in  std_logic;
...
signal significandZ :  std_logic_vector(55 downto 0);
   -- timing of significandZ: (c1, 0.405250ns)
signal z1 :  std_logic;
   -- timing of z1: (c1, 0.405250ns)
signal z0 :  std_logic;
   -- timing of z0: (c1, 0.405250ns)
signal lzcZInput :  std_logic_vector(54 downto 0);
   -- timing of lzcZInput: (c1, 0.405250ns)
signal lzc :  std_logic_vector(5 downto 0);
   -- timing of lzc: (c1, 2.362750ns)
signal leftShiftVal :  std_logic_vector(5 downto 0);
   -- timing of leftShiftVal: (c1, 3.049750ns)
signal normalizedSignificand, normalizedSignificand_d1 :  std_logic_vector(110 downto 0);
   -- timing of normalizedSignificand: (c2, 3.675519ns)
signal significandPreRound :  std_logic_vector(51 downto 0);
   -- timing of significandPreRound: (c2, 3.675519ns)
signal lsb, lsb_d1 :  std_logic;
   -- timing of lsb: (c2, 3.675519ns)
signal roundBit, roundBit_d1 :  std_logic;
   -- timing of roundBit: (c2, 3.675519ns)
signal stickyBit :  std_logic;
   -- timing of stickyBit: (c3, 0.323519ns)
signal deltaExp :  std_logic_vector(10 downto 0);
   -- timing of deltaExp: (c1, 2.362750ns)
signal fullCancellation, fullCancellation_d1, fullCancellation_d2 :  std_logic;
   -- timing of fullCancellation: (c1, 2.834750ns)
signal expPreRound, expPreRound_d1 :  std_logic_vector(10 downto 0);
   -- timing of expPreRound: (c1, 2.860750ns)
signal expSigPreRound :  std_logic_vector(62 downto 0);
   -- timing of expSigPreRound: (c2, 3.675519ns)
signal roundUpBit :  std_logic;
   -- timing of roundUpBit: (c3, 0.538519ns)
signal expSigR :  std_logic_vector(62 downto 0);
   -- timing of expSigR: (c3, 1.282519ns)
signal resultIsZero :  std_logic;
   -- timing of resultIsZero: (c3, 1.754519ns)
signal resultIsInf :  std_logic;
   -- timing of resultIsInf: (c3, 1.754519ns)
signal constInf, constInf_d1, constInf_d2, constInf_d3 :  std_logic_vector(62 downto 0);
   -- timing of constInf: (c0, 0.000000ns)
signal constNaN, constNaN_d1, constNaN_d2, constNaN_d3 :  std_logic_vector(62 downto 0);
   -- timing of constNaN: (c0, 0.000000ns)
signal expSigR2 :  std_logic_vector(62 downto 0);
   -- timing of expSigR2: (c3, 1.969519ns)
signal signR :  std_logic;
   -- timing of signR: (c3, 1.969519ns)
signal computedR :  std_logic_vector(63 downto 0);
   -- timing of computedR: (c3, 1.969519ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   RightShifterComponent: RightShifterSticky55_by_max_54_Freq250_uid4
      port map ( clk  => clk,
   ...
   fracAdder: IntAdder_56_Freq250_uid6
      port map ( clk  => clk,
                 Cin => carryIn,
                 X => summandX,
                 Y => summandY,
   ...
   IEEEFPAdd_11_52_Freq250_uid2LeadingZeroCounter: LZC_55_Freq250_uid8
      port map ( clk  => clk,
                 I => lzcZInput,
                 O => lzc);
   leftShiftVal <= 
      lzc when ((z1='1') or (z1='0' and z0='1' and xExpFieldZero_d1='1') or (z1='0' and z0='0' and xExpFieldZero_d1='0' and lzc<=expNewX_d1)  or (xExpFieldZero_d1='0' and lzc>=55) ) 
      else (expNewX_d1(5 downto 0)) when (xExpFieldZero_d1='0' and (lzc < 55) and (("00000"&lzc)>=expNewX_d1)) 
       else "00000"&'1';
   LeftShifterComponent: LeftShifter56_by_max_55_Freq250_uid10
      port map ( clk  => clk,
                 S => leftShiftVal,
                 X => significandZ,
   ...
   roundingAdder: IntAdder_63_Freq250_uid13
      port map ( clk  => clk,
                 Cin => roundUpBit,
                 X => expSigPreRound,
   ...
   resultIsInf <= '1' when resultIsNaN_d3='0' and (((xIsInfinity_d3='1' and yIsInfinity_d3='1'  and EffSub_d3='0')  or (xIsInfinity_d3='0' and yIsInfinity_d3='1')  or (xIsInfinity_d3='1' and yIsInfinity_d3='0')  or  (expSigR(62 downto 52)="11111111111"))) else '0';
