...
--  approx. output signal timings: O: (c1, 0.065096ns)
...
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c1, 0.065096ns)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c0, 2.398846ns)S: (c1, 0.065096ns)
--  approx. output signal timings: R: (c1, 3.663942ns)
...
entity flopoco_00093_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00093_ieeefpfma_top is
...
signal tmpExpCompRes2 :  std_logic_vector(6 downto 0);
   -- timing of tmpExpCompRes2: (c1, 0.065096ns)
signal RisSubNormal :  std_logic;
   -- timing of RisSubNormal: (c1, 0.065096ns)
signal RisZero :  std_logic;
   -- timing of RisZero: (c1, 0.065096ns)
signal RisSubNormalOrZero :  std_logic;
   -- timing of RisSubNormalOrZero: (c1, 0.065096ns)
signal Rsgn :  std_logic;
   -- timing of Rsgn: (c1, 0.065096ns)
...
signal normShiftValue :  std_logic_vector(5 downto 0);
   -- timing of normShiftValue: (c1, 0.065096ns)
signal BigSumNormd :  std_logic_vector(72 downto 0);
   -- timing of BigSumNormd: (c1, 3.663942ns)
signal expTentative :  std_logic_vector(6 downto 0);
   -- timing of expTentative: (c1, 0.065096ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c1, 3.663942ns)
signal fracTentative :  std_logic_vector(13 downto 0);
   -- timing of fracTentative: (c1, 3.663942ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c1, 3.663942ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c1, 3.663942ns)
signal fracResultNormd :  std_logic_vector(9 downto 0);
   -- timing of fracResultNormd: (c1, 3.663942ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c1, 3.663942ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c1, 3.663942ns)
signal round :  std_logic;
   -- timing of round: (c1, 3.663942ns)
signal expUpdate :  std_logic_vector(6 downto 0);
   -- timing of expUpdate: (c1, 3.663942ns)
signal exponentResult1 :  std_logic_vector(6 downto 0);
   -- timing of exponentResult1: (c1, 3.663942ns)
signal resultBeforeRound :  std_logic_vector(16 downto 0);
   -- timing of resultBeforeRound: (c1, 3.663942ns)
signal resultRounded :  std_logic_vector(16 downto 0);
   -- timing of resultRounded: (c1, 3.663942ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c1, 3.663942ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c1, 3.663942ns)
