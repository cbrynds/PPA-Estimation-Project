--------------------------------------------------------------------------------
--                    CBLKTable_l0_d3_alpha3_Freq200_uid7
...
entity CBLKTable_l0_d3_alpha3_Freq200_uid7 is
    port (X : in  std_logic_vector(2 downto 0);
          Y : out  std_logic_vector(3 downto 0)   );
end entity;

architecture arch of CBLKTable_l0_d3_alpha3_Freq200_uid7 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l1_d3_alpha3_Freq200_uid24
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l1_d3_alpha3_Freq200_uid24 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(4 downto 0)   );
end entity;

architecture arch of CBLKTable_l1_d3_alpha3_Freq200_uid24 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l2_d3_alpha3_Freq200_uid35
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l2_d3_alpha3_Freq200_uid35 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(7 downto 0)   );
end entity;

architecture arch of CBLKTable_l2_d3_alpha3_Freq200_uid35 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l3_d3_alpha3_Freq200_uid43
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l3_d3_alpha3_Freq200_uid43 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(13 downto 0)   );
end entity;

architecture arch of CBLKTable_l3_d3_alpha3_Freq200_uid43 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l4_d3_alpha3_Freq200_uid49
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l4_d3_alpha3_Freq200_uid49 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(25 downto 0)   );
end entity;

architecture arch of CBLKTable_l4_d3_alpha3_Freq200_uid49 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_3_38_1_3_Freq200_uid3
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity IntConstDiv_QR_3_38_1_3_Freq200_uid3 is
...
architecture arch of IntConstDiv_QR_3_38_1_3_Freq200_uid3 is
   component CBLKTable_l0_d3_alpha3_Freq200_uid7 is
      port ( X : in  std_logic_vector(2 downto 0);
             Y : out  std_logic_vector(3 downto 0)   );
   end component;

   component CBLKTable_l1_d3_alpha3_Freq200_uid24 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(4 downto 0)   );
   end component;

   component CBLKTable_l2_d3_alpha3_Freq200_uid35 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(7 downto 0)   );
   end component;

   component CBLKTable_l3_d3_alpha3_Freq200_uid43 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(13 downto 0)   );
   end component;

   component CBLKTable_l4_d3_alpha3_Freq200_uid49 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(25 downto 0)   );
   end component;
...
signal qs_l0_12 :  std_logic_vector(0 downto 0);
...
signal out_l1_0_copy25 :  std_logic_vector(4 downto 0);
   -- timing of out_l1_0_copy25: (c0, 0.722000ns)
...
signal out_l1_1_copy26 :  std_logic_vector(4 downto 0);
   -- timing of out_l1_1_copy26: (c0, 0.722000ns)
...
signal out_l1_2_copy27 :  std_logic_vector(4 downto 0);
   -- timing of out_l1_2_copy27: (c0, 0.722000ns)
...
signal out_l1_3_copy28 :  std_logic_vector(4 downto 0);
   -- timing of out_l1_3_copy28: (c0, 0.722000ns)
...
signal out_l1_4_copy29 :  std_logic_vector(4 downto 0);
   -- timing of out_l1_4_copy29: (c0, 0.722000ns)
...
signal out_l1_5_copy30 :  std_logic_vector(4 downto 0);
   -- timing of out_l1_5_copy30: (c0, 0.722000ns)
...
signal out_l1_6 :  std_logic_vector(4 downto 0);
   -- timing of out_l1_6: (c0, 0.937000ns)
signal out_l1_6_copy31 :  std_logic_vector(4 downto 0);
   -- timing of out_l1_6_copy31: (c0, 0.722000ns)
signal r_l1_6 :  std_logic_vector(1 downto 0);
   -- timing of r_l1_6: (c0, 0.937000ns)
signal q_l1_6 :  std_logic_vector(0 downto 0);
   -- timing of q_l1_6: (c0, 0.937000ns)
signal qs_l1_6 :  std_logic_vector(0 downto 0);
...
signal out_l2_0_copy36 :  std_logic_vector(7 downto 0);
   -- timing of out_l2_0_copy36: (c0, 0.937000ns)
...
signal out_l2_1_copy37 :  std_logic_vector(7 downto 0);
   -- timing of out_l2_1_copy37: (c0, 0.937000ns)
...
signal out_l2_2_copy38 :  std_logic_vector(7 downto 0);
   -- timing of out_l2_2_copy38: (c0, 0.937000ns)
...
signal out_l2_3 :  std_logic_vector(7 downto 0);
   -- timing of out_l2_3: (c0, 1.152000ns)
signal out_l2_3_copy39 :  std_logic_vector(7 downto 0);
   -- timing of out_l2_3_copy39: (c0, 0.937000ns)
signal r_l2_3 :  std_logic_vector(1 downto 0);
   -- timing of r_l2_3: (c0, 1.152000ns)
signal q_l2_3 :  std_logic_vector(0 downto 0);
   -- timing of q_l2_3: (c0, 1.152000ns)
signal qs_l2_3 :  std_logic_vector(0 downto 0);
...
signal out_l3_0_copy44 :  std_logic_vector(13 downto 0);
   -- timing of out_l3_0_copy44: (c0, 1.152000ns)
...
signal out_l3_1_copy45 :  std_logic_vector(13 downto 0);
   -- timing of out_l3_1_copy45: (c0, 1.152000ns)
signal r_l3_1 :  std_logic_vector(1 downto 0);
   -- timing of r_l3_1: (c0, 1.367000ns)
signal q_l3_1 :  std_logic_vector(12 downto 0);
   -- timing of q_l3_1: (c0, 1.367000ns)
signal qs_l3_1 :  std_logic_vector(12 downto 0);
...
signal out_l4_0_copy50 :  std_logic_vector(25 downto 0);
   -- timing of out_l4_0_copy50: (c0, 1.367000ns)
signal r_l4_0 :  std_logic_vector(1 downto 0);
   -- timing of r_l4_0: (c0, 1.582000ns)
signal q_l4_0 :  std_logic_vector(36 downto 0);
   -- timing of q_l4_0: (c0, 1.582000ns)
signal qs_l4_0 :  std_logic_vector(36 downto 0);
   -- timing of qs_l4_0: (c0, 3.067000ns)
begin
   x0 <= X(2 downto 0);
   table0: CBLKTable_l0_d3_alpha3_Freq200_uid7
      port map ( X => x0,
                 Y => out0_copy8);
   ...
   x1 <= X(5 downto 3);
   table1: CBLKTable_l0_d3_alpha3_Freq200_uid7
      port map ( X => x1,
                 Y => out1_copy9);
   ...
   x2 <= X(8 downto 6);
   table2: CBLKTable_l0_d3_alpha3_Freq200_uid7
      port map ( X => x2,
                 Y => out2_copy10);
   ...
   x3 <= X(11 downto 9);
   table3: CBLKTable_l0_d3_alpha3_Freq200_uid7
      port map ( X => x3,
                 Y => out3_copy11);
   ...
   x4 <= X(14 downto 12);
   table4: CBLKTable_l0_d3_alpha3_Freq200_uid7
      port map ( X => x4,
                 Y => out4_copy12);
   ...
   x5 <= X(17 downto 15);
   table5: CBLKTable_l0_d3_alpha3_Freq200_uid7
      port map ( X => x5,
                 Y => out5_copy13);
   ...
   x6 <= X(20 downto 18);
   table6: CBLKTable_l0_d3_alpha3_Freq200_uid7
      port map ( X => x6,
                 Y => out6_copy14);
   ...
   x7 <= X(23 downto 21);
   table7: CBLKTable_l0_d3_alpha3_Freq200_uid7
      port map ( X => x7,
                 Y => out7_copy15);
   ...
   x8 <= X(26 downto 24);
   table8: CBLKTable_l0_d3_alpha3_Freq200_uid7
      port map ( X => x8,
                 Y => out8_copy16);
   ...
   x9 <= X(29 downto 27);
   table9: CBLKTable_l0_d3_alpha3_Freq200_uid7
      port map ( X => x9,
                 Y => out9_copy17);
   ...
   x10 <= X(32 downto 30);
   table10: CBLKTable_l0_d3_alpha3_Freq200_uid7
      port map ( X => x10,
                 Y => out10_copy18);
   ...
   x11 <= X(35 downto 33);
   table11: CBLKTable_l0_d3_alpha3_Freq200_uid7
      port map ( X => x11,
                 Y => out11_copy19);
   out11 <= out11_copy19; -- output copy to hold a pipeline register if needed
   qs_l0_11 <= "0" & (out11(3 downto 2));
   r_l0_11 <= out11(1 downto 0);
   x12 <= "0" & X(37 downto 36);
   table12: CBLKTable_l0_d3_alpha3_Freq200_uid7
      port map ( X => x12,
                 Y => out12_copy20);
   out12 <= out12_copy20; -- output copy to hold a pipeline register if needed
   qs_l0_12 <= out12(2 downto 2);
   r_l0_12 <= out12(1 downto 0);
   in_l1_0 <= r_l0_1 & r_l0_0;
   table_l1_0: CBLKTable_l1_d3_alpha3_Freq200_uid24
      port map ( X => in_l1_0,
                 Y => out_l1_0_copy25);
   out_l1_0 <= out_l1_0_copy25; -- output copy to hold a pipeline register if needed
   ...
   table_l1_1: CBLKTable_l1_d3_alpha3_Freq200_uid24
      port map ( X => in_l1_1,
                 Y => out_l1_1_copy26);
   out_l1_1 <= out_l1_1_copy26; -- output copy to hold a pipeline register if needed
   ...
   table_l1_2: CBLKTable_l1_d3_alpha3_Freq200_uid24
      port map ( X => in_l1_2,
                 Y => out_l1_2_copy27);
   out_l1_2 <= out_l1_2_copy27; -- output copy to hold a pipeline register if needed
   ...
   table_l1_3: CBLKTable_l1_d3_alpha3_Freq200_uid24
      port map ( X => in_l1_3,
                 Y => out_l1_3_copy28);
   out_l1_3 <= out_l1_3_copy28; -- output copy to hold a pipeline register if needed
   ...
   table_l1_4: CBLKTable_l1_d3_alpha3_Freq200_uid24
      port map ( X => in_l1_4,
                 Y => out_l1_4_copy29);
   out_l1_4 <= out_l1_4_copy29; -- output copy to hold a pipeline register if needed
   ...
   table_l1_5: CBLKTable_l1_d3_alpha3_Freq200_uid24
      port map ( X => in_l1_5,
                 Y => out_l1_5_copy30);
   out_l1_5 <= out_l1_5_copy30; -- output copy to hold a pipeline register if needed
   r_l1_5 <= out_l1_5(1 downto 0);
   q_l1_5 <= "000" & out_l1_5(4 downto 2);
   qs_l1_5 <= q_l1_5 + (qs_l0_11 & qs_l0_10);  -- partial quotient so far
   in_l1_6 <= "00" & r_l0_12;
   table_l1_6: CBLKTable_l1_d3_alpha3_Freq200_uid24
      port map ( X => in_l1_6,
                 Y => out_l1_6_copy31);
   out_l1_6 <= out_l1_6_copy31; -- output copy to hold a pipeline register if needed
   r_l1_6 <= out_l1_6(1 downto 0);
   q_l1_6 <= out_l1_6(2 downto 2);
   qs_l1_6 <= q_l1_6 + qs_l0_12;  -- partial quotient so far
   in_l2_0 <= r_l1_1 & r_l1_0;
   table_l2_0: CBLKTable_l2_d3_alpha3_Freq200_uid35
      port map ( X => in_l2_0,
                 Y => out_l2_0_copy36);
   out_l2_0 <= out_l2_0_copy36; -- output copy to hold a pipeline register if needed
   ...
   table_l2_1: CBLKTable_l2_d3_alpha3_Freq200_uid35
      port map ( X => in_l2_1,
                 Y => out_l2_1_copy37);
   out_l2_1 <= out_l2_1_copy37; -- output copy to hold a pipeline register if needed
   ...
   table_l2_2: CBLKTable_l2_d3_alpha3_Freq200_uid35
      port map ( X => in_l2_2,
                 Y => out_l2_2_copy38);
   out_l2_2 <= out_l2_2_copy38; -- output copy to hold a pipeline register if needed
   r_l2_2 <= out_l2_2(1 downto 0);
   q_l2_2 <= "000000" & out_l2_2(7 downto 2);
   qs_l2_2 <= q_l2_2 + (qs_l1_5 & qs_l1_4);  -- partial quotient so far
   in_l2_3 <= "00" & r_l1_6;
   table_l2_3: CBLKTable_l2_d3_alpha3_Freq200_uid35
      port map ( X => in_l2_3,
                 Y => out_l2_3_copy39);
   out_l2_3 <= out_l2_3_copy39; -- output copy to hold a pipeline register if needed
   r_l2_3 <= out_l2_3(1 downto 0);
   q_l2_3 <= out_l2_3(2 downto 2);
   qs_l2_3 <= q_l2_3 + qs_l1_6;  -- partial quotient so far
   in_l3_0 <= r_l2_1 & r_l2_0;
   table_l3_0: CBLKTable_l3_d3_alpha3_Freq200_uid43
      port map ( X => in_l3_0,
                 Y => out_l3_0_copy44);
   out_l3_0 <= out_l3_0_copy44; -- output copy to hold a pipeline register if needed
   ...
   table_l3_1: CBLKTable_l3_d3_alpha3_Freq200_uid43
      port map ( X => in_l3_1,
                 Y => out_l3_1_copy45);
   out_l3_1 <= out_l3_1_copy45; -- output copy to hold a pipeline register if needed
   r_l3_1 <= out_l3_1(1 downto 0);
   q_l3_1 <= "0" & out_l3_1(13 downto 2);
   qs_l3_1 <= q_l3_1 + (qs_l2_3 & qs_l2_2);  -- partial quotient so far
   in_l4_0 <= r_l3_1 & r_l3_0;
   table_l4_0: CBLKTable_l4_d3_alpha3_Freq200_uid49
      port map ( X => in_l4_0,
                 Y => out_l4_0_copy50);
   out_l4_0 <= out_l4_0_copy50; -- output copy to hold a pipeline register if needed
   r_l4_0 <= out_l4_0(1 downto 0);
   q_l4_0 <= "0000000000000" & out_l4_0(25 downto 2);
   qs_l4_0 <= q_l4_0 + (qs_l3_1 & qs_l3_0);  -- partial quotient so far
   Q <= qs_l4_0(36 downto 0);
   R <= r_l4_0;
end architecture;

--------------------------------------------------------------------------------
--                        flopoco_00317_fpconstdiv_top
--                     (FPConstDiv_10_35_10_35_3_1_0_200)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00317_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(10+35+2 downto 0);
          R : out  std_logic_vector(10+35+2 downto 0)   );
end entity;

architecture arch of flopoco_00317_fpconstdiv_top is
   component IntConstDiv_QR_3_38_1_3_Freq200_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(37 downto 0);
             Q : out  std_logic_vector(36 downto 0);
             R : out  std_logic_vector(1 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_3_38_1_3_Freq200_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
