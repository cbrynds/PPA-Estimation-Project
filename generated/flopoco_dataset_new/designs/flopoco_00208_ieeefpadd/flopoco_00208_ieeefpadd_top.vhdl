--------------------------------------------------------------------------------
--                RightShifterSticky55_by_max_54_Freq150_uid4
...
entity RightShifterSticky55_by_max_54_Freq150_uid4 is
...
architecture arch of RightShifterSticky55_by_max_54_Freq150_uid4 is
...
entity IntAdder_56_Freq150_uid6 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_56_Freq150_uid6 is
...
--  approx. output signal timings: O: (c0, 6.171750ns)
...
entity LZC_55_Freq150_uid8 is
    port (clk : in std_logic;
          I : in  std_logic_vector(54 downto 0);
          O : out  std_logic_vector(5 downto 0)   );
end entity;

architecture arch of LZC_55_Freq150_uid8 is
...
signal digit4 :  std_logic;
   -- timing of digit4: (c0, 4.876125ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c0, 5.091125ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c0, 5.309875ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c0, 5.524875ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c0, 5.741750ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c0, 5.956750ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c0, 6.171750ns)
signal outHighBits :  std_logic_vector(3 downto 0);
   -- timing of outHighBits: (c0, 5.741750ns)
begin
...
--------------------------------------------------------------------------------
--                   LeftShifter56_by_max_55_Freq150_uid10
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c0, 4.214250ns)S: (c1, 0.342083ns)
--  approx. output signal timings: R: (c1, 4.817853ns)
...
entity LeftShifter56_by_max_55_Freq150_uid10 is
    port (clk : in std_logic;
          X : in  std_logic_vector(55 downto 0);
          S : in  std_logic_vector(5 downto 0);
...
architecture arch of LeftShifter56_by_max_55_Freq150_uid10 is
signal ps :  std_logic_vector(5 downto 0);
   -- timing of ps: (c1, 0.342083ns)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 4.817853ns)Y: (c0, 0.000000ns)Cin: (c1, 5.530853ns)
--  approx. output signal timings: R: (c1, 6.274853ns)
...
entity IntAdder_63_Freq150_uid13 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_63_Freq150_uid13 is
signal Rtmp :  std_logic_vector(62 downto 0);
   -- timing of Rtmp: (c1, 6.274853ns)
signal Y_d1 :  std_logic_vector(62 downto 0);
...
--------------------------------------------------------------------------------
--                        flopoco_00208_ieeefpadd_top
--                       (IEEEFPAdd_11_52_Freq150_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c2, 0.445186ns)
...
entity flopoco_00208_ieeefpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00208_ieeefpadd_top is
   component RightShifterSticky55_by_max_54_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(54 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(54 downto 0);
   ...
   component IntAdder_56_Freq150_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(55 downto 0);
             Y : in  std_logic_vector(55 downto 0);
             Cin : in  std_logic;
   ...
   component LZC_55_Freq150_uid8 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(54 downto 0);
             O : out  std_logic_vector(5 downto 0)   );
   end component;

   component LeftShifter56_by_max_55_Freq150_uid10 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(55 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(110 downto 0)   );
   ...
   component IntAdder_63_Freq150_uid13 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(62 downto 0);
             Y : in  std_logic_vector(62 downto 0);
             Cin : in  std_logic;
...
signal lzc, lzc_d1 :  std_logic_vector(5 downto 0);
   -- timing of lzc: (c0, 6.171750ns)
signal leftShiftVal :  std_logic_vector(5 downto 0);
   -- timing of leftShiftVal: (c1, 0.342083ns)
signal normalizedSignificand :  std_logic_vector(110 downto 0);
   -- timing of normalizedSignificand: (c1, 4.817853ns)
signal significandPreRound :  std_logic_vector(51 downto 0);
   -- timing of significandPreRound: (c1, 4.817853ns)
signal lsb :  std_logic;
   -- timing of lsb: (c1, 4.817853ns)
signal roundBit :  std_logic;
   -- timing of roundBit: (c1, 4.817853ns)
signal stickyBit :  std_logic;
   -- timing of stickyBit: (c1, 5.315853ns)
signal deltaExp, deltaExp_d1 :  std_logic_vector(10 downto 0);
   -- timing of deltaExp: (c0, 6.171750ns)
signal fullCancellation, fullCancellation_d1 :  std_logic;
   -- timing of fullCancellation: (c1, 0.127083ns)
signal expPreRound :  std_logic_vector(10 downto 0);
   -- timing of expPreRound: (c1, 0.153083ns)
signal expSigPreRound :  std_logic_vector(62 downto 0);
   -- timing of expSigPreRound: (c1, 4.817853ns)
signal roundUpBit :  std_logic;
   -- timing of roundUpBit: (c1, 5.530853ns)
signal expSigR, expSigR_d1 :  std_logic_vector(62 downto 0);
   -- timing of expSigR: (c1, 6.274853ns)
signal resultIsZero :  std_logic;
   -- timing of resultIsZero: (c2, 0.230186ns)
signal resultIsInf :  std_logic;
   -- timing of resultIsInf: (c2, 0.230186ns)
...
signal expSigR2 :  std_logic_vector(62 downto 0);
   -- timing of expSigR2: (c2, 0.445186ns)
signal signR :  std_logic;
   -- timing of signR: (c2, 0.445186ns)
signal computedR :  std_logic_vector(63 downto 0);
   -- timing of computedR: (c2, 0.445186ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   RightShifterComponent: RightShifterSticky55_by_max_54_Freq150_uid4
      port map ( clk  => clk,
   ...
   fracAdder: IntAdder_56_Freq150_uid6
      port map ( clk  => clk,
                 Cin => carryIn,
                 X => summandX,
                 Y => summandY,
   ...
   IEEEFPAdd_11_52_Freq150_uid2LeadingZeroCounter: LZC_55_Freq150_uid8
      port map ( clk  => clk,
                 I => lzcZInput,
                 O => lzc);
   leftShiftVal <= 
      lzc_d1 when ((z1_d1='1') or (z1_d1='0' and z0_d1='1' and xExpFieldZero_d1='1') or (z1_d1='0' and z0_d1='0' and xExpFieldZero_d1='0' and lzc_d1<=expNewX_d1)  or (xExpFieldZero_d1='0' and lzc_d1>=55) ) 
      else (expNewX_d1(5 downto 0)) when (xExpFieldZero_d1='0' and (lzc_d1 < 55) and (("00000"&lzc_d1)>=expNewX_d1)) 
       else "00000"&'1';
   LeftShifterComponent: LeftShifter56_by_max_55_Freq150_uid10
      port map ( clk  => clk,
                 S => leftShiftVal,
                 X => significandZ,
   ...
   deltaExp <=    -- value to subtract to exponent for normalization
      "00000000000" when ( (z1='0' and z0='1' and xExpFieldZero='0')
          or  (z1='0' and z0='0' and xExpFieldZero='1') )
      else "11111111111" when ( (z1='1')  or  (z1='0' and z0='1' and xExpFieldZero='1'))
      else ("00000" & lzc)-'1' when (z1='0' and z0='0' and xExpFieldZero='0' and lzc<=expNewX and lzc<55)      else expNewX;
   ...
   roundingAdder: IntAdder_63_Freq150_uid13
      port map ( clk  => clk,
                 Cin => roundUpBit,
                 X => expSigPreRound,
                 ...
                 R => expSigR);
   -- Final packing
   resultIsZero <= '1' when (fullCancellation_d1='1' and expSigR_d1(62 downto 52)="00000000000") else '0';
   resultIsInf <= '1' when resultIsNaN_d2='0' and (((xIsInfinity_d2='1' and yIsInfinity_d2='1'  and EffSub_d2='0')  or (xIsInfinity_d2='0' and yIsInfinity_d2='1')  or (xIsInfinity_d2='1' and yIsInfinity_d2='0')  or  (expSigR_d1(62 downto 52)="11111111111"))) else '0';
