--------------------------------------------------------------------------------
--                RightShifterSticky26_by_max_25_Freq200_uid4
...
entity RightShifterSticky26_by_max_25_Freq200_uid4 is
...
architecture arch of RightShifterSticky26_by_max_25_Freq200_uid4 is
...
--  approx. output signal timings: O: (c1, 0.423250ns)
...
entity LZC_26_Freq200_uid8 is
    port (clk : in std_logic;
          I : in  std_logic_vector(25 downto 0);
          O : out  std_logic_vector(4 downto 0)   );
end entity;

architecture arch of LZC_26_Freq200_uid8 is
...
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c1, 0.208250ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c1, 0.423250ns)
...
--------------------------------------------------------------------------------
--                   LeftShifter27_by_max_26_Freq200_uid10
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c0, 3.757000ns)S: (c1, 1.110250ns)
--  approx. output signal timings: R: (c1, 2.647942ns)
...
entity LeftShifter27_by_max_26_Freq200_uid10 is
    port (clk : in std_logic;
          X : in  std_logic_vector(26 downto 0);
          S : in  std_logic_vector(4 downto 0);
...
architecture arch of LeftShifter27_by_max_26_Freq200_uid10 is
signal ps :  std_logic_vector(4 downto 0);
   -- timing of ps: (c1, 1.110250ns)
signal level0, level0_d1 :  std_logic_vector(26 downto 0);
   -- timing of level0: (c0, 3.757000ns)
signal level1 :  std_logic_vector(27 downto 0);
   -- timing of level1: (c1, 1.110250ns)
signal level2 :  std_logic_vector(29 downto 0);
   -- timing of level2: (c1, 1.786788ns)
signal level3 :  std_logic_vector(33 downto 0);
   -- timing of level3: (c1, 1.786788ns)
signal level4 :  std_logic_vector(41 downto 0);
   -- timing of level4: (c1, 2.647942ns)
signal level5 :  std_logic_vector(57 downto 0);
   -- timing of level5: (c1, 2.647942ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 2.647942ns)Y: (c0, 0.000000ns)Cin: (c1, 3.334942ns)
--  approx. output signal timings: R: (c1, 3.914942ns)
...
entity IntAdder_31_Freq200_uid13 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_31_Freq200_uid13 is
signal Rtmp :  std_logic_vector(30 downto 0);
   -- timing of Rtmp: (c1, 3.914942ns)
...
--------------------------------------------------------------------------------
--                        flopoco_00432_ieeefpadd_top
--                       (IEEEFPAdd_8_23_Freq200_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 4.601942ns)
...
entity flopoco_00432_ieeefpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00432_ieeefpadd_top is
   component RightShifterSticky26_by_max_25_Freq200_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(25 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(25 downto 0);
   ...
   component LZC_26_Freq200_uid8 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(25 downto 0);
             O : out  std_logic_vector(4 downto 0)   );
   end component;

   component LeftShifter27_by_max_26_Freq200_uid10 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(26 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(52 downto 0)   );
   ...
   component IntAdder_31_Freq200_uid13 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(30 downto 0);
             Y : in  std_logic_vector(30 downto 0);
             Cin : in  std_logic;
...
signal lzc :  std_logic_vector(4 downto 0);
   -- timing of lzc: (c1, 0.423250ns)
signal leftShiftVal :  std_logic_vector(4 downto 0);
   -- timing of leftShiftVal: (c1, 1.110250ns)
signal normalizedSignificand :  std_logic_vector(52 downto 0);
   -- timing of normalizedSignificand: (c1, 2.647942ns)
signal significandPreRound :  std_logic_vector(22 downto 0);
   -- timing of significandPreRound: (c1, 2.647942ns)
signal lsb :  std_logic;
   -- timing of lsb: (c1, 2.647942ns)
signal roundBit :  std_logic;
   -- timing of roundBit: (c1, 2.647942ns)
signal stickyBit :  std_logic;
   -- timing of stickyBit: (c1, 3.119942ns)
signal deltaExp :  std_logic_vector(7 downto 0);
   -- timing of deltaExp: (c1, 0.423250ns)
signal fullCancellation :  std_logic;
   -- timing of fullCancellation: (c1, 0.895250ns)
signal expPreRound :  std_logic_vector(7 downto 0);
   -- timing of expPreRound: (c1, 0.895250ns)
signal expSigPreRound :  std_logic_vector(30 downto 0);
   -- timing of expSigPreRound: (c1, 2.647942ns)
signal roundUpBit :  std_logic;
   -- timing of roundUpBit: (c1, 3.334942ns)
signal expSigR :  std_logic_vector(30 downto 0);
   -- timing of expSigR: (c1, 3.914942ns)
signal resultIsZero :  std_logic;
   -- timing of resultIsZero: (c1, 4.386942ns)
signal resultIsInf :  std_logic;
   -- timing of resultIsInf: (c1, 4.386942ns)
...
signal expSigR2 :  std_logic_vector(30 downto 0);
   -- timing of expSigR2: (c1, 4.601942ns)
signal signR :  std_logic;
   -- timing of signR: (c1, 4.601942ns)
signal computedR :  std_logic_vector(31 downto 0);
   -- timing of computedR: (c1, 4.601942ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   RightShifterComponent: RightShifterSticky26_by_max_25_Freq200_uid4
      port map ( clk  => clk,
   ...
   IEEEFPAdd_8_23_Freq200_uid2LeadingZeroCounter: LZC_26_Freq200_uid8
      port map ( clk  => clk,
                 I => lzcZInput,
                 O => lzc);
   leftShiftVal <= 
      lzc when ((z1_d1='1') or (z1_d1='0' and z0_d1='1' and xExpFieldZero_d1='1') or (z1_d1='0' and z0_d1='0' and xExpFieldZero_d1='0' and lzc<=expNewX_d1)  or (xExpFieldZero_d1='0' and lzc>=26) ) 
      else (expNewX_d1(4 downto 0)) when (xExpFieldZero_d1='0' and (lzc < 26) and (("000"&lzc)>=expNewX_d1)) 
       else "0000"&'1';
   LeftShifterComponent: LeftShifter27_by_max_26_Freq200_uid10
      port map ( clk  => clk,
                 S => leftShiftVal,
                 X => significandZ,
   ...
   deltaExp <=    -- value to subtract to exponent for normalization
      ...
      else ("000" & lzc)-'1' when (z1_d1='0' and z0_d1='0' and xExpFieldZero_d1='0' and lzc<=expNewX_d1 and lzc<26)      else expNewX_d1;
   ...
   roundingAdder: IntAdder_31_Freq200_uid13
      port map ( clk  => clk,
                 Cin => roundUpBit,
                 X => expSigPreRound,
