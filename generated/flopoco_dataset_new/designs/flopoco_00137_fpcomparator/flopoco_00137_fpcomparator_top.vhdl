--------------------------------------------------------------------------------
--                     IntComparator_15_010_Freq150_uid4
...
entity IntComparator_15_010_Freq150_uid4 is
...
architecture arch of IntComparator_15_010_Freq150_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00137_fpcomparator_top
...
entity flopoco_00137_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00137_fpcomparator_top is
   component IntComparator_15_010_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(14 downto 0);
             Y : in  std_logic_vector(14 downto 0);
             XeqY : out  std_logic   );
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_15_010_Freq150_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
