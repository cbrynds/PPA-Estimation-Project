...
--  approx. output signal timings: R: (c4, 2.550000ns)
...
entity flopoco_00165_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+23+2 downto 0);
          R : out  std_logic_vector(8+23+2 downto 0)   );
end entity;

architecture arch of flopoco_00165_fpsqrt_top is
...
signal R13s_l :  std_logic_vector(9 downto 0);
...
signal fR :  std_logic_vector(22 downto 0);
   -- timing of fR: (c4, 2.011000ns)
signal round :  std_logic;
   -- timing of round: (c4, 1.976000ns)
signal fRrnd :  std_logic_vector(22 downto 0);
   -- timing of fRrnd: (c4, 2.550000ns)
signal Rn2 :  std_logic_vector(30 downto 0);
   -- timing of Rn2: (c4, 2.550000ns)
