--------------------------------------------------------------------------------
--                     IntComparator_39_010_Freq500_uid4
...
entity IntComparator_39_010_Freq500_uid4 is
...
architecture arch of IntComparator_39_010_Freq500_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00155_fpcomparator_top
...
entity flopoco_00155_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00155_fpcomparator_top is
   component IntComparator_39_010_Freq500_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(38 downto 0);
             Y : in  std_logic_vector(38 downto 0);
             XeqY : out  std_logic   );
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_39_010_Freq500_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
