--------------------------------------------------------------------------------
--                    RightShifter8_by_max_28_Freq150_uid4
...
entity RightShifter8_by_max_28_Freq150_uid4 is
...
architecture arch of RightShifter8_by_max_28_Freq150_uid4 is
...
entity LZC_20_Freq150_uid6 is
    port (clk : in std_logic;
          I : in  std_logic_vector(19 downto 0);
          O : out  std_logic_vector(4 downto 0)   );
end entity;

architecture arch of LZC_20_Freq150_uid6 is
...
--------------------------------------------------------------------------------
--                    LeftShifter28_by_max_27_Freq150_uid8
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
entity LeftShifter28_by_max_27_Freq150_uid8 is
    port (clk : in std_logic;
...
architecture arch of LeftShifter28_by_max_27_Freq150_uid8 is
signal ps :  std_logic_vector(4 downto 0);
...
--------------------------------------------------------------------------------
--                        flopoco_00129_ieeefpfma_top
--                        (IEEEFPFMA_8_7_Freq150_uid2)
...
entity flopoco_00129_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00129_ieeefpfma_top is
   component RightShifter8_by_max_28_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(7 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(35 downto 0)   );
   ...
   component LZC_20_Freq150_uid6 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(19 downto 0);
             O : out  std_logic_vector(4 downto 0)   );
   end component;

   component LeftShifter28_by_max_27_Freq150_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(27 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(54 downto 0)   );
...
begin
   ...
   RightShifterComponent: RightShifter8_by_max_28_Freq150_uid4
      port map ( clk  => clk,
                 S => ShiftValue,
                 X => Csig,
                 R => CsigShifted);
   ...
   IEEEFPFMA_8_7_Freq150_uid2LeadingZeroCounter: LZC_20_Freq150_uid6
      port map ( clk  => clk,
   ...
   NormalizationShifter: LeftShifter28_by_max_27_Freq150_uid8
      port map ( clk  => clk,
                 S => normShiftValue,
                 X => BigSumAbs,
                 R => BigSumNormd);
