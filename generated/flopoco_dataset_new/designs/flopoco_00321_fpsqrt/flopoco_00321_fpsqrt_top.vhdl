...
--  approx. output signal timings: R: (c1, 1.051000ns)
...
entity flopoco_00321_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00321_fpsqrt_top is
...
signal R5s_l :  std_logic_vector(1 downto 0);
...
signal R6s_l, R6s_l_d1 :  std_logic_vector(0 downto 0);
...
signal fR :  std_logic_vector(6 downto 0);
   -- timing of fR: (c1, 0.579000ns)
signal round :  std_logic;
   -- timing of round: (c1, 0.544000ns)
signal fRrnd :  std_logic_vector(6 downto 0);
   -- timing of fRrnd: (c1, 1.051000ns)
signal Rn2 :  std_logic_vector(14 downto 0);
   -- timing of Rn2: (c1, 1.051000ns)
