...
--  approx. output signal timings: R: (c12, 0.470067ns)
...
entity flopoco_00382_fpdiv_top is
...
architecture arch of flopoco_00382_fpdiv_top is
...
signal prescaledfY, prescaledfY_d1, prescaledfY_d2, prescaledfY_d3, prescaledfY_d4, prescaledfY_d5, prescaledfY_d6, prescaledfY_d7, prescaledfY_d8, prescaledfY_d9, prescaledfY_d10, prescaledfY_d11 :  std_logic_vector(25 downto 0);
...
signal w9pad, w9pad_d1 :  std_logic_vector(29 downto 0);
   -- timing of w9pad: (c0, 0.580000ns)
signal w8fulla :  std_logic_vector(29 downto 0);
   -- timing of w8fulla: (c1, 0.448077ns)
signal fYdec8, fYdec8_d1 :  std_logic_vector(29 downto 0);
   -- timing of fYdec8: (c0, 1.753077ns)
signal w8full :  std_logic_vector(29 downto 0);
   -- timing of w8full: (c1, 1.028077ns)
signal w8 :  std_logic_vector(28 downto 0);
   -- timing of w8: (c1, 1.028077ns)
signal sel8 :  std_logic_vector(6 downto 0);
   -- timing of sel8: (c1, 1.028077ns)
signal q8, q8_d1 :  std_logic_vector(3 downto 0);
   -- timing of q8: (c1, 1.243077ns)
signal q8_copy6 :  std_logic_vector(3 downto 0);
   -- timing of q8_copy6: (c1, 1.028077ns)
signal w8pad, w8pad_d1 :  std_logic_vector(29 downto 0);
   -- timing of w8pad: (c1, 1.028077ns)
signal w7fulla :  std_logic_vector(29 downto 0);
   -- timing of w7fulla: (c2, 0.896154ns)
signal fYdec7 :  std_logic_vector(29 downto 0);
   -- timing of fYdec7: (c2, 0.351154ns)
signal w7full :  std_logic_vector(29 downto 0);
   -- timing of w7full: (c2, 1.476154ns)
signal w7 :  std_logic_vector(28 downto 0);
   -- timing of w7: (c2, 1.476154ns)
signal sel7 :  std_logic_vector(6 downto 0);
   -- timing of sel7: (c2, 1.476154ns)
signal q7, q7_d1, q7_d2 :  std_logic_vector(3 downto 0);
   -- timing of q7: (c2, 1.691154ns)
signal q7_copy7 :  std_logic_vector(3 downto 0);
   -- timing of q7_copy7: (c2, 1.476154ns)
signal w7pad, w7pad_d1 :  std_logic_vector(29 downto 0);
   -- timing of w7pad: (c2, 1.476154ns)
signal w6fulla, w6fulla_d1 :  std_logic_vector(29 downto 0);
   -- timing of w6fulla: (c3, 1.344231ns)
signal fYdec6, fYdec6_d1 :  std_logic_vector(29 downto 0);
   -- timing of fYdec6: (c3, 0.799231ns)
signal w6full :  std_logic_vector(29 downto 0);
   -- timing of w6full: (c4, 0.074231ns)
signal w6 :  std_logic_vector(28 downto 0);
   -- timing of w6: (c4, 0.074231ns)
signal sel6 :  std_logic_vector(6 downto 0);
   -- timing of sel6: (c4, 0.074231ns)
signal q6, q6_d1 :  std_logic_vector(3 downto 0);
   -- timing of q6: (c4, 0.289231ns)
signal q6_copy8 :  std_logic_vector(3 downto 0);
   -- timing of q6_copy8: (c4, 0.074231ns)
signal w6pad :  std_logic_vector(29 downto 0);
   -- timing of w6pad: (c4, 0.074231ns)
signal w5fulla, w5fulla_d1 :  std_logic_vector(29 downto 0);
   -- timing of w5fulla: (c4, 1.792308ns)
signal fYdec5, fYdec5_d1 :  std_logic_vector(29 downto 0);
   -- timing of fYdec5: (c4, 1.247308ns)
signal w5full :  std_logic_vector(29 downto 0);
   -- timing of w5full: (c5, 0.522308ns)
signal w5 :  std_logic_vector(28 downto 0);
   -- timing of w5: (c5, 0.522308ns)
signal sel5 :  std_logic_vector(6 downto 0);
   -- timing of sel5: (c5, 0.522308ns)
signal q5, q5_d1 :  std_logic_vector(3 downto 0);
   -- timing of q5: (c5, 0.737308ns)
signal q5_copy9 :  std_logic_vector(3 downto 0);
   -- timing of q5_copy9: (c5, 0.522308ns)
signal w5pad, w5pad_d1 :  std_logic_vector(29 downto 0);
   -- timing of w5pad: (c5, 0.522308ns)
signal w4fulla :  std_logic_vector(29 downto 0);
   -- timing of w4fulla: (c6, 0.390385ns)
signal fYdec4, fYdec4_d1 :  std_logic_vector(29 downto 0);
   -- timing of fYdec4: (c5, 1.695385ns)
signal w4full :  std_logic_vector(29 downto 0);
   -- timing of w4full: (c6, 0.970385ns)
signal w4 :  std_logic_vector(28 downto 0);
   -- timing of w4: (c6, 0.970385ns)
signal sel4 :  std_logic_vector(6 downto 0);
   -- timing of sel4: (c6, 0.970385ns)
signal q4, q4_d1 :  std_logic_vector(3 downto 0);
   -- timing of q4: (c6, 1.185385ns)
signal q4_copy10 :  std_logic_vector(3 downto 0);
   -- timing of q4_copy10: (c6, 0.970385ns)
signal w4pad, w4pad_d1 :  std_logic_vector(29 downto 0);
   -- timing of w4pad: (c6, 0.970385ns)
signal w3fulla :  std_logic_vector(29 downto 0);
   -- timing of w3fulla: (c7, 0.838462ns)
signal fYdec3 :  std_logic_vector(29 downto 0);
   -- timing of fYdec3: (c7, 0.293462ns)
signal w3full :  std_logic_vector(29 downto 0);
   -- timing of w3full: (c7, 1.418462ns)
signal w3 :  std_logic_vector(28 downto 0);
   -- timing of w3: (c7, 1.418462ns)
signal sel3 :  std_logic_vector(6 downto 0);
   -- timing of sel3: (c7, 1.418462ns)
signal q3, q3_d1, q3_d2 :  std_logic_vector(3 downto 0);
   -- timing of q3: (c7, 1.633462ns)
signal q3_copy11 :  std_logic_vector(3 downto 0);
   -- timing of q3_copy11: (c7, 1.418462ns)
signal w3pad, w3pad_d1 :  std_logic_vector(29 downto 0);
   -- timing of w3pad: (c7, 1.418462ns)
signal w2fulla, w2fulla_d1 :  std_logic_vector(29 downto 0);
   -- timing of w2fulla: (c8, 1.286538ns)
signal fYdec2, fYdec2_d1 :  std_logic_vector(29 downto 0);
   -- timing of fYdec2: (c8, 0.741538ns)
signal w2full :  std_logic_vector(29 downto 0);
   -- timing of w2full: (c9, 0.016538ns)
signal w2 :  std_logic_vector(28 downto 0);
   -- timing of w2: (c9, 0.016538ns)
signal sel2 :  std_logic_vector(6 downto 0);
   -- timing of sel2: (c9, 0.016538ns)
signal q2, q2_d1 :  std_logic_vector(3 downto 0);
   -- timing of q2: (c9, 0.231538ns)
signal q2_copy12 :  std_logic_vector(3 downto 0);
   -- timing of q2_copy12: (c9, 0.016538ns)
signal w2pad :  std_logic_vector(29 downto 0);
   -- timing of w2pad: (c9, 0.016538ns)
signal w1fulla, w1fulla_d1 :  std_logic_vector(29 downto 0);
   -- timing of w1fulla: (c9, 1.734615ns)
signal fYdec1, fYdec1_d1 :  std_logic_vector(29 downto 0);
   -- timing of fYdec1: (c9, 1.189615ns)
signal w1full :  std_logic_vector(29 downto 0);
   -- timing of w1full: (c10, 0.464615ns)
signal w1 :  std_logic_vector(28 downto 0);
   -- timing of w1: (c10, 0.464615ns)
signal sel1 :  std_logic_vector(6 downto 0);
   -- timing of sel1: (c10, 0.464615ns)
signal q1, q1_d1 :  std_logic_vector(3 downto 0);
   -- timing of q1: (c10, 0.679615ns)
signal q1_copy13 :  std_logic_vector(3 downto 0);
   -- timing of q1_copy13: (c10, 0.464615ns)
signal w1pad, w1pad_d1 :  std_logic_vector(29 downto 0);
   -- timing of w1pad: (c10, 0.464615ns)
signal w0fulla :  std_logic_vector(29 downto 0);
   -- timing of w0fulla: (c11, 0.332692ns)
signal fYdec0, fYdec0_d1 :  std_logic_vector(29 downto 0);
   -- timing of fYdec0: (c10, 1.637692ns)
signal w0full :  std_logic_vector(29 downto 0);
   -- timing of w0full: (c11, 0.912692ns)
signal w0 :  std_logic_vector(28 downto 0);
   -- timing of w0: (c11, 0.912692ns)
signal q0 :  std_logic_vector(3 downto 0);
   -- timing of q0: (c11, 1.137067ns)
signal qP9, qP9_d1, qP9_d2, qP9_d3, qP9_d4, qP9_d5, qP9_d6, qP9_d7, qP9_d8, qP9_d9, qP9_d10, qP9_d11 :  std_logic_vector(2 downto 0);
   -- timing of qP9: (c0, 0.795000ns)
signal qM9, qM9_d1, qM9_d2, qM9_d3, qM9_d4, qM9_d5, qM9_d6, qM9_d7, qM9_d8, qM9_d9, qM9_d10, qM9_d11 :  std_logic_vector(2 downto 0);
   -- timing of qM9: (c0, 0.795000ns)
signal qP8, qP8_d1, qP8_d2, qP8_d3, qP8_d4, qP8_d5, qP8_d6, qP8_d7, qP8_d8, qP8_d9, qP8_d10 :  std_logic_vector(2 downto 0);
   -- timing of qP8: (c1, 1.243077ns)
signal qM8, qM8_d1, qM8_d2, qM8_d3, qM8_d4, qM8_d5, qM8_d6, qM8_d7, qM8_d8, qM8_d9, qM8_d10 :  std_logic_vector(2 downto 0);
   -- timing of qM8: (c1, 1.243077ns)
signal qP7, qP7_d1, qP7_d2, qP7_d3, qP7_d4, qP7_d5, qP7_d6, qP7_d7, qP7_d8, qP7_d9 :  std_logic_vector(2 downto 0);
   -- timing of qP7: (c2, 1.691154ns)
signal qM7, qM7_d1, qM7_d2, qM7_d3, qM7_d4, qM7_d5, qM7_d6, qM7_d7, qM7_d8, qM7_d9 :  std_logic_vector(2 downto 0);
   -- timing of qM7: (c2, 1.691154ns)
signal qP6, qP6_d1, qP6_d2, qP6_d3, qP6_d4, qP6_d5, qP6_d6, qP6_d7 :  std_logic_vector(2 downto 0);
   -- timing of qP6: (c4, 0.289231ns)
signal qM6, qM6_d1, qM6_d2, qM6_d3, qM6_d4, qM6_d5, qM6_d6, qM6_d7 :  std_logic_vector(2 downto 0);
   -- timing of qM6: (c4, 0.289231ns)
signal qP5, qP5_d1, qP5_d2, qP5_d3, qP5_d4, qP5_d5, qP5_d6 :  std_logic_vector(2 downto 0);
   -- timing of qP5: (c5, 0.737308ns)
signal qM5, qM5_d1, qM5_d2, qM5_d3, qM5_d4, qM5_d5, qM5_d6 :  std_logic_vector(2 downto 0);
   -- timing of qM5: (c5, 0.737308ns)
signal qP4, qP4_d1, qP4_d2, qP4_d3, qP4_d4, qP4_d5 :  std_logic_vector(2 downto 0);
   -- timing of qP4: (c6, 1.185385ns)
signal qM4, qM4_d1, qM4_d2, qM4_d3, qM4_d4, qM4_d5 :  std_logic_vector(2 downto 0);
   -- timing of qM4: (c6, 1.185385ns)
signal qP3, qP3_d1, qP3_d2, qP3_d3, qP3_d4 :  std_logic_vector(2 downto 0);
   -- timing of qP3: (c7, 1.633462ns)
signal qM3, qM3_d1, qM3_d2, qM3_d3, qM3_d4 :  std_logic_vector(2 downto 0);
   -- timing of qM3: (c7, 1.633462ns)
signal qP2, qP2_d1, qP2_d2 :  std_logic_vector(2 downto 0);
   -- timing of qP2: (c9, 0.231538ns)
signal qM2, qM2_d1, qM2_d2 :  std_logic_vector(2 downto 0);
   -- timing of qM2: (c9, 0.231538ns)
signal qP1, qP1_d1 :  std_logic_vector(2 downto 0);
   -- timing of qP1: (c10, 0.679615ns)
signal qM1, qM1_d1 :  std_logic_vector(2 downto 0);
   -- timing of qM1: (c10, 0.679615ns)
signal qP0 :  std_logic_vector(2 downto 0);
   -- timing of qP0: (c11, 1.137067ns)
signal qM0 :  std_logic_vector(2 downto 0);
   -- timing of qM0: (c11, 1.137067ns)
signal qP :  std_logic_vector(29 downto 0);
   -- timing of qP: (c11, 1.137067ns)
signal qM :  std_logic_vector(29 downto 0);
   -- timing of qM: (c11, 1.137067ns)
signal quotient :  std_logic_vector(29 downto 0);
   -- timing of quotient: (c11, 1.717067ns)
signal mR, mR_d1 :  std_logic_vector(25 downto 0);
   -- timing of mR: (c11, 1.752067ns)
signal fRnorm, fRnorm_d1 :  std_logic_vector(23 downto 0);
   -- timing of fRnorm: (c11, 1.787067ns)
signal round, round_d1 :  std_logic;
   -- timing of round: (c11, 1.822067ns)
signal expR1 :  std_logic_vector(9 downto 0);
   -- timing of expR1: (c12, 0.400067ns)
signal expfrac :  std_logic_vector(32 downto 0);
   -- timing of expfrac: (c12, 0.400067ns)
signal expfracR :  std_logic_vector(32 downto 0);
   -- timing of expfracR: (c12, 0.400067ns)
signal exnR :  std_logic_vector(1 downto 0);
   -- timing of exnR: (c12, 0.435067ns)
signal exnRfinal :  std_logic_vector(1 downto 0);
   -- timing of exnRfinal: (c12, 0.470067ns)
begin
   process(clk)
      begin
   ...
   w8fulla <= 
      w9pad_d1 - ("0000" & prescaledfY_d1)			when "01",
      w9pad_d1 + ("0000" & prescaledfY_d1)			when "11",
      w9pad_d1 + ("000" & prescaledfY_d1 & "0")		when "10",
   ...
   with q9_d1(3)  select 
   w8full <= 
      w8fulla - fYdec8_d1			when '0',
      w8fulla + fYdec8_d1			when others;
   w8 <= w8full(26 downto 0) & "00";
   sel8 <= w8(28 downto 24) & prescaledfY_d1(23 downto 22);
   ...
   w7fulla <= 
      w8pad_d1 - ("0000" & prescaledfY_d2)			when "01",
      w8pad_d1 + ("0000" & prescaledfY_d2)			when "11",
      w8pad_d1 + ("000" & prescaledfY_d2 & "0")		when "10",
   ...
   sel7 <= w7(28 downto 24) & prescaledfY_d2(23 downto 22);
   ...
   sel6 <= w6(28 downto 24) & prescaledfY_d4(23 downto 22);
   ...
   sel5 <= w5(28 downto 24) & prescaledfY_d5(23 downto 22);
   ...
   sel4 <= w4(28 downto 24) & prescaledfY_d6(23 downto 22);
   ...
   sel3 <= w3(28 downto 24) & prescaledfY_d7(23 downto 22);
   ...
   sel2 <= w2(28 downto 24) & prescaledfY_d9(23 downto 22);
   ...
   sel1 <= w1(28 downto 24) & prescaledfY_d10(23 downto 22);
   ...
   qP0 <= q0(2 downto 0);
   qM0 <= q0(3)  & "00";
   qP <= qP9_d11 & qP8_d10 & qP7_d9 & qP6_d7 & qP5_d6 & qP4_d5 & qP3_d4 & qP2_d2 & qP1_d1 & qP0;
   qM <= qM9_d11(1 downto 0) & qM8_d10 & qM7_d9 & qM6_d7 & qM5_d6 & qM4_d5 & qM3_d4 & qM2_d2 & qM1_d1 & qM0 & "0";
   quotient <= qP - qM;
