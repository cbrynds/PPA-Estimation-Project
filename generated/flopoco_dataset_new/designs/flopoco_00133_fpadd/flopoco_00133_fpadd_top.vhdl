...
entity IntDualSub_34_Freq250_uid4 is
...
architecture arch of IntDualSub_34_Freq250_uid4 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_33_33_33_Freq250_uid6
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Count: (c0, 3.725250ns)R: (c1, 0.090250ns)
...
entity Normalizer_Z_33_33_33_Freq250_uid6 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_33_33_33_Freq250_uid6 is
...
signal level0 :  std_logic_vector(32 downto 0);
   -- timing of level0: (c1, 0.090250ns)
...
begin
   ...
   level0<= level1_d1(32 downto 0) when count0_d1='0' else level1_d1(31 downto 0) & (0 downto 0 => '0');
...
--------------------------------------------------------------------------------
--                RightShifterSticky32_by_max_34_Freq250_uid8
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity RightShifterSticky32_by_max_34_Freq250_uid8 is
    port (clk : in std_logic;
...
architecture arch of RightShifterSticky32_by_max_34_Freq250_uid8 is
...
entity IntAdder_35_Freq250_uid10 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_35_Freq250_uid10 is
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.125250ns)Y: (c0, 0.000000ns)Cin: (c1, 0.125250ns)
--  approx. output signal timings: R: (c1, 0.787250ns)
...
entity IntAdder_41_Freq250_uid13 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_41_Freq250_uid13 is
signal Rtmp :  std_logic_vector(40 downto 0);
   -- timing of Rtmp: (c1, 0.787250ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00133_fpadd_top
--                         (FPSub_8_31_Freq250_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 0.857250ns)
...
entity flopoco_00133_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00133_fpadd_top is
   component IntDualSub_34_Freq250_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(33 downto 0);
             Y : in  std_logic_vector(33 downto 0);
             XmY : out  std_logic_vector(33 downto 0);
   ...
   component Normalizer_Z_33_33_33_Freq250_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(32 downto 0);
             Count : out  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(32 downto 0)   );
   ...
   component RightShifterSticky32_by_max_34_Freq250_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(31 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(33 downto 0);
   ...
   component IntAdder_35_Freq250_uid10 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(34 downto 0);
             Y : in  std_logic_vector(34 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_41_Freq250_uid13 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(40 downto 0);
             Y : in  std_logic_vector(40 downto 0);
             Cin : in  std_logic;
...
signal shiftedFrac :  std_logic_vector(32 downto 0);
   -- timing of shiftedFrac: (c1, 0.090250ns)
signal roundClose0 :  std_logic;
   -- timing of roundClose0: (c1, 0.090250ns)
...
signal resultBeforeRoundClose :  std_logic_vector(40 downto 0);
   -- timing of resultBeforeRoundClose: (c1, 0.090250ns)
signal roundClose :  std_logic;
   -- timing of roundClose: (c1, 0.090250ns)
...
signal resultBeforeRoundFar, resultBeforeRoundFar_d1 :  std_logic_vector(40 downto 0);
...
signal resultBeforeRound :  std_logic_vector(40 downto 0);
   -- timing of resultBeforeRound: (c1, 0.125250ns)
signal round :  std_logic;
   -- timing of round: (c1, 0.125250ns)
...
signal resultRounded :  std_logic_vector(40 downto 0);
   -- timing of resultRounded: (c1, 0.787250ns)
...
-- Close Path --
   ...
   FPSub_8_31_Freq250_uid2_DualSubClose: IntDualSub_34_Freq250_uid4
      port map ( clk  => clk,
                 X => fracXClose1,
                 Y => fracYClose1,
                 XmY => fracRClosexMy,
   ...
   norm: Normalizer_Z_33_33_33_Freq250_uid6
      port map ( clk  => clk,
                 X => fracRClose1,
                 Count => nZerosNew,
                 R => shiftedFrac);
   ...
   resultBeforeRoundClose <= exponentResultClose_d1(9 downto 0) & shiftedFrac(31 downto 1);
   roundClose <= roundClose0;
   resultCloseIsZero <= resultCloseIsZero0;

-- Far Path --
   fracNewY <= '1' & newY(30 downto 0);
   RightShifterComponent: RightShifterSticky32_by_max_34_Freq250_uid8
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracNewY,
                 R => shiftedFracY,
   ...
   -- far path adder
   FPSub_8_31_Freq250_uid2_fracAddFar: IntAdder_35_Freq250_uid10
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
...
-- Synchronization of both paths --
   ...
   -- final round adder
   FPSub_8_31_Freq250_uid2_finalRoundAdd: IntAdder_41_Freq250_uid13
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
   ...
   resultNoExn(41 downto 40) <=   (not zeroFromClose_d1) & "0" when "01", -- overflow
