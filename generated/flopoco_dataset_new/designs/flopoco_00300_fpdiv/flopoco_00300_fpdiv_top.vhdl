...
--  approx. output signal timings: R: (c13, 0.773000ns)
...
entity flopoco_00300_fpdiv_top is
...
architecture arch of flopoco_00300_fpdiv_top is
...
signal expR0, expR0_d1, expR0_d2, expR0_d3, expR0_d4, expR0_d5, expR0_d6, expR0_d7, expR0_d8, expR0_d9, expR0_d10, expR0_d11, expR0_d12, expR0_d13 :  std_logic_vector(9 downto 0);
...
signal D, D_d1, D_d2, D_d3, D_d4, D_d5, D_d6, D_d7, D_d8, D_d9, D_d10, D_d11, D_d12 :  std_logic_vector(23 downto 0);
   -- timing of D: (c0, 0.000000ns)
signal psX :  std_logic_vector(24 downto 0);
   -- timing of psX: (c0, 0.000000ns)
signal Dx3, Dx3_d1, Dx3_d2, Dx3_d3, Dx3_d4, Dx3_d5, Dx3_d6, Dx3_d7, Dx3_d8, Dx3_d9, Dx3_d10, Dx3_d11, Dx3_d12 :  std_logic_vector(24 downto 0);
...
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
            ...
            absq8D_d1 <=  absq8D;
            betaw6_d1 <=  betaw6;
            q6_copy12_d1 <=  q6_copy12;
            betaw5_d1 <=  betaw5;
            q5_copy13_d1 <=  q5_copy13;
            betaw4_d1 <=  betaw4;
            q4_copy14_d1 <=  q4_copy14;
            betaw3_d1 <=  betaw3;
            q3_d1 <=  q3;
            betaw2_d1 <=  betaw2;
            q2_d1 <=  q2;
   ...
   sel12 <= betaw12(26 downto 23) & D_d1(22 downto 22);
   ...
   sel11 <= betaw11(26 downto 23) & D_d2(22 downto 22);
   ...
   sel10 <= betaw10(26 downto 23) & D_d3(22 downto 22);
   ...
   sel9 <= betaw9(26 downto 23) & D_d4(22 downto 22);
   ...
   sel8 <= betaw8(26 downto 23) & D_d5(22 downto 22);
   ...
   sel7 <= betaw7(26 downto 23) & D_d6(22 downto 22);
   ...
   sel6 <= betaw6(26 downto 23) & D_d6(22 downto 22);
   SelFunctionTable6: selFunction_Freq500_uid4
      port map ( X => sel6,
                 Y => q6_copy12);
   q6 <= q6_copy12_d1; -- output copy to hold a pipeline register if needed
   ...
   sel5 <= betaw5(26 downto 23) & D_d7(22 downto 22);
   ...
   sel4 <= betaw4(26 downto 23) & D_d8(22 downto 22);
   SelFunctionTable4: selFunction_Freq500_uid4
      port map ( X => sel4,
                 Y => q4_copy14);
   q4 <= q4_copy14_d1; -- output copy to hold a pipeline register if needed
   ...
   sel3 <= betaw3(26 downto 23) & D_d9(22 downto 22);
   ...
   sel2 <= betaw2(26 downto 23) & D_d10(22 downto 22);
   ...
   sel1 <= betaw1(26 downto 23) & D_d11(22 downto 22);
   ...
   qP1 <=      q1(1 downto 0);
   qM1 <=      q1(2) & "0";
   qP <= qP13_d11 & qP12_d10 & qP11_d9 & qP10_d8 & qP9_d7 & qP8_d6 & qP7_d5 & qP6_d4 & qP5_d3 & qP4_d2 & qP3_d2 & qP2_d1 & qP1;
   qM <= qM13_d12(0) & qM12_d11 & qM11_d10 & qM10_d9 & qM9_d8 & qM8_d7 & qM7_d6 & qM6_d5 & qM5_d4 & qM4_d3 & qM3_d3 & qM2_d2 & qM1_d1 & qM0;
   ...
   round <= fRnorm(0); 
   expR1 <= expR0_d13 + ("000" & (6 downto 1 => '1') & mR(25)); -- add back bias
   -- final rounding
