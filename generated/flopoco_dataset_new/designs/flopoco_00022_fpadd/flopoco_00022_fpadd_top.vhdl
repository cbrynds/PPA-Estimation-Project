--------------------------------------------------------------------------------
--                RightShifterSticky12_by_max_14_Freq400_uid4
...
entity RightShifterSticky12_by_max_14_Freq400_uid4 is
...
architecture arch of RightShifterSticky12_by_max_14_Freq400_uid4 is
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.713000ns)Y: (c0, 1.791750ns)Cin: (c1, 0.096125ns)
--  approx. output signal timings: R: (c1, 0.594125ns)
...
entity IntAdder_15_Freq400_uid6 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_15_Freq400_uid6 is
signal Rtmp :  std_logic_vector(14 downto 0);
   -- timing of Rtmp: (c1, 0.594125ns)
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_16_16_16_Freq400_uid8
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. input signal timings: X: (c1, 0.594125ns)
--  approx. output signal timings: Count: (c2, 0.194125ns)R: (c2, 0.409125ns)
...
entity Normalizer_Z_16_16_16_Freq400_uid8 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_16_16_16_Freq400_uid8 is
signal level5 :  std_logic_vector(15 downto 0);
   -- timing of level5: (c1, 0.594125ns)
signal count4, count4_d1 :  std_logic;
   -- timing of count4: (c1, 0.814750ns)
signal level4 :  std_logic_vector(15 downto 0);
   -- timing of level4: (c1, 1.029750ns)
signal count3, count3_d1 :  std_logic;
   -- timing of count3: (c1, 1.248500ns)
signal level3 :  std_logic_vector(15 downto 0);
   -- timing of level3: (c1, 1.463500ns)
signal count2, count2_d1 :  std_logic;
   -- timing of count2: (c1, 1.680375ns)
signal level2 :  std_logic_vector(15 downto 0);
   -- timing of level2: (c1, 1.895375ns)
signal count1, count1_d1 :  std_logic;
   -- timing of count1: (c1, 2.112250ns)
signal level1, level1_d1 :  std_logic_vector(15 downto 0);
   -- timing of level1: (c1, 2.327250ns)
signal count0 :  std_logic;
   -- timing of count0: (c2, 0.194125ns)
signal level0 :  std_logic_vector(15 downto 0);
   -- timing of level0: (c2, 0.409125ns)
signal sCount :  std_logic_vector(4 downto 0);
   -- timing of sCount: (c2, 0.194125ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   level0<= level1_d1(15 downto 0) when count0='0' else level1_d1(14 downto 0) & (0 downto 0 => '0');
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c2, 0.666125ns)Y: (c0, 0.000000ns)Cin: (c2, 0.624125ns)
--  approx. output signal timings: R: (c2, 1.205125ns)
...
entity IntAdder_20_Freq400_uid11 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_20_Freq400_uid11 is
signal Rtmp :  std_logic_vector(19 downto 0);
   -- timing of Rtmp: (c2, 1.205125ns)
signal Y_d1, Y_d2 :  std_logic_vector(19 downto 0);
...
--------------------------------------------------------------------------------
--                          flopoco_00022_fpadd_top
--                         (FPAdd_6_11_Freq400_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c2, 1.635125ns)
...
entity flopoco_00022_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00022_fpadd_top is
   component RightShifterSticky12_by_max_14_Freq400_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(11 downto 0);
             S : in  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(13 downto 0);
   ...
   component IntAdder_15_Freq400_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(14 downto 0);
             Y : in  std_logic_vector(14 downto 0);
             Cin : in  std_logic;
   ...
   component Normalizer_Z_16_16_16_Freq400_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(15 downto 0);
             Count : out  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(15 downto 0)   );
   ...
   component IntAdder_20_Freq400_uid11 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(19 downto 0);
             Y : in  std_logic_vector(19 downto 0);
             Cin : in  std_logic;
...
signal cInSigAdd :  std_logic;
   -- timing of cInSigAdd: (c1, 0.096125ns)
signal fracAddResult :  std_logic_vector(14 downto 0);
   -- timing of fracAddResult: (c1, 0.594125ns)
signal fracSticky :  std_logic_vector(15 downto 0);
   -- timing of fracSticky: (c1, 0.594125ns)
signal nZerosNew :  std_logic_vector(4 downto 0);
   -- timing of nZerosNew: (c2, 0.194125ns)
signal shiftedFrac :  std_logic_vector(15 downto 0);
   -- timing of shiftedFrac: (c2, 0.409125ns)
...
signal updatedExp :  std_logic_vector(7 downto 0);
   -- timing of updatedExp: (c2, 0.666125ns)
signal eqdiffsign :  std_logic;
   -- timing of eqdiffsign: (c2, 0.194125ns)
signal expFrac :  std_logic_vector(19 downto 0);
   -- timing of expFrac: (c2, 0.666125ns)
signal stk :  std_logic;
   -- timing of stk: (c2, 0.409125ns)
signal rnd :  std_logic;
   -- timing of rnd: (c2, 0.409125ns)
signal lsb :  std_logic;
   -- timing of lsb: (c2, 0.409125ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c2, 0.624125ns)
signal RoundedExpFrac :  std_logic_vector(19 downto 0);
   -- timing of RoundedExpFrac: (c2, 1.205125ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c2, 1.205125ns)
signal fracR :  std_logic_vector(10 downto 0);
   -- timing of fracR: (c2, 1.205125ns)
signal expR :  std_logic_vector(5 downto 0);
   -- timing of expR: (c2, 1.205125ns)
signal exExpExc :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c2, 1.205125ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c2, 1.420125ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c2, 1.635125ns)
signal signR2 :  std_logic;
   -- timing of signR2: (c2, 0.409125ns)
signal computedR :  std_logic_vector(19 downto 0);
   -- timing of computedR: (c2, 1.635125ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   RightShifterComponent: RightShifterSticky12_by_max_14_Freq400_uid4
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracY,
                 R => shiftedFracY,
   ...
   cInSigAdd <= EffSub_d1 and not sticky_d1; -- if we subtract and the sticky was one, some of the negated sticky bits would have absorbed this carry 
   fracAdder: IntAdder_15_Freq400_uid6
      port map ( clk  => clk,
                 Cin => cInSigAdd,
                 X => fracXpad,
                 Y => fracYpadXorOp,
   ...
   LZCAndShifter: Normalizer_Z_16_16_16_Freq400_uid8
      port map ( clk  => clk,
                 X => fracSticky,
                 Count => nZerosNew,
                 R => shiftedFrac);
   ...
   roundingAdder: IntAdder_20_Freq400_uid11
      port map ( clk  => clk,
                 Cin => needToRound,
                 X => expFrac,
