...
entity IntAdder_47_Freq200_uid9 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_47_Freq200_uid9 is
...
architecture arch of flopoco_00214_fpadd_top is
   ...
   component IntAdder_47_Freq200_uid9 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(46 downto 0);
             Y : in  std_logic_vector(46 downto 0);
             Cin : in  std_logic;
...
signal exponentResultfar0 :  std_logic_vector(11 downto 0);
...
signal syncX :  std_logic_vector(47 downto 0);
...
-- Far Path --
   ...
   -- far path adder
   FPAdd_10_35_Freq200_uid2_fracAddFar: IntAdder_39_Freq200_uid6
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   -- final round adder
   FPAdd_10_35_Freq200_uid2_finalRoundAdd: IntAdder_47_Freq200_uid9
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
   ...
   resultNoExn(45 downto 0) <= syncResSign & resultRounded(44 downto 0);
   syncExnXY <= sdExnXY;
   ...
   with syncExnXY  select 
      sgnR <= resultNoExn(45)         when "0101",
              syncX(45) and syncSignY when "0000",
              syncX(45)               when others;
   -- Exponent and significand of the result
   with syncExnXY  select   
      expsigR <= resultNoExn(44 downto 0)   when "0101" ,
                 syncX(44 downto  0)        when others; -- 0100, or at least one NaN or one infty 
   R <= exnR & sgnR & expsigR;
end architecture;
