...
entity IntDualSub_10_Freq200_uid4 is
...
architecture arch of IntDualSub_10_Freq200_uid4 is
...
--------------------------------------------------------------------------------
--                      Normalizer_Z_9_9_9_Freq200_uid6
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity Normalizer_Z_9_9_9_Freq200_uid6 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_9_9_9_Freq200_uid6 is
...
--------------------------------------------------------------------------------
--                 RightShifterSticky8_by_max_10_Freq200_uid8
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity RightShifterSticky8_by_max_10_Freq200_uid8 is
    port (clk : in std_logic;
...
architecture arch of RightShifterSticky8_by_max_10_Freq200_uid8 is
...
entity IntAdder_11_Freq200_uid10 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_11_Freq200_uid10 is
...
--  approx. output signal timings: R: (c0, 3.514375ns)
...
entity IntAdder_17_Freq200_uid13 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_17_Freq200_uid13 is
signal Rtmp :  std_logic_vector(16 downto 0);
   -- timing of Rtmp: (c0, 3.514375ns)
begin
   Rtmp <= X + Y + Cin;
   R <= Rtmp;
end architecture;
...
--  approx. output signal timings: R: (c0, 3.584375ns)
...
entity flopoco_00021_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00021_fpadd_top is
   component IntDualSub_10_Freq200_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(9 downto 0);
             Y : in  std_logic_vector(9 downto 0);
             XmY : out  std_logic_vector(9 downto 0);
   ...
   component Normalizer_Z_9_9_9_Freq200_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(8 downto 0);
             Count : out  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(8 downto 0)   );
   ...
   component RightShifterSticky8_by_max_10_Freq200_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(7 downto 0);
             S : in  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(9 downto 0);
   ...
   component IntAdder_11_Freq200_uid10 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(10 downto 0);
             Y : in  std_logic_vector(10 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_17_Freq200_uid13 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(16 downto 0);
             Y : in  std_logic_vector(16 downto 0);
             Cin : in  std_logic;
...
signal resultRounded :  std_logic_vector(16 downto 0);
   -- timing of resultRounded: (c0, 3.514375ns)
...
-- Close Path --
   ...
   FPAdd_8_7_Freq200_uid2_DualSubClose: IntDualSub_10_Freq200_uid4
      port map ( clk  => clk,
                 X => fracXClose1,
                 Y => fracYClose1,
                 XmY => fracRClosexMy,
   ...
   norm: Normalizer_Z_9_9_9_Freq200_uid6
      port map ( clk  => clk,
                 X => fracRClose1,
                 Count => nZerosNew,
                 R => shiftedFrac);
...
-- Far Path --
   ...
   RightShifterComponent: RightShifterSticky8_by_max_10_Freq200_uid8
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracNewY,
                 R => shiftedFracY,
   ...
   -- far path adder
   FPAdd_8_7_Freq200_uid2_fracAddFar: IntAdder_11_Freq200_uid10
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
...
-- Synchronization of both paths --
   ...
   -- final round adder
   FPAdd_8_7_Freq200_uid2_finalRoundAdd: IntAdder_17_Freq200_uid13
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
                 Y => "00000000000000000",
