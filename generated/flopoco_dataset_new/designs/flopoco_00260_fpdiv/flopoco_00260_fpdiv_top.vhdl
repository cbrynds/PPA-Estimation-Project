...
--------------------------------------------------------------------------------
--                          flopoco_00260_fpdiv_top
--                         (FPDiv_10_35_Freq200_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c8, 0.121125ns)
...
entity flopoco_00260_fpdiv_top is
...
architecture arch of flopoco_00260_fpdiv_top is
...
signal expR0, expR0_d1, expR0_d2, expR0_d3, expR0_d4, expR0_d5, expR0_d6, expR0_d7, expR0_d8 :  std_logic_vector(11 downto 0);
...
signal prescaledfY, prescaledfY_d1, prescaledfY_d2, prescaledfY_d3, prescaledfY_d4, prescaledfY_d5, prescaledfY_d6, prescaledfY_d7 :  std_logic_vector(37 downto 0);
...
begin
   ...
   sel11 <= w11(40 downto 36) & prescaledfY_d1(35 downto 34);
   ...
   sel9 <= w9(40 downto 36) & prescaledfY_d2(35 downto 34);
   ...
   w8fulla <= 
      w9pad - ("0000" & prescaledfY_d2)			when "01",
      w9pad + ("0000" & prescaledfY_d2)			when "11",
      w9pad + ("000" & prescaledfY_d2 & "0")		when "10",
      w9pad							when others;
   ...
   sel8 <= w8(40 downto 36) & prescaledfY_d3(35 downto 34);
   ...
   w7fulla <= 
      w8pad - ("0000" & prescaledfY_d3)			when "01",
      w8pad + ("0000" & prescaledfY_d3)			when "11",
      w8pad + ("000" & prescaledfY_d3 & "0")		when "10",
      w8pad							when others;
   ...
   sel7 <= w7(40 downto 36) & prescaledfY_d3(35 downto 34);
   ...
   w6fulla <= 
      w7pad_d1 - ("0000" & prescaledfY_d4)			when "01",
      w7pad_d1 + ("0000" & prescaledfY_d4)			when "11",
      w7pad_d1 + ("000" & prescaledfY_d4 & "0")		when "10",
   ...
   sel6 <= w6(40 downto 36) & prescaledfY_d4(35 downto 34);
   ...
   w5fulla <= 
      w6pad - ("0000" & prescaledfY_d4)			when "01",
      w6pad + ("0000" & prescaledfY_d4)			when "11",
      w6pad + ("000" & prescaledfY_d4 & "0")		when "10",
      w6pad							when others;
   ...
   sel5 <= w5(40 downto 36) & prescaledfY_d4(35 downto 34);
   ...
   sel4 <= w4(40 downto 36) & prescaledfY_d5(35 downto 34);
   ...
   w3fulla <= 
      w4pad - ("0000" & prescaledfY_d5)			when "01",
      w4pad + ("0000" & prescaledfY_d5)			when "11",
      w4pad + ("000" & prescaledfY_d5 & "0")		when "10",
      w4pad							when others;
   ...
   sel3 <= w3(40 downto 36) & prescaledfY_d5(35 downto 34);
   SelFunctionTable3: selFunction7_4_Freq200_uid4
      port map ( X => sel3,
                 Y => q3_copy15);
   q3 <= q3_copy15_d1; -- output copy to hold a pipeline register if needed
   w3pad <= w3 & '0';
   with q3(1 downto 0)  select  
   w2fulla <= 
      w3pad_d1 - ("0000" & prescaledfY_d6)			when "01",
      w3pad_d1 + ("0000" & prescaledfY_d6)			when "11",
      w3pad_d1 + ("000" & prescaledfY_d6 & "0")		when "10",
   ...
   sel2 <= w2(40 downto 36) & prescaledfY_d6(35 downto 34);
   ...
   w1fulla <= 
      w2pad - ("0000" & prescaledfY_d6)			when "01",
      w2pad + ("0000" & prescaledfY_d6)			when "11",
      w2pad + ("000" & prescaledfY_d6 & "0")		when "10",
      w2pad							when others;
   ...
   sel1 <= w1(40 downto 36) & prescaledfY_d7(35 downto 34);
   ...
   w0fulla <= 
      w1pad - ("0000" & prescaledfY_d7)			when "01",
      w1pad + ("0000" & prescaledfY_d7)			when "11",
      w1pad + ("000" & prescaledfY_d7 & "0")		when "10",
      w1pad							when others;
   ...
   qP0 <= q0(2 downto 0);
   qM0 <= q0(3)  & "00";
   qP <= qP13_d7 & qP12_d7 & qP11_d6 & qP10_d6 & qP9_d5 & qP8_d4 & qP7_d4 & qP6_d3 & qP5_d3 & qP4_d2 & qP3_d1 & qP2_d1 & qP1 & qP0;
   qM <= qM13_d7(1 downto 0) & qM12_d7 & qM11_d6 & qM10_d6 & qM9_d5 & qM8_d4 & qM7_d4 & qM6_d3 & qM5_d3 & qM4_d2 & qM3_d1 & qM2_d1 & qM1 & qM0 & "0";
   quotient <= qP - qM;
   ...
   round <= fRnorm(0); 
   expR1 <= expR0_d8 + ("000" & (8 downto 1 => '1') & mR_d1(37)); -- add back bias
   -- final rounding
   ...
   R <= exnRfinal & sR_d8 & expfracR(44 downto 0);
end architecture;
