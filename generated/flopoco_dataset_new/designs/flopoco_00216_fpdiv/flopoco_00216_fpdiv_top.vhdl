...
--------------------------------------------------------------------------------
--                          flopoco_00216_fpdiv_top
--                          (FPDiv_8_7_Freq200_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 0.529000ns)
...
entity flopoco_00216_fpdiv_top is
...
architecture arch of flopoco_00216_fpdiv_top is
...
signal w1 :  std_logic_vector(10 downto 0);
   -- timing of w1: (c0, 3.565000ns)
signal betaw1 :  std_logic_vector(10 downto 0);
   -- timing of betaw1: (c0, 3.565000ns)
signal sel1 :  std_logic_vector(8 downto 0);
   -- timing of sel1: (c0, 3.565000ns)
signal q1 :  std_logic_vector(2 downto 0);
   -- timing of q1: (c0, 3.780000ns)
signal q1_copy10 :  std_logic_vector(2 downto 0);
   -- timing of q1_copy10: (c0, 3.565000ns)
signal absq1D :  std_logic_vector(10 downto 0);
   -- timing of absq1D: (c0, 3.780000ns)
signal w0 :  std_logic_vector(10 downto 0);
   -- timing of w0: (c0, 4.278000ns)
signal wfinal :  std_logic_vector(8 downto 0);
   -- timing of wfinal: (c0, 4.278000ns)
signal qM0 :  std_logic;
   -- timing of qM0: (c0, 4.278000ns)
...
signal qP1 :  std_logic_vector(1 downto 0);
   -- timing of qP1: (c0, 3.780000ns)
signal qM1 :  std_logic_vector(1 downto 0);
   -- timing of qM1: (c0, 3.780000ns)
signal qP :  std_logic_vector(11 downto 0);
   -- timing of qP: (c0, 3.780000ns)
signal qM :  std_logic_vector(11 downto 0);
   -- timing of qM: (c0, 4.278000ns)
signal quotient :  std_logic_vector(11 downto 0);
   -- timing of quotient: (c0, 4.776000ns)
signal mR, mR_d1 :  std_logic_vector(9 downto 0);
   -- timing of mR: (c0, 4.811000ns)
signal fRnorm, fRnorm_d1 :  std_logic_vector(7 downto 0);
   -- timing of fRnorm: (c0, 4.846000ns)
signal round :  std_logic;
   -- timing of round: (c1, 0.031000ns)
signal expR1 :  std_logic_vector(9 downto 0);
   -- timing of expR1: (c1, 0.459000ns)
signal expfrac :  std_logic_vector(16 downto 0);
   -- timing of expfrac: (c1, 0.459000ns)
signal expfracR :  std_logic_vector(16 downto 0);
   -- timing of expfracR: (c1, 0.459000ns)
signal exnR :  std_logic_vector(1 downto 0);
   -- timing of exnR: (c1, 0.494000ns)
signal exnRfinal :  std_logic_vector(1 downto 0);
   -- timing of exnRfinal: (c1, 0.529000ns)
begin
   process(clk)
      begin
   ...
   sel1 <= betaw1(10 downto 5) & D(6 downto 4);
   ...
   qP1 <=      q1(1 downto 0);
   qM1 <=      q1(2) & "0";
   qP <= qP6 & qP5 & qP4 & qP3 & qP2 & qP1;
   qM <= qM6(0) & qM5 & qM4 & qM3 & qM2 & qM1 & qM0;
   quotient <= qP - qM;
   ...
   round <= fRnorm_d1(0); 
   expR1 <= expR0_d1 + ("000" & (6 downto 1 => '1') & mR_d1(9)); -- add back bias
   -- final rounding
   expfrac <= expR1 & fRnorm_d1(7 downto 1) ;
