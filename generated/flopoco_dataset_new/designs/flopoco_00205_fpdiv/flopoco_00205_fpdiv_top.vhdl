...
--------------------------------------------------------------------------------
--                          flopoco_00205_fpdiv_top
--                         (FPDiv_6_11_Freq250_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c2, 3.368856ns)
...
entity flopoco_00205_fpdiv_top is
...
architecture arch of flopoco_00205_fpdiv_top is
...
signal prescaledfY, prescaledfY_d1, prescaledfY_d2 :  std_logic_vector(13 downto 0);
...
begin
   ...
   sel2 <= w2(16 downto 12) & prescaledfY_d1(11 downto 10);
   ...
   sel1 <= w1(16 downto 12) & prescaledfY_d2(11 downto 10);
