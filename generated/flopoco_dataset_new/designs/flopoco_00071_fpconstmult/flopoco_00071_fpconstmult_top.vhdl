--------------------------------------------------------------------------------
--                       flopoco_00071_fpconstmult_top
--                  (FPConstMult_1b1_8_31_9_35_Freq150_uid2)
...
entity flopoco_00071_fpconstmult_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+31+2 downto 0);
          R : out  std_logic_vector(9+35+2 downto 0)   );
end entity;

architecture arch of flopoco_00071_fpconstmult_top is
...
begin
   ...
   r_frac <= X(30 downto 0)  &  (3 downto 0 => '0');
   norm <= '0';
