...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 3.070000ns)Y: (c0, 0.000000ns)Cin: (c0, 3.070000ns)
--  approx. output signal timings: R: (c0, 3.691000ns)
...
--  approx. output signal timings: R: (c0, 3.761000ns)
...
entity flopoco_00435_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00435_fpadd_top is
...
-- Far Path --
   ...
   -- far path adder
   FPSub_8_23_Freq200_uid2_fracAddFar: IntAdder_27_Freq200_uid6
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   -- final round adder
   FPSub_8_23_Freq200_uid2_finalRoundAdd: IntAdder_33_Freq200_uid9
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
