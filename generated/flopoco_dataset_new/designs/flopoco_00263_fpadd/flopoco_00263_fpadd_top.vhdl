...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 2.767375ns)Y: (c0, 0.000000ns)Cin: (c0, 2.767375ns)
--  approx. output signal timings: R: (c0, 3.306375ns)
...
--  approx. output signal timings: R: (c0, 3.376375ns)
...
entity flopoco_00263_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00263_fpadd_top is
...
-- Far Path --
   ...
   -- far path adder
   FPSub_8_7_Freq250_uid2_fracAddFar: IntAdder_11_Freq250_uid6
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   -- final round adder
   FPSub_8_7_Freq250_uid2_finalRoundAdd: IntAdder_17_Freq250_uid9
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
                 Y => "00000000000000000",
