...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.720000ns)Y: (c0, 0.000000ns)Cin: (c1, 0.720000ns)
--  approx. output signal timings: R: (c1, 1.341000ns)
...
entity flopoco_00389_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00389_fpadd_top is
...
signal resultBeforeRound :  std_logic_vector(32 downto 0);
   -- timing of resultBeforeRound: (c1, 0.720000ns)
signal round :  std_logic;
   -- timing of round: (c1, 0.720000ns)
...
signal resultRounded :  std_logic_vector(32 downto 0);
   -- timing of resultRounded: (c1, 1.341000ns)
...
-- Far Path --
   ...
   -- far path adder
   FPAdd_8_23_Freq400_uid2_fracAddFar: IntAdder_27_Freq400_uid6
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   -- final round adder
   FPAdd_8_23_Freq400_uid2_finalRoundAdd: IntAdder_33_Freq400_uid9
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
