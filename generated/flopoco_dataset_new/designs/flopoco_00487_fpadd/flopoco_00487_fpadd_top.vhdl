...
entity IntAdder_48_Freq300_uid11 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_48_Freq300_uid11 is
signal Rtmp :  std_logic_vector(47 downto 0);
   -- timing of Rtmp: (c2, 0.739583ns)
signal Y_d1, Y_d2 :  std_logic_vector(47 downto 0);
...
--------------------------------------------------------------------------------
--                          flopoco_00487_fpadd_top
--                         (FPSub_10_35_Freq300_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00487_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00487_fpadd_top is
   ...
   component IntAdder_48_Freq300_uid11 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(47 downto 0);
             Y : in  std_logic_vector(47 downto 0);
             Cin : in  std_logic;
...
begin
   ...
   roundingAdder: IntAdder_48_Freq300_uid11
      port map ( clk  => clk,
                 Cin => needToRound,
                 X => expFrac,
