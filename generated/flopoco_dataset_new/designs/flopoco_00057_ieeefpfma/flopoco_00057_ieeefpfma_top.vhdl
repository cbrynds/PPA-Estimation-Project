--------------------------------------------------------------------------------
--                   RightShifter53_by_max_163_Freq150_uid4
...
--  approx. output signal timings: R: (c1, 2.774103ns)
...
entity RightShifter53_by_max_163_Freq150_uid4 is
...
architecture arch of RightShifter53_by_max_163_Freq150_uid4 is
...
-- Input signals: I
-- Output signals: O
--  approx. input signal timings: I: (c1, 2.774103ns)
--  approx. output signal timings: O: (c1, 5.182228ns)
...
entity LZC_110_Freq150_uid6 is
    port (clk : in std_logic;
          I : in  std_logic_vector(109 downto 0);
          O : out  std_logic_vector(6 downto 0)   );
end entity;

architecture arch of LZC_110_Freq150_uid6 is
signal level7 :  std_logic_vector(126 downto 0);
   -- timing of level7: (c1, 2.774103ns)
signal digit6 :  std_logic;
   -- timing of digit6: (c1, 3.009728ns)
signal level6 :  std_logic_vector(62 downto 0);
   -- timing of level6: (c1, 3.224728ns)
signal digit5 :  std_logic;
   -- timing of digit5: (c1, 3.450978ns)
signal level5 :  std_logic_vector(30 downto 0);
   -- timing of level5: (c1, 3.665978ns)
signal digit4 :  std_logic;
   -- timing of digit4: (c1, 3.886603ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c1, 4.101603ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c1, 4.320353ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c1, 4.535353ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c1, 4.752228ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c1, 4.967228ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c1, 5.182228ns)
signal outHighBits :  std_logic_vector(4 downto 0);
   -- timing of outHighBits: (c1, 4.752228ns)
begin
...
--------------------------------------------------------------------------------
--                   LeftShifter163_by_max_162_Freq150_uid8
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c1, 2.774103ns)S: (c1, 5.182228ns)
--  approx. output signal timings: R: (c4, 1.692228ns)
...
entity LeftShifter163_by_max_162_Freq150_uid8 is
    port (clk : in std_logic;
...
--------------------------------------------------------------------------------
--                        flopoco_00057_ieeefpfma_top
--                       (IEEEFPFMA_11_52_Freq150_uid2)
...
entity flopoco_00057_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00057_ieeefpfma_top is
   component RightShifter53_by_max_163_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(52 downto 0);
             S : in  std_logic_vector(7 downto 0);
             R : out  std_logic_vector(215 downto 0)   );
   ...
   component LZC_110_Freq150_uid6 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(109 downto 0);
             O : out  std_logic_vector(6 downto 0)   );
   end component;

   component LeftShifter163_by_max_162_Freq150_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(162 downto 0);
             S : in  std_logic_vector(7 downto 0);
             R : out  std_logic_vector(324 downto 0)   );
...
signal normShiftValue :  std_logic_vector(7 downto 0);
   -- timing of normShiftValue: (c1, 5.182228ns)
signal BigSumNormd :  std_logic_vector(324 downto 0);
   -- timing of BigSumNormd: (c4, 1.692228ns)
signal expTentative, expTentative_d1, expTentative_d2, expTentative_d3 :  std_logic_vector(12 downto 0);
   -- timing of expTentative: (c1, 5.182228ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c4, 1.692228ns)
signal fracTentative :  std_logic_vector(55 downto 0);
   -- timing of fracTentative: (c4, 1.692228ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c4, 1.692228ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c4, 1.692228ns)
signal fracResultNormd :  std_logic_vector(51 downto 0);
   -- timing of fracResultNormd: (c4, 1.692228ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c4, 1.692228ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c4, 1.692228ns)
signal round :  std_logic;
   -- timing of round: (c4, 1.692228ns)
signal expUpdate :  std_logic_vector(12 downto 0);
   -- timing of expUpdate: (c4, 1.692228ns)
signal exponentResult1 :  std_logic_vector(12 downto 0);
   -- timing of exponentResult1: (c4, 1.692228ns)
signal resultBeforeRound :  std_logic_vector(64 downto 0);
   -- timing of resultBeforeRound: (c4, 1.692228ns)
signal resultRounded :  std_logic_vector(64 downto 0);
   -- timing of resultRounded: (c4, 1.692228ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c4, 1.692228ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c4, 1.692228ns)
signal Inf, Inf_d1, Inf_d2, Inf_d3, Inf_d4 :  std_logic_vector(62 downto 0);
   -- timing of Inf: (c0, 0.000000ns)
signal NaN, NaN_d1, NaN_d2, NaN_d3, NaN_d4 :  std_logic_vector(62 downto 0);
...
begin
   ...
   RightShifterComponent: RightShifter53_by_max_163_Freq150_uid4
      port map ( clk  => clk,
                 S => ShiftValue,
                 X => Csig,
                 R => CsigShifted);
   ...
   IEEEFPFMA_11_52_Freq150_uid2LeadingZeroCounter: LZC_110_Freq150_uid6
      port map ( clk  => clk,
   ...
   NormalizationShifter: LeftShifter163_by_max_162_Freq150_uid8
      port map ( clk  => clk,
                 S => normShiftValue,
                 X => BigSumAbs,
                 R => BigSumNormd);
   ...
   R <= 
           Rsgn_d3 & Inf_d4 when ((not RisNaN_d4) and finalRisInf)='1'
