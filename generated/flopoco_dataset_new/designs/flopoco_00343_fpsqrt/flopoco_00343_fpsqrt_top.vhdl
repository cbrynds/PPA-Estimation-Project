...
--  approx. output signal timings: R: (c8, 4.337000ns)
...
signal eRn1, eRn1_d1, eRn1_d2, eRn1_d3, eRn1_d4, eRn1_d5, eRn1_d6, eRn1_d7, eRn1_d8 :  std_logic_vector(10 downto 0);
...
begin
   ...
   T33 <= R32s_h_d1 - ("0" & S32_d1 & "01"); -- tentative subtraction 
   d33 <= not T33(35); -- next digit
   S33 <= S32_d1 & d33; 
   R33_h <= T33(34 downto 0)   when d33= '1' else
          R32s_h_d1(34 downto 0); 
   R33 <= R33_h & R32s_l_d1; 
   -- Step 34
   R33s <= R33 & "0";
   ...
   S38 <= S37 & d38; 
   R38_h <= T38_d1(39 downto 0)   when d38_d1= '1' else
   ...
   T39 <= R38s_h - ("0" & S38_d1 & "01"); -- tentative subtraction 
   ...
   T44 <= R43s_h_d1 - ("0" & S43_d1 & "01"); -- tentative subtraction 
   d44 <= not T44(46); -- next digit
   S44 <= S43_d1 & d44; 
   R44_h <= T44(45 downto 0)   when d44= '1' else
          R43s_h_d1(45 downto 0); 
   R44 <= R44_h & R43s_l_d1; 
   -- Step 45
   R44s <= R44 & "0";
