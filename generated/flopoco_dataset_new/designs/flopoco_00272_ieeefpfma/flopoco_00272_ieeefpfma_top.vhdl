--------------------------------------------------------------------------------
--                    RightShifter8_by_max_28_Freq500_uid4
...
entity RightShifter8_by_max_28_Freq500_uid4 is
...
architecture arch of RightShifter8_by_max_28_Freq500_uid4 is
...
--  approx. output signal timings: O: (c1, 0.619327ns)
...
entity LZC_20_Freq500_uid6 is
    port (clk : in std_logic;
          I : in  std_logic_vector(19 downto 0);
          O : out  std_logic_vector(4 downto 0)   );
end entity;

architecture arch of LZC_20_Freq500_uid6 is
...
signal digit2 :  std_logic;
   -- timing of digit2: (c1, 0.189327ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c1, 0.404327ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c1, 0.619327ns)
signal outHighBits :  std_logic_vector(2 downto 0);
   -- timing of outHighBits: (c1, 0.189327ns)
begin
   process(clk)
      begin
...
--------------------------------------------------------------------------------
--                    LeftShifter28_by_max_27_Freq500_uid8
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.953077ns)S: (c1, 0.619327ns)
--  approx. output signal timings: R: (c2, 0.337788ns)
...
entity LeftShifter28_by_max_27_Freq500_uid8 is
    port (clk : in std_logic;
...
architecture arch of LeftShifter28_by_max_27_Freq500_uid8 is
signal ps, ps_d1 :  std_logic_vector(4 downto 0);
   -- timing of ps: (c1, 0.619327ns)
signal level0, level0_d1 :  std_logic_vector(27 downto 0);
   -- timing of level0: (c0, 0.953077ns)
signal level1 :  std_logic_vector(28 downto 0);
   -- timing of level1: (c1, 0.619327ns)
signal level2 :  std_logic_vector(30 downto 0);
   -- timing of level2: (c1, 1.311250ns)
signal level3, level3_d1 :  std_logic_vector(34 downto 0);
   -- timing of level3: (c1, 1.311250ns)
signal level4 :  std_logic_vector(42 downto 0);
   -- timing of level4: (c2, 0.337788ns)
signal level5 :  std_logic_vector(58 downto 0);
   -- timing of level5: (c2, 0.337788ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
--------------------------------------------------------------------------------
--                        flopoco_00272_ieeefpfma_top
--                        (IEEEFPFMA_8_7_Freq500_uid2)
...
entity flopoco_00272_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00272_ieeefpfma_top is
   component RightShifter8_by_max_28_Freq500_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(7 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(35 downto 0)   );
   ...
   component LZC_20_Freq500_uid6 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(19 downto 0);
             O : out  std_logic_vector(4 downto 0)   );
   end component;

   component LeftShifter28_by_max_27_Freq500_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(27 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(54 downto 0)   );
...
signal ShiftValue, ShiftValue_d1 :  std_logic_vector(4 downto 0);
...
signal tmpExpCompRes2 :  std_logic_vector(9 downto 0);
   -- timing of tmpExpCompRes2: (c1, 0.619327ns)
signal RisSubNormal, RisSubNormal_d1 :  std_logic;
   -- timing of RisSubNormal: (c1, 0.619327ns)
signal RisZero, RisZero_d1 :  std_logic;
   -- timing of RisZero: (c1, 0.619327ns)
signal RisSubNormalOrZero :  std_logic;
   -- timing of RisSubNormalOrZero: (c1, 0.619327ns)
signal Rsgn, Rsgn_d1 :  std_logic;
   -- timing of Rsgn: (c1, 0.619327ns)
...
signal normShiftValue :  std_logic_vector(4 downto 0);
   -- timing of normShiftValue: (c1, 0.619327ns)
signal BigSumNormd :  std_logic_vector(54 downto 0);
   -- timing of BigSumNormd: (c2, 0.337788ns)
signal expTentative, expTentative_d1 :  std_logic_vector(9 downto 0);
   -- timing of expTentative: (c1, 0.619327ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c2, 0.337788ns)
signal fracTentative :  std_logic_vector(10 downto 0);
   -- timing of fracTentative: (c2, 0.337788ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c2, 0.337788ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c2, 0.337788ns)
signal fracResultNormd :  std_logic_vector(6 downto 0);
   -- timing of fracResultNormd: (c2, 0.337788ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c2, 0.337788ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c2, 0.337788ns)
signal round :  std_logic;
   -- timing of round: (c2, 0.337788ns)
signal expUpdate :  std_logic_vector(9 downto 0);
   -- timing of expUpdate: (c2, 0.337788ns)
signal exponentResult1 :  std_logic_vector(9 downto 0);
   -- timing of exponentResult1: (c2, 0.337788ns)
signal resultBeforeRound :  std_logic_vector(16 downto 0);
   -- timing of resultBeforeRound: (c2, 0.337788ns)
signal resultRounded :  std_logic_vector(16 downto 0);
   -- timing of resultRounded: (c2, 0.337788ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c2, 0.337788ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c2, 0.337788ns)
...
begin
   ...
   RightShifterComponent: RightShifter8_by_max_28_Freq500_uid4
      port map ( clk  => clk,
                 S => ShiftValue,
                 X => Csig,
                 R => CsigShifted);
   ...
   IEEEFPFMA_8_7_Freq500_uid2LeadingZeroCounter: LZC_20_Freq500_uid6
      port map ( clk  => clk,
                 I => BigSumAbsLowerBits,
                 O => L);
   tmpExpCompRes1 <= (AexpPlusBexp(8) & AexpPlusBexp) + "0010000001";
   tmpExpCompRes2 <= tmpExpCompRes1_d1 - ((9 downto 5 => '0') & L);
   RisSubNormal <= (expDiffSmall_d1 or not CisNormal_d1) and  tmpExpCompRes2(9);
   RisZero <= expDiffSmall_d1 when L="10100"  else '0';
   ...
   normShiftValue <= 
           L + "01001" when (expDiffSmall_d1 and not RisSubNormal)='1'
      else shiftValueCaseSubnormal_d1(4 downto 0) when (expDiffSmall_d1 and RisSubNormal)='1'
      else ShiftValue_d1; -- undo inital shift
   NormalizationShifter: LeftShifter28_by_max_27_Freq500_uid8
      port map ( clk  => clk,
                 S => normShiftValue,
                 X => BigSumAbs,
                 R => BigSumNormd);
   ...
   expTentative <= 
      ...
      else (AexpPlusBexp_d1(8) & AexpPlusBexp_d1 - ((9 downto 5 => '0') & L))  + "0000000011" when (expDiffSmall_d1 and not RisSubNormal)='1'
