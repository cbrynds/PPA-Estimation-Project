...
--  approx. output signal timings: R: (c0, 1.589000ns)Sticky: (c1, 0.393375ns)
...
signal stk0 :  std_logic;
   -- timing of stk0: (c1, 0.178375ns)
signal level0 :  std_logic_vector(12 downto 0);
   -- timing of level0: (c0, 1.589000ns)
signal stk :  std_logic;
   -- timing of stk: (c1, 0.393375ns)
begin
   process(clk)
      begin
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.687000ns)Y: (c0, 1.589000ns)Cin: (c1, 0.393375ns)
--  approx. output signal timings: R: (c1, 0.891375ns)
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.891375ns)Y: (c0, 0.000000ns)Cin: (c1, 0.891375ns)
--  approx. output signal timings: R: (c1, 1.430375ns)
...
--  approx. output signal timings: R: (c1, 1.500375ns)
...
entity flopoco_00073_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00073_fpadd_top is
...
signal sticky :  std_logic;
   -- timing of sticky: (c1, 0.393375ns)
...
signal cInAddFar :  std_logic;
   -- timing of cInAddFar: (c1, 0.393375ns)
signal fracResultfar0 :  std_logic_vector(13 downto 0);
   -- timing of fracResultfar0: (c1, 0.891375ns)
signal fracResultFarNormStage :  std_logic_vector(13 downto 0);
   -- timing of fracResultFarNormStage: (c1, 0.891375ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c1, 0.891375ns)
signal fracResultFar1 :  std_logic_vector(9 downto 0);
   -- timing of fracResultFar1: (c1, 0.891375ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c1, 0.891375ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c1, 0.891375ns)
signal roundFar1 :  std_logic;
   -- timing of roundFar1: (c1, 0.891375ns)
signal expOperationSel :  std_logic_vector(1 downto 0);
   -- timing of expOperationSel: (c1, 0.891375ns)
signal exponentUpdate :  std_logic_vector(6 downto 0);
   -- timing of exponentUpdate: (c1, 0.891375ns)
signal exponentResultfar0, exponentResultfar0_d1 :  std_logic_vector(6 downto 0);
   -- timing of exponentResultfar0: (c0, 0.687000ns)
signal exponentResultFar1 :  std_logic_vector(6 downto 0);
   -- timing of exponentResultFar1: (c1, 0.891375ns)
signal resultBeforeRoundFar :  std_logic_vector(16 downto 0);
   -- timing of resultBeforeRoundFar: (c1, 0.891375ns)
signal roundFar :  std_logic;
   -- timing of roundFar: (c1, 0.891375ns)
signal resultBeforeRound :  std_logic_vector(16 downto 0);
   -- timing of resultBeforeRound: (c1, 0.891375ns)
signal round :  std_logic;
   -- timing of round: (c1, 0.891375ns)
...
signal resultRounded :  std_logic_vector(16 downto 0);
   -- timing of resultRounded: (c1, 1.430375ns)
...
-- Far Path --
   ...
   -- far path adder
   FPSub_5_10_Freq500_uid2_fracAddFar: IntAdder_14_Freq500_uid6
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   -- final round adder
   FPSub_5_10_Freq500_uid2_finalRoundAdd: IntAdder_17_Freq500_uid9
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
                 Y => "00000000000000000",
