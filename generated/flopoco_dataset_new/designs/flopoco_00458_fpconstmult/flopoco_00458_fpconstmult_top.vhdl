--------------------------------------------------------------------------------
--                       flopoco_00458_fpconstmult_top
--                 (FPConstMult_1b1_10_35_11_39_Freq250_uid2)
...
entity flopoco_00458_fpconstmult_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(10+35+2 downto 0);
          R : out  std_logic_vector(11+39+2 downto 0)   );
end entity;

architecture arch of flopoco_00458_fpconstmult_top is
...
signal r_frac :  std_logic_vector(38 downto 0);
...
begin
   ...
   r_frac <= X(34 downto 0)  &  (3 downto 0 => '0');
   norm <= '0';
   ...
   R <= r_exn & r_sgn & (expfrac_rnd(49 downto 0));
end architecture;
