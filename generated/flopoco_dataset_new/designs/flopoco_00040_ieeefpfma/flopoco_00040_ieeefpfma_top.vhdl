...
--  approx. output signal timings: R: (c1, 0.048846ns)
...
signal level6 :  std_logic_vector(73 downto 0);
   -- timing of level6: (c1, 0.048846ns)
begin
   process(clk)
      begin
...
-- Input signals: I
-- Output signals: O
--  approx. input signal timings: I: (c1, 0.048846ns)
--  approx. output signal timings: O: (c1, 1.565096ns)
...
signal level5 :  std_logic_vector(30 downto 0);
   -- timing of level5: (c1, 0.048846ns)
signal digit4 :  std_logic;
   -- timing of digit4: (c1, 0.269471ns)
signal level4 :  std_logic_vector(14 downto 0);
   -- timing of level4: (c1, 0.484471ns)
signal digit3 :  std_logic;
   -- timing of digit3: (c1, 0.703221ns)
signal level3 :  std_logic_vector(6 downto 0);
   -- timing of level3: (c1, 0.918221ns)
signal digit2 :  std_logic;
   -- timing of digit2: (c1, 1.135096ns)
signal level2 :  std_logic_vector(2 downto 0);
   -- timing of level2: (c1, 1.350096ns)
signal lowBits :  std_logic_vector(1 downto 0);
   -- timing of lowBits: (c1, 1.565096ns)
signal outHighBits :  std_logic_vector(2 downto 0);
   -- timing of outHighBits: (c1, 1.135096ns)
begin
...
-- Input signals: X S
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.048846ns)S: (c1, 1.565096ns)
--  approx. output signal timings: R: (c3, 0.463942ns)
...
entity flopoco_00040_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00040_ieeefpfma_top is
...
signal CsigShifted :  std_logic_vector(47 downto 0);
   -- timing of CsigShifted: (c1, 0.048846ns)
signal sticky1, sticky1_d1, sticky1_d2 :  std_logic;
   -- timing of sticky1: (c1, 0.048846ns)
signal CsigShiftedT :  std_logic_vector(36 downto 0);
   -- timing of CsigShiftedT: (c1, 0.048846ns)
...
signal tmpExpCompRes2 :  std_logic_vector(6 downto 0);
   -- timing of tmpExpCompRes2: (c1, 1.565096ns)
signal RisSubNormal, RisSubNormal_d1, RisSubNormal_d2 :  std_logic;
   -- timing of RisSubNormal: (c1, 1.565096ns)
signal RisZero, RisZero_d1, RisZero_d2 :  std_logic;
   -- timing of RisZero: (c1, 1.565096ns)
signal RisSubNormalOrZero :  std_logic;
   -- timing of RisSubNormalOrZero: (c1, 1.565096ns)
signal Rsgn, Rsgn_d1, Rsgn_d2 :  std_logic;
   -- timing of Rsgn: (c1, 1.565096ns)
...
signal normShiftValue :  std_logic_vector(5 downto 0);
   -- timing of normShiftValue: (c1, 1.565096ns)
signal BigSumNormd :  std_logic_vector(72 downto 0);
   -- timing of BigSumNormd: (c3, 0.463942ns)
signal expTentative, expTentative_d1, expTentative_d2 :  std_logic_vector(6 downto 0);
   -- timing of expTentative: (c1, 1.565096ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c3, 0.463942ns)
signal fracTentative :  std_logic_vector(13 downto 0);
   -- timing of fracTentative: (c3, 0.463942ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c3, 0.463942ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c3, 0.463942ns)
signal fracResultNormd :  std_logic_vector(9 downto 0);
   -- timing of fracResultNormd: (c3, 0.463942ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c3, 0.463942ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c3, 0.463942ns)
signal round :  std_logic;
   -- timing of round: (c3, 0.463942ns)
signal expUpdate :  std_logic_vector(6 downto 0);
   -- timing of expUpdate: (c3, 0.463942ns)
signal exponentResult1 :  std_logic_vector(6 downto 0);
   -- timing of exponentResult1: (c3, 0.463942ns)
signal resultBeforeRound :  std_logic_vector(16 downto 0);
   -- timing of resultBeforeRound: (c3, 0.463942ns)
signal resultRounded :  std_logic_vector(16 downto 0);
   -- timing of resultRounded: (c3, 0.463942ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c3, 0.463942ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c3, 0.463942ns)
