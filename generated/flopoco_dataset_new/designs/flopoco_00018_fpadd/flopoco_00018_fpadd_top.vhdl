...
entity flopoco_00018_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00018_fpadd_top is
...
-- Far Path --
   ...
   -- far path adder
   FPSub_8_23_Freq400_uid2_fracAddFar: IntAdder_27_Freq400_uid6
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   -- final round adder
   FPSub_8_23_Freq400_uid2_finalRoundAdd: IntAdder_33_Freq400_uid9
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
