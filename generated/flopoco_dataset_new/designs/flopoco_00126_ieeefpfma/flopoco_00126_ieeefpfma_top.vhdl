--------------------------------------------------------------------------------
--                    RightShifter8_by_max_28_Freq200_uid4
...
entity RightShifter8_by_max_28_Freq200_uid4 is
...
architecture arch of RightShifter8_by_max_28_Freq200_uid4 is
...
entity LZC_20_Freq200_uid6 is
    port (clk : in std_logic;
          I : in  std_logic_vector(19 downto 0);
          O : out  std_logic_vector(4 downto 0)   );
end entity;

architecture arch of LZC_20_Freq200_uid6 is
...
--------------------------------------------------------------------------------
--                    LeftShifter28_by_max_27_Freq200_uid8
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Bogdan Pasca (2008-2011), Florent de Dinechin (2008-2019)
...
--  approx. output signal timings: R: (c0, 4.037788ns)
...
entity LeftShifter28_by_max_27_Freq200_uid8 is
    port (clk : in std_logic;
...
architecture arch of LeftShifter28_by_max_27_Freq200_uid8 is
signal ps :  std_logic_vector(4 downto 0);
...
signal level4 :  std_logic_vector(42 downto 0);
   -- timing of level4: (c0, 4.037788ns)
signal level5 :  std_logic_vector(58 downto 0);
   -- timing of level5: (c0, 4.037788ns)
begin
   ps<= S;
   level0<= X;
...
--------------------------------------------------------------------------------
--                        flopoco_00126_ieeefpfma_top
--                        (IEEEFPFMA_8_7_Freq200_uid2)
...
entity flopoco_00126_ieeefpfma_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00126_ieeefpfma_top is
   component RightShifter8_by_max_28_Freq200_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(7 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(35 downto 0)   );
   ...
   component LZC_20_Freq200_uid6 is
      port ( clk : in std_logic;
             I : in  std_logic_vector(19 downto 0);
             O : out  std_logic_vector(4 downto 0)   );
   end component;

   component LeftShifter28_by_max_27_Freq200_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(27 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(54 downto 0)   );
...
signal BigSumNormd :  std_logic_vector(54 downto 0);
   -- timing of BigSumNormd: (c0, 4.037788ns)
signal expTentative :  std_logic_vector(9 downto 0);
   -- timing of expTentative: (c0, 2.469327ns)
signal sticky2 :  std_logic;
   -- timing of sticky2: (c0, 4.037788ns)
signal fracTentative :  std_logic_vector(10 downto 0);
   -- timing of fracTentative: (c0, 4.037788ns)
signal fracLeadingBitsNormal :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBitsNormal: (c0, 4.037788ns)
signal fracLeadingBits :  std_logic_vector(1 downto 0);
   -- timing of fracLeadingBits: (c0, 4.037788ns)
signal fracResultNormd :  std_logic_vector(6 downto 0);
   -- timing of fracResultNormd: (c0, 4.037788ns)
signal fracResultRoundBit :  std_logic;
   -- timing of fracResultRoundBit: (c0, 4.037788ns)
signal fracResultStickyBit :  std_logic;
   -- timing of fracResultStickyBit: (c0, 4.037788ns)
signal round :  std_logic;
   -- timing of round: (c0, 4.037788ns)
signal expUpdate :  std_logic_vector(9 downto 0);
   -- timing of expUpdate: (c0, 4.037788ns)
signal exponentResult1 :  std_logic_vector(9 downto 0);
   -- timing of exponentResult1: (c0, 4.037788ns)
signal resultBeforeRound :  std_logic_vector(16 downto 0);
   -- timing of resultBeforeRound: (c0, 4.037788ns)
signal resultRounded :  std_logic_vector(16 downto 0);
   -- timing of resultRounded: (c0, 4.037788ns)
signal Roverflowed :  std_logic;
   -- timing of Roverflowed: (c0, 4.037788ns)
signal finalRisInf :  std_logic;
   -- timing of finalRisInf: (c0, 4.037788ns)
...
begin
   ...
   RightShifterComponent: RightShifter8_by_max_28_Freq200_uid4
      port map ( clk  => clk,
                 S => ShiftValue,
                 X => Csig,
                 R => CsigShifted);
   ...
   IEEEFPFMA_8_7_Freq200_uid2LeadingZeroCounter: LZC_20_Freq200_uid6
      port map ( clk  => clk,
   ...
   NormalizationShifter: LeftShifter28_by_max_27_Freq200_uid8
      port map ( clk  => clk,
                 S => normShiftValue,
                 X => BigSumAbs,
                 R => BigSumNormd);
