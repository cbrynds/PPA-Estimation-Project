--------------------------------------------------------------------------------
--                     IntComparator_39_111_Freq250_uid4
...
entity IntComparator_39_111_Freq250_uid4 is
...
architecture arch of IntComparator_39_111_Freq250_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00390_fpcomparator_top
...
--  approx. input signal timings: X: (c0, 0.000000ns)Y: (c0, 0.000000ns)
--  approx. output signal timings: unordered: (c0, 0.000000ns)XltY: (c0, 0.754000ns)XeqY: (c0, 0.713000ns)
...
entity flopoco_00390_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00390_fpcomparator_top is
   component IntComparator_39_111_Freq250_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(38 downto 0);
             Y : in  std_logic_vector(38 downto 0);
             XltY : out  std_logic;
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_39_111_Freq250_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
