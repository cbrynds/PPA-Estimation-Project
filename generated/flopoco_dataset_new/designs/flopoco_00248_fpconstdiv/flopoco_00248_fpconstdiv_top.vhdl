--------------------------------------------------------------------------------
--                  EuclideanDivTable_d3_alpha2_Freq200_uid7
...
entity EuclideanDivTable_d3_alpha2_Freq200_uid7 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(3 downto 0)   );
end entity;

architecture arch of EuclideanDivTable_d3_alpha2_Freq200_uid7 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_3_13_0_2_Freq200_uid3
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Q: (c0, 2.012000ns)R: (c0, 2.012000ns)
...
entity IntConstDiv_QR_3_13_0_2_Freq200_uid3 is
...
architecture arch of IntConstDiv_QR_3_13_0_2_Freq200_uid3 is
   component EuclideanDivTable_d3_alpha2_Freq200_uid7 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(3 downto 0)   );
   end component;
...
signal out0 :  std_logic_vector(3 downto 0);
   -- timing of out0: (c0, 2.012000ns)
signal out0_copy14 :  std_logic_vector(3 downto 0);
   -- timing of out0_copy14: (c0, 1.797000ns)
signal q0 :  std_logic_vector(1 downto 0);
   -- timing of q0: (c0, 2.012000ns)
signal r0 :  std_logic_vector(1 downto 0);
   -- timing of r0: (c0, 2.012000ns)
signal tempQ :  std_logic_vector(13 downto 0);
   -- timing of tempQ: (c0, 2.012000ns)
begin
   r7 <= "00";
   x6 <= "0" & X(12 downto 12);
   in6 <= r7 & x6;
   table6: EuclideanDivTable_d3_alpha2_Freq200_uid7
      port map ( X => in6,
                 Y => out6_copy8);
   ...
   x5 <= X(11 downto 10);
   in5 <= r6 & x5;
   table5: EuclideanDivTable_d3_alpha2_Freq200_uid7
      port map ( X => in5,
                 Y => out5_copy9);
   ...
   x4 <= X(9 downto 8);
   in4 <= r5 & x4;
   table4: EuclideanDivTable_d3_alpha2_Freq200_uid7
      port map ( X => in4,
                 Y => out4_copy10);
   ...
   x3 <= X(7 downto 6);
   in3 <= r4 & x3;
   table3: EuclideanDivTable_d3_alpha2_Freq200_uid7
      port map ( X => in3,
                 Y => out3_copy11);
   ...
   x2 <= X(5 downto 4);
   in2 <= r3 & x2;
   table2: EuclideanDivTable_d3_alpha2_Freq200_uid7
      port map ( X => in2,
                 Y => out2_copy12);
   ...
   x1 <= X(3 downto 2);
   in1 <= r2 & x1;
   table1: EuclideanDivTable_d3_alpha2_Freq200_uid7
      port map ( X => in1,
                 Y => out1_copy13);
   ...
   x0 <= X(1 downto 0);
   in0 <= r1 & x0;
   table0: EuclideanDivTable_d3_alpha2_Freq200_uid7
      port map ( X => in0,
                 Y => out0_copy14);
   out0 <= out0_copy14; -- output copy to hold a pipeline register if needed
   q0 <= out0(3 downto 2);
   r0 <= out0(1 downto 0);
   tempQ <= q6 & q5 & q4 & q3 & q2 & q1 & q0 ;
   Q <= tempQ(11 downto 0);
   R <= r0;
end architecture;

--------------------------------------------------------------------------------
--                        flopoco_00248_fpconstdiv_top
--                      (FPConstDiv_5_10_5_10_3_0_0_200)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.000000ns)
--  approx. output signal timings: R: (c0, 2.012000ns)
...
entity flopoco_00248_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(5+10+2 downto 0);
          R : out  std_logic_vector(5+10+2 downto 0)   );
end entity;

architecture arch of flopoco_00248_fpconstdiv_top is
   component IntConstDiv_QR_3_13_0_2_Freq200_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(12 downto 0);
             Q : out  std_logic_vector(11 downto 0);
             R : out  std_logic_vector(1 downto 0)   );
...
signal quotient :  std_logic_vector(11 downto 0);
   -- timing of quotient: (c0, 2.012000ns)
signal remainder :  std_logic_vector(1 downto 0);
   -- timing of remainder: (c0, 2.012000ns)
signal r_frac :  std_logic_vector(9 downto 0);
   -- timing of r_frac: (c0, 2.012000ns)
begin
   ...
   intconstdiv: IntConstDiv_QR_3_13_0_2_Freq200_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
