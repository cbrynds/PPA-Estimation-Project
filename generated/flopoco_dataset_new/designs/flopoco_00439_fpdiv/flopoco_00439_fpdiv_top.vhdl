...
--  approx. output signal timings: R: (c3, 3.120067ns)
...
entity flopoco_00439_fpdiv_top is
...
architecture arch of flopoco_00439_fpdiv_top is
...
signal prescaledfY, prescaledfY_d1, prescaledfY_d2, prescaledfY_d3 :  std_logic_vector(25 downto 0);
...
begin
   ...
   w3fulla <= 
      w4pad_d1 - ("0000" & prescaledfY_d2)			when "01",
      w4pad_d1 + ("0000" & prescaledfY_d2)			when "11",
      w4pad_d1 + ("000" & prescaledfY_d2 & "0")		when "10",
   ...
   w2fulla <= 
      w3pad - ("0000" & prescaledfY_d2)			when "01",
      w3pad + ("0000" & prescaledfY_d2)			when "11",
      w3pad + ("000" & prescaledfY_d2 & "0")		when "10",
      w3pad							when others;
   ...
   w0fulla <= 
      w1pad_d1 - ("0000" & prescaledfY_d3)			when "01",
      w1pad_d1 + ("0000" & prescaledfY_d3)			when "11",
      w1pad_d1 + ("000" & prescaledfY_d3 & "0")		when "10",
   ...
   qP0 <= q0(2 downto 0);
   qM0 <= q0(3)  & "00";
   qP <= qP9_d3 & qP8_d3 & qP7_d3 & qP6_d2 & qP5_d2 & qP4_d2 & qP3_d1 & qP2_d1 & qP1_d1 & qP0;
   qM <= qM9_d3(1 downto 0) & qM8_d3 & qM7_d3 & qM6_d2 & qM5_d2 & qM4_d2 & qM3_d1 & qM2_d1 & qM1_d1 & qM0 & "0";
   quotient <= qP - qM;
