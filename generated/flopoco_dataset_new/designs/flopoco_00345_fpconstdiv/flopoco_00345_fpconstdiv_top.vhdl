--------------------------------------------------------------------------------
--                  EuclideanDivTable_d3_alpha3_Freq250_uid7
...
entity EuclideanDivTable_d3_alpha3_Freq250_uid7 is
    port (X : in  std_logic_vector(4 downto 0);
          Y : out  std_logic_vector(4 downto 0)   );
end entity;

architecture arch of EuclideanDivTable_d3_alpha3_Freq250_uid7 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_3_10_0_3_Freq250_uid3
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity IntConstDiv_QR_3_10_0_3_Freq250_uid3 is
...
architecture arch of IntConstDiv_QR_3_10_0_3_Freq250_uid3 is
   component EuclideanDivTable_d3_alpha3_Freq250_uid7 is
      port ( X : in  std_logic_vector(4 downto 0);
             Y : out  std_logic_vector(4 downto 0)   );
   end component;
...
signal out3_copy8 :  std_logic_vector(4 downto 0);
...
signal out2_copy9 :  std_logic_vector(4 downto 0);
...
signal out1_copy10 :  std_logic_vector(4 downto 0);
...
signal out0_copy11 :  std_logic_vector(4 downto 0);
...
begin
   ...
   x3 <= "00" & X(9 downto 9);
   in3 <= r4 & x3;
   table3: EuclideanDivTable_d3_alpha3_Freq250_uid7
      port map ( X => in3,
                 Y => out3_copy8);
   ...
   x2 <= X(8 downto 6);
   in2 <= r3 & x2;
   table2: EuclideanDivTable_d3_alpha3_Freq250_uid7
      port map ( X => in2,
                 Y => out2_copy9);
   ...
   x1 <= X(5 downto 3);
   in1 <= r2 & x1;
   table1: EuclideanDivTable_d3_alpha3_Freq250_uid7
      port map ( X => in1,
                 Y => out1_copy10);
   ...
   x0 <= X(2 downto 0);
   in0 <= r1 & x0;
   table0: EuclideanDivTable_d3_alpha3_Freq250_uid7
      port map ( X => in0,
                 Y => out0_copy11);
...
--------------------------------------------------------------------------------
--                        flopoco_00345_fpconstdiv_top
--                       (FPConstDiv_8_7_8_7_3_0_0_250)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00345_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00345_fpconstdiv_top is
   component IntConstDiv_QR_3_10_0_3_Freq250_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(9 downto 0);
             Q : out  std_logic_vector(8 downto 0);
             R : out  std_logic_vector(1 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_3_10_0_3_Freq250_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
