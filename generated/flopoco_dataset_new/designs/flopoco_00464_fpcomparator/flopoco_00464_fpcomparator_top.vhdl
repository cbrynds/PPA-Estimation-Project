--------------------------------------------------------------------------------
--                     IntComparator_39_101_Freq500_uid4
...
entity IntComparator_39_101_Freq500_uid4 is
...
architecture arch of IntComparator_39_101_Freq500_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00464_fpcomparator_top
--                      (FPComparator_8_31_Freq500_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin (2021)
...
--  approx. input signal timings: X: (c0, 0.000000ns)Y: (c0, 0.000000ns)
--  approx. output signal timings: unordered: (c0, 0.000000ns)XgtY: (c0, 0.754000ns)
...
entity flopoco_00464_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00464_fpcomparator_top is
   component IntComparator_39_101_Freq500_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(38 downto 0);
             Y : in  std_logic_vector(38 downto 0);
             XltY : out  std_logic;
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_39_101_Freq500_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
