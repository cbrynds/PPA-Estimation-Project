...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.106500ns)Y: (c0, 0.000000ns)Cin: (c1, 0.038500ns)
--  approx. output signal timings: R: (c1, 0.645500ns)
...
--  approx. output signal timings: R: (c1, 1.075500ns)
...
signal needToRound :  std_logic;
   -- timing of needToRound: (c1, 0.038500ns)
signal RoundedExpFrac :  std_logic_vector(17 downto 0);
   -- timing of RoundedExpFrac: (c1, 0.645500ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c1, 0.645500ns)
signal fracR :  std_logic_vector(6 downto 0);
   -- timing of fracR: (c1, 0.645500ns)
signal expR :  std_logic_vector(7 downto 0);
   -- timing of expR: (c1, 0.645500ns)
signal exExpExc :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c1, 0.645500ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c1, 0.860500ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c1, 1.075500ns)
signal signR2, signR2_d1 :  std_logic;
   -- timing of signR2: (c0, 4.673500ns)
signal computedR :  std_logic_vector(17 downto 0);
   -- timing of computedR: (c1, 1.075500ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   updatedExp <= ("0" &extendedExpInc_d1) - ("000000" & nZerosNew_d1);
