...
--------------------------------------------------------------------------------
--                    CBLKTable_l1_d7_alpha4_Freq200_uid18
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l1_d7_alpha4_Freq200_uid18 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(6 downto 0)   );
end entity;

architecture arch of CBLKTable_l1_d7_alpha4_Freq200_uid18 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l2_d7_alpha4_Freq200_uid26
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l2_d7_alpha4_Freq200_uid26 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(10 downto 0)   );
end entity;

architecture arch of CBLKTable_l2_d7_alpha4_Freq200_uid26 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l3_d7_alpha4_Freq200_uid32
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l3_d7_alpha4_Freq200_uid32 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(18 downto 0)   );
end entity;

architecture arch of CBLKTable_l3_d7_alpha4_Freq200_uid32 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_7_27_1_4_Freq200_uid3
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Q: (c0, 2.600000ns)R: (c0, 1.706000ns)
...
entity IntConstDiv_QR_7_27_1_4_Freq200_uid3 is
...
architecture arch of IntConstDiv_QR_7_27_1_4_Freq200_uid3 is
   component CBLKTable_l0_d7_alpha4_Freq200_uid7 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(4 downto 0)   );
   end component;

   component CBLKTable_l1_d7_alpha4_Freq200_uid18 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(6 downto 0)   );
   end component;

   component CBLKTable_l2_d7_alpha4_Freq200_uid26 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(10 downto 0)   );
   end component;

   component CBLKTable_l3_d7_alpha4_Freq200_uid32 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(18 downto 0)   );
   end component;
...
signal q_l3_0 :  std_logic_vector(24 downto 0);
...
begin
   ...
   table_l1_0: CBLKTable_l1_d7_alpha4_Freq200_uid18
      port map ( X => in_l1_0,
                 Y => out_l1_0_copy19);
   ...
   table_l1_1: CBLKTable_l1_d7_alpha4_Freq200_uid18
      port map ( X => in_l1_1,
                 Y => out_l1_1_copy20);
   ...
   table_l1_2: CBLKTable_l1_d7_alpha4_Freq200_uid18
      port map ( X => in_l1_2,
                 Y => out_l1_2_copy21);
   ...
   in_l1_3 <= "000" & r_l0_6;
   table_l1_3: CBLKTable_l1_d7_alpha4_Freq200_uid18
      port map ( X => in_l1_3,
                 Y => out_l1_3_copy22);
   ...
   table_l2_0: CBLKTable_l2_d7_alpha4_Freq200_uid26
      port map ( X => in_l2_0,
                 Y => out_l2_0_copy27);
   ...
   table_l2_1: CBLKTable_l2_d7_alpha4_Freq200_uid26
      port map ( X => in_l2_1,
                 Y => out_l2_1_copy28);
   ...
   table_l3_0: CBLKTable_l3_d7_alpha4_Freq200_uid32
      port map ( X => in_l3_0,
                 Y => out_l3_0_copy33);
...
--                      (FPConstDiv_8_23_8_23_7_1_0_200)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.000000ns)
--  approx. output signal timings: R: (c0, 2.600000ns)
...
architecture arch of flopoco_00488_fpconstdiv_top is
   component IntConstDiv_QR_7_27_1_4_Freq200_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(26 downto 0);
             Q : out  std_logic_vector(24 downto 0);
             R : out  std_logic_vector(2 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_7_27_1_4_Freq200_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
