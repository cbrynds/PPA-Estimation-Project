--------------------------------------------------------------------------------
--                    CBLKTable_l0_d3_alpha6_Freq250_uid7
...
entity CBLKTable_l0_d3_alpha6_Freq250_uid7 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(6 downto 0)   );
end entity;

architecture arch of CBLKTable_l0_d3_alpha6_Freq250_uid7 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l1_d3_alpha6_Freq250_uid14
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l1_d3_alpha6_Freq250_uid14 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(7 downto 0)   );
end entity;

architecture arch of CBLKTable_l1_d3_alpha6_Freq250_uid14 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l2_d3_alpha6_Freq250_uid20
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l2_d3_alpha6_Freq250_uid20 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(13 downto 0)   );
end entity;

architecture arch of CBLKTable_l2_d3_alpha6_Freq250_uid20 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_3_13_1_6_Freq250_uid3
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity IntConstDiv_QR_3_13_1_6_Freq250_uid3 is
...
architecture arch of IntConstDiv_QR_3_13_1_6_Freq250_uid3 is
   component CBLKTable_l0_d3_alpha6_Freq250_uid7 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(6 downto 0)   );
   end component;

   component CBLKTable_l1_d3_alpha6_Freq250_uid14 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(7 downto 0)   );
   end component;

   component CBLKTable_l2_d3_alpha6_Freq250_uid20 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(13 downto 0)   );
   end component;
...
signal out_l1_0_copy15 :  std_logic_vector(7 downto 0);
...
signal out_l1_1_copy16 :  std_logic_vector(7 downto 0);
...
signal out_l2_0_copy21 :  std_logic_vector(13 downto 0);
...
begin
   x0 <= X(5 downto 0);
   table0: CBLKTable_l0_d3_alpha6_Freq250_uid7
      port map ( X => x0,
                 Y => out0_copy8);
   ...
   in_l1_1 <= "00" & r_l0_2;
   table_l1_1: CBLKTable_l1_d3_alpha6_Freq250_uid14
      port map ( X => in_l1_1,
                 Y => out_l1_1_copy16);
...
--------------------------------------------------------------------------------
--                        flopoco_00331_fpconstdiv_top
--                      (FPConstDiv_5_10_5_10_3_1_0_250)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00331_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(5+10+2 downto 0);
          R : out  std_logic_vector(5+10+2 downto 0)   );
end entity;

architecture arch of flopoco_00331_fpconstdiv_top is
   component IntConstDiv_QR_3_13_1_6_Freq250_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(12 downto 0);
             Q : out  std_logic_vector(11 downto 0);
             R : out  std_logic_vector(1 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_3_13_1_6_Freq250_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
