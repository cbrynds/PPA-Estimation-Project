...
--  approx. output signal timings: R: (c3, 1.016000ns)
...
entity flopoco_00492_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(5+10+2 downto 0);
          R : out  std_logic_vector(5+10+2 downto 0)   );
end entity;

architecture arch of flopoco_00492_fpsqrt_top is
...
signal R2s_l :  std_logic_vector(7 downto 0);
...
signal R3s_l, R3s_l_d1 :  std_logic_vector(6 downto 0);
...
signal R5s_l :  std_logic_vector(4 downto 0);
...
signal R6s_l, R6s_l_d1 :  std_logic_vector(3 downto 0);
...
signal R7s_l :  std_logic_vector(2 downto 0);
...
signal fR :  std_logic_vector(9 downto 0);
   -- timing of fR: (c3, 0.518000ns)
signal round :  std_logic;
   -- timing of round: (c3, 0.483000ns)
signal fRrnd :  std_logic_vector(9 downto 0);
   -- timing of fRrnd: (c3, 1.016000ns)
signal Rn2 :  std_logic_vector(14 downto 0);
   -- timing of Rn2: (c3, 1.016000ns)
