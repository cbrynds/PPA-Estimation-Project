...
--  approx. output signal timings: R: (c3, 0.351000ns)
...
entity flopoco_00189_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00189_fpsqrt_top is
...
signal R2s_l, R2s_l_d1 :  std_logic_vector(4 downto 0);
...
signal fR, fR_d1 :  std_logic_vector(6 downto 0);
   -- timing of fR: (c2, 1.729000ns)
signal round, round_d1 :  std_logic;
   -- timing of round: (c2, 1.694000ns)
signal fRrnd :  std_logic_vector(6 downto 0);
   -- timing of fRrnd: (c3, 0.351000ns)
signal Rn2 :  std_logic_vector(14 downto 0);
   -- timing of Rn2: (c3, 0.351000ns)
