...
--  approx. output signal timings: R: (c3, 2.926000ns)
...
entity flopoco_00034_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+31+2 downto 0);
          R : out  std_logic_vector(8+31+2 downto 0)   );
end entity;

architecture arch of flopoco_00034_fpsqrt_top is
...
signal T10s_l, T10s_l_d1 :  std_logic_vector(20 downto 0);
...
signal T28s_l, T28s_l_d1 :  std_logic_vector(2 downto 0);
...
signal d33 :  std_logic;
   -- timing of d33: (c3, 2.346000ns)
signal mR :  std_logic_vector(33 downto 0);
   -- timing of mR: (c3, 2.346000ns)
signal fR :  std_logic_vector(30 downto 0);
   -- timing of fR: (c3, 2.346000ns)
signal round :  std_logic;
   -- timing of round: (c3, 2.346000ns)
signal fRrnd :  std_logic_vector(30 downto 0);
   -- timing of fRrnd: (c3, 2.926000ns)
signal Rn2 :  std_logic_vector(38 downto 0);
   -- timing of Rn2: (c3, 2.926000ns)
