--------------------------------------------------------------------------------
--                RightShifterSticky12_by_max_14_Freq200_uid4
...
entity RightShifterSticky12_by_max_14_Freq200_uid4 is
...
architecture arch of RightShifterSticky12_by_max_14_Freq200_uid4 is
...
entity IntAdder_15_Freq200_uid6 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_15_Freq200_uid6 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_16_16_16_Freq200_uid8
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Count: (c1, 0.044125ns)R: (c1, 0.259125ns)
...
entity Normalizer_Z_16_16_16_Freq200_uid8 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_16_16_16_Freq200_uid8 is
...
signal count0 :  std_logic;
   -- timing of count0: (c1, 0.044125ns)
signal level0 :  std_logic_vector(15 downto 0);
   -- timing of level0: (c1, 0.259125ns)
signal sCount :  std_logic_vector(4 downto 0);
   -- timing of sCount: (c1, 0.044125ns)
begin
   process(clk)
      begin
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.516125ns)Y: (c0, 0.000000ns)Cin: (c1, 0.474125ns)
--  approx. output signal timings: R: (c1, 1.055125ns)
...
entity IntAdder_20_Freq200_uid11 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_20_Freq200_uid11 is
signal Rtmp :  std_logic_vector(19 downto 0);
   -- timing of Rtmp: (c1, 1.055125ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00042_fpadd_top
--                         (FPSub_6_11_Freq200_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 200MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 1.485125ns)
...
entity flopoco_00042_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00042_fpadd_top is
   component RightShifterSticky12_by_max_14_Freq200_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(11 downto 0);
             S : in  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(13 downto 0);
   ...
   component IntAdder_15_Freq200_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(14 downto 0);
             Y : in  std_logic_vector(14 downto 0);
             Cin : in  std_logic;
   ...
   component Normalizer_Z_16_16_16_Freq200_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(15 downto 0);
             Count : out  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(15 downto 0)   );
   ...
   component IntAdder_20_Freq200_uid11 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(19 downto 0);
             Y : in  std_logic_vector(19 downto 0);
             Cin : in  std_logic;
...
signal nZerosNew :  std_logic_vector(4 downto 0);
   -- timing of nZerosNew: (c1, 0.044125ns)
signal shiftedFrac :  std_logic_vector(15 downto 0);
   -- timing of shiftedFrac: (c1, 0.259125ns)
...
signal updatedExp :  std_logic_vector(7 downto 0);
   -- timing of updatedExp: (c1, 0.516125ns)
signal eqdiffsign :  std_logic;
   -- timing of eqdiffsign: (c1, 0.044125ns)
signal expFrac :  std_logic_vector(19 downto 0);
   -- timing of expFrac: (c1, 0.516125ns)
signal stk :  std_logic;
   -- timing of stk: (c1, 0.259125ns)
signal rnd :  std_logic;
   -- timing of rnd: (c1, 0.259125ns)
signal lsb :  std_logic;
   -- timing of lsb: (c1, 0.259125ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c1, 0.474125ns)
signal RoundedExpFrac :  std_logic_vector(19 downto 0);
   -- timing of RoundedExpFrac: (c1, 1.055125ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c1, 1.055125ns)
signal fracR :  std_logic_vector(10 downto 0);
   -- timing of fracR: (c1, 1.055125ns)
signal expR :  std_logic_vector(5 downto 0);
   -- timing of expR: (c1, 1.055125ns)
signal exExpExc :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c1, 1.055125ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c1, 1.270125ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c1, 1.485125ns)
signal signR2 :  std_logic;
   -- timing of signR2: (c1, 0.259125ns)
signal computedR :  std_logic_vector(19 downto 0);
   -- timing of computedR: (c1, 1.485125ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   RightShifterComponent: RightShifterSticky12_by_max_14_Freq200_uid4
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracY,
                 R => shiftedFracY,
   ...
   fracAdder: IntAdder_15_Freq200_uid6
      port map ( clk  => clk,
                 Cin => cInSigAdd,
                 X => fracXpad,
                 Y => fracYpadXorOp,
   ...
   LZCAndShifter: Normalizer_Z_16_16_16_Freq200_uid8
      port map ( clk  => clk,
                 X => fracSticky,
                 Count => nZerosNew,
                 R => shiftedFrac);
   ...
   roundingAdder: IntAdder_20_Freq200_uid11
      port map ( clk  => clk,
                 Cin => needToRound,
                 X => expFrac,
