--------------------------------------------------------------------------------
--                     IntComparator_15_101_Freq300_uid4
...
entity IntComparator_15_101_Freq300_uid4 is
...
architecture arch of IntComparator_15_101_Freq300_uid4 is
...
--                      (FPComparator_5_10_Freq300_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin (2021)
...
--  approx. input signal timings: X: (c0, 0.000000ns)Y: (c0, 0.000000ns)
--  approx. output signal timings: unordered: (c0, 0.000000ns)XgtY: (c0, 0.687000ns)
...
architecture arch of flopoco_00334_fpcomparator_top is
   component IntComparator_15_101_Freq300_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(14 downto 0);
             Y : in  std_logic_vector(14 downto 0);
             XltY : out  std_logic;
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_15_101_Freq300_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
