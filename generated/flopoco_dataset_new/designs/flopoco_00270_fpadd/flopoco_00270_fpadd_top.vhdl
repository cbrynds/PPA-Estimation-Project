...
entity IntDualSub_55_Freq150_uid4 is
...
architecture arch of IntDualSub_55_Freq150_uid4 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_54_54_54_Freq150_uid6
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Count: (c0, 3.807250ns)R: (c0, 4.022250ns)
...
entity Normalizer_Z_54_54_54_Freq150_uid6 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_54_54_54_Freq150_uid6 is
...
signal level0 :  std_logic_vector(53 downto 0);
   -- timing of level0: (c0, 4.022250ns)
...
--------------------------------------------------------------------------------
--                RightShifterSticky53_by_max_55_Freq150_uid8
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity RightShifterSticky53_by_max_55_Freq150_uid8 is
    port (clk : in std_logic;
...
architecture arch of RightShifterSticky53_by_max_55_Freq150_uid8 is
...
entity IntAdder_56_Freq150_uid10 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_56_Freq150_uid10 is
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c0, 4.057250ns)Y: (c0, 0.000000ns)Cin: (c0, 4.057250ns)
--  approx. output signal timings: R: (c0, 4.842250ns)
...
entity IntAdder_65_Freq150_uid13 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_65_Freq150_uid13 is
signal Rtmp :  std_logic_vector(64 downto 0);
   -- timing of Rtmp: (c0, 4.842250ns)
begin
   Rtmp <= X + Y + Cin;
   R <= Rtmp;
end architecture;
...
--------------------------------------------------------------------------------
--                          flopoco_00270_fpadd_top
--                         (FPAdd_11_52_Freq150_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c0, 4.912250ns)
...
entity flopoco_00270_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00270_fpadd_top is
   component IntDualSub_55_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(54 downto 0);
             Y : in  std_logic_vector(54 downto 0);
             XmY : out  std_logic_vector(54 downto 0);
   ...
   component Normalizer_Z_54_54_54_Freq150_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(53 downto 0);
             Count : out  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(53 downto 0)   );
   ...
   component RightShifterSticky53_by_max_55_Freq150_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(52 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(54 downto 0);
   ...
   component IntAdder_56_Freq150_uid10 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(55 downto 0);
             Y : in  std_logic_vector(55 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_65_Freq150_uid13 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(64 downto 0);
             Y : in  std_logic_vector(64 downto 0);
             Cin : in  std_logic;
...
signal shiftedFrac :  std_logic_vector(53 downto 0);
   -- timing of shiftedFrac: (c0, 4.022250ns)
signal roundClose0 :  std_logic;
   -- timing of roundClose0: (c0, 4.022250ns)
...
signal resultBeforeRoundClose :  std_logic_vector(64 downto 0);
   -- timing of resultBeforeRoundClose: (c0, 4.022250ns)
signal roundClose :  std_logic;
   -- timing of roundClose: (c0, 4.022250ns)
...
-- Close Path --
   ...
   FPAdd_11_52_Freq150_uid2_DualSubClose: IntDualSub_55_Freq150_uid4
      port map ( clk  => clk,
                 X => fracXClose1,
                 Y => fracYClose1,
                 XmY => fracRClosexMy,
   ...
   norm: Normalizer_Z_54_54_54_Freq150_uid6
      port map ( clk  => clk,
                 X => fracRClose1,
                 Count => nZerosNew,
                 R => shiftedFrac);
...
-- Far Path --
   ...
   RightShifterComponent: RightShifterSticky53_by_max_55_Freq150_uid8
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracNewY,
                 R => shiftedFracY,
   ...
   -- far path adder
   FPAdd_11_52_Freq150_uid2_fracAddFar: IntAdder_56_Freq150_uid10
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
...
-- Synchronization of both paths --
   ...
   -- final round adder
   FPAdd_11_52_Freq150_uid2_finalRoundAdd: IntAdder_65_Freq150_uid13
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
   ...
   resultNoExn(65 downto 64) <=   (not zeroFromClose) & "0" when "01", -- overflow
                                 "00" when "10" | "11",  -- underflow
                                 "0" &  not zeroFromClose  when others; -- normal 
   resultNoExn(63 downto 0) <= syncResSign & resultRounded(62 downto 0);
   syncExnXY <= sdExnXY;
   ...
   with syncExnXY  select 
      sgnR <= resultNoExn(63)         when "0101",
              syncX(63) and syncSignY when "0000",
              syncX(63)               when others;
   -- Exponent and significand of the result
   with syncExnXY  select   
      expsigR <= resultNoExn(62 downto 0)   when "0101" ,
                 syncX(62 downto  0)        when others; -- 0100, or at least one NaN or one infty 
   R <= exnR & sgnR & expsigR;
end architecture;
