--------------------------------------------------------------------------------
--                    CBLKTable_l0_d5_alpha3_Freq150_uid7
...
entity CBLKTable_l0_d5_alpha3_Freq150_uid7 is
    port (X : in  std_logic_vector(2 downto 0);
          Y : out  std_logic_vector(3 downto 0)   );
end entity;

architecture arch of CBLKTable_l0_d5_alpha3_Freq150_uid7 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l1_d5_alpha3_Freq150_uid16
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l1_d5_alpha3_Freq150_uid16 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(5 downto 0)   );
end entity;

architecture arch of CBLKTable_l1_d5_alpha3_Freq150_uid16 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l2_d5_alpha3_Freq150_uid23
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l2_d5_alpha3_Freq150_uid23 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(8 downto 0)   );
end entity;

architecture arch of CBLKTable_l2_d5_alpha3_Freq150_uid23 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l3_d5_alpha3_Freq150_uid29
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l3_d5_alpha3_Freq150_uid29 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(14 downto 0)   );
end entity;

architecture arch of CBLKTable_l3_d5_alpha3_Freq150_uid29 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_5_14_1_3_Freq150_uid3
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity IntConstDiv_QR_5_14_1_3_Freq150_uid3 is
...
architecture arch of IntConstDiv_QR_5_14_1_3_Freq150_uid3 is
   component CBLKTable_l0_d5_alpha3_Freq150_uid7 is
      port ( X : in  std_logic_vector(2 downto 0);
             Y : out  std_logic_vector(3 downto 0)   );
   end component;

   component CBLKTable_l1_d5_alpha3_Freq150_uid16 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(5 downto 0)   );
   end component;

   component CBLKTable_l2_d5_alpha3_Freq150_uid23 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(8 downto 0)   );
   end component;

   component CBLKTable_l3_d5_alpha3_Freq150_uid29 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(14 downto 0)   );
   end component;
...
begin
   x0 <= X(2 downto 0);
   table0: CBLKTable_l0_d5_alpha3_Freq150_uid7
      port map ( X => x0,
                 Y => out0_copy8);
   ...
   x1 <= X(5 downto 3);
   table1: CBLKTable_l0_d5_alpha3_Freq150_uid7
      port map ( X => x1,
                 Y => out1_copy9);
   ...
   x2 <= X(8 downto 6);
   table2: CBLKTable_l0_d5_alpha3_Freq150_uid7
      port map ( X => x2,
                 Y => out2_copy10);
   ...
   x3 <= X(11 downto 9);
   table3: CBLKTable_l0_d5_alpha3_Freq150_uid7
      port map ( X => x3,
                 Y => out3_copy11);
   ...
   table_l1_1: CBLKTable_l1_d5_alpha3_Freq150_uid16
      port map ( X => in_l1_1,
                 Y => out_l1_1_copy18);
   ...
   in_l1_2 <= "000" & r_l0_4;
   table_l1_2: CBLKTable_l1_d5_alpha3_Freq150_uid16
      port map ( X => in_l1_2,
                 Y => out_l1_2_copy19);
   ...
   table_l2_0: CBLKTable_l2_d5_alpha3_Freq150_uid23
      port map ( X => in_l2_0,
                 Y => out_l2_0_copy24);
   ...
   in_l2_1 <= "000" & r_l1_2;
   table_l2_1: CBLKTable_l2_d5_alpha3_Freq150_uid23
      port map ( X => in_l2_1,
                 Y => out_l2_1_copy25);
   ...
   table_l3_0: CBLKTable_l3_d5_alpha3_Freq150_uid29
      port map ( X => in_l3_0,
                 Y => out_l3_0_copy30);
...
--------------------------------------------------------------------------------
--                        flopoco_00329_fpconstdiv_top
--                      (FPConstDiv_5_10_5_10_5_1_0_150)
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00329_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(5+10+2 downto 0);
          R : out  std_logic_vector(5+10+2 downto 0)   );
end entity;

architecture arch of flopoco_00329_fpconstdiv_top is
   component IntConstDiv_QR_5_14_1_3_Freq150_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(13 downto 0);
             Q : out  std_logic_vector(11 downto 0);
             R : out  std_logic_vector(2 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_5_14_1_3_Freq150_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
