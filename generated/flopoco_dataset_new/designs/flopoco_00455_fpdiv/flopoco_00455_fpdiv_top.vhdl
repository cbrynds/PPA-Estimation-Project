...
--  approx. output signal timings: R: (c4, 1.668856ns)
...
entity flopoco_00455_fpdiv_top is
...
architecture arch of flopoco_00455_fpdiv_top is
...
signal prescaledfY, prescaledfY_d1, prescaledfY_d2, prescaledfY_d3 :  std_logic_vector(13 downto 0);
...
begin
   ...
   w3fulla <= 
      w4pad_d1 - ("0000" & prescaledfY_d1)			when "01",
      w4pad_d1 + ("0000" & prescaledfY_d1)			when "11",
      w4pad_d1 + ("000" & prescaledfY_d1 & "0")		when "10",
   ...
   sel3 <= w3(16 downto 12) & prescaledfY_d1(11 downto 10);
   ...
   sel2 <= w2(16 downto 12) & prescaledfY_d2(11 downto 10);
   ...
   w1fulla <= 
      w2pad_d1 - ("0000" & prescaledfY_d3)			when "01",
      w2pad_d1 + ("0000" & prescaledfY_d3)			when "11",
      w2pad_d1 + ("000" & prescaledfY_d3 & "0")		when "10",
   ...
   sel1 <= w1(16 downto 12) & prescaledfY_d3(11 downto 10);
   ...
   w0fulla <= 
      w1pad - ("0000" & prescaledfY_d3)			when "01",
      w1pad + ("0000" & prescaledfY_d3)			when "11",
      w1pad + ("000" & prescaledfY_d3 & "0")		when "10",
      w1pad							when others;
   ...
   qP0 <= q0(2 downto 0);
   qM0 <= q0(3)  & "00";
   qP <= qP5_d4 & qP4_d3 & qP3_d3 & qP2_d2 & qP1_d1 & qP0;
   qM <= qM5_d4(1 downto 0) & qM4_d3 & qM3_d3 & qM2_d2 & qM1_d1 & qM0 & "0";
   quotient <= qP - qM;
   ...
   round <= fRnorm(0); 
   expR1 <= expR0_d4 + ("000" & (4 downto 1 => '1') & mR(13)); -- add back bias
   -- final rounding
   ...
   R <= exnRfinal & sR_d4 & expfracR(16 downto 0);
end architecture;
