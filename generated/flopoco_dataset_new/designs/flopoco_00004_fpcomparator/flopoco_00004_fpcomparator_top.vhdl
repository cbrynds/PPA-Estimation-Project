--------------------------------------------------------------------------------
--                     IntComparator_45_111_Freq400_uid4
...
entity IntComparator_45_111_Freq400_uid4 is
...
architecture arch of IntComparator_45_111_Freq400_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00004_fpcomparator_top
...
entity flopoco_00004_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00004_fpcomparator_top is
   component IntComparator_45_111_Freq400_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(44 downto 0);
             Y : in  std_logic_vector(44 downto 0);
             XltY : out  std_logic;
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_45_111_Freq400_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
