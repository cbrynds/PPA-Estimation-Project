...
--  approx. output signal timings: R: (c3, 1.729000ns)
...
entity flopoco_00291_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(6+11+2 downto 0);
          R : out  std_logic_vector(6+11+2 downto 0)   );
end entity;

architecture arch of flopoco_00291_fpsqrt_top is
...
signal R3s_l, R3s_l_d1 :  std_logic_vector(7 downto 0);
...
signal fR :  std_logic_vector(10 downto 0);
   -- timing of fR: (c3, 1.231000ns)
signal round :  std_logic;
   -- timing of round: (c3, 1.196000ns)
signal fRrnd :  std_logic_vector(10 downto 0);
   -- timing of fRrnd: (c3, 1.729000ns)
signal Rn2 :  std_logic_vector(16 downto 0);
   -- timing of Rn2: (c3, 1.729000ns)
