...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_7_11_0_3_Freq400_uid3
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity IntConstDiv_QR_7_11_0_3_Freq400_uid3 is
...
architecture arch of IntConstDiv_QR_7_11_0_3_Freq400_uid3 is
...
--------------------------------------------------------------------------------
--                        flopoco_00148_fpconstdiv_top
--                       (FPConstDiv_8_7_8_7_7_0_0_400)
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity flopoco_00148_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00148_fpconstdiv_top is
   component IntConstDiv_QR_7_11_0_3_Freq400_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(10 downto 0);
             Q : out  std_logic_vector(8 downto 0);
             R : out  std_logic_vector(2 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_7_11_0_3_Freq400_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
