...
--  approx. output signal timings: R: (c2, 1.699333ns)
...
entity flopoco_00290_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(5+10+2 downto 0);
          R : out  std_logic_vector(5+10+2 downto 0)   );
end entity;

architecture arch of flopoco_00290_fpsqrt_top is
...
signal R4s_l, R4s_l_d1 :  std_logic_vector(5 downto 0);
...
signal R9s_l, R9s_l_d1 :  std_logic_vector(0 downto 0);
...
signal fR :  std_logic_vector(9 downto 0);
   -- timing of fR: (c2, 1.201333ns)
signal round :  std_logic;
   -- timing of round: (c2, 1.166333ns)
signal fRrnd :  std_logic_vector(9 downto 0);
   -- timing of fRrnd: (c2, 1.699333ns)
signal Rn2 :  std_logic_vector(14 downto 0);
   -- timing of Rn2: (c2, 1.699333ns)
