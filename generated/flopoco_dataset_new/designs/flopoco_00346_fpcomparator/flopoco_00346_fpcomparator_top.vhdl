--------------------------------------------------------------------------------
--                     IntComparator_17_101_Freq150_uid4
...
--  approx. output signal timings: XltY: (c0, 0.498000ns)XgtY: (c0, 0.498000ns)
...
entity IntComparator_17_101_Freq150_uid4 is
...
architecture arch of IntComparator_17_101_Freq150_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00346_fpcomparator_top
--                      (FPComparator_6_11_Freq150_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin (2021)
...
--  approx. input signal timings: X: (c0, 0.000000ns)Y: (c0, 0.000000ns)
--  approx. output signal timings: unordered: (c0, 0.000000ns)XgtY: (c0, 0.713000ns)
...
entity flopoco_00346_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00346_fpcomparator_top is
   component IntComparator_17_101_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(16 downto 0);
             Y : in  std_logic_vector(16 downto 0);
             XltY : out  std_logic;
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_17_101_Freq150_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
