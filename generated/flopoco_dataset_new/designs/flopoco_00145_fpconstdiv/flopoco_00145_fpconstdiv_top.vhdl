--------------------------------------------------------------------------------
--                    CBLKTable_l0_d3_alpha4_Freq250_uid7
...
entity CBLKTable_l0_d3_alpha4_Freq250_uid7 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(4 downto 0)   );
end entity;

architecture arch of CBLKTable_l0_d3_alpha4_Freq250_uid7 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l1_d3_alpha4_Freq250_uid20
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l1_d3_alpha4_Freq250_uid20 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(5 downto 0)   );
end entity;

architecture arch of CBLKTable_l1_d3_alpha4_Freq250_uid20 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l2_d3_alpha4_Freq250_uid29
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l2_d3_alpha4_Freq250_uid29 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(9 downto 0)   );
end entity;

architecture arch of CBLKTable_l2_d3_alpha4_Freq250_uid29 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l3_d3_alpha4_Freq250_uid36
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l3_d3_alpha4_Freq250_uid36 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(17 downto 0)   );
end entity;

architecture arch of CBLKTable_l3_d3_alpha4_Freq250_uid36 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l4_d3_alpha4_Freq250_uid42
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l4_d3_alpha4_Freq250_uid42 is
    port (X : in  std_logic_vector(3 downto 0);
          Y : out  std_logic_vector(33 downto 0)   );
end entity;

architecture arch of CBLKTable_l4_d3_alpha4_Freq250_uid42 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_3_34_1_4_Freq250_uid3
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Q: (c0, 3.108000ns)R: (c0, 1.582000ns)
...
entity IntConstDiv_QR_3_34_1_4_Freq250_uid3 is
...
architecture arch of IntConstDiv_QR_3_34_1_4_Freq250_uid3 is
   component CBLKTable_l0_d3_alpha4_Freq250_uid7 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(4 downto 0)   );
   end component;

   component CBLKTable_l1_d3_alpha4_Freq250_uid20 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(5 downto 0)   );
   end component;

   component CBLKTable_l2_d3_alpha4_Freq250_uid29 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(9 downto 0)   );
   end component;

   component CBLKTable_l3_d3_alpha4_Freq250_uid36 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(17 downto 0)   );
   end component;

   component CBLKTable_l4_d3_alpha4_Freq250_uid42 is
      port ( X : in  std_logic_vector(3 downto 0);
             Y : out  std_logic_vector(33 downto 0)   );
   end component;
...
signal qs_l0_8 :  std_logic_vector(0 downto 0);
...
signal out_l1_0_copy21 :  std_logic_vector(5 downto 0);
   -- timing of out_l1_0_copy21: (c0, 0.722000ns)
...
signal out_l1_1_copy22 :  std_logic_vector(5 downto 0);
   -- timing of out_l1_1_copy22: (c0, 0.722000ns)
...
signal out_l1_2_copy23 :  std_logic_vector(5 downto 0);
   -- timing of out_l1_2_copy23: (c0, 0.722000ns)
...
signal out_l1_3_copy24 :  std_logic_vector(5 downto 0);
   -- timing of out_l1_3_copy24: (c0, 0.722000ns)
...
signal out_l1_4_copy25 :  std_logic_vector(5 downto 0);
   -- timing of out_l1_4_copy25: (c0, 0.722000ns)
signal r_l1_4 :  std_logic_vector(1 downto 0);
   -- timing of r_l1_4: (c0, 0.937000ns)
signal q_l1_4 :  std_logic_vector(0 downto 0);
   -- timing of q_l1_4: (c0, 0.937000ns)
signal qs_l1_4 :  std_logic_vector(0 downto 0);
...
signal out_l2_0_copy30 :  std_logic_vector(9 downto 0);
   -- timing of out_l2_0_copy30: (c0, 0.937000ns)
...
signal out_l2_1_copy31 :  std_logic_vector(9 downto 0);
   -- timing of out_l2_1_copy31: (c0, 0.937000ns)
...
signal out_l2_2 :  std_logic_vector(9 downto 0);
   -- timing of out_l2_2: (c0, 1.152000ns)
signal out_l2_2_copy32 :  std_logic_vector(9 downto 0);
   -- timing of out_l2_2_copy32: (c0, 0.937000ns)
signal r_l2_2 :  std_logic_vector(1 downto 0);
   -- timing of r_l2_2: (c0, 1.152000ns)
signal q_l2_2 :  std_logic_vector(0 downto 0);
   -- timing of q_l2_2: (c0, 1.152000ns)
signal qs_l2_2 :  std_logic_vector(0 downto 0);
...
signal out_l3_0_copy37 :  std_logic_vector(17 downto 0);
   -- timing of out_l3_0_copy37: (c0, 1.152000ns)
...
signal qs_l3_0 :  std_logic_vector(31 downto 0);
   -- timing of qs_l3_0: (c0, 2.487000ns)
signal in_l3_1 :  std_logic_vector(3 downto 0);
   -- timing of in_l3_1: (c0, 1.152000ns)
signal out_l3_1 :  std_logic_vector(17 downto 0);
   -- timing of out_l3_1: (c0, 1.367000ns)
signal out_l3_1_copy38 :  std_logic_vector(17 downto 0);
   -- timing of out_l3_1_copy38: (c0, 1.152000ns)
signal r_l3_1 :  std_logic_vector(1 downto 0);
   -- timing of r_l3_1: (c0, 1.367000ns)
signal q_l3_1 :  std_logic_vector(0 downto 0);
   -- timing of q_l3_1: (c0, 1.367000ns)
signal qs_l3_1 :  std_logic_vector(0 downto 0);
   -- timing of qs_l3_1: (c0, 2.353000ns)
signal in_l4_0 :  std_logic_vector(3 downto 0);
   -- timing of in_l4_0: (c0, 1.367000ns)
signal out_l4_0 :  std_logic_vector(33 downto 0);
   -- timing of out_l4_0: (c0, 1.582000ns)
signal out_l4_0_copy43 :  std_logic_vector(33 downto 0);
   -- timing of out_l4_0_copy43: (c0, 1.367000ns)
...
signal qs_l4_0 :  std_logic_vector(32 downto 0);
   -- timing of qs_l4_0: (c0, 3.108000ns)
begin
   x0 <= X(3 downto 0);
   table0: CBLKTable_l0_d3_alpha4_Freq250_uid7
      port map ( X => x0,
                 Y => out0_copy8);
   ...
   x1 <= X(7 downto 4);
   table1: CBLKTable_l0_d3_alpha4_Freq250_uid7
      port map ( X => x1,
                 Y => out1_copy9);
   ...
   x2 <= X(11 downto 8);
   table2: CBLKTable_l0_d3_alpha4_Freq250_uid7
      port map ( X => x2,
                 Y => out2_copy10);
   ...
   x3 <= X(15 downto 12);
   table3: CBLKTable_l0_d3_alpha4_Freq250_uid7
      port map ( X => x3,
                 Y => out3_copy11);
   ...
   x4 <= X(19 downto 16);
   table4: CBLKTable_l0_d3_alpha4_Freq250_uid7
      port map ( X => x4,
                 Y => out4_copy12);
   ...
   x5 <= X(23 downto 20);
   table5: CBLKTable_l0_d3_alpha4_Freq250_uid7
      port map ( X => x5,
                 Y => out5_copy13);
   ...
   x6 <= X(27 downto 24);
   table6: CBLKTable_l0_d3_alpha4_Freq250_uid7
      port map ( X => x6,
                 Y => out6_copy14);
   out6 <= out6_copy14; -- output copy to hold a pipeline register if needed
   qs_l0_6 <= "0" & (out6(4 downto 2));
   r_l0_6 <= out6(1 downto 0);
   x7 <= X(31 downto 28);
   table7: CBLKTable_l0_d3_alpha4_Freq250_uid7
      port map ( X => x7,
                 Y => out7_copy15);
   out7 <= out7_copy15; -- output copy to hold a pipeline register if needed
   qs_l0_7 <= "0" & (out7(4 downto 2));
   r_l0_7 <= out7(1 downto 0);
   x8 <= "00" & X(33 downto 32);
   table8: CBLKTable_l0_d3_alpha4_Freq250_uid7
      port map ( X => x8,
                 Y => out8_copy16);
   out8 <= out8_copy16; -- output copy to hold a pipeline register if needed
   qs_l0_8 <= out8(2 downto 2);
   r_l0_8 <= out8(1 downto 0);
   in_l1_0 <= r_l0_1 & r_l0_0;
   table_l1_0: CBLKTable_l1_d3_alpha4_Freq250_uid20
      port map ( X => in_l1_0,
                 Y => out_l1_0_copy21);
   out_l1_0 <= out_l1_0_copy21; -- output copy to hold a pipeline register if needed
   ...
   table_l1_1: CBLKTable_l1_d3_alpha4_Freq250_uid20
      port map ( X => in_l1_1,
                 Y => out_l1_1_copy22);
   out_l1_1 <= out_l1_1_copy22; -- output copy to hold a pipeline register if needed
   ...
   table_l1_2: CBLKTable_l1_d3_alpha4_Freq250_uid20
      port map ( X => in_l1_2,
                 Y => out_l1_2_copy23);
   out_l1_2 <= out_l1_2_copy23; -- output copy to hold a pipeline register if needed
   ...
   table_l1_3: CBLKTable_l1_d3_alpha4_Freq250_uid20
      port map ( X => in_l1_3,
                 Y => out_l1_3_copy24);
   out_l1_3 <= out_l1_3_copy24; -- output copy to hold a pipeline register if needed
   r_l1_3 <= out_l1_3(1 downto 0);
   q_l1_3 <= "0000" & out_l1_3(5 downto 2);
   qs_l1_3 <= q_l1_3 + (qs_l0_7 & qs_l0_6);  -- partial quotient so far
   in_l1_4 <= "00" & r_l0_8;
   table_l1_4: CBLKTable_l1_d3_alpha4_Freq250_uid20
      port map ( X => in_l1_4,
                 Y => out_l1_4_copy25);
   out_l1_4 <= out_l1_4_copy25; -- output copy to hold a pipeline register if needed
   r_l1_4 <= out_l1_4(1 downto 0);
   q_l1_4 <= out_l1_4(2 downto 2);
   qs_l1_4 <= q_l1_4 + qs_l0_8;  -- partial quotient so far
   in_l2_0 <= r_l1_1 & r_l1_0;
   table_l2_0: CBLKTable_l2_d3_alpha4_Freq250_uid29
      port map ( X => in_l2_0,
                 Y => out_l2_0_copy30);
   out_l2_0 <= out_l2_0_copy30; -- output copy to hold a pipeline register if needed
   ...
   table_l2_1: CBLKTable_l2_d3_alpha4_Freq250_uid29
      port map ( X => in_l2_1,
                 Y => out_l2_1_copy31);
   out_l2_1 <= out_l2_1_copy31; -- output copy to hold a pipeline register if needed
   r_l2_1 <= out_l2_1(1 downto 0);
   q_l2_1 <= "00000000" & out_l2_1(9 downto 2);
   qs_l2_1 <= q_l2_1 + (qs_l1_3 & qs_l1_2);  -- partial quotient so far
   in_l2_2 <= "00" & r_l1_4;
   table_l2_2: CBLKTable_l2_d3_alpha4_Freq250_uid29
      port map ( X => in_l2_2,
                 Y => out_l2_2_copy32);
   out_l2_2 <= out_l2_2_copy32; -- output copy to hold a pipeline register if needed
   r_l2_2 <= out_l2_2(1 downto 0);
   q_l2_2 <= out_l2_2(2 downto 2);
   qs_l2_2 <= q_l2_2 + qs_l1_4;  -- partial quotient so far
   in_l3_0 <= r_l2_1 & r_l2_0;
   table_l3_0: CBLKTable_l3_d3_alpha4_Freq250_uid36
      port map ( X => in_l3_0,
                 Y => out_l3_0_copy37);
   out_l3_0 <= out_l3_0_copy37; -- output copy to hold a pipeline register if needed
   r_l3_0 <= out_l3_0(1 downto 0);
   q_l3_0 <= "0000000000000000" & out_l3_0(17 downto 2);
   qs_l3_0 <= q_l3_0 + (qs_l2_1 & qs_l2_0);  -- partial quotient so far
   in_l3_1 <= "00" & r_l2_2;
   table_l3_1: CBLKTable_l3_d3_alpha4_Freq250_uid36
      port map ( X => in_l3_1,
                 Y => out_l3_1_copy38);
   out_l3_1 <= out_l3_1_copy38; -- output copy to hold a pipeline register if needed
   r_l3_1 <= out_l3_1(1 downto 0);
   q_l3_1 <= out_l3_1(2 downto 2);
   qs_l3_1 <= q_l3_1 + qs_l2_2;  -- partial quotient so far
   in_l4_0 <= r_l3_1 & r_l3_0;
   table_l4_0: CBLKTable_l4_d3_alpha4_Freq250_uid42
      port map ( X => in_l4_0,
                 Y => out_l4_0_copy43);
   out_l4_0 <= out_l4_0_copy43; -- output copy to hold a pipeline register if needed
   r_l4_0 <= out_l4_0(1 downto 0);
   q_l4_0 <= "0" & out_l4_0(33 downto 2);
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.000000ns)
--  approx. output signal timings: R: (c0, 3.108000ns)
...
entity flopoco_00145_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+31+2 downto 0);
          R : out  std_logic_vector(8+31+2 downto 0)   );
end entity;

architecture arch of flopoco_00145_fpconstdiv_top is
   component IntConstDiv_QR_3_34_1_4_Freq250_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(33 downto 0);
             Q : out  std_logic_vector(32 downto 0);
             R : out  std_logic_vector(1 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_3_34_1_4_Freq250_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
