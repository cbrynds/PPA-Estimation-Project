--------------------------------------------------------------------------------
--                RightShifterSticky32_by_max_34_Freq400_uid4
...
entity RightShifterSticky32_by_max_34_Freq400_uid4 is
...
architecture arch of RightShifterSticky32_by_max_34_Freq400_uid4 is
...
entity IntAdder_35_Freq400_uid6 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_35_Freq400_uid6 is
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.987250ns)Y: (c0, 0.000000ns)Cin: (c1, 0.987250ns)
--  approx. output signal timings: R: (c1, 1.649250ns)
...
entity IntAdder_41_Freq400_uid9 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_41_Freq400_uid9 is
signal Rtmp :  std_logic_vector(40 downto 0);
   -- timing of Rtmp: (c1, 1.649250ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00108_fpadd_top
--                         (FPAdd_8_31_Freq400_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 1.719250ns)
...
entity flopoco_00108_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00108_fpadd_top is
   component RightShifterSticky32_by_max_34_Freq400_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(31 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(33 downto 0);
   ...
   component IntAdder_35_Freq400_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(34 downto 0);
             Y : in  std_logic_vector(34 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_41_Freq400_uid9 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(40 downto 0);
             Y : in  std_logic_vector(40 downto 0);
             Cin : in  std_logic;
...
signal resultBeforeRound :  std_logic_vector(40 downto 0);
   -- timing of resultBeforeRound: (c1, 0.987250ns)
signal round :  std_logic;
   -- timing of round: (c1, 0.987250ns)
...
signal resultRounded :  std_logic_vector(40 downto 0);
   -- timing of resultRounded: (c1, 1.649250ns)
...
-- Far Path --
   ...
   RightShifterComponent: RightShifterSticky32_by_max_34_Freq400_uid4
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracNewY,
                 R => shiftedFracY,
   ...
   -- far path adder
   FPAdd_8_31_Freq400_uid2_fracAddFar: IntAdder_35_Freq400_uid6
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   -- final round adder
   FPAdd_8_31_Freq400_uid2_finalRoundAdd: IntAdder_41_Freq400_uid9
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
