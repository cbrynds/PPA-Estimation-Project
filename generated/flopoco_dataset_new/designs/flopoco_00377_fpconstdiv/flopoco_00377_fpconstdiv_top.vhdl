...
--------------------------------------------------------------------------------
--                    CBLKTable_l1_d5_alpha6_Freq400_uid14
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l1_d5_alpha6_Freq400_uid14 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(8 downto 0)   );
end entity;

architecture arch of CBLKTable_l1_d5_alpha6_Freq400_uid14 is
...
--------------------------------------------------------------------------------
--                    CBLKTable_l2_d5_alpha6_Freq400_uid20
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin, Bogdan Pasca (2007-2022)
...
entity CBLKTable_l2_d5_alpha6_Freq400_uid20 is
    port (X : in  std_logic_vector(5 downto 0);
          Y : out  std_logic_vector(14 downto 0)   );
end entity;

architecture arch of CBLKTable_l2_d5_alpha6_Freq400_uid20 is
...
--------------------------------------------------------------------------------
--                    IntConstDiv_QR_5_14_1_6_Freq400_uid3
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Q: (c0, 2.159000ns)R: (c0, 1.491000ns)
...
entity IntConstDiv_QR_5_14_1_6_Freq400_uid3 is
...
architecture arch of IntConstDiv_QR_5_14_1_6_Freq400_uid3 is
   component CBLKTable_l0_d5_alpha6_Freq400_uid7 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(6 downto 0)   );
   end component;

   component CBLKTable_l1_d5_alpha6_Freq400_uid14 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(8 downto 0)   );
   end component;

   component CBLKTable_l2_d5_alpha6_Freq400_uid20 is
      port ( X : in  std_logic_vector(5 downto 0);
             Y : out  std_logic_vector(14 downto 0)   );
   end component;
...
signal out_l1_0_copy15 :  std_logic_vector(8 downto 0);
...
signal out_l1_1_copy16 :  std_logic_vector(8 downto 0);
...
signal out_l2_0_copy21 :  std_logic_vector(14 downto 0);
   -- timing of out_l2_0_copy21: (c0, 1.163000ns)
...
signal qs_l2_0 :  std_logic_vector(11 downto 0);
   -- timing of qs_l2_0: (c0, 2.159000ns)
begin
   x0 <= X(5 downto 0);
   ...
   table_l1_0: CBLKTable_l1_d5_alpha6_Freq400_uid14
      port map ( X => in_l1_0,
                 Y => out_l1_0_copy15);
   ...
   in_l1_1 <= "000" & r_l0_2;
   table_l1_1: CBLKTable_l1_d5_alpha6_Freq400_uid14
      port map ( X => in_l1_1,
                 Y => out_l1_1_copy16);
   ...
   table_l2_0: CBLKTable_l2_d5_alpha6_Freq400_uid20
      port map ( X => in_l2_0,
                 Y => out_l2_0_copy21);
   out_l2_0 <= out_l2_0_copy21; -- output copy to hold a pipeline register if needed
   r_l2_0 <= out_l2_0(2 downto 0);
   q_l2_0 <= "" & out_l2_0(14 downto 3);
   qs_l2_0 <= q_l2_0 + qs_l1_0;  -- partial quotient so far
   Q <= qs_l2_0(11 downto 0);
   R <= r_l2_0;
end architecture;

--------------------------------------------------------------------------------
--                        flopoco_00377_fpconstdiv_top
--                      (FPConstDiv_5_10_5_10_5_1_0_400)
-- VHDL generated for VirtexUltrascalePlus @ 400MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.000000ns)
--  approx. output signal timings: R: (c0, 2.159000ns)
...
entity flopoco_00377_fpconstdiv_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(5+10+2 downto 0);
          R : out  std_logic_vector(5+10+2 downto 0)   );
end entity;

architecture arch of flopoco_00377_fpconstdiv_top is
   component IntConstDiv_QR_5_14_1_6_Freq400_uid3 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(13 downto 0);
             Q : out  std_logic_vector(11 downto 0);
             R : out  std_logic_vector(2 downto 0)   );
...
begin
   ...
   intconstdiv: IntConstDiv_QR_5_14_1_6_Freq400_uid3
      port map ( clk  => clk,
                 X => divIn,
                 Q => quotient,
                 R => remainder);
