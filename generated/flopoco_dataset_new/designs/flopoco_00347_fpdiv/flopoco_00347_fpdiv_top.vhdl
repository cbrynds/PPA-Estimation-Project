...
--  approx. output signal timings: R: (c1, 1.216000ns)
...
entity flopoco_00347_fpdiv_top is
...
architecture arch of flopoco_00347_fpdiv_top is
...
begin
   ...
   sel2 <= betaw2(13 downto 8) & D(9 downto 7);
   ...
   sel1 <= betaw1(13 downto 8) & D(9 downto 7);
   ...
   qP1 <=      q1(1 downto 0);
   qM1 <=      q1(2) & "0";
   qP <= qP7 & qP6 & qP5 & qP4 & qP3 & qP2 & qP1;
   qM <= qM7_d1(0) & qM6_d1 & qM5_d1 & qM4_d1 & qM3_d1 & qM2_d1 & qM1_d1 & qM0;
   quotient <= qP_d1 - qM;
