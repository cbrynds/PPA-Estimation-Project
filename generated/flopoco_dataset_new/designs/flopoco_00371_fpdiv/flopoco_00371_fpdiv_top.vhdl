...
--------------------------------------------------------------------------------
--                          flopoco_00371_fpdiv_top
--                         (FPDiv_5_10_Freq150_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 4.826026ns)
...
entity flopoco_00371_fpdiv_top is
...
architecture arch of flopoco_00371_fpdiv_top is
...
signal Dx3, Dx3_d1 :  std_logic_vector(11 downto 0);
...
signal qP3, qP3_d1 :  std_logic_vector(1 downto 0);
   -- timing of qP3: (c0, 6.203538ns)
signal qM3, qM3_d1 :  std_logic_vector(1 downto 0);
   -- timing of qM3: (c0, 6.203538ns)
signal qP2 :  std_logic_vector(1 downto 0);
   -- timing of qP2: (c1, 1.113256ns)
signal qM2 :  std_logic_vector(1 downto 0);
   -- timing of qM2: (c1, 1.113256ns)
signal qP1 :  std_logic_vector(1 downto 0);
   -- timing of qP1: (c1, 2.539641ns)
signal qM1 :  std_logic_vector(1 downto 0);
   -- timing of qM1: (c1, 2.539641ns)
signal qP :  std_logic_vector(13 downto 0);
   -- timing of qP: (c1, 2.539641ns)
signal qM :  std_logic_vector(13 downto 0);
   -- timing of qM: (c1, 3.751026ns)
signal quotient :  std_logic_vector(13 downto 0);
   -- timing of quotient: (c1, 4.249026ns)
signal mR :  std_logic_vector(12 downto 0);
   -- timing of mR: (c1, 4.284026ns)
signal fRnorm :  std_logic_vector(10 downto 0);
   -- timing of fRnorm: (c1, 4.319026ns)
signal round :  std_logic;
   -- timing of round: (c1, 4.354026ns)
signal expR1 :  std_logic_vector(6 downto 0);
   -- timing of expR1: (c1, 4.756026ns)
signal expfrac :  std_logic_vector(16 downto 0);
   -- timing of expfrac: (c1, 4.756026ns)
signal expfracR :  std_logic_vector(16 downto 0);
   -- timing of expfracR: (c1, 4.756026ns)
signal exnR :  std_logic_vector(1 downto 0);
   -- timing of exnR: (c1, 4.791026ns)
signal exnRfinal :  std_logic_vector(1 downto 0);
   -- timing of exnRfinal: (c1, 4.826026ns)
begin
   process(clk)
      begin
   ...
   sel3 <= betaw3(13 downto 10) & D(9 downto 9);
