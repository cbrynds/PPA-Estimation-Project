...
--------------------------------------------------------------------------------
--                     Normalizer_Z_16_16_16_Freq300_uid8
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Count: (c1, 1.710792ns)R: (c1, 1.925792ns)
...
entity Normalizer_Z_16_16_16_Freq300_uid8 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_16_16_16_Freq300_uid8 is
signal level5, level5_d1 :  std_logic_vector(15 downto 0);
   -- timing of level5: (c0, 2.944125ns)
signal count4, count4_d1 :  std_logic;
   -- timing of count4: (c0, 3.164750ns)
signal level4 :  std_logic_vector(15 downto 0);
   -- timing of level4: (c1, 0.196417ns)
signal count3 :  std_logic;
   -- timing of count3: (c1, 0.415167ns)
signal level3 :  std_logic_vector(15 downto 0);
   -- timing of level3: (c1, 0.630167ns)
signal count2 :  std_logic;
   -- timing of count2: (c1, 0.847042ns)
signal level2 :  std_logic_vector(15 downto 0);
   -- timing of level2: (c1, 1.062042ns)
signal count1 :  std_logic;
   -- timing of count1: (c1, 1.278917ns)
signal level1 :  std_logic_vector(15 downto 0);
   -- timing of level1: (c1, 1.493917ns)
signal count0 :  std_logic;
   -- timing of count0: (c1, 1.710792ns)
signal level0 :  std_logic_vector(15 downto 0);
   -- timing of level0: (c1, 1.925792ns)
signal sCount :  std_logic_vector(4 downto 0);
   -- timing of sCount: (c1, 1.710792ns)
begin
   process(clk)
      begin
   ...
   level4<= level5_d1(15 downto 0) when count4_d1='0' else (15 downto 0 => '0');
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 2.182792ns)Y: (c0, 0.000000ns)Cin: (c1, 2.140792ns)
--  approx. output signal timings: R: (c1, 2.721792ns)
...
entity IntAdder_20_Freq300_uid11 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_20_Freq300_uid11 is
signal Rtmp :  std_logic_vector(19 downto 0);
   -- timing of Rtmp: (c1, 2.721792ns)
...
--  approx. output signal timings: R: (c1, 3.151792ns)
...
entity flopoco_00486_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00486_fpadd_top is
   ...
   component Normalizer_Z_16_16_16_Freq300_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(15 downto 0);
             Count : out  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(15 downto 0)   );
   ...
   component IntAdder_20_Freq300_uid11 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(19 downto 0);
             Y : in  std_logic_vector(19 downto 0);
             Cin : in  std_logic;
...
signal nZerosNew :  std_logic_vector(4 downto 0);
   -- timing of nZerosNew: (c1, 1.710792ns)
signal shiftedFrac :  std_logic_vector(15 downto 0);
   -- timing of shiftedFrac: (c1, 1.925792ns)
...
signal updatedExp :  std_logic_vector(7 downto 0);
   -- timing of updatedExp: (c1, 2.182792ns)
signal eqdiffsign :  std_logic;
   -- timing of eqdiffsign: (c1, 1.710792ns)
signal expFrac :  std_logic_vector(19 downto 0);
   -- timing of expFrac: (c1, 2.182792ns)
signal stk :  std_logic;
   -- timing of stk: (c1, 1.925792ns)
signal rnd :  std_logic;
   -- timing of rnd: (c1, 1.925792ns)
signal lsb :  std_logic;
   -- timing of lsb: (c1, 1.925792ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c1, 2.140792ns)
signal RoundedExpFrac :  std_logic_vector(19 downto 0);
   -- timing of RoundedExpFrac: (c1, 2.721792ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c1, 2.721792ns)
signal fracR :  std_logic_vector(10 downto 0);
   -- timing of fracR: (c1, 2.721792ns)
signal expR :  std_logic_vector(5 downto 0);
   -- timing of expR: (c1, 2.721792ns)
signal exExpExc :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c1, 2.721792ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c1, 2.936792ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c1, 3.151792ns)
signal signR2 :  std_logic;
   -- timing of signR2: (c1, 1.925792ns)
signal computedR :  std_logic_vector(19 downto 0);
   -- timing of computedR: (c1, 3.151792ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   fracAdder: IntAdder_15_Freq300_uid6
      port map ( clk  => clk,
                 Cin => cInSigAdd,
                 X => fracXpad,
                 Y => fracYpadXorOp,
   ...
   LZCAndShifter: Normalizer_Z_16_16_16_Freq300_uid8
      port map ( clk  => clk,
                 X => fracSticky,
                 Count => nZerosNew,
                 R => shiftedFrac);
   ...
   roundingAdder: IntAdder_20_Freq300_uid11
      port map ( clk  => clk,
                 Cin => needToRound,
                 X => expFrac,
