...
entity IntDualSub_26_Freq300_uid4 is
...
architecture arch of IntDualSub_26_Freq300_uid4 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_25_25_25_Freq300_uid6
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Count: (c1, 0.059667ns)R: (c1, 0.274667ns)
...
entity Normalizer_Z_25_25_25_Freq300_uid6 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_25_25_25_Freq300_uid6 is
...
signal count0 :  std_logic;
   -- timing of count0: (c1, 0.059667ns)
signal level0 :  std_logic_vector(24 downto 0);
   -- timing of level0: (c1, 0.274667ns)
signal sCount :  std_logic_vector(4 downto 0);
   -- timing of sCount: (c1, 0.059667ns)
begin
   process(clk)
      begin
...
--------------------------------------------------------------------------------
--                RightShifterSticky24_by_max_26_Freq300_uid8
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity RightShifterSticky24_by_max_26_Freq300_uid8 is
    port (clk : in std_logic;
...
architecture arch of RightShifterSticky24_by_max_26_Freq300_uid8 is
...
entity IntAdder_27_Freq300_uid10 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_27_Freq300_uid10 is
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.309667ns)Y: (c0, 0.000000ns)Cin: (c1, 0.309667ns)
--  approx. output signal timings: R: (c1, 0.930667ns)
...
entity IntAdder_33_Freq300_uid13 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_33_Freq300_uid13 is
signal Rtmp :  std_logic_vector(32 downto 0);
   -- timing of Rtmp: (c1, 0.930667ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00284_fpadd_top
--                         (FPSub_8_23_Freq300_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 1.000667ns)
...
entity flopoco_00284_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00284_fpadd_top is
   component IntDualSub_26_Freq300_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(25 downto 0);
             Y : in  std_logic_vector(25 downto 0);
             XmY : out  std_logic_vector(25 downto 0);
   ...
   component Normalizer_Z_25_25_25_Freq300_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(24 downto 0);
             Count : out  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(24 downto 0)   );
   ...
   component RightShifterSticky24_by_max_26_Freq300_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(23 downto 0);
             S : in  std_logic_vector(4 downto 0);
             R : out  std_logic_vector(25 downto 0);
   ...
   component IntAdder_27_Freq300_uid10 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(26 downto 0);
             Y : in  std_logic_vector(26 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_33_Freq300_uid13 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(32 downto 0);
             Y : in  std_logic_vector(32 downto 0);
             Cin : in  std_logic;
...
signal nZerosNew :  std_logic_vector(4 downto 0);
   -- timing of nZerosNew: (c1, 0.059667ns)
signal shiftedFrac :  std_logic_vector(24 downto 0);
   -- timing of shiftedFrac: (c1, 0.274667ns)
signal roundClose0 :  std_logic;
   -- timing of roundClose0: (c1, 0.274667ns)
signal resultCloseIsZero0 :  std_logic;
   -- timing of resultCloseIsZero0: (c1, 0.059667ns)
signal exponentResultClose :  std_logic_vector(9 downto 0);
   -- timing of exponentResultClose: (c1, 0.059667ns)
signal resultBeforeRoundClose :  std_logic_vector(32 downto 0);
   -- timing of resultBeforeRoundClose: (c1, 0.274667ns)
signal roundClose :  std_logic;
   -- timing of roundClose: (c1, 0.274667ns)
signal resultCloseIsZero :  std_logic;
   -- timing of resultCloseIsZero: (c1, 0.059667ns)
...
signal resultBeforeRoundFar, resultBeforeRoundFar_d1 :  std_logic_vector(32 downto 0);
...
signal resultBeforeRound :  std_logic_vector(32 downto 0);
   -- timing of resultBeforeRound: (c1, 0.309667ns)
signal round :  std_logic;
   -- timing of round: (c1, 0.309667ns)
signal zeroFromClose :  std_logic;
   -- timing of zeroFromClose: (c1, 0.059667ns)
signal resultRounded :  std_logic_vector(32 downto 0);
   -- timing of resultRounded: (c1, 0.930667ns)
...
-- Close Path --
   ...
   FPSub_8_23_Freq300_uid2_DualSubClose: IntDualSub_26_Freq300_uid4
      port map ( clk  => clk,
                 X => fracXClose1,
                 Y => fracYClose1,
                 XmY => fracRClosexMy,
   ...
   norm: Normalizer_Z_25_25_25_Freq300_uid6
      port map ( clk  => clk,
                 X => fracRClose1,
                 Count => nZerosNew,
                 R => shiftedFrac);
...
-- Far Path --
   ...
   RightShifterComponent: RightShifterSticky24_by_max_26_Freq300_uid8
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracNewY,
                 R => shiftedFracY,
   ...
   -- far path adder
   FPSub_8_23_Freq300_uid2_fracAddFar: IntAdder_27_Freq300_uid10
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
...
-- Synchronization of both paths --
   ...
   -- final round adder
   FPSub_8_23_Freq300_uid2_finalRoundAdd: IntAdder_33_Freq300_uid13
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
