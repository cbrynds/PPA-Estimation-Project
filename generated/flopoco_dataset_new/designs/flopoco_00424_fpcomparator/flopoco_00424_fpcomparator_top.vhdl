--------------------------------------------------------------------------------
--                     IntComparator_63_111_Freq250_uid4
...
entity IntComparator_63_111_Freq250_uid4 is
...
architecture arch of IntComparator_63_111_Freq250_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00424_fpcomparator_top
--                     (FPComparator_11_52_Freq250_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin (2021)
...
--  approx. input signal timings: X: (c0, 0.000000ns)Y: (c0, 0.000000ns)
--  approx. output signal timings: unordered: (c0, 0.000000ns)XltY: (c0, 0.795000ns)XeqY: (c0, 0.754000ns)XgtY: (c0, 0.795000ns)XleY: (c0, 0.795000ns)XgeY: (c0, 0.795000ns)
...
entity flopoco_00424_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00424_fpcomparator_top is
   component IntComparator_63_111_Freq250_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(62 downto 0);
             Y : in  std_logic_vector(62 downto 0);
             XltY : out  std_logic;
...
signal XltYR :  std_logic;
   -- timing of XltYR: (c0, 0.795000ns)
signal XeqYR :  std_logic;
   -- timing of XeqYR: (c0, 0.754000ns)
signal XgtYR :  std_logic;
   -- timing of XgtYR: (c0, 0.795000ns)
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_63_111_Freq250_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
