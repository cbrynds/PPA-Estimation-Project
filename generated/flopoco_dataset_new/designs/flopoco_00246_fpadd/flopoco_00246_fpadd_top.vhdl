--------------------------------------------------------------------------------
--                RightShifterSticky12_by_max_14_Freq250_uid4
...
entity RightShifterSticky12_by_max_14_Freq250_uid4 is
...
architecture arch of RightShifterSticky12_by_max_14_Freq250_uid4 is
...
entity IntAdder_15_Freq250_uid6 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_15_Freq250_uid6 is
...
--  approx. output signal timings: R: (c0, 3.280375ns)
...
entity IntAdder_19_Freq250_uid9 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_19_Freq250_uid9 is
signal Rtmp :  std_logic_vector(18 downto 0);
   -- timing of Rtmp: (c0, 3.280375ns)
begin
   Rtmp <= X + Y + Cin;
   R <= Rtmp;
end architecture;
...
--------------------------------------------------------------------------------
--                          flopoco_00246_fpadd_top
--                         (FPAdd_6_11_Freq250_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c0, 3.350375ns)
...
entity flopoco_00246_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00246_fpadd_top is
   component RightShifterSticky12_by_max_14_Freq250_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(11 downto 0);
             S : in  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(13 downto 0);
   ...
   component IntAdder_15_Freq250_uid6 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(14 downto 0);
             Y : in  std_logic_vector(14 downto 0);
             Cin : in  std_logic;
   ...
   component IntAdder_19_Freq250_uid9 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(18 downto 0);
             Y : in  std_logic_vector(18 downto 0);
             Cin : in  std_logic;
...
signal resultRounded :  std_logic_vector(18 downto 0);
   -- timing of resultRounded: (c0, 3.280375ns)
signal syncEffSub :  std_logic;
   -- timing of syncEffSub: (c0, 0.000000ns)
signal syncX :  std_logic_vector(19 downto 0);
...
-- Far Path --
   ...
   RightShifterComponent: RightShifterSticky12_by_max_14_Freq250_uid4
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracNewY,
                 R => shiftedFracY,
   ...
   -- far path adder
   FPAdd_6_11_Freq250_uid2_fracAddFar: IntAdder_15_Freq250_uid6
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   -- final round adder
   FPAdd_6_11_Freq250_uid2_finalRoundAdd: IntAdder_19_Freq250_uid9
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
   ...
   resultNoExn(19 downto 18) <=   (not zeroFromClose) & "0" when "01", -- overflow
                                 "00" when "10" | "11",  -- underflow
                                 "0" &  not zeroFromClose  when others; -- normal 
   resultNoExn(17 downto 0) <= syncResSign & resultRounded(16 downto 0);
   syncExnXY <= sdExnXY;
   ...
   with syncExnXY  select 
      sgnR <= resultNoExn(17)         when "0101",
              syncX(17) and syncSignY when "0000",
              syncX(17)               when others;
   -- Exponent and significand of the result
   with syncExnXY  select   
      expsigR <= resultNoExn(16 downto 0)   when "0101" ,
                 syncX(16 downto  0)        when others; -- 0100, or at least one NaN or one infty 
   R <= exnR & sgnR & expsigR;
end architecture;
