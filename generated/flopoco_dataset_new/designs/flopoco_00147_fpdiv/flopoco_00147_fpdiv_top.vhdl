...
--------------------------------------------------------------------------------
--                          flopoco_00147_fpdiv_top
--                         (FPDiv_10_35_Freq300_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 300MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c12, 0.721125ns)
...
entity flopoco_00147_fpdiv_top is
...
architecture arch of flopoco_00147_fpdiv_top is
...
signal expR0, expR0_d1, expR0_d2, expR0_d3, expR0_d4, expR0_d5, expR0_d6, expR0_d7, expR0_d8, expR0_d9, expR0_d10, expR0_d11, expR0_d12 :  std_logic_vector(11 downto 0);
...
signal prescaledfY, prescaledfY_d1, prescaledfY_d2, prescaledfY_d3, prescaledfY_d4, prescaledfY_d5, prescaledfY_d6, prescaledfY_d7, prescaledfY_d8, prescaledfY_d9, prescaledfY_d10, prescaledfY_d11 :  std_logic_vector(37 downto 0);
...
begin
   ...
   w12full <= 
      w12fulla_d1 - fYdec12_d1			when '0',
      w12fulla_d1 + fYdec12_d1			when others;
   ...
   w11fulla <= 
      w12pad - ("0000" & prescaledfY_d1)			when "01",
      w12pad + ("0000" & prescaledfY_d1)			when "11",
      w12pad + ("000" & prescaledfY_d1 & "0")		when "10",
      w12pad							when others;
   ...
   SelFunctionTable11: selFunction7_4_Freq300_uid4
      port map ( X => sel11,
                 Y => q11_copy7);
   q11 <= q11_copy7_d1; -- output copy to hold a pipeline register if needed
   w11pad <= w11 & '0';
   ...
   sel10 <= w10(40 downto 36) & prescaledfY_d2(35 downto 34);
   ...
   sel9 <= w9(40 downto 36) & prescaledfY_d3(35 downto 34);
   ...
   sel8 <= w8(40 downto 36) & prescaledfY_d4(35 downto 34);
   ...
   sel7 <= w7(40 downto 36) & prescaledfY_d5(35 downto 34);
   ...
   sel6 <= w6(40 downto 36) & prescaledfY_d6(35 downto 34);
   ...
   sel5 <= w5(40 downto 36) & prescaledfY_d7(35 downto 34);
   ...
   w4fulla <= 
      w5pad - ("0000" & prescaledfY_d7)			when "01",
      w5pad + ("0000" & prescaledfY_d7)			when "11",
      w5pad + ("000" & prescaledfY_d7 & "0")		when "10",
      w5pad							when others;
   ...
   sel4 <= w4(40 downto 36) & prescaledfY_d8(35 downto 34);
   ...
   sel3 <= w3(40 downto 36) & prescaledfY_d9(35 downto 34);
   ...
   w2fulla <= 
      w3pad - ("0000" & prescaledfY_d9)			when "01",
      w3pad + ("0000" & prescaledfY_d9)			when "11",
      w3pad + ("000" & prescaledfY_d9 & "0")		when "10",
      w3pad							when others;
   ...
   sel2 <= w2(40 downto 36) & prescaledfY_d9(35 downto 34);
   ...
   w1fulla <= 
      w2pad_d1 - ("0000" & prescaledfY_d10)			when "01",
      w2pad_d1 + ("0000" & prescaledfY_d10)			when "11",
      w2pad_d1 + ("000" & prescaledfY_d10 & "0")		when "10",
   ...
   sel1 <= w1(40 downto 36) & prescaledfY_d10(35 downto 34);
   ...
   w0fulla <= 
      w1pad_d1 - ("0000" & prescaledfY_d11)			when "01",
      w1pad_d1 + ("0000" & prescaledfY_d11)			when "11",
      w1pad_d1 + ("000" & prescaledfY_d11 & "0")		when "10",
   ...
   qP0 <= q0(2 downto 0);
   qM0 <= q0(3)  & "00";
   qP <= qP13_d11 & qP12_d10 & qP11_d9 & qP10_d9 & qP9_d8 & qP8_d7 & qP7_d6 & qP6_d5 & qP5_d4 & qP4_d3 & qP3_d2 & qP2_d1 & qP1_d1 & qP0;
   qM <= qM13_d11(1 downto 0) & qM12_d10 & qM11_d9 & qM10_d9 & qM9_d8 & qM8_d7 & qM7_d6 & qM6_d5 & qM5_d4 & qM4_d3 & qM3_d2 & qM2_d1 & qM1_d1 & qM0 & "0";
   ...
   round <= fRnorm(0); 
   expR1 <= expR0_d12 + ("000" & (8 downto 1 => '1') & mR(37)); -- add back bias
   -- final rounding
   ...
   R <= exnRfinal & sR_d12 & expfracR(44 downto 0);
end architecture;
