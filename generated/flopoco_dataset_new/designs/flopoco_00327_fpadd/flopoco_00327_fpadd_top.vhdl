...
entity IntAdder_41_Freq200_uid9 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_41_Freq200_uid9 is
...
architecture arch of flopoco_00327_fpadd_top is
   ...
   component IntAdder_41_Freq200_uid9 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(40 downto 0);
             Y : in  std_logic_vector(40 downto 0);
             Cin : in  std_logic;
...
-- Far Path --
   ...
   -- far path adder
   FPAdd_8_31_Freq200_uid2_fracAddFar: IntAdder_35_Freq200_uid6
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
   ...
   -- final round adder
   FPAdd_8_31_Freq200_uid2_finalRoundAdd: IntAdder_41_Freq200_uid9
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
