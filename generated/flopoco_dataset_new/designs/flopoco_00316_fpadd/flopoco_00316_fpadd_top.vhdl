...
entity flopoco_00316_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00316_fpadd_top is
...
-- Exponent difference and swap  --
   ...
   mY <= inY(47 downto 46) & not(inY(45)) & inY(44 downto 0);
...
-- Close Path --
   ...
   FPSub_10_35_Freq300_uid2_DualSubClose: IntDualSub_38_Freq300_uid4
      port map ( clk  => clk,
                 X => fracXClose1,
                 Y => fracYClose1,
                 XmY => fracRClosexMy,
...
-- Far Path --
   ...
   -- far path adder
   FPSub_10_35_Freq300_uid2_fracAddFar: IntAdder_39_Freq300_uid10
      port map ( clk  => clk,
                 Cin => cInAddFar,
                 X => fracXfar,
                 Y => fracYfarXorOp,
...
-- Synchronization of both paths --
   ...
   -- final round adder
   FPSub_10_35_Freq300_uid2_finalRoundAdd: IntAdder_47_Freq300_uid13
      port map ( clk  => clk,
                 Cin => round,
                 X => resultBeforeRound,
