--------------------------------------------------------------------------------
--                 RightShifterSticky8_by_max_10_Freq250_uid4
...
entity RightShifterSticky8_by_max_10_Freq250_uid4 is
...
architecture arch of RightShifterSticky8_by_max_10_Freq250_uid4 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_12_12_12_Freq250_uid8
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Count: (c1, 0.608500ns)R: (c1, 0.823500ns)
...
entity Normalizer_Z_12_12_12_Freq250_uid8 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_12_12_12_Freq250_uid8 is
...
signal count1 :  std_logic;
   -- timing of count1: (c1, 0.176625ns)
signal level1 :  std_logic_vector(11 downto 0);
   -- timing of level1: (c1, 0.391625ns)
signal count0 :  std_logic;
   -- timing of count0: (c1, 0.608500ns)
signal level0 :  std_logic_vector(11 downto 0);
   -- timing of level0: (c1, 0.823500ns)
signal sCount :  std_logic_vector(3 downto 0);
   -- timing of sCount: (c1, 0.608500ns)
begin
   process(clk)
      begin
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 1.106500ns)Y: (c0, 0.000000ns)Cin: (c1, 1.038500ns)
--  approx. output signal timings: R: (c1, 1.645500ns)
...
entity IntAdder_18_Freq250_uid11 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_18_Freq250_uid11 is
signal Rtmp :  std_logic_vector(17 downto 0);
   -- timing of Rtmp: (c1, 1.645500ns)
...
--------------------------------------------------------------------------------
--                          flopoco_00280_fpadd_top
--                          (FPSub_8_7_Freq250_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 250MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c1, 2.075500ns)
...
entity flopoco_00280_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00280_fpadd_top is
   component RightShifterSticky8_by_max_10_Freq250_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(7 downto 0);
             S : in  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(9 downto 0);
   ...
   component Normalizer_Z_12_12_12_Freq250_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(11 downto 0);
             Count : out  std_logic_vector(3 downto 0);
             R : out  std_logic_vector(11 downto 0)   );
   ...
   component IntAdder_18_Freq250_uid11 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(17 downto 0);
             Y : in  std_logic_vector(17 downto 0);
             Cin : in  std_logic;
...
signal nZerosNew :  std_logic_vector(3 downto 0);
   -- timing of nZerosNew: (c1, 0.608500ns)
signal shiftedFrac :  std_logic_vector(11 downto 0);
   -- timing of shiftedFrac: (c1, 0.823500ns)
signal extendedExpInc, extendedExpInc_d1 :  std_logic_vector(8 downto 0);
   -- timing of extendedExpInc: (c0, 1.211000ns)
signal updatedExp :  std_logic_vector(9 downto 0);
   -- timing of updatedExp: (c1, 1.106500ns)
signal eqdiffsign :  std_logic;
   -- timing of eqdiffsign: (c1, 0.608500ns)
signal expFrac :  std_logic_vector(17 downto 0);
   -- timing of expFrac: (c1, 1.106500ns)
signal stk :  std_logic;
   -- timing of stk: (c1, 0.823500ns)
signal rnd :  std_logic;
   -- timing of rnd: (c1, 0.823500ns)
signal lsb :  std_logic;
   -- timing of lsb: (c1, 0.823500ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c1, 1.038500ns)
signal RoundedExpFrac :  std_logic_vector(17 downto 0);
   -- timing of RoundedExpFrac: (c1, 1.645500ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c1, 1.645500ns)
signal fracR :  std_logic_vector(6 downto 0);
   -- timing of fracR: (c1, 1.645500ns)
signal expR :  std_logic_vector(7 downto 0);
   -- timing of expR: (c1, 1.645500ns)
signal exExpExc :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c1, 1.645500ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c1, 1.860500ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c1, 2.075500ns)
signal signR2 :  std_logic;
   -- timing of signR2: (c1, 0.823500ns)
signal computedR :  std_logic_vector(17 downto 0);
   -- timing of computedR: (c1, 2.075500ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   RightShifterComponent: RightShifterSticky8_by_max_10_Freq250_uid4
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracY,
                 R => shiftedFracY,
   ...
   LZCAndShifter: Normalizer_Z_12_12_12_Freq250_uid8
      port map ( clk  => clk,
                 X => fracSticky,
                 Count => nZerosNew,
                 R => shiftedFrac);
   ...
   roundingAdder: IntAdder_18_Freq250_uid11
      port map ( clk  => clk,
                 Cin => needToRound,
                 X => expFrac,
