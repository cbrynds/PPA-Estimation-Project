--------------------------------------------------------------------------------
--                     IntComparator_15_111_Freq150_uid4
...
entity IntComparator_15_111_Freq150_uid4 is
...
architecture arch of IntComparator_15_111_Freq150_uid4 is
...
--------------------------------------------------------------------------------
--                       flopoco_00479_fpcomparator_top
--                      (FPComparator_8_7_Freq150_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
-- Authors: Florent de Dinechin (2021)
...
entity flopoco_00479_fpcomparator_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00479_fpcomparator_top is
   component IntComparator_15_111_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(14 downto 0);
             Y : in  std_logic_vector(14 downto 0);
             XltY : out  std_logic;
...
begin
   ...
   positiveY <= not signY ;
   -- expfrac comparisons 
   ExpFracCmp: IntComparator_15_111_Freq150_uid4
      port map ( clk  => clk,
                 X => ExpFracX,
                 Y => ExpFracY,
