...
--  approx. output signal timings: R: (c1, 1.959000ns)
...
entity flopoco_00339_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+7+2 downto 0);
          R : out  std_logic_vector(8+7+2 downto 0)   );
end entity;

architecture arch of flopoco_00339_fpsqrt_top is
...
signal T4s_l, T4s_l_d1 :  std_logic_vector(2 downto 0);
...
signal d9 :  std_logic;
   -- timing of d9: (c1, 1.487000ns)
signal mR :  std_logic_vector(9 downto 0);
   -- timing of mR: (c1, 1.487000ns)
signal fR :  std_logic_vector(6 downto 0);
   -- timing of fR: (c1, 1.487000ns)
signal round :  std_logic;
   -- timing of round: (c1, 1.487000ns)
signal fRrnd :  std_logic_vector(6 downto 0);
   -- timing of fRrnd: (c1, 1.959000ns)
signal Rn2 :  std_logic_vector(14 downto 0);
   -- timing of Rn2: (c1, 1.959000ns)
