...
--  approx. output signal timings: R: (c2, 4.916667ns)
...
entity flopoco_00141_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+23+2 downto 0);
          R : out  std_logic_vector(8+23+2 downto 0)   );
end entity;

architecture arch of flopoco_00141_fpsqrt_top is
...
signal fR :  std_logic_vector(22 downto 0);
   -- timing of fR: (c2, 4.377667ns)
signal round :  std_logic;
   -- timing of round: (c2, 4.342667ns)
signal fRrnd :  std_logic_vector(22 downto 0);
   -- timing of fRrnd: (c2, 4.916667ns)
signal Rn2 :  std_logic_vector(30 downto 0);
   -- timing of Rn2: (c2, 4.916667ns)
