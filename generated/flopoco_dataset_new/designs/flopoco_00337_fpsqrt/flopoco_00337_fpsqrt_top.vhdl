...
--  approx. output signal timings: R: (c6, 1.654000ns)
...
entity flopoco_00337_fpsqrt_top is
    port (clk : in std_logic;
          X : in  std_logic_vector(8+23+2 downto 0);
          R : out  std_logic_vector(8+23+2 downto 0)   );
end entity;

architecture arch of flopoco_00337_fpsqrt_top is
...
signal d25 :  std_logic;
   -- timing of d25: (c6, 1.115000ns)
signal mR :  std_logic_vector(25 downto 0);
   -- timing of mR: (c6, 1.115000ns)
signal fR :  std_logic_vector(22 downto 0);
   -- timing of fR: (c6, 1.115000ns)
signal round :  std_logic;
   -- timing of round: (c6, 1.115000ns)
signal fRrnd :  std_logic_vector(22 downto 0);
   -- timing of fRrnd: (c6, 1.654000ns)
signal Rn2 :  std_logic_vector(30 downto 0);
   -- timing of Rn2: (c6, 1.654000ns)
