--------------------------------------------------------------------------------
--                RightShifterSticky53_by_max_55_Freq150_uid4
...
entity RightShifterSticky53_by_max_55_Freq150_uid4 is
...
architecture arch of RightShifterSticky53_by_max_55_Freq150_uid4 is
...
--------------------------------------------------------------------------------
--                     Normalizer_Z_57_57_57_Freq150_uid8
-- VHDL generated for VirtexUltrascalePlus @ 150MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: Count: (c0, 6.110250ns)R: (c0, 6.325250ns)
...
entity Normalizer_Z_57_57_57_Freq150_uid8 is
    port (clk : in std_logic;
...
architecture arch of Normalizer_Z_57_57_57_Freq150_uid8 is
signal level6 :  std_logic_vector(56 downto 0);
   -- timing of level6: (c0, 3.719000ns)
signal count5 :  std_logic;
   -- timing of count5: (c0, 3.945250ns)
signal level5 :  std_logic_vector(56 downto 0);
   -- timing of level5: (c0, 4.160250ns)
signal count4 :  std_logic;
   -- timing of count4: (c0, 4.380875ns)
signal level4 :  std_logic_vector(56 downto 0);
   -- timing of level4: (c0, 4.595875ns)
signal count3 :  std_logic;
   -- timing of count3: (c0, 4.814625ns)
signal level3 :  std_logic_vector(56 downto 0);
   -- timing of level3: (c0, 5.029625ns)
signal count2 :  std_logic;
   -- timing of count2: (c0, 5.246500ns)
signal level2 :  std_logic_vector(56 downto 0);
   -- timing of level2: (c0, 5.461500ns)
signal count1 :  std_logic;
   -- timing of count1: (c0, 5.678375ns)
signal level1 :  std_logic_vector(56 downto 0);
   -- timing of level1: (c0, 5.893375ns)
signal count0 :  std_logic;
   -- timing of count0: (c0, 6.110250ns)
signal level0 :  std_logic_vector(56 downto 0);
   -- timing of level0: (c0, 6.325250ns)
signal sCount :  std_logic_vector(5 downto 0);
   -- timing of sCount: (c0, 6.110250ns)
begin
   level6 <= X ;
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c1, 0.091583ns)Y: (c0, 0.000000ns)Cin: (c1, 0.023583ns)
--  approx. output signal timings: R: (c1, 0.876583ns)
...
entity IntAdder_66_Freq150_uid11 is
    port (clk : in std_logic;
...
architecture arch of IntAdder_66_Freq150_uid11 is
signal Rtmp :  std_logic_vector(65 downto 0);
   -- timing of Rtmp: (c1, 0.876583ns)
...
--  approx. output signal timings: R: (c1, 1.306583ns)
...
entity flopoco_00336_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00336_fpadd_top is
   component RightShifterSticky53_by_max_55_Freq150_uid4 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(52 downto 0);
             S : in  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(54 downto 0);
   ...
   component Normalizer_Z_57_57_57_Freq150_uid8 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(56 downto 0);
             Count : out  std_logic_vector(5 downto 0);
             R : out  std_logic_vector(56 downto 0)   );
   ...
   component IntAdder_66_Freq150_uid11 is
      port ( clk : in std_logic;
             X : in  std_logic_vector(65 downto 0);
             Y : in  std_logic_vector(65 downto 0);
             Cin : in  std_logic;
...
signal nZerosNew, nZerosNew_d1 :  std_logic_vector(5 downto 0);
   -- timing of nZerosNew: (c0, 6.110250ns)
signal shiftedFrac, shiftedFrac_d1 :  std_logic_vector(56 downto 0);
   -- timing of shiftedFrac: (c0, 6.325250ns)
signal extendedExpInc, extendedExpInc_d1 :  std_logic_vector(11 downto 0);
   -- timing of extendedExpInc: (c0, 1.334000ns)
signal updatedExp :  std_logic_vector(12 downto 0);
   -- timing of updatedExp: (c1, 0.091583ns)
signal eqdiffsign, eqdiffsign_d1 :  std_logic;
   -- timing of eqdiffsign: (c0, 6.110250ns)
signal expFrac :  std_logic_vector(65 downto 0);
   -- timing of expFrac: (c1, 0.091583ns)
signal stk, stk_d1 :  std_logic;
   -- timing of stk: (c0, 6.325250ns)
signal rnd, rnd_d1 :  std_logic;
   -- timing of rnd: (c0, 6.325250ns)
signal lsb, lsb_d1 :  std_logic;
   -- timing of lsb: (c0, 6.325250ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c1, 0.023583ns)
signal RoundedExpFrac :  std_logic_vector(65 downto 0);
   -- timing of RoundedExpFrac: (c1, 0.876583ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c1, 0.876583ns)
signal fracR :  std_logic_vector(51 downto 0);
   -- timing of fracR: (c1, 0.876583ns)
signal expR :  std_logic_vector(10 downto 0);
   -- timing of expR: (c1, 0.876583ns)
signal exExpExc :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c1, 0.876583ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c1, 1.091583ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c1, 1.306583ns)
signal signR2, signR2_d1 :  std_logic;
   -- timing of signR2: (c0, 6.325250ns)
signal computedR :  std_logic_vector(65 downto 0);
   -- timing of computedR: (c1, 1.306583ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   RightShifterComponent: RightShifterSticky53_by_max_55_Freq150_uid4
      port map ( clk  => clk,
                 S => shiftVal,
                 X => fracY,
                 R => shiftedFracY,
   ...
   LZCAndShifter: Normalizer_Z_57_57_57_Freq150_uid8
      port map ( clk  => clk,
                 X => fracSticky,
                 Count => nZerosNew,
                 R => shiftedFrac);
   extendedExpInc<= ("0" & expX) + '1';
   updatedExp <= ("0" &extendedExpInc_d1) - ("0000000" & nZerosNew_d1);
   ...
   roundingAdder: IntAdder_66_Freq150_uid11
      port map ( clk  => clk,
                 Cin => needToRound,
                 X => expFrac,
