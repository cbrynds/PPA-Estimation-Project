...
--  approx. output signal timings: R: (c1, 0.064750ns)Sticky: (c1, 0.951000ns)
...
-- Output signals: R
--  approx. input signal timings: X: (c0, 0.836000ns)Y: (c1, 0.279750ns)Cin: (c1, 1.166000ns)
--  approx. output signal timings: R: (c2, 0.517000ns)
...
signal Cin_0, Cin_0_d1 :  std_logic;
   -- timing of Cin_0: (c1, 1.166000ns)
signal X_0, X_0_d1, X_0_d2 :  std_logic_vector(48 downto 0);
   -- timing of X_0: (c0, 0.836000ns)
signal Y_0, Y_0_d1 :  std_logic_vector(48 downto 0);
   -- timing of Y_0: (c1, 0.279750ns)
signal S_0 :  std_logic_vector(48 downto 0);
   -- timing of S_0: (c2, 0.019000ns)
signal R_0 :  std_logic_vector(47 downto 0);
   -- timing of R_0: (c2, 0.019000ns)
signal Cin_1 :  std_logic;
   -- timing of Cin_1: (c2, 0.019000ns)
signal X_1, X_1_d1, X_1_d2 :  std_logic_vector(8 downto 0);
   -- timing of X_1: (c0, 0.836000ns)
signal Y_1, Y_1_d1 :  std_logic_vector(8 downto 0);
   -- timing of Y_1: (c1, 0.279750ns)
signal S_1 :  std_logic_vector(8 downto 0);
   -- timing of S_1: (c2, 0.517000ns)
signal R_1 :  std_logic_vector(7 downto 0);
   -- timing of R_1: (c2, 0.517000ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   R_0 <= S_0(47 downto 0);
   Cin_1 <= S_0(48);
   X_1 <= '0' & X(55 downto 48);
   Y_1 <= '0' & Y(55 downto 48);
...
--  approx. input signal timings: X: (c2, 0.517000ns)
--  approx. output signal timings: Count: (c3, 1.058250ns)R: (c3, 1.273250ns)
...
signal level6 :  std_logic_vector(56 downto 0);
   -- timing of level6: (c2, 0.517000ns)
signal count5, count5_d1 :  std_logic;
   -- timing of count5: (c2, 0.743250ns)
signal level5 :  std_logic_vector(56 downto 0);
   -- timing of level5: (c2, 0.958250ns)
signal count4, count4_d1 :  std_logic;
   -- timing of count4: (c2, 1.178875ns)
signal level4 :  std_logic_vector(56 downto 0);
   -- timing of level4: (c2, 1.393875ns)
signal count3, count3_d1 :  std_logic;
   -- timing of count3: (c2, 1.612625ns)
signal level3, level3_d1 :  std_logic_vector(56 downto 0);
   -- timing of level3: (c2, 1.827625ns)
signal count2 :  std_logic;
   -- timing of count2: (c3, 0.194500ns)
signal level2 :  std_logic_vector(56 downto 0);
   -- timing of level2: (c3, 0.409500ns)
signal count1 :  std_logic;
   -- timing of count1: (c3, 0.626375ns)
signal level1 :  std_logic_vector(56 downto 0);
   -- timing of level1: (c3, 0.841375ns)
signal count0 :  std_logic;
   -- timing of count0: (c3, 1.058250ns)
signal level0 :  std_logic_vector(56 downto 0);
   -- timing of level0: (c3, 1.273250ns)
signal sCount :  std_logic_vector(5 downto 0);
   -- timing of sCount: (c3, 1.058250ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
-- Input signals: X Y Cin
-- Output signals: R
--  approx. input signal timings: X: (c3, 1.556250ns)Y: (c0, 0.000000ns)Cin: (c3, 1.488250ns)
--  approx. output signal timings: R: (c4, 0.491250ns)
...
signal Cin_1, Cin_1_d1 :  std_logic;
   -- timing of Cin_1: (c3, 1.488250ns)
signal X_1, X_1_d1 :  std_logic_vector(66 downto 0);
   -- timing of X_1: (c3, 1.556250ns)
signal Y_1, Y_1_d1, Y_1_d2, Y_1_d3, Y_1_d4 :  std_logic_vector(66 downto 0);
   -- timing of Y_1: (c0, 0.000000ns)
signal S_1 :  std_logic_vector(66 downto 0);
   -- timing of S_1: (c4, 0.491250ns)
signal R_1 :  std_logic_vector(65 downto 0);
   -- timing of R_1: (c4, 0.491250ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
...
--------------------------------------------------------------------------------
--                          flopoco_00436_fpadd_top
--                         (FPSub_11_52_Freq500_uid2)
-- VHDL generated for VirtexUltrascalePlus @ 500MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
--  approx. output signal timings: R: (c4, 0.921250ns)
...
entity flopoco_00436_fpadd_top is
    port (clk : in std_logic;
...
architecture arch of flopoco_00436_fpadd_top is
...
signal shiftedFracY :  std_logic_vector(54 downto 0);
   -- timing of shiftedFracY: (c1, 0.064750ns)
signal sticky, sticky_d1 :  std_logic;
   -- timing of sticky: (c1, 0.951000ns)
signal fracYpad :  std_logic_vector(55 downto 0);
   -- timing of fracYpad: (c1, 0.064750ns)
...
signal fracYpadXorOp :  std_logic_vector(55 downto 0);
   -- timing of fracYpadXorOp: (c1, 0.279750ns)
signal fracXpad :  std_logic_vector(55 downto 0);
   -- timing of fracXpad: (c0, 0.836000ns)
signal cInSigAdd :  std_logic;
   -- timing of cInSigAdd: (c1, 1.166000ns)
signal fracAddResult :  std_logic_vector(55 downto 0);
   -- timing of fracAddResult: (c2, 0.517000ns)
signal fracSticky :  std_logic_vector(56 downto 0);
   -- timing of fracSticky: (c2, 0.517000ns)
signal nZerosNew :  std_logic_vector(5 downto 0);
   -- timing of nZerosNew: (c3, 1.058250ns)
signal shiftedFrac :  std_logic_vector(56 downto 0);
   -- timing of shiftedFrac: (c3, 1.273250ns)
signal extendedExpInc, extendedExpInc_d1, extendedExpInc_d2, extendedExpInc_d3 :  std_logic_vector(11 downto 0);
   -- timing of extendedExpInc: (c0, 1.334000ns)
signal updatedExp :  std_logic_vector(12 downto 0);
   -- timing of updatedExp: (c3, 1.556250ns)
signal eqdiffsign, eqdiffsign_d1 :  std_logic;
   -- timing of eqdiffsign: (c3, 1.058250ns)
signal expFrac :  std_logic_vector(65 downto 0);
   -- timing of expFrac: (c3, 1.556250ns)
signal stk :  std_logic;
   -- timing of stk: (c3, 1.273250ns)
signal rnd :  std_logic;
   -- timing of rnd: (c3, 1.273250ns)
signal lsb :  std_logic;
   -- timing of lsb: (c3, 1.273250ns)
signal needToRound :  std_logic;
   -- timing of needToRound: (c3, 1.488250ns)
signal RoundedExpFrac :  std_logic_vector(65 downto 0);
   -- timing of RoundedExpFrac: (c4, 0.491250ns)
signal upExc :  std_logic_vector(1 downto 0);
   -- timing of upExc: (c4, 0.491250ns)
signal fracR :  std_logic_vector(51 downto 0);
   -- timing of fracR: (c4, 0.491250ns)
signal expR :  std_logic_vector(10 downto 0);
   -- timing of expR: (c4, 0.491250ns)
signal exExpExc :  std_logic_vector(3 downto 0);
   -- timing of exExpExc: (c4, 0.491250ns)
signal excRt2 :  std_logic_vector(1 downto 0);
   -- timing of excRt2: (c4, 0.706250ns)
signal excR :  std_logic_vector(1 downto 0);
   -- timing of excR: (c4, 0.921250ns)
signal signR2, signR2_d1 :  std_logic;
   -- timing of signR2: (c3, 1.273250ns)
signal computedR :  std_logic_vector(65 downto 0);
   -- timing of computedR: (c4, 0.921250ns)
begin
   process(clk)
      begin
         if clk'event and clk = '1' then
   ...
   updatedExp <= ("0" &extendedExpInc_d3) - ("0000000" & nZerosNew);
