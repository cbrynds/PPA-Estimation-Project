...
# Plot a training metric across epochs (e.g. loss, MAE, R^2)
...
# Plot a pair of training metric curves on a single figure (e.g. training vs testing loss, training vs testing MAE)
