...
class Hyperparameters:
    ...
    learning_rate: float = float( os.getenv("QORNET_LEARNING_RATE", 1e-4) )
    #batch_size: int = 32
    ...
    hidden_dim: int = int( os.getenv("QORNET_HIDDEN_DIM", 32) )
    #num_gat_layers: int = 2                 # Reduced to 2 for simplicity
    num_gat_layers: int = int( os.getenv("QORNET_NUM_GAT_LAYERS", 2) )
    num_heads: int = 4
    dropout: float = 0.1
