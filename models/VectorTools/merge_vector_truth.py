...
DEFAULT_VECTOR_JSON = DATA_ROOT / "AST_parsing_vector_data" / "ast_vector.json"
DEFAULT_TRUTH_CSV = DATA_ROOT / "post_synthesis_truth_data" / "iscas_ground_truth_qor.csv"
DEFAULT_OUTPUT_CSV = DATA_ROOT / "merged_vector_dataset.csv"
...
# Minimal set of columns required for a complete row to be used by the vector models.
