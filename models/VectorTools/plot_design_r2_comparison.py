...
DATA_ROOT = ROOT / "models" / "VectorTools" / "data"
TOOL_RESULTS_ROOT = ROOT / "models" / "VectorTools" / "results"
MODEL_RESULT_DIRS = {
    "linear_regression": ROOT / "models" / "LinearRegression" / "results" / "linear_regression",
    "mlp": ROOT / "models" / "MLP" / "results" / "mlp",
}
DEFAULT_OUTPUT_DIR = TOOL_RESULTS_ROOT / "design_r2_comparison"
GRAPH_R2_SOURCES = {
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=[],
        metavar="MODEL=PATH",
        help="Example: --run mlp=models/MLP/results/mlp/run_072",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
...
def find_latest_run(model_name):
    model_dir = MODEL_RESULT_DIRS[model_name]
